...
[try to solve]
Updated ten-locale `tool_unit_converter_title` values so H1 lists Length / Mass / Temperature / Area / Volume / Speed (localized). Used `/` separators instead of commas/顿号 to avoid the param-enum title heuristic while still surfacing every category. Synced work-tasks 02/03; merge:tools + coverage:gate phase 2/4 + build:site + lint:seo OK. Example en: “Unit Converter — Length / Mass / Temperature / Area / Volume / Speed”; zh: “单位换算器 — 长度 / 质量 / 温度 / 面积 / 体积 / 速度”.
