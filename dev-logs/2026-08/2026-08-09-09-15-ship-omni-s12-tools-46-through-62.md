...
[try to solve]
Shipped all 17 remaining §12 tools (#46–#62) serially via omni-s12 ship-one (work-tasks 00–03, coverage 0b/2/4/all, build:site, lint:seo, isolation). Catalog count 114. YMYL only for macros and heart-rate. Inventory §9/§12 and Omni TSV marked live; README en/zh updated.
...
- inventory/README/TSV marked live; catalog 114
