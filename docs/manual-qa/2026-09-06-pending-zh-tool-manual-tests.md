...
- **自动测试报告**：`docs/manual-qa/2026-09-06-zh-tool-auto-qa-report.md`（2026-09-06 09:24；本地 `8788`）
...
- **自动结论摘要**：5 个样例稳定失败（html2pdf 缺 jsPDF、unlock 样例、数字标记、PDF→Word）；1 个导航超时复测已过（markdown-to-html）；10 个文案/How 警告。其余优先手动项见报告 §4。
