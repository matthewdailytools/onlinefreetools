...
2026-08-28 用户点名后已开：`terraform-cidrsubnet`、`ip-range-to-cidr`、`private-cidr-ranges`；同日点名「cidr notation calculator」已开收割页 `work-tasks/cidr-to-ip-range/`（0b ready；不占周进攻）。其余 P1/P2 slug 仍须点名再建夹。
