...
- locale / gl:
- seed queries: (list; may include head terms for expansion only)
- method note: (manual / export / other — no secrets)

## Candidates (pre-filter)

| candidate | from (related/paa/autocomplete) | SERP type notes | competition_tier | gap (1 line) | draft verdict |
|---|---|---|---|---|---|
| … | … | tool / wiki / forum / thin | head/mid_covered/long_gap/locale_gap | who owns + what's missing | build/absorb/defer/drop |

## Picked for pool (~10)

- … (prefer long_gap / locale_gap)
```
