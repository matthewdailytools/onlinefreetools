/**
 * write-nested-if-formula-for-excel tool page.
...
const PREFIX = 'tool_write_nested_if_formula_for_excel';
...
export const renderWriteNestedIfFormulaForExcelPage = (opts: {
	...
	const sidebarHtml = renderSidebar({
		...
		groups: buildToolSidebarItems({
			...
			currentSlug: 'write-nested-if-formula-for-excel',
			currentAnchor: '#write',
		}),
		id: 'toolNav',
	});
  ...
  <style>
	...
	const referencesHtml = renderToolReferencesSection({
		lang: opts.lang,
		links: [
			{ label: "Microsoft IF function", href: "https://support.microsoft.com/office/if-function-69aed7c9-4e8a-4755-a9bc-aa8bbff73be2" }
		],
	});
  ...
  <script>
    (function () {
      ...
      function run() {
        ...
        showErr('');
        var formula = emitNested(cell, list, elseEl.value);
	...
	const toolMeta = getToolBySlug('write-nested-if-formula-for-excel');
