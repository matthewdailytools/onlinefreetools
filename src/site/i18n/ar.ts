...
const ar: SiteLangDict = {
  ...
  tool_prompt_template_builder_desc: 'قالب Prompt منظم (Markdown/JSON) — يبقى على جهازك دون رفع إلى خادم.',
  ...
  tool_prompt_template_builder_faq_a1: 'لا. يُبنى القالب في تبويب المتصفح هذا. لا يُرفع إلى OpenAI أو Anthropic أو خوادمنا.',
  tool_prompt_template_builder_faq_a2: 'لا. هذه الصفحة تنسّق نصك فقط في كتل. لا تستدعي أي نموذج ولا ت invent نصًا جديدًا.',
  ...
  tool_prompt_template_builder_faq_a4: 'نعم. شريحة JSON تُخرج {role,task,constraints,output}. ادمجها مع مدقق JSON Schema عند الحاجة.',
  ...
  tool_prompt_template_builder_how_item_1: 'الصق مسودة أو املأ Role وTask وConstraints وOutput — المهمة قالب prompt منظم.',
  ...
  tool_prompt_template_builder_rules_body: 'القالب القابل لإعادة الاستخدام يحتاج كتلًا واضحة وحدودًا صادقة — وليس مولّدًا ثانيًا.',
  ...
  tool_prompt_template_builder_usecase_1: 'انشر system prompt لمراجعة الكود يمكن للفريق لصقه في أي واجهة دردشة.',
  tool_prompt_template_builder_usecase_2: 'حوّل ملاحظات الاجتماع إلى كتل Role/Task/Constraints قبل ربط API.',
  tool_prompt_template_builder_usecase_3: 'صدّر JSON ثم افتح مدقق JSON Schema للتحقق من ملفات الإعداد.',
