...
const ar: SiteLangDict = {
  ...
  pdf_work_page: 'الصفحة {n} / {total}',
  pdf_work_prev: 'السابق',
  pdf_work_preview: 'معاينة PDF',
  pdf_work_progress: 'التقدم',
  ...
  tool_add_digital_signature_to_pdf_description:
    'أضف مظهر توقيع رقمي إلى PDF في المتصفح: احسب SHA-256، اختم مربعاً «موسوم رقمياً» بختم زمني وبادئة تجزئة، ثم نزّل. تبقى الملفات على جهازك دون رفع إلى خادم. تظهر عملية الوسم ومثال مع العينة. هذا مظهر سلامة وليس توقيع PKI بشهادة.',
  tool_add_digital_signature_to_pdf_disclaimer:
    'مظهر سلامة فقط — ليس توقيعاً رقمياً بشهادة (بلا PKCS#7 / PAdES) ولا مشورة قانونية. بعد الختم يتغير تجزئة الملف.',
  ...
  tool_add_text_to_pdf_file_description:
    'إضافة نص إلى ملف PDF. تبقى الملفات على جهازك دون رفع إلى خادم. يمكن تحميل المثال لمراجعة مدخل فعلي ونتيجته؛ وتوضح الصفحة الخطوات والحدود.',
  ...
  tool_add_text_to_pdf_file_faq_a4:
    'تحرير نص PDF يغيّر الصياغة الموجودة. كتابة PDF ينشئ ملفاً جديداً من نص مكتوب. هذه الصفحة ترسم طابعاً جديداً عند X/Y في كل صفحة فقط.',
  ...
  tool_add_text_to_pdf_file_how_body:
    'اختر PDF، حدّد نص الطابع وX/Y وحجم الخط، أضفه لكل صفحة، اعرض المعاينة ثم نزّل. الملفات تبقى في هذا التبويب.',
  ...
  tool_add_text_to_pdf_file_rules_item_3:
    'PDF الممسوح ضوئياً كصورة فقط يعمل أيضاً: يُرسم النص الجديد فوقه؛ البكسل الحالي لا يُعرّف ضوئياً ولا يُعاد كتابته.',
  ...
  tool_android_prompt_builder_ai_consent_cancel: 'إلغاء',
  tool_android_prompt_builder_ai_consent_ok: 'متابعة',
  tool_android_prompt_builder_ai_consent_title: 'إرسال المسودة إلى Cloudflare Workers AI؟',
  tool_android_prompt_builder_ai_done: 'استبدل نص الذكاء الاصطناعي محتوى النتيجة. راجعه قبل النسخ.',
  tool_android_prompt_builder_ai_err_generic: 'فشل الذكاء الاصطناعي، والنتيجة كما هي.',
  tool_android_prompt_builder_ai_err_rate: 'نفد حد الذكاء الاصطناعي. استخدم الوضع المحلي أو عد غداً (UTC).',
  tool_android_prompt_builder_ai_err_turnstile: 'أكمل Turnstile قبل استخدام الذكاء الاصطناعي.',
  tool_android_prompt_builder_ai_expand: 'توسيع بالذكاء الاصطناعي',
  tool_android_prompt_builder_ai_panel_label: 'Cloudflare AI اختياري (Turnstile)',
  tool_android_prompt_builder_ai_polish: 'تنقيح بالذكاء الاصطناعي',
  tool_android_prompt_builder_ai_working: 'Cloudflare AI يعمل…',
  ...
  tool_android_prompt_builder_build: 'إنشاء البرومبت',
  tool_android_prompt_builder_clear: 'تفريغ',
  tool_android_prompt_builder_compose_ui_label: 'Compose / الشاشة',
  tool_android_prompt_builder_compose_ui_ph: 'مثال: LazyColumn برؤوس ثابتة…',
  ...
  tool_android_prompt_builder_empty: 'املأ حقلاً واحداً على الأقل قبل الإنشاء.',
  ...
  tool_android_prompt_builder_faq_q1: 'هل يُرفع ما أكتبه إلى خادم؟',
  tool_android_prompt_builder_faq_q2: 'هل تستدعي الصفحة واجهة ChatGPT أو نماذج أخرى؟',
  tool_android_prompt_builder_faq_q3: 'ما الفرق عن أداة قوالب البرومبت؟',
  tool_android_prompt_builder_faq_q4: 'لماذا يطلب الذكاء الاصطناعي الاختياري Turnstile؟',
  tool_android_prompt_builder_faq_q5: 'هل يمكن التصدير بصيغة JSON؟',
  tool_android_prompt_builder_faq_q6: 'هل تعمل مع ChatGPT و Gemini و Claude و DeepSeek؟',
  tool_android_prompt_builder_faq_q7: 'ما الفرق بين التجميع المحلي و Cloudflare AI الاختياري؟',
  tool_android_prompt_builder_feature_spec_label: 'الميزة / المواصفات',
  tool_android_prompt_builder_feature_spec_ph: 'مثال: قائمة قراءة دون اتصال مع بحث…',
  ...
  tool_android_prompt_builder_gradle_constraints_label: 'Gradle / القيود',
  tool_android_prompt_builder_gradle_constraints_ph: 'مثال: minSdk 26، targetSdk 35، وحدة :core:data…',
  ...
  tool_android_prompt_builder_how_item_1: 'اضغط «تحميل المثال» فتُملأ الحقول ويُجمَّع برومبت جاهز، ثم ابدأ التعديل منه.',
  tool_android_prompt_builder_how_item_2: 'عدّل الميزة والحزمة والشاشة والقيود ثم اضغط «إنشاء البرومبت»؛ وللتصدير المهيكل بدّل إلى JSON.',
  tool_android_prompt_builder_how_item_3: 'اختياري: أكمل Turnstile ثم اضغط «توسيع» أو «تنقيح»، فيحتل نص الذكاء الاصطناعي منطقة النتيجة.',
  tool_android_prompt_builder_how_item_4: 'انسخ النتيجة أو نزّلها، ثم الصقها في ChatGPT أو Gemini أو Claude أو DeepSeek.',
  tool_android_prompt_builder_how_title: 'طريقة الاستخدام',
  tool_android_prompt_builder_kotlin_stack_label: 'Kotlin / الحزمة التقنية',
  tool_android_prompt_builder_kotlin_stack_ph: 'مثال: Kotlin 2.0، Jetpack Compose، Room، Hilt…',
  tool_android_prompt_builder_load_sample: 'تحميل المثال',
  tool_android_prompt_builder_platforms_lead: 'البرومبت النهائي نص عادي، ويُلصق كما هو في ChatGPT أو Gemini أو Claude أو DeepSeek.',
  tool_android_prompt_builder_result_label: 'ناتج البرومبت',
  ...
  tool_android_prompt_builder_rules_item_1: 'كل حقل يذهب إلى كتلة خاصة في Markdown: Role و Task و Constraints و Output.',
  tool_android_prompt_builder_rules_item_2: 'الإخراج الافتراضي Markdown، ويمكن للمنطقة نفسها إظهار JSON بالحقول والبرومبت المجمَّع.',
  tool_android_prompt_builder_rules_item_3: 'لا يغني Cloudflare AI عن التجميع المحلي: جوابه يشغل منطقة النتيجة بالكامل، فراجعه قبل النسخ.',
  tool_android_prompt_builder_rules_item_4: 'الأداة تجمع النص فقط: لا تبني Kotlin ولا تشغّل Gradle ولا تستدعي واجهات المحادثة بالنيابة عنك.',
  tool_android_prompt_builder_rules_title: 'حدود ينبغي توقعها',
  ...
  tool_android_prompt_builder_status_copied: 'تم النسخ إلى الحافظة.',
  tool_android_prompt_builder_status_done: 'البرومبت جاهز.',
  tool_android_prompt_builder_status_working: 'يجري تجميع البرومبت…',
  tool_android_prompt_builder_title: 'أداة إنشاء برومبت لتطوير Android — تجميع محلي مع ذكاء اصطناعي اختياري',
  tool_android_prompt_builder_usecase_1: 'تحويل المتطلب الذي ذُكر شفهياً في اجتماع التخطيط إلى برومبت يمكن لصقه في محادثة الفريق.',
  tool_android_prompt_builder_usecase_2: 'تصدير JSON لربط الحقول باختبار انحدار، ثم توسيع النص عبر Cloudflare AI عند الحاجة.',
  tool_android_prompt_builder_usecase_3: 'إن لم تحتج حقول Android وكفاك قالب عام من أربع كتل، فانتقل إلى أداة قوالب البرومبت.',
  tool_android_prompt_builder_usecase_4: 'صُغ الوصف الداخلي في المتصفح أولاً، ثم قرر بعدها إن كان يصح إرساله إلى الذكاء الاصطناعي الاختياري.',
  tool_android_prompt_builder_usecases_title: 'متى تفيد',
  ...
  tool_batch_checksum_release_files_faq_a2: 'لا. التصدير جدول CSV وملف SHA256SUMS. تعبئة الثنائيات هي إنشاء ZIP — مهمة أخرى.',
  tool_batch_checksum_release_files_faq_a3: 'هاش الملف ملف واحد أو لصق. هذه الصفحة تهشّ مجموعة إصدار وتقارن SHA256SUMS الملصوق وتصدّر CSV وSUMS.',
  tool_batch_checksum_release_files_faq_a4: 'شغّل «أيضاً MD5». SHA-256 يعمل دائماً. MD5 للقوائم القديمة وليس عنواناً ثانياً.',
  tool_batch_checksum_release_files_faq_a5: 'عمود المسار يفضّل webkitRelativePath. الأسماء المكررة في الصف تأخذ لاحقة حتى لا تتصادم أسطر SUMS.',
  ...
  tool_batch_checksum_release_files_rules_item_1: 'SHA-256 يعمل دائماً. MD5 اختياري ويحمّل crypto-js من هذا الموقع؛ البايتات تبقى في التبويب.',
  ...
  tool_batch_checksum_release_files_rules_item_3: 'فشل القراءة يتخطى ذلك الصف. الأسماء المكررة تأخذ لاحقة. الصف الفارغ يعطّل التصدير.',
  tool_batch_checksum_release_files_rules_item_4: 'الملفات تبقى على الجهاز ولا تُرفع إلى خادم.',
  ...
  tool_batch_compress_pdfs_for_email_faq_a2: 'لا. تحصل على ZIP فيه N من ملفات PDF. الدمج في كتيّب واحد هو دمج PDF — مهمة أخرى، ليست هذه الصفحة.',
  tool_batch_compress_pdfs_for_email_faq_a3: 'المسوحات بالصور غالباً تصغر. ملف النص فقط قد لا يتحرك تقريباً. الجدول يعرض الحجم قبل وبعد.',
  tool_batch_compress_pdfs_for_email_faq_a4: 'ضغط PDF يعالج ملفاً واحداً. هذه الصفحة تشارك إعداد بريد على رزمة وتعبئ الناجح في ZIP.',
  tool_batch_compress_pdfs_for_email_faq_a5: 'يُتخطى ذلك الصف ويكمل الباقي. أزل القفل في موضع آخر ثم أضفه مجدداً.',
  ...
  tool_batch_compress_pdfs_for_email_how_body: 'ضع عدة مرفقات في الصف، اختر إعداد البريد، اضغط كل ملف على حدة، ثم خذ ZIP للملفات التي نجحت.',
  ...
  tool_batch_compress_pdfs_for_email_rules_body: 'كل PDF يُحوَّل إلى صفحات JPEG ثم يُعاد بناؤه. الخرج دائماً ZIP لملفات PDF منفصلة.',
  tool_batch_compress_pdfs_for_email_rules_item_1: 'البريد هو الافتراضي: مقياس حوالي 1.0 وجودة JPEG حوالي 0.55. الطباعة ألطف. الأقصى يصغّر أكثر.',
  tool_batch_compress_pdfs_for_email_rules_item_2: 'التشفير أو التلف أو نفاد الذاكرة يتخطى ذلك الصف فقط. الأسماء المكررة في ZIP تصبح اسم (2).pdf.',
  tool_batch_compress_pdfs_for_email_rules_item_3: 'ملف النص فقط قد لا يصغر تقريباً. هذا متوقع؛ الجدول ما زال يعرض الأحجام.',
  tool_batch_compress_pdfs_for_email_rules_item_4: 'الملفات تبقى على الجهاز ولا تُرفع إلى خادم.',
  ...
  tool_batch_convert_jpg_to_text_with_ocr_combined_hint: 'مفعّل افتراضيًا. يتضمّن الأرشيف combined.txt مع --- اسم الملف --- بين الصور.',
  ...
  tool_batch_convert_jpg_to_text_with_ocr_err_empty: 'لا نص مطبوع. تم التخطي. جرّب صفحة أوضح، لا خط اليد.',
  tool_batch_convert_jpg_to_text_with_ocr_err_engine: 'تعذّر تحميل محرك التعرّف. حدّث الصفحة ثم تحويل الكل. الصفوف المكتملة تبقى قابلة للتنزيل.',
  ...
  tool_batch_convert_jpg_to_text_with_ocr_example: 'تحميل مثال يضيف sample-1.jpg و sample-2.jpg ثم تحويل الكل ويفعّل تنزيل ZIP بملفي TXT و combined.txt.',
  tool_batch_convert_jpg_to_text_with_ocr_example_title: 'مثال',
  tool_batch_convert_jpg_to_text_with_ocr_faq_a1: 'لا. الصور تبقى في تبويب المتصفح. سكربتات المحرك والأرشيف من هذا الموقع؛ لا رفع إلى خوادمنا.',
  ...
  tool_batch_convert_jpg_to_text_with_ocr_faq_a4: 'ملف TXT لكل صورة باسم الأصل. combined.txt افتراضي ويفصل --- اسم الملف --- بين الصفحات.',
  ...
  tool_batch_convert_jpg_to_text_with_ocr_faq_a8: 'لا PDF ولا Word ولا جداول. PDF رقمي بطبقة نص يذهب إلى استخراج النص من PDF.',
  ...
  tool_batch_convert_jpg_to_text_with_ocr_rules_item_1: 'أسماء ZIP تتبع الأصل. combined.txt (افتراضي) يدرج --- اسم الملف --- بين الصور ككتيّب مصوَّر.',
  tool_batch_convert_jpg_to_text_with_ocr_rules_item_2: 'الملفات تبقى على جهازك ولا تُرفع إلى خادم. السكربتات من هذا الموقع.',
  tool_batch_convert_jpg_to_text_with_ocr_rules_item_3: 'خط اليد والضباب والمنظور القوي غالبًا تفشل في ذلك الصف. الجداول أسطر قراءة لا CSV.',
  ...
  tool_batch_convert_web_pages_to_excel_faq_a4: 'نعم. سطر واحد يكفي لتحويل صفحة ويب إلى إكسل. العناوين الناجحة تشترك في .xlsx واحد بأوراق عدة.',
  ...
  tool_batch_convert_web_pages_to_excel_how_item_1: 'عنوان https واحد في كل سطر (قوائم الأسعار والجداول العامة تناسب). سطر واحد يكفي لصفحة ويب إلى إكسل.',
  tool_batch_convert_web_pages_to_excel_how_item_2: 'اضغط تحويل الكل. يُجلب كل عنوان عام مرة؛ الصفحات بلا جدول صالح تُتخطى والباقي يستمر.',
  ...
  tool_batch_convert_web_pages_to_excel_how_item_4: 'تريد ورقة لكل عنوان بدل كل جدول، أو الإبقاء على الجداول الصغيرة؟ افتح الإعدادات المتقدمة.',
  ...
  tool_batch_convert_web_pages_to_excel_rules_item_1: 'يُرسل كل عنوان مرة لجلب HTML ولا يُحفظ. الملصق لا يغادر التبويب. يُبنى المصنف هنا.',
  tool_batch_convert_web_pages_to_excel_rules_item_2: 'الشبكات الخاصة وجدران الدخول والصفحات بلا <table> تفشل ذلك الصف والباقي يستمر.',
  ...
  tool_batch_convert_web_pages_to_excel_rules_item_4: 'ليست زاحف موقع كامل ولا إكسل للويب. الصق العناوين أو HTML الذي لديك. أسماء الأوراق حتى 31 حرفًا.',
  ...
  tool_batch_convert_web_pages_to_excel_url_hint:
    'عنوان http(s) عام في كل سطر، حتى 10. نجلب كل صفحة مرة. تُزال النصوص البرمجية. أوراق إكسل من جداول HTML فقط.',
  ...
  tool_batch_convert_web_pages_to_excel_usecase_1: 'أرشف قائمة أسعار أو SKU من HTML في إكسل لتبقى الكميات أرقامًا قابلة للتصفية — PNG مجرد نقاط.',
  tool_batch_convert_web_pages_to_excel_usecase_2: 'اجمع جداول معاملات من صفحتي مساعدة في مصنف واحد ثم أضف عمود SUM. وورد يبقي العناوين فقرات.',
  ...
  tool_batch_convert_web_pages_to_jpg_faq_a5: 'كل صف ناجح صورة JPEG منفصلة داخل ZIP واحد. رابط واحد يعمل أيضاً. لا ندمج الصور في ملف واحد.',
  ...
  tool_batch_convert_web_pages_to_jpg_how_item_2:
    'اضغط تحويل الكل. الافتراضي سطح مكتب 1280 وجودة JPEG 85٪ والصفحة كاملة. يُجلب كل رابط عام مرة؛ تُتجاوز الصفوف الفاشلة.',
  tool_batch_convert_web_pages_to_jpg_how_item_3:
    'تريد عرض هاتف أو الشاشة الأولى فقط أو انتظاراً أطول إن بقيت الصور فارغة؟ افتح الإعدادات المتقدمة لتغيير العرض وجودة JPEG ونطاق الالتقاط وانتظار التحميل.',
  tool_batch_convert_web_pages_to_jpg_how_item_4:
    'تحتاج ملفات A4 للطباعة بدل اللقطات؟ استخدم تحويل عدة صفحات ويب إلى PDF. لديك ملف PDF؟ استخدم تحويل PDF إلى JPG.',
  tool_batch_convert_web_pages_to_jpg_how_item_5: 'نزّل ZIP عندما ينجح صف واحد على الأقل.',
  tool_batch_convert_web_pages_to_jpg_how_item_6: 'حمّل المثال لتجربة صفحتين محليتين؛ تظهر لوحة التقدم أثناء التحويل.',
  ...
  tool_batch_convert_web_pages_to_jpg_rules_item_1: 'يُرسل كل رابط إلى الخادم مرة لجلب HTML ولا يُحفظ. تُبنى صورة JPEG في هذا التبويب.',
  tool_batch_convert_web_pages_to_jpg_rules_item_2: 'الشبكات الخاصة وتسجيل الدخول والصفحات المفقودة تفشل ذلك الصف. بقية الدفعة تستمر.',
  ...
  tool_batch_convert_web_pages_to_jpg_rules_item_4: 'هذه ليست زاحفاً لموقع كامل. الصق الروابط التي لديك.',
  ...
  tool_batch_convert_web_pages_to_pdf_faq_a5: 'كل صف ناجح ملف PDF مستقل داخل ZIP. لا ندمجها — بعد التنزيل استخدم دمج ملفات في PDF واحد.',
  ...
  tool_batch_convert_web_pages_to_pdf_how_item_3:
    'اضغط تحويل الكل. يُجلب كل رابط عام مرة ويُقسَّم إلى A4 عمودي (فواصل CSS قد تقطع الأقسام). تُتجاوز الصفوف الفاشلة.',
  tool_batch_convert_web_pages_to_pdf_how_item_4:
    'مقتطف HTML مع معاينة؟ تحويل HTML إلى PDF. لقطة بعرض الشاشة بدل الورق؟ تحويل عدة صفحات ويب إلى JPG دفعة واحدة.',
  tool_batch_convert_web_pages_to_pdf_how_item_5: 'نزّل ZIP بعد نجاح صف واحد على الأقل. تحميل مثال يجرب صفحتي A4 محليتين بفاصل CSS.',
  ...
  tool_batch_convert_web_pages_to_pdf_rules_item_1: 'يُرسل كل رابط مرة لجلب HTML ولا يُخزَّن. يُبنى PDF في هذا التبويب على ورق A4 عمودي.',
  ...
  tool_batch_convert_web_pages_to_pdf_rules_item_4: 'ليست زاحفًا لموقع كامل ولا أداة لقطات. الصق الروابط العامة التي لديك.',
  ...
  tool_batch_convert_web_pages_to_pdf_status_converting: 'جارٍ إنشاء PDF… قد تتوقف هذه الصفحة ثوانٍ',
  ...
  tool_batch_convert_web_pages_to_pdf_usecase_3:
    'لصق HTML يبقى في تحويل HTML إلى PDF. لقطات الدردشة ومقارنة الهاتف/الحاسوب في JPG. هنا أرشيف الطباعة من قائمة الروابط.',
  tool_batch_convert_web_pages_to_pdf_usecases_title: 'حالات مناسبة',
  tool_batch_convert_web_pages_to_pdf_wait_hint: 'ثوانٍ إضافية بعد بدء تحميل الصور في كل ورقة A4. الافتراضي 1. ارفعه إن ظهر مربع صورة فارغ في PDF.',
  ...
  tool_batch_convert_web_pages_to_png_how_item_6: 'تحميل مثال يجرّب واجهتين محليتين؛ يظهر شريط التقدم أثناء التحويل.',
  ...
  tool_batch_convert_web_pages_to_png_rules_item_1: 'يُرسل كل رابط مرة إلى خادمنا لجلب HTML ولا يُخزَّن. يُبنى PNG في هذا التبويب.',
  tool_batch_convert_web_pages_to_png_rules_item_2: 'الشبكات الخاصة وتسجيل الدخول والعناوين المفقودة تفشل ذلك الصف. بقية الدفعة تستمر.',
  ...
  tool_batch_convert_web_pages_to_png_usecase_1: 'أرشفة طقم مكوّنات كـ PNG حاد حتى تبقى حدود 1px والتسميات مقروءة. JPEG يموّه الحواف.',
  tool_batch_convert_web_pages_to_png_usecase_2: 'تصدير لوحة عائمة بخلفية شفافة وإسقاط PNG على إطار فيغما. الصفحة الرئيسية المصمتة البيضاء تبقى بيضاء.',
  tool_batch_convert_web_pages_to_png_usecase_3: 'اترك JPEG الدردشة لأداة JPG وملفات A4 لأداة PDF؛ استخدم هذه الأداة عندما تحتاج شبكة واجهة بلا فقدان.',
  ...
  tool_batch_convert_web_pages_to_png_wait_hint: 'ثوانٍ إضافية بعد بدء تحميل الصور البعيدة. الافتراضي 1. ارفعه إن ظهر PNG بإطارات صور فارغة.',
  ...
  tool_batch_watermark_product_photos_faq_a3: 'لا. هذه الصفحة تختم الصور. ختم PDF عمل آخر — استخدم أداة PDF عندما تحتاج صفحات لا JPEG عرض.',
  ...
  tool_batch_watermark_product_photos_faq_a5: 'يُبحث أيضًا عن وسم الصور بالجملة. في هذا الموقع تلك المهمة هنا؛ لا يوجد عنوان bulk-watermark ثانٍ.',
  ...
  tool_batch_watermark_product_photos_how_body: 'ضع الدفعة في الطابور، حدّد ختمًا، عاين إطارًا، ثم طبّق العلامة النسبية نفسها على كل الصور وخذ ZIP.',
  ...
  tool_batch_watermark_product_photos_rules_body: 'حجم الخط بالبكسل هو الضلع القصير مضروبًا في النسبة. المراسي كسور من تلك اللوحة لا بكسل ثابت.',
  tool_batch_watermark_product_photos_rules_item_1: 'الختم الافتراضي: SAMPLE، أسفل يمين، 8% من min(العرض، الارتفاع)، عتامة 45%. JPEG بخلفية بيضاء.',
  tool_batch_watermark_product_photos_rules_item_2: 'ضلع قصير أقل من 64 بكسل يفشل ذلك الصف. النص الفارغ يعطّل التطبيق. فشل الفك يتخطى.',
  tool_batch_watermark_product_photos_rules_item_3: 'DRAFT المائل يرصف الكلمة على الإطار. الأسماء المكررة في ZIP تصبح اسم (2).jpg أو .png.',
  tool_batch_watermark_product_photos_rules_item_4: 'تبقى الملفات على جهازك دون رفع إلى خادم.',
  ...
  tool_bulk_compress_png_images_faq_a3: 'نعم. تُرسم البكسلات بلا خلفية مصمتة ثم تُحفظ PNG، فتبقى الفتحات فتحات.',
  ...
  tool_bulk_compress_png_images_faq_a5: 'لا. يُحفظ الإطار الأول فقط كـ PNG ثابت.',
  ...
  tool_bulk_compress_png_images_how_body: 'إذا كان المجلد يجب أن يبقى PNG، شارك سقفًا لأطول ضلع عند الحاجة، اضغط هنا، ثم خذ ZIP لما نجح.',
  ...
  tool_bulk_compress_png_images_rules_body: 'لا تُرسم خلفية JPEG. الحجم ينخفض عادة عند تقليص أطول ضلع، لا عند إعادة الحفظ وحدها.',
  tool_bulk_compress_png_images_rules_item_1: 'نوع المخرج PNG. الشفافية لا تُسوَّى. لا منزلق جودة لأن PNG هنا بلا فقد.',
  ...
  tool_bulk_compress_png_images_rules_item_4: 'الملفات تبقى على جهازك دون رفع إلى خادم.',
  ...
  tool_bulk_compress_product_photos_faq_a2: 'ليس دائماً. إن بقي الحجم فوق الحد عند جودة 0.5 تُعلَّم الصف كتفويت مع الإبقاء على أقرب ملف.',
  tool_bulk_compress_product_photos_faq_a3: 'لا حاجة لصفحة ثانية. JPEG وJPG نفس المخرج وامتداد .jpg.',
  tool_bulk_compress_product_photos_faq_a4: 'إن وجب بقاء PNG شفافاً فاستخدم صفحة ضغط PNG. هنا العمل تصغير صور الكتالوج.',
  tool_bulk_compress_product_photos_faq_a5: 'لا. تُضغط الإطار الأول فقط كصورة ثابتة.',
  ...
  tool_bulk_compress_product_photos_how_body: 'اجمع صور العرض، شارك حد الحجم، اضغط هنا، وخذ ZIP للناجح فقط.',
  ...
  tool_bulk_compress_product_photos_how_item_2:
    'الصيغة والكيلوبايت والمقاس تبدأ «بدون تحديد»: إعادة ترميز فقط. إن طلب المتجر JPEG أو 200 كيلوبايت ففعّل الشريحة أو الإعداد الجاهز. WebP وPNG متاحان أيضاً.',
  ...
  tool_bulk_compress_product_photos_jpeg_bg_hint: 'JPEG بلا شفافية. اللون يملأ البكسلات الفارغة فقط؛ الصور المعتمة لا تتغير. بدون تحديد يعني بلا طبقة.',
  ...
  tool_bulk_compress_product_photos_quality_hint_target: 'مع حد الكيلوبايت يكون الشريط بداية البحث لا الجودة النهائية.',
  tool_bulk_compress_product_photos_quality_label: 'الجودة',
  tool_bulk_compress_product_photos_resize_on: 'تقييد حجم الإخراج',
  tool_bulk_compress_product_photos_rules_body: 'الإعدادات مشتركة للدفع. إن فوّتت صورة الحد فالجدول يوضح ذلك.',
  ...
  tool_bulk_compress_product_photos_warn_png_target: 'PNG لا يبحث عن حد الكيلوبايت. ابقَ على PNG أو انتقل إلى JPEG/WebP إن احتجت الحد.',
  ...
  tool_bulk_convert_images_to_jpg_drop_hint: 'أسقط PNG أو JPEG أو WebP أو GIF أو HEIC (حتى 20). التحويل يبقى في هذا التبويب.',
  ...
  tool_bulk_convert_images_to_jpg_example: 'تحميل مثال يضع كتلة معتمة وشعارًا شفافًا، يرسمهما على أبيض، يُظهر اسمي .jpg ويفعّل تنزيل ZIP.',
  ...
  tool_bulk_convert_images_to_jpg_faq_a3: 'إن تعذر فك HEIC تُتخطى تلك الصف وتُعبَّأ البقية. جرّب سفاري أو حوّل الملف على الهاتف أولًا.',
  tool_bulk_convert_images_to_jpg_faq_a4: 'لا. JPEG وJPG ناتج واحد. الأسماء تنتهي بـ .jpg.',
  tool_bulk_convert_images_to_jpg_faq_a5: 'هذه الأداة تغيّر اللاحقة إلى JPG. تصغير صور العرض نحو 200 ك.ب هو ضغط صور المنتجات بالجملة.',
  ...
  tool_bulk_convert_images_to_jpg_rules_body: 'JPG بلا قناة شفافية. تُرسم كل الملفات على الخلفية نفسها ثم تُحفظ .jpg.',
  tool_bulk_convert_images_to_jpg_rules_item_1: 'أسماء الإخراج تنتهي دائمًا بـ .jpg.',
  ...
  tool_bulk_convert_images_to_jpg_rules_item_4: 'تبقى الملفات على جهازك دون رفع إلى خادم.',
  ...
  tool_bulk_convert_images_to_png_faq_a4: 'ضغط PNG للملفات التي هي PNG أصلًا ويجب أن تبقى PNG لكن أصغر. هذه الصفحة تغيّر اللاحقة إلى PNG.',
  tool_bulk_convert_images_to_png_faq_a5: 'لا. يُحفظ الإطار الأول فقط كـ PNG ثابت، ويُذكر ذلك الصف.',
  ...
  tool_bulk_convert_images_to_png_how_body: 'اختر الصور التي يجب أن تصبح PNG، حوّلها هنا دون طلاء خلفية، ثم خذ ZIP للملفات الناجحة.',
  ...
  tool_bulk_convert_images_to_png_rules_body: 'المخرج دائمًا PNG. هذه الصفحة لا تسطح الشفافية على خلفية JPEG.',
  tool_bulk_convert_images_to_png_rules_item_1: 'تُحفظ الشفافية إن وُجدت في المصدر. مصدر JPEG لا يملك شفافية للحفظ.',
  tool_bulk_convert_images_to_png_rules_item_2: 'تصغير الضلع الأطول اختياري ومطفأ افتراضيًا حتى لا يُغيَّر الحجم سرًا أثناء التحويل.',
  tool_bulk_convert_images_to_png_rules_item_3: 'إن كان PNG أكبر من الأصل يقول الصف ذلك. فشل الفك يتخطى. الأسماء المكررة في ZIP تصبح اسم (2).png.',
  tool_bulk_convert_images_to_png_rules_item_4: 'تبقى الملفات على جهازك دون رفع إلى خادم.',
  ...
  tool_bulk_convert_images_to_webp_err_unsupported: 'لم يُرجع هذا المتصفح كائن WebP. يُتخطى الصف بدل كتابة JPEG.',
  tool_bulk_convert_images_to_webp_example: 'تحميل مثال يضع كتلة معتمة وشعارًا شفافًا، يكتب ملفين .webp ويفعّل تنزيل ZIP. يبقى ثقب الشعار.',
  ...
  tool_bulk_convert_images_to_webp_faq_a3: 'بعض تطبيقات البريد وأنظمة المحتوى ترفض WebP. لتلك المرفقات استخدم تحويل الصور إلى JPG بالجملة.',
  tool_bulk_convert_images_to_webp_faq_a4: 'يُتخطى ذلك الصف. هذه الصفحة لا تكتب JPEG سرًا. جرّب كروم أو إيدج أو فايرفوكس حديثًا.',
  tool_bulk_convert_images_to_webp_faq_a5: 'لا. يُحفظ الإطار الأول فقط كـ WebP ثابت، ويُذكر ذلك الصف.',
  ...
  tool_bulk_convert_images_to_webp_how_body: 'اختر الصور التي يجب أن تصبح WebP للموقع، حوّلها هنا دون خلفية JPEG، ثم خذ ZIP للملفات الناجحة.',
  ...
  tool_bulk_convert_images_to_webp_how_item_4:
    'تحتاج JPG للبريد؟ استخدم تحويل الصور إلى JPG بالجملة. تريد PNG بلا فقدان؟ تحويل الصور إلى PNG بالجملة.',
  ...
  tool_bulk_convert_images_to_webp_rules_body: 'المخرج دائمًا WebP. هذه الصفحة لا تسطح الشفافية على خلفية JPEG ولا تتراجع إلى JPEG.',
  tool_bulk_convert_images_to_webp_rules_item_1: 'تُحفظ الشفافية إن وُجدت في المصدر. مصدر JPEG لا يملك شفافية للحفظ.',
  tool_bulk_convert_images_to_webp_rules_item_2: 'الجودة الافتراضية 0.8. اخفضها فقط إن احتاج ميزانية الموقع ملفًا أصغر.',
  tool_bulk_convert_images_to_webp_rules_item_3: 'إن تعذر كتابة WebP يُتخطى الصف. فشل الفك يتخطى. الأسماء المكررة في ZIP تصبح اسم (2).webp.',
  tool_bulk_convert_images_to_webp_rules_item_4: 'تبقى الملفات على جهازك دون رفع إلى خادم.',
  ...
  tool_chatgpt_export_to_markdown_faq_a3:
    'نعم. مصفوفات chat_messages الخاصة بـ Claude (sender + text) يحللها المحوّل نفسه، فلصقة واحدة تكفي لملفات تصدير ChatGPT وClaude معًا.',
  ...
  tool_check_pdf_a_compliance_description:
    'يفحص محلياً ترويسة PDF ومعرّف PDF/A في XMP غير المضغوط وهدف الإخراج وعلامة الخط المضمّن والتشفير. يعرض المثال قرائن لا شهادة مطابقة.',
  ...
  tool_check_pdf_a_compliance_warn:
    'فحص أولي فقط: لا تثبت هذه الصفحة توافق PDF/A. استخدم مدققاً يدعم ملفات التعريف مثل veraPDF لقرارات الأرشفة أو القرارات القانونية.',
  ...
  tool_check_robots_txt_url_blocked_faq_a1: 'لا. الصفحة تفحص الحظر فقط. لكتابة القواعد استخدم مولّد robots.txt.',
  tool_check_robots_txt_url_blocked_faq_a2: 'Googlebot يستخدم مجموعته إن وُجدت؛ كثير من الزواحف تعود إلى *. الفصل يمنحك رؤية أوضح.',
  tool_check_robots_txt_url_blocked_faq_a3: 'الممارسة الشائعة تعتبر ذلك سماحًا كاملاً. تُعرض حالة HTTP لترى 404 أو إعادة التوجيه.',
  tool_check_robots_txt_url_blocked_faq_a4: 'نعم عبر قائمة الوكيل. المطابقة وفق RFC 9309 كتقييم طرفي وليست حكمًا رسميًا للزاحف.',
  ...
  tool_check_robots_txt_url_blocked_fetch_failed: 'تعذّر جلب robots.txt. قد يكون المضيف غير متاح أو يمنع الروبوتات.',
  ...
  tool_check_robots_txt_url_blocked_home_desc: 'الصق رابط الصفحة لمعرفة إن كان robots.txt يحظر المسار أمام Googlebot أو زواحف أخرى.',
  ...
  tool_check_robots_txt_url_blocked_privacy_note: 'يُرسل الرابط واسم المضيف إلى عاملنا (Worker) لجلب /robots.txt دون تخزينهما كقاعدة بيانات للمنتج.',
  ...
  tool_check_robots_txt_url_blocked_usecase_1: 'قبل الإطلاق: تأكد أن /admin أو /staging محظوران بينما تبقى الصفحات العامة قابلة للزحف.',
  tool_check_robots_txt_url_blocked_usecase_2: 'اختبار/التحقق من robots.txt: بعد تعديل Disallow تأكد أن الرابط المقصود يطابق القاعدة فعلاً.',
  tool_check_robots_txt_url_blocked_usecase_3: 'قواعد زواحف الذكاء الاصطناعي: اختر GPTBot (أو *) وافحص المسارات الحساسة دون إنشاء الملف.',
  ...
  tool_check_ssl_certificate_expiration_faq_a1: 'لا. لا تقرأ Workers شهادة النظير من fetch؛ نستعلم Certificate Transparency (crt.sh).',
  tool_check_ssl_certificate_expiration_faq_a2: 'قد تتأخر سجلات CT عن الإصدار أو التجديد. إن كان التوقيت حرجًا فأكد بمصافحة محلية.',
  tool_check_ssl_certificate_expiration_faq_a3: 'التركيز على انتهاء أحدث تطابق. فاحص السلسلة وحده حاجة ثانوية وليست عنوان هذه الصفحة.',
  tool_check_ssl_certificate_expiration_faq_a4: 'لا. العنوان هو فحص انتهاء صلاحية شهادة SSL. النية الأوسع ليست العنوان الوحيد.',
  tool_check_ssl_certificate_expiration_faq_a5: 'تُرفض المضيفات الخاصة أو المحظورة. راجع أداة نطاقات CIDR الخاصة للسياق.',
  ...
  tool_check_ssl_certificate_expiration_fetch_failed: 'تعذر استعلام crt.sh. قد يكون هناك حد معدل أو عدم توفر.',
  ...
  tool_check_ssl_certificate_expiration_home_desc: 'اعرف متى تنتهي أحدث شهادة CT لاسم مضيف (crt.sh — ليست مصافحة مباشرة).',
  ...
  tool_check_ssl_certificate_expiration_how_body: 'تجيب الصفحة عن سؤال واحد: متى تنتهي أحدث مطابقة CT لهذا المضيف؟ ليست مدقق مصافحة SSL مباشرة.',
  ...
  tool_check_ssl_certificate_expiration_privacy_note: 'يُرسل اسم المضيف إلى Worker لاستعلام crt.sh. لا نخزنه كقاعدة بيانات منتج.',
  ...
  tool_check_ssl_certificate_expiration_result_disclaimer: 'تأخر سجلات CT — ليست شهادة نظير مصافحة TLS مباشرة. قد تتأخر التواريخ عن الإصدار أو التجديد.',
  ...
  tool_combine_files_into_one_pdf_description:
    'دمج ملفات في PDF واحد. تبقى الملفات على جهازك دون رفع إلى خادم. يمكن تحميل المثال لمراجعة مدخل فعلي ونتيجته؛ وتوضح الصفحة الخطوات والحدود.',
  ...
  tool_compare_two_pdfs_description:
    'مقارنة ملفي PDF. تبقى الملفات على جهازك دون رفع إلى خادم. يمكن تحميل المثال لمراجعة مدخل فعلي ونتيجته؛ وتوضح الصفحة الخطوات والحدود.',
  ...
  tool_compare_two_pdfs_faq_a1: 'لا. العرض يعمل في تبويبك (تُحمَّل المكتبات من هذا الموقع). ملفك لا يُرفع إلى خوادمنا.',
  ...
  tool_compare_two_text_files_online_how_item_3: 'اضغط «قارن» لتحديث فرق الأسطر؛ ويعمل أيضاً تلقائياً بعد اختيار الملفين.',
  ...
  tool_compare_two_word_documents_for_differences_how_item_3: 'اضغط «قارن» لاستخراج النص الظاهر وتشغيل مقارنة الصياغة.',
  ...
  tool_convert_a_jpg_to_text_with_ocr_err_pdf: 'هذه الصفحة للصور لا لملفات PDF. إن كان للـ PDF طبقة نص فاستخدم استخراج النص من PDF.',
  ...
  tool_convert_a_jpg_to_text_with_ocr_faq_a1: 'لا. تبقى الصورة على جهازك. تُحمَّل السكربتات من هذا الموقع ولا نرفع ملفك إلى خادم.',
  tool_convert_a_jpg_to_text_with_ocr_faq_a2: 'استخراج نص PDF يقرأ طبقة موجودة. هنا نتعرّف على صورة. لا نقبل PDF الماسح.',
  tool_convert_a_jpg_to_text_with_ocr_faq_a3: 'نعم. لقطة PNG تمرّ عبر زر التحويل نفسه. لا عنوان منفصل لـ«صورة إلى نص».',
  tool_convert_a_jpg_to_text_with_ocr_faq_a4: 'الحروف المطبوعة أوضح. خط اليد المتصل يفشل كثيراً؛ ليست أداة خط عربي يدوي.',
  ...
  tool_convert_a_jpg_to_text_with_ocr_faq_a6: '«OCR أونلاين» بحث عام. هنا TXT فقط: لا وورد ولا PDF قابل للبحث ولا جدول ولا برنامج تثبيت.',
  ...
  tool_convert_html_to_pdf_description:
    'حوّل HTML إلى PDF بخطوات واضحة: الصق مقطعًا أو حمّل عنوان الصفحة، أزل السكربتات والسمات الخطرة، راجع المعاينة ونزّل ملف A4. عند تحميل رابط يجلب الخادم HTML مرة واحدة دون حفظه؛ التحويل يبقى في التبويب. مثال ذلك عنوان وفقرة يخرجان في صفحة A4؛ المواقع المعتمدة على جافاسكربت وتنسيقات الطباعة والصور من نطاق آخر قد لا تطابق الصفحة الحية.',
  ...
  tool_convert_html_to_pdf_faq_a1:
    'يبقى HTML الملصوق في هذا التبويب (تُحمَّل المكتبات من هذا الموقع). إذا حمّلت رابطًا نرسل العنوان إلى الخادم مرة واحدة لجلب HTML دون حفظ الصفحة. يُنشأ PDF في المتصفح.',
  ...
  tool_convert_html_to_pdf_faq_a6:
    'نعم. أدخل العنوان ثم اضغط «تحميل الرابط». تُحوَّل روابط CSS والصور إلى عناوين مطلقة. تُزال السكربتات قبل PDF.',
  ...
  tool_convert_html_to_pdf_how_body:
    'الصق HTML أو حمّل رابطًا، حوّل، راجع المعاينة، ثم نزّل. اللصق يبقى على الجهاز؛ جلب الرابط يمر بالخادم مرة واحدة.',
  ...
  tool_convert_html_web_pages_to_word_document_faq_a5: 'لا. صدّر HTML أو انسخه. حزمة «صفحة كاملة» / MHTML في كروم صيغة أخرى ولا تُحلَّل هنا.',
  ...
  tool_convert_html_web_pages_to_word_document_how_item_1: 'إن كان المصدر عندك ابقَ على لصق HTML. لتحويل عنوان https عام استخدم تبويب العنوان.',
  ...
  tool_convert_html_web_pages_to_word_document_html_hint: 'الصق مقطعًا أو مستند HTML كاملًا. تُزال السكربتات قبل التحويل. تخطيط CSS لا يُعاد بكسلًا بكسل.',
  ...
  tool_convert_html_web_pages_to_word_document_rules_item_1: 'الـ HTML الملصق يبقى في هذا التبويب دون رفع إلى خادم. العنوان يُجلب مرة ولا يُخزَّن.',
  ...
  tool_convert_html_web_pages_to_word_document_rules_item_3: 'جدران الدخول وتطبيقات جافاسكربت وCSS الطباعة غالبًا لا تطابق الموقع الحي. هذه ليست شبكة لقطة شاشة.',
  ...
  tool_convert_html_web_pages_to_word_document_usecase_1: 'جلب عنوان عام لملاحظات إصدار والإبقاء على الجدول كجدول وورد حقيقي يمكن تعديله.',
  tool_convert_html_web_pages_to_word_document_usecase_2: 'تحويل تصدير HTML من مركز المساعدة إلى مسودة يعلّق عليها القانوني — العناوين تبقى عناوين.',
  ...
  tool_convert_pdf_to_dwg_article:
    'حوّل PDF نحو DWG بتصدير DXF ASCII: كيانات TEXT وإطار صفحة يفتحه أوتوكاد. المتصفح لا يكتب DWG المملوك. تبقى الملفات على جهازك دون رفع إلى خادم.',
  ...
  tool_convert_pdf_to_dwg_description:
    'حوّل PDF نحو DWG في المتصفح بتصدير DXF ASCII: كيانات TEXT وإطار صفحة يفتحه أوتوكاد. المتصفح لا يكتب DWG المملوك. تبقى الملفات على جهازك دون رفع إلى خادم. تعرض الصفحة العملية والخطوات ومثالًا.',
  ...
  tool_convert_pdf_to_pdf_a_article:
    'حوّل PDF نحو PDF/A في المتصفح: اكتب العنوان والمنشئ وادمج خطًا قياسيًا. هذا ليس أرشيفًا معتمدًا من veraPDF. تبقى الملفات على جهازك دون رفع إلى خادم.',
  ...
  tool_convert_pdf_to_pdf_a_description:
    'حوّل PDF نحو PDF/A في المتصفح: اكتب العنوان والمنشئ وادمج خطًا قياسيًا. هذا ليس PDF/A معتمدًا من veraPDF. تبقى الملفات على جهازك دون رفع إلى خادم. تعرض الصفحة العملية والخطوات ومثالًا.',
  ...
  tool_convert_word_document_to_pdf_description:
    'حوّل مستند وورد إلى PDF في المتصفح: ارفع ملف .docx، راجع معاينة HTML، ثم اتبع الخطوات لتصدير PDF للطباعة. تبقى الملفات على جهازك دون رفع إلى خادم. تظهر عملية التحويل ومثال جاهز عند تحميل العينة.',
  ...
  tool_convert_word_document_to_pdf_faq_a2:
    'المسار .docx ← HTML ← PDF. العناوين والكائنات العائمة تُبسَّط. إن كان لديك HTML فاستخدم تحويل HTML إلى PDF.',
  ...
  tool_create_budget_spreadsheet_add: 'أضف صفاً',
  tool_create_budget_spreadsheet_alt: 'إذا #N/A',
  tool_create_budget_spreadsheet_article: 'أنجز جدول ميزانية في المتصفح دون رفع.',
  tool_create_budget_spreadsheet_bar: 'أعمدة',
  tool_create_budget_spreadsheet_buyer: 'المشتري',
  tool_create_budget_spreadsheet_cell: 'خلية',
  tool_create_budget_spreadsheet_clear: 'مسح',
  tool_create_budget_spreadsheet_copy: 'نسخ',
  tool_create_budget_spreadsheet_count: 'عد',
  tool_create_budget_spreadsheet_criteria: 'معيار',
  tool_create_budget_spreadsheet_csv: 'لصق CSV',
  tool_create_budget_spreadsheet_desc: 'أنجز جدول ميزانية في المتصفح دون رفع.',
  tool_create_budget_spreadsheet_description:
    'أنشئ ميزانية وحمل xlsx. العملية: فئات ومبالغ. مثال إيجار 1200 وطعام 400. الحساب في المتصفح. العملية والخطوات تطابق المثال الظاهر. دون رفع إلى خادم.',
  tool_create_budget_spreadsheet_disclaimer: 'أرقام تخطيط فقط، ليست مشورة مالية أو ضريبية أو استثمارية.',
  tool_create_budget_spreadsheet_download: 'تنزيل xlsx',
  tool_create_budget_spreadsheet_draw: 'رسم',
  tool_create_budget_spreadsheet_else: 'وإلا',
  tool_create_budget_spreadsheet_empty: 'حمّل المثال أو املأ الحقول.',
  tool_create_budget_spreadsheet_err_read: 'تعذر القراءة. جرّب xlsx أو csv.',
  tool_create_budget_spreadsheet_example: 'Rent 1200 + Food 400 → total 1600.',
  tool_create_budget_spreadsheet_example_title: 'مثال',
  tool_create_budget_spreadsheet_faq_a1: 'لا. تبقى على الجهاز دون رفع إلى خادم.',
  tool_create_budget_spreadsheet_faq_a2: 'لا.',
  tool_create_budget_spreadsheet_faq_a3: 'زر المثال يملأ الحقول.',
  tool_create_budget_spreadsheet_faq_a4: 'حسب الأداة؛ العارض للقراءة فقط.',
  tool_create_budget_spreadsheet_faq_q1: 'هل تُرفع الملفات عند جدول ميزانية؟',
  tool_create_budget_spreadsheet_faq_q2: 'هل هذا Excel Online؟',
  tool_create_budget_spreadsheet_faq_q3: 'أين المثال؟',
  tool_create_budget_spreadsheet_faq_q4: 'هل يمكن التحرير؟',
  tool_create_budget_spreadsheet_file: 'ملف',
  tool_create_budget_spreadsheet_filter: 'تصفية',
  tool_create_budget_spreadsheet_formula: 'صيغة',
  tool_create_budget_spreadsheet_how_body: 'أنجز جدول ميزانية في المتصفح دون رفع.',
  tool_create_budget_spreadsheet_how_item_1: 'ابدأ بإدخال بيانات جدول ميزانية.',
  tool_create_budget_spreadsheet_how_item_2: 'املأ الحقول بالترتيب الظاهر.',
  tool_create_budget_spreadsheet_how_item_3: 'حمّل المثال وقارن النتيجة.',
  tool_create_budget_spreadsheet_how_item_4: 'انسخ الصيغة أو نزّل ملف xlsx.',
  tool_create_budget_spreadsheet_how_title: 'كيف يعمل',
  tool_create_budget_spreadsheet_inner: 'الصيغة الداخلية',
  tool_create_budget_spreadsheet_line: 'خط',
  tool_create_budget_spreadsheet_lines: 'وصف,كمية,سعر',
  tool_create_budget_spreadsheet_need_lib: 'تعذر تحميل المكتبة. تحقق من الشبكة.',
  tool_create_budget_spreadsheet_note_2016: 'تحتاج IFS إلى Excel 2019 أو Microsoft 365 أو إصدار أحدث.',
  tool_create_budget_spreadsheet_op_blank: 'فارغ',
  tool_create_budget_spreadsheet_op_contains: 'يحتوي',
  tool_create_budget_spreadsheet_op_eq: 'يساوي',
  tool_create_budget_spreadsheet_range: 'نطاق',
  tool_create_budget_spreadsheet_row_field: 'حقل الصف',
  tool_create_budget_spreadsheet_rules_body: 'راجع تنسيق الحقول قبل النسخ أو التنزيل. الصفوف غير الصالحة قد تُتجاهل.',
  tool_create_budget_spreadsheet_rules_item_1: 'راجع تنسيق الحقول قبل النسخ أو التنزيل.',
  tool_create_budget_spreadsheet_rules_item_2: 'الصفوف غير الصالحة قد تُتجاهل.',
  tool_create_budget_spreadsheet_rules_item_3: 'النتيجة المعروضة تطابق بيانات المثال.',
  tool_create_budget_spreadsheet_rules_item_4: 'تبقى البيانات على الجهاز دون رفع إلى خادم.',
  tool_create_budget_spreadsheet_rules_title: 'القواعد',
  tool_create_budget_spreadsheet_sample: 'تحميل مثال',
  tool_create_budget_spreadsheet_seller: 'البائع',
  tool_create_budget_spreadsheet_sheet: 'ورقة',
  tool_create_budget_spreadsheet_sum: 'جمع',
  tool_create_budget_spreadsheet_tax: 'ضريبة ٪',
  tool_create_budget_spreadsheet_title: 'أنشئ جدول ميزانية',
  tool_create_budget_spreadsheet_trial: 'تجربة',
  tool_create_budget_spreadsheet_usecase_1: 'واجب صف.',
  tool_create_budget_spreadsheet_usecase_2: 'مسودة سريعة.',
  tool_create_budget_spreadsheet_usecase_3: 'تحقق قبل اللصق في إكسل.',
  tool_create_budget_spreadsheet_usecases_title: 'متى يفيد',
  tool_create_budget_spreadsheet_val_field: 'حقل القيمة',
  tool_create_budget_spreadsheet_write: 'أنشئ الجدول',
  ...
  tool_create_excel_timesheet_description:
    'أنشئ كشف ساعات وحمل xlsx. العملية: تاريخ ومشروع وساعات. مثال خمسة أيام×8 → 40. الحساب في المتصفح. العملية والخطوات تطابق المثال الظاهر. دون رفع إلى خادم.',
  ...
  tool_create_invoice_spreadsheet_add: 'أضف صفاً',
  tool_create_invoice_spreadsheet_alt: 'إذا #N/A',
  tool_create_invoice_spreadsheet_article: 'أنجز جدول فاتورة في المتصفح دون رفع.',
  tool_create_invoice_spreadsheet_bar: 'أعمدة',
  tool_create_invoice_spreadsheet_buyer: 'المشتري',
  tool_create_invoice_spreadsheet_cell: 'خلية',
  tool_create_invoice_spreadsheet_clear: 'مسح',
  tool_create_invoice_spreadsheet_copy: 'نسخ',
  tool_create_invoice_spreadsheet_count: 'عد',
  tool_create_invoice_spreadsheet_criteria: 'معيار',
  tool_create_invoice_spreadsheet_csv: 'لصق CSV',
  tool_create_invoice_spreadsheet_desc: 'أنجز جدول فاتورة في المتصفح دون رفع.',
  tool_create_invoice_spreadsheet_description:
    'أنشئ جدول فاتورة وحمل xlsx. العملية: بائع وبنود وضريبة. مثال سطرين×10 وضريبة 10٪ → 22. الحساب في المتصفح. العملية والخطوات تطابق المثال الظاهر. دون رفع إلى خادم.',
  tool_create_invoice_spreadsheet_disclaimer: 'مسودة جدول فقط، ليست مشورة ضريبية أو قانونية.',
  tool_create_invoice_spreadsheet_download: 'تنزيل xlsx',
  tool_create_invoice_spreadsheet_draw: 'رسم',
  tool_create_invoice_spreadsheet_else: 'وإلا',
  tool_create_invoice_spreadsheet_empty: 'حمّل المثال أو املأ الحقول.',
  tool_create_invoice_spreadsheet_err_read: 'تعذر القراءة. جرّب xlsx أو csv.',
  tool_create_invoice_spreadsheet_example: 'Widget 2×10 = 20; tax 10% = 2; total 22.',
  tool_create_invoice_spreadsheet_example_title: 'مثال',
  tool_create_invoice_spreadsheet_faq_a1: 'لا. تبقى على الجهاز دون رفع إلى خادم.',
  tool_create_invoice_spreadsheet_faq_a2: 'لا.',
  tool_create_invoice_spreadsheet_faq_a3: 'زر المثال يملأ الحقول.',
  tool_create_invoice_spreadsheet_faq_a4: 'حسب الأداة؛ العارض للقراءة فقط.',
  tool_create_invoice_spreadsheet_faq_q1: 'هل تُرفع الملفات عند جدول فاتورة؟',
  tool_create_invoice_spreadsheet_faq_q2: 'هل هذا Excel Online؟',
  tool_create_invoice_spreadsheet_faq_q3: 'أين المثال؟',
  tool_create_invoice_spreadsheet_faq_q4: 'هل يمكن التحرير؟',
  tool_create_invoice_spreadsheet_file: 'ملف',
  tool_create_invoice_spreadsheet_filter: 'تصفية',
  tool_create_invoice_spreadsheet_formula: 'صيغة',
  tool_create_invoice_spreadsheet_how_body: 'أنجز جدول فاتورة في المتصفح دون رفع.',
  tool_create_invoice_spreadsheet_how_item_1: 'ابدأ بإدخال بيانات جدول فاتورة.',
  tool_create_invoice_spreadsheet_how_item_2: 'املأ الحقول بالترتيب الظاهر.',
  tool_create_invoice_spreadsheet_how_item_3: 'حمّل المثال وقارن النتيجة.',
  tool_create_invoice_spreadsheet_how_item_4: 'انسخ الصيغة أو نزّل ملف xlsx.',
  tool_create_invoice_spreadsheet_how_title: 'كيف يعمل',
  tool_create_invoice_spreadsheet_inner: 'الصيغة الداخلية',
  tool_create_invoice_spreadsheet_line: 'خط',
  tool_create_invoice_spreadsheet_lines: 'وصف,كمية,سعر',
  tool_create_invoice_spreadsheet_need_lib: 'تعذر تحميل المكتبة. تحقق من الشبكة.',
  tool_create_invoice_spreadsheet_note_2016: 'تحتاج IFS إلى Excel 2019 أو Microsoft 365 أو إصدار أحدث.',
  tool_create_invoice_spreadsheet_op_blank: 'فارغ',
  tool_create_invoice_spreadsheet_op_contains: 'يحتوي',
  tool_create_invoice_spreadsheet_op_eq: 'يساوي',
  tool_create_invoice_spreadsheet_range: 'نطاق',
  tool_create_invoice_spreadsheet_row_field: 'حقل الصف',
  tool_create_invoice_spreadsheet_rules_body: 'راجع تنسيق الحقول قبل النسخ أو التنزيل. الصفوف غير الصالحة قد تُتجاهل.',
  tool_create_invoice_spreadsheet_rules_item_1: 'راجع تنسيق الحقول قبل النسخ أو التنزيل.',
  tool_create_invoice_spreadsheet_rules_item_2: 'الصفوف غير الصالحة قد تُتجاهل.',
  tool_create_invoice_spreadsheet_rules_item_3: 'النتيجة المعروضة تطابق بيانات المثال.',
  tool_create_invoice_spreadsheet_rules_item_4: 'تبقى البيانات على الجهاز دون رفع إلى خادم.',
  tool_create_invoice_spreadsheet_rules_title: 'القواعد',
  tool_create_invoice_spreadsheet_sample: 'تحميل مثال',
  tool_create_invoice_spreadsheet_seller: 'البائع',
  tool_create_invoice_spreadsheet_sheet: 'ورقة',
  tool_create_invoice_spreadsheet_sum: 'جمع',
  tool_create_invoice_spreadsheet_tax: 'ضريبة ٪',
  tool_create_invoice_spreadsheet_title: 'أنشئ جدول فاتورة',
  tool_create_invoice_spreadsheet_trial: 'تجربة',
  tool_create_invoice_spreadsheet_usecase_1: 'واجب صف.',
  tool_create_invoice_spreadsheet_usecase_2: 'مسودة سريعة.',
  tool_create_invoice_spreadsheet_usecase_3: 'تحقق قبل اللصق في إكسل.',
  tool_create_invoice_spreadsheet_usecases_title: 'متى يفيد',
  tool_create_invoice_spreadsheet_val_field: 'حقل القيمة',
  tool_create_invoice_spreadsheet_write: 'أنشئ الجدول',
  tool_create_pdf_form_add_field: 'إضافة حقل',
  tool_create_pdf_form_article:
    'ابدأ من صفحة فارغة، سمِّ النص أو الخانات ثم نزّل نموذجاً حقيقياً. وضع حقول على ملف موجود في «جعل PDF قابلاً للتعبئة».',
  ...
  tool_create_pdf_form_description:
    'أنشئ نموذج PDF من صفحة فارغة: أضف حقول نص أو خانات مسمّاة عند X/Y بالعرض والارتفاع ثم نزّل. لا رفع إلى خادم؛ يُبنى الملف في هذا التبويب. مثال الدخول Name وEmail — عملية بخطوات ومثال يمكن توسيعه قبل التصدير.',
  ...
  tool_crop_pdf_faq_a1: 'لا. مكتبة PDF يعمل في تبويبك (قد تُحمَّل السكربتات من هذا الموقع). PDF لا يُرفع إلى خوادمنا.',
  ...
  tool_edit_pdf_form_fields_article:
    'اعرض أسماء حقول AcroForm، أعد تسميتها أو احذف الصناديق الزائدة ثم نزّل. كتابة الإجابات في «تعبئة نموذج PDF».',
  ...
  tool_edit_pdf_form_fields_description:
    'عدّل حقول نموذج PDF في هذا التبويب: تُعرض الأسماء، تعيد تسمية صندوق أو تعلّمه للحذف ثم تنزّل. تبقى الملفات على جهازك دون رفع إلى خادم. مثال الدخول نموذج Name + Email لرؤية القائمة فوراً — عملية بخطوات ومثال قبل المساس بملف حقيقي.',
  ...
  tool_edit_pdf_form_fields_example:
    'تحميل المثال ينشئ PDF بـ Name وEmail ويعرض الصفين والمعاينة ويسمح بإعادة التسمية أو الحذف قبل التنزيل.',
  ...
  tool_edit_pdf_form_fields_how_body:
    'افتح PDF نموذجاً، راجع قائمة الأسماء، أعد التسمية أو علّم الحذف، طبّق ثم نزّل. المثال يعرض Name وEmail عند الدخول.',
  ...
  tool_edit_pdf_text_online_article:
    'حرّر نص PDF عبر الإنترنت: عدّل الصياغة ثم اكتبها على الصفحات الأصلية. تبقى الصور والرسوم والأسطر غير المعدّلة. تبقى الملفات على جهازك دون رفع إلى خادم.',
  ...
  tool_edit_pdf_text_online_desc:
    'تحرير نص PDF عبر الإنترنت — التعديل على الصفحات الأصلية لتبقى الصور والتنسيق. تبقى الملفات على جهازك دون رفع إلى خادم.',
  tool_edit_pdf_text_online_description:
    'حرّر نص PDF عبر الإنترنت في المتصفح: عدّله في المحرر ثم تطبيق يكتبه على الصفحات الأصلية فتبقى الصور والرسوم والأسطر غير المعدّلة. تبقى الملفات على جهازك دون رفع إلى خادم. المثال يغيّر كلمة واحدة ويُبقي الصورة.',
  ...
  tool_edit_pdf_text_online_example:
    'تحميل المثال ينشئ PDF من صفحة واحدة فيه مربع لوني و«Hello edit PDF text sample.» ويستبدل sample بـ edited؛ تطبيق يُبقي الصورة في الملف القابل للتنزيل.',
  ...
  tool_edit_pdf_text_online_faq_a2:
    'لا. الأسطر المعدّلة تُغطّى وتُكتب من جديد عند الإحداثيات الأصلية. تبقى الصور وحجم الصفحة والأسطر غير المعدّلة في PDF الأصلي. هذا ليس تعديل رموز في موضعها.',
  ...
  tool_edit_pdf_text_online_faq_a4:
    'إضافة نص تختم سطرًا عند X/Y. تحويل PDF إلى مستند قابل للتحرير يعطي أولوية لتنزيل .txt. هنا التنزيل الأساسي ملف .pdf: نص معدّل على الصفحات الأصلية مع بقاء الصور.',
  ...
  tool_edit_pdf_text_online_how_body:
    'اختر PDF فيه طبقة نص وعدّل الصياغة ثم اضغط تطبيق للكتابة على الصفحات الأصلية. تبقى الصور. تبقى الملفات على جهازك دون رفع إلى خادم.',
  ...
  tool_edit_pdf_text_online_rules_item_2:
    'ليس تعديل رموز في موضعها. تبقى الصور وحجم الصفحة والأسطر غير المعدّلة؛ الأسطر المعدّلة تُغطّى عند إحداثياتها الأصلية.',
  ...
  tool_excel_compare_files_faq_a5:
    'تُقارن الكتابة المعروضة المقروءة من كل خلية. لا تُقارن تعبيرات الصيغ أو الأنماط أو التعليقات أو عرض الأعمدة أو بنية المصنف منفصلة؛ وقد لا يظهر تغيير صيغة إذا بقيت القيمة المخزنة نفسها.',
  ...
  tool_excel_formulas_cheat_sheet_description:
    'انسخ الصيغ من ورقة غش. العملية: صفّ ثم انسخ. مثال بطاقة IF. ليست منشئ IF المتداخل. الحساب في المتصفح. العملية والخطوات تطابق المثال الظاهر. دون رفع إلى خادم.',
  ...
  tool_extract_text_from_pdf_description:
    'استخراج نص من PDF. تبقى الملفات على جهازك دون رفع إلى خادم. يمكن تحميل المثال لمراجعة مدخل فعلي ونتيجته؛ وتوضح الصفحة الخطوات والحدود.',
  ...
  tool_extract_text_from_pdf_how_body:
    'اختر PDF بطبقة نص، استخرج فقرات عادية (فواصل الصفحات كأسطر فارغة)، انسخ أو نزّل .txt. لمسودة Markdown بعناوين ## Page N استخدم PDF إلى Markdown.',
  ...
  tool_file_hash_rules_item_4: 'الخصوصية: لا رفع. MD5 فقط يجلب crypto-js من هذا الموقع؛ SHA-* يستخدم Web Crypto المدمج فقط.',
  ...
  tool_fill_out_pdf_form_article:
    'استخدمه عندما يكون الملف قابلاً للتعبئة أصلاً وتريد الكتابة دون برنامج مكتبي. الصفحات الممسوحة بلا حقول. الملفات المشفّرة تفشل برسالة واضحة.',
  ...
  tool_fill_out_pdf_form_description:
    'عبّئ نموذج PDF في المتصفح: تُكتشف حقول النص وخانات الاختيار، ثم تكتب القيم وتنزّل الملف. تبقى الملفات على جهازك دون رفع إلى خادم. مثال الدخول نموذج بحقلين (Name وEmail) مملوء مسبقاً — عملية واضحة بخطوات ومثال يمكن تكراره على ملفك.',
  ...
  tool_fill_out_pdf_form_example:
    'تحميل المثال ينشئ PDF بحقلَي Name وEmail، يملأ Ada Lovelace / ada@example.com، يعرض المعاينة ويتيح التنزيل.',
  ...
  tool_fill_out_pdf_form_how_body:
    'افتح نموذجاً قابلاً للتعبئة، اكتب في الحقول المكتشفة، ثم نزّل. مثال الدخول يعرض الاسم والبريد معبّأين.',
  ...
  tool_film_prompt_builder_act1_label: 'الفصل الأول',
  tool_film_prompt_builder_act1_ph: 'مثلاً: منشأ الخلاف وما يجبرهما على القبول…',
  tool_film_prompt_builder_act2_label: 'الفصل الثاني',
  tool_film_prompt_builder_act2_ph: 'مثلاً: نجاح قصير ثم انفلات الأمور…',
  tool_film_prompt_builder_act3_label: 'الفصل الثالث',
  tool_film_prompt_builder_act3_ph: 'مثلاً: مواجهة مباشرة وتسوية لها ثمن…',
  ...
  tool_film_prompt_builder_ai_consent_cancel: 'إلغاء',
  tool_film_prompt_builder_ai_consent_ok: 'متابعة',
  tool_film_prompt_builder_ai_consent_title: 'هل تريد إرسال المسوّد إلى Cloudflare Workers AI؟',
  tool_film_prompt_builder_ai_done: 'كُتب نص الذكاء الاصطناعي كاملاً في حقل المُخرج. راجعه قبل النسخ.',
  tool_film_prompt_builder_ai_err_generic: 'لم يستجب الذكاء الاصطناعي هذه المرة؛ ومحتوى المُخرج كما هو.',
  tool_film_prompt_builder_ai_err_rate: 'نفدت حصة الذكاء الاصطناعي. تابع التركيب هنا أو جرّب غداً بتوقيت UTC.',
  tool_film_prompt_builder_ai_err_turnstile: 'أكمل فحص Turnstile قبل استخدام الذكاء الاصطناعي.',
  tool_film_prompt_builder_ai_expand: 'توسيع بالذكاء الاصطناعي',
  tool_film_prompt_builder_ai_panel_label: 'اختياري: Cloudflare AI (يلزم Turnstile)',
  tool_film_prompt_builder_ai_polish: 'تنقيح بالذكاء الاصطناعي',
  tool_film_prompt_builder_ai_working: 'يعمل Cloudflare AI الآن…',
  ...
  tool_film_prompt_builder_build: 'أنشئ البرومبت',
  tool_film_prompt_builder_character_arc_label: 'مسار تحوّل الشخصية',
  tool_film_prompt_builder_character_arc_ph: 'مثلاً: كبرياء ← تعاون على مضض ← شريكان…',
  tool_film_prompt_builder_clear: 'تفريغ',
  ...
  tool_film_prompt_builder_empty: 'املأ حقلاً واحداً على الأقل قبل إنشاء البرومبت.',
  ...
  tool_film_prompt_builder_faq_q1: 'هل تُرسل مادة السيناريو التي أكتبها إلى أي خادم؟',
  tool_film_prompt_builder_faq_q2: 'هل تستدعي هذه الصفحة واجهة ChatGPT أو نماذج أخرى؟',
  tool_film_prompt_builder_faq_q3: 'ما الفرق بينها وبين منشئ قوالب البرومبت؟',
  tool_film_prompt_builder_faq_q4: 'لماذا يلزم Turnstile لاستخدام الذكاء الاصطناعي؟',
  tool_film_prompt_builder_faq_q5: 'هل أحصل على المُخرج بصيغة JSON؟',
  tool_film_prompt_builder_faq_q6: 'هل تعمل مع ChatGPT وGemini وClaude وDeepSeek؟',
  tool_film_prompt_builder_faq_q7: 'ما الفرق بين الوضع المحلي وذكاء Cloudflare الاختياري؟',
  tool_film_prompt_builder_fmt_json: 'JSON',
  tool_film_prompt_builder_fmt_label: 'صيغة المُخرج',
  ...
  tool_film_prompt_builder_how_item_1: 'انقر «تحميل عيّنة» لإدخال الإعداد الافتراضي.',
  ...
  tool_film_prompt_builder_how_item_4: 'انسخ أو نزّل، ثم الصق في ChatGPT أو Gemini أو Claude أو DeepSeek ليكمل النموذج على هذه البنية.',
  tool_film_prompt_builder_how_title: 'طريقة الاستخدام',
  tool_film_prompt_builder_load_sample: 'تحميل المثال',
  tool_film_prompt_builder_logline_label: 'الفكرة في سطر',
  tool_film_prompt_builder_logline_ph: 'مثلاً: شاحنتا طعام متنافستان تتقاسمان مطبخاً واحداً…',
  tool_film_prompt_builder_platforms_lead: 'المُخرج يُلصق كما هو في محادثة ChatGPT أو Gemini أو Claude أو DeepSeek.',
  tool_film_prompt_builder_result_label: 'البرومبت الناتج',
  ...
  tool_film_prompt_builder_rules_item_1: 'كل حقل في النموذج يستقرّ في أحد أقسام Markdown: Role أو Task أو Constraints أو Output.',
  tool_film_prompt_builder_rules_item_2: 'التصدير الافتراضي Markdown، وJSON زرّ فوق حقل المُخرج نفسه.',
  ...
  tool_film_prompt_builder_rules_item_4: 'هذه الصفحة تجمع نصاً فقط: لا تكتب السيناريو عنك ولا تشغّل أي نموذج أو واجهة محادثة في متصفحك.',
  tool_film_prompt_builder_rules_title: 'ما تفعله وما لا تفعله',
  tool_film_prompt_builder_scene_list_label: 'قائمة المشاهد',
  tool_film_prompt_builder_scene_list_ph: 'مثلاً: 1. خلاف على موقف السيارة 2. تفتيش مزدوج…',
  ...
  tool_film_prompt_builder_status_copied: 'تم النسخ إلى الحافظة.',
  tool_film_prompt_builder_status_done: 'البرومبت جاهز.',
  tool_film_prompt_builder_status_working: 'جارٍ التركيب…',
  ...
  tool_film_prompt_builder_usecase_2: 'تصدير JSON وحفظ الفكرة والفصول ومسار التحوّل في كل نسخة كحقول في جدول أو مستودع للمقارنة لاحقاً.',
  tool_film_prompt_builder_usecase_3: 'إن كان المطلوب الهيكل العام من أربعة أقسام لا بنية فيلم طويل، فاستخدم منشئ قوالب البرومبت.',
  ...
  tool_film_prompt_builder_usecases_title: 'متى تفيدك',
  ...
  tool_find_and_validate_xml_sitemap_faq_a1: 'لا — تعثر وتتحقق فقط. لإنشاء ملف من قائمة عناوين استخدم مولّد XML Sitemap.',
  tool_find_and_validate_xml_sitemap_faq_a2: 'أولًا أسطر Sitemap: في robots.txt، ثم /sitemap.xml ومسارات الفهرس على نفس المضيف.',
  tool_find_and_validate_xml_sitemap_faq_a3: 'sitemapindex يسرد خرائط فرعية؛ urlset يسرد locs للصفحات. كلاهما جذر صالح؛ الجدول يبيّن النوع.',
  tool_find_and_validate_xml_sitemap_faq_a4: 'لا. نعدّ <loc> ونعرض عيّنة ونتحقق من البنية فقط دون حالة كل صفحة.',
  ...
  tool_find_and_validate_xml_sitemap_fetch_failed: 'تعذّر جلب مرشحي خريطة الموقع. قد يكون المضيف غير متصل أو يحظر الروبوتات.',
  tool_find_and_validate_xml_sitemap_formula_body: 'وفق بروتوكول sitemaps.org: XML سليم بجذر urlset أو sitemapindex ووسوم <loc> قابلة للعد.',
  tool_find_and_validate_xml_sitemap_formula_item_1: 'الترتيب: توجيهات Sitemap: في robots.txt ثم /sitemap.xml و /sitemap_index.xml و /sitemap-index.xml.',
  tool_find_and_validate_xml_sitemap_formula_item_2: 'تُعد البنية صالحة عندما يبدو الرد XML لخريطة موقع وحالة HTTP ناجحة.',
  tool_find_and_validate_xml_sitemap_formula_item_3: 'sitemapindex يسرد خرائط فرعية؛ urlset يسرد locs للصفحات — يُعرض كلاهما.',
  tool_find_and_validate_xml_sitemap_formula_item_4: 'نعدّ <loc> ونعرض حتى 10 عيّنات؛ لا نزحف كل عنوان مدرج.',
  tool_find_and_validate_xml_sitemap_formula_item_5: 'قد تفشل الاستجابات المضغوطة أو الضخمة أو غير XML. تُرفض المضيفات الخاصة.',
  tool_find_and_validate_xml_sitemap_formula_title: 'قواعد الاكتشاف والتحقق',
  tool_find_and_validate_xml_sitemap_home_desc: 'اكتشف خريطة الموقع من robots.txt أو /sitemap.xml وتحقق من البنية والنوع وعيّنات loc.',
  ...
  tool_find_and_validate_xml_sitemap_how_item_2: 'انقر «بحث وتحقق»؛ يقرأ Worker أسطر Sitemap: ثم يجرّب /sitemap.xml ومسارات الفهرس الشائعة.',
  tool_find_and_validate_xml_sitemap_how_item_3: 'راجع في الجدول نوع الجذر وعدد العناوين وعيّنات <loc>.',
  tool_find_and_validate_xml_sitemap_how_item_4: 'أصلِح مشاكل XML أو الاكتشاف قبل إرسال IndexNow أو Search Console.',
  tool_find_and_validate_xml_sitemap_how_title: 'كيف يعمل',
  tool_find_and_validate_xml_sitemap_privacy_note: 'يُرسل العنوان واسم المضيف إلى Worker لجلب robots.txt وملفات sitemap. لا نخزّنها كقاعدة منتج.',
  ...
  tool_find_and_validate_xml_sitemap_references: 'بروتوكول sitemaps.org؛ نظرة عامة على خرائط الموقع في Google Search Central.',
  ...
  tool_find_and_validate_xml_sitemap_usecase_1: 'باحث خريطة موقع: بعد نقل CMS أو CDN تأكد أين تُنشر الخريطة.',
  tool_find_and_validate_xml_sitemap_usecase_2: 'فاحص / مدقق XML: قبل Search Console تحقق من سلامة الملف وهل هو فهرس أم urlset.',
  tool_find_and_validate_xml_sitemap_usecase_3: 'فحص سريع لـ loc: بعد إعادة توليد خريطة كبيرة اطّلع على عيّنات دون تنزيل الملف كاملًا.',
  ...
  tool_html_entity_rules_item_3:
    'ترميز نص مُرمّز مسبقًا يعطي &amp;amp;. استخدم «حتى الاستقرار» عند الشك؛ تبقى علامتا < و > المجردتان كما هما في كل جولة ولا تُقرأ كوسوم.',
  ...
  tool_ios_prompt_builder_ai_consent_body:
    'خطوة اختيارية: تُرسل مسودتك الحالية إلى Cloudflare Workers AI للاستدلال. ولا تُمرَّر من خوادمنا إلى OpenAI أو Google أو Anthropic أو DeepSeek. وبدون الذكاء الاصطناعي يظل التجميع داخل المتصفح متاحاً.',
  tool_ios_prompt_builder_ai_consent_cancel: 'إلغاء',
  tool_ios_prompt_builder_ai_consent_ok: 'متابعة',
  tool_ios_prompt_builder_ai_consent_title: 'إرسال المسودة إلى Cloudflare Workers AI؟',
  tool_ios_prompt_builder_ai_done: 'استبدل نص الذكاء الاصطناعي محتوى النتيجة. راجعه قبل النسخ.',
  tool_ios_prompt_builder_ai_err_generic: 'فشل الذكاء الاصطناعي، والنتيجة كما هي.',
  tool_ios_prompt_builder_ai_err_rate: 'نفد حد الذكاء الاصطناعي. استخدم الوضع المحلي أو عد غداً (UTC).',
  tool_ios_prompt_builder_ai_err_turnstile: 'أكمل Turnstile قبل استخدام الذكاء الاصطناعي.',
  tool_ios_prompt_builder_ai_expand: 'توسيع بالذكاء الاصطناعي',
  tool_ios_prompt_builder_ai_panel_label: 'Cloudflare AI اختياري (Turnstile)',
  tool_ios_prompt_builder_ai_polish: 'تنقيح بالذكاء الاصطناعي',
  tool_ios_prompt_builder_ai_working: 'Cloudflare AI يعمل…',
  ...
  tool_ios_prompt_builder_build: 'إنشاء البرومبت',
  tool_ios_prompt_builder_clear: 'تفريغ',
  ...
  tool_ios_prompt_builder_empty: 'املأ حقلاً واحداً على الأقل قبل الإنشاء.',
  ...
  tool_ios_prompt_builder_faq_a7:
    'التجميع المحلي يرتّب حقولك فحسب: بلا طلبات وبلا حدود استخدام. أما «توسيع» و«تنقيح» فيرسلان المسودة إلى Cloudflare Workers AI (يلزم Turnstile وهناك حد للاستخدام)، والنص العائد يستبدل منطقة النتيجة بالكامل، فراجعه قبل النسخ. وعند الفشل أو نفاد الحد تابع بالوضع المحلي.',
  tool_ios_prompt_builder_faq_q1: 'هل يُرفع ما أكتبه إلى خادم؟',
  tool_ios_prompt_builder_faq_q2: 'هل تستدعي الصفحة واجهة ChatGPT أو نماذج أخرى؟',
  tool_ios_prompt_builder_faq_q3: 'ما الفرق عن أداة قوالب البرومبت؟',
  tool_ios_prompt_builder_faq_q4: 'لماذا يطلب الذكاء الاصطناعي الاختياري Turnstile؟',
  tool_ios_prompt_builder_faq_q5: 'هل يمكن التصدير بصيغة JSON؟',
  tool_ios_prompt_builder_faq_q6: 'هل تعمل مع ChatGPT و Gemini و Claude و DeepSeek؟',
  tool_ios_prompt_builder_faq_q7: 'ما الفرق بين التجميع المحلي و Cloudflare AI الاختياري؟',
  tool_ios_prompt_builder_feature_spec_label: 'الميزة / المواصفات',
  tool_ios_prompt_builder_feature_spec_ph: 'مثال: اتجاه الخطوات ونطاق نبض الراحة…',
  ...
  tool_ios_prompt_builder_hig_constraints_label: 'HIG / الوصولية',
  tool_ios_prompt_builder_hig_constraints_ph: 'مثال: Dynamic Type XXL، VoiceOver، بلا force-unwrap…',
  tool_ios_prompt_builder_how_body:
    'املأ الحقول الأربعة فتجمع الصفحة منها Markdown (أو JSON) داخل المتصفح؛ وإن أردت تفصيلاً أكثر اطلب من Cloudflare AI توسيع النص، ثم الصق البرومبت في محادثتك.',
  tool_ios_prompt_builder_how_item_1: 'اضغط «تحميل المثال» فتُملأ الحقول ويُجمَّع برومبت جاهز، ثم ابدأ التعديل منه.',
  tool_ios_prompt_builder_how_item_2: 'عدّل الميزة والحزمة والشاشة وقواعد HIG ثم اضغط «إنشاء البرومبت»؛ وللتصدير المهيكل بدّل إلى JSON.',
  tool_ios_prompt_builder_how_item_3: 'اختياري: أكمل Turnstile ثم اضغط «توسيع» أو «تنقيح»، فيحتل نص الذكاء الاصطناعي منطقة النتيجة.',
  tool_ios_prompt_builder_how_item_4: 'انسخ النتيجة أو نزّلها، ثم الصقها في ChatGPT أو Gemini أو Claude أو DeepSeek.',
  tool_ios_prompt_builder_how_title: 'طريقة الاستخدام',
  tool_ios_prompt_builder_load_sample: 'تحميل المثال',
  tool_ios_prompt_builder_platforms_lead: 'البرومبت النهائي نص عادي، ويُلصق كما هو في ChatGPT أو Gemini أو Claude أو DeepSeek.',
  tool_ios_prompt_builder_result_label: 'ناتج البرومبت',
  ...
  tool_ios_prompt_builder_rules_item_1: 'كل حقل يذهب إلى كتلة خاصة في Markdown: Role و Task و Constraints و Output.',
  tool_ios_prompt_builder_rules_item_2: 'الإخراج الافتراضي Markdown، ويمكن للمنطقة نفسها إظهار JSON بالحقول والبرومبت المجمَّع.',
  tool_ios_prompt_builder_rules_item_3: 'لا يغني Cloudflare AI عن التجميع المحلي: جوابه يشغل منطقة النتيجة بالكامل، فراجعه قبل النسخ.',
  tool_ios_prompt_builder_rules_item_4: 'الأداة تجمع النص فقط: لا تبني Swift ولا تشغّل Xcode ولا تستدعي واجهات المحادثة بالنيابة عنك.',
  tool_ios_prompt_builder_rules_title: 'حدود ينبغي توقعها',
  ...
  tool_ios_prompt_builder_status_copied: 'تم النسخ إلى الحافظة.',
  tool_ios_prompt_builder_status_done: 'البرومبت جاهز.',
  tool_ios_prompt_builder_status_working: 'يجري تجميع البرومبت…',
  tool_ios_prompt_builder_swift_stack_label: 'Swift / الحزمة التقنية',
  tool_ios_prompt_builder_swift_stack_ph: 'مثال: Swift 5.10، SwiftUI، iOS 17+، SwiftData…',
  tool_ios_prompt_builder_swiftui_ui_label: 'SwiftUI / الشاشة',
  tool_ios_prompt_builder_swiftui_ui_ph: 'مثال: NavigationStack، Charts، ورقة أذونات…',
  tool_ios_prompt_builder_title: 'أداة إنشاء برومبت لتطوير iOS — تجميع محلي مع ذكاء اصطناعي اختياري',
  tool_ios_prompt_builder_usecase_1: 'تحويل المتطلب الذي ذُكر شفهياً في مراجعة التصميم إلى برومبت يمكن لصقه في محادثة الفريق.',
  tool_ios_prompt_builder_usecase_2: 'تصدير JSON لتحويل قواعد HIG إلى قائمة تحقّق، ثم توسيع النص عبر Cloudflare AI عند الحاجة.',
  tool_ios_prompt_builder_usecase_3: 'إن لم تحتج حقول iOS وكفاك قالب عام من أربع كتل، فانتقل إلى أداة قوالب البرومبت.',
  tool_ios_prompt_builder_usecase_4: 'صُغ وصف ميزة لم تُعلَن بعد داخل المتصفح، ثم قرر إن كان يصح إرساله إلى الذكاء الاصطناعي الاختياري.',
  tool_ios_prompt_builder_usecases_title: 'متى تفيد',
  ...
  tool_json_schema_validator_faq_a4: 'لا يُرفع Schema أو JSON الخاص بك. هذا الموقع يحمّل كود Ajv فقط وليس لصقك.',
  ...
  tool_json_schema_validator_rules_item_4: 'الخصوصية: اللصق يبقى في التبويب. هذا الموقع يحمّل كود Ajv فقط.',
  ...
  tool_magnet_link_decoder_how_item_1: 'الصق URI magnet كاملًا واحدًا.',
  tool_magnet_link_decoder_how_item_2: 'انقر «فك» (أو «تحميل مثال»).',
  tool_magnet_link_decoder_how_item_3: 'راجع infohash والاسم والحجم وقائمة tracker.',
  tool_magnet_link_decoder_how_item_4: 'انسخ JSON أو URI المنظم عند الحاجة.',
  ...
  tool_make_pdf_fillable_article:
    'عندما يبدو الملف نموذجاً لكن الصناديق مجرد رسم. تضيف هذه الصفحة حقولاً حقيقية. كتابة الإجابات في «تعبئة نموذج PDF».',
  ...
  tool_make_pdf_fillable_description:
    'اجعل PDF قابلاً للتعبئة في هذا التبويب: افتح صفحة ثابتة، ضع حقول نص عند X/Y بالعرض والارتفاع، أو أضف N حقول افتراضية ثم نزّل. تبقى الملفات على جهازك دون رفع إلى خادم. مثال الدخول صفحة فارغة مع حقل FullName — عملية بخطوات ومثال يمكن نسخه إلى ملفك.',
  ...
  tool_make_pdf_fillable_how_body:
    'افتح PDF ثابتاً، سمِّ الحقل وحدّد الصندوق، أضف حقلاً أو N افتراضية ثم نزّل. المثال يضع FullName على صفحة فارغة.',
  ...
  tool_make_pdf_flipbook_description:
    'إنشاء كتاب PDF تفاعلي. تبقى الملفات على جهازك دون رفع إلى خادم. يمكن تحميل المثال لمراجعة مدخل فعلي ونتيجته؛ وتوضح الصفحة الخطوات والحدود.',
  ...
  tool_merge_pdf_faq_a1: 'لا. يعمل pdf-lib في تبويبك (قد تُحمَّل المكتبة من هذا الموقع). لا نرفع ملفاتك إلى خوادمنا.',
  ...
  tool_midjourney_prompt_builder_ai_consent_body:
    'هذه الخطوة اختيارية: ترسل المسوّد الموجود الآن في الحقول إلى Cloudflare Workers AI لتشغيل واحد. ولا نمرّره من خوادمنا إلى OpenAI أو Google أو Anthropic أو DeepSeek. وبدون الذكاء الاصطناعي يبقى البرومبت يُجمَّع في متصفحك.',
  tool_midjourney_prompt_builder_ai_consent_cancel: 'إلغاء',
  tool_midjourney_prompt_builder_ai_consent_ok: 'متابعة',
  tool_midjourney_prompt_builder_ai_consent_title: 'هل تريد إرسال المسوّد إلى Cloudflare Workers AI؟',
  tool_midjourney_prompt_builder_ai_done: 'كُتب نص الذكاء الاصطناعي كاملاً في حقل المُخرج. راجعه قبل النسخ.',
  tool_midjourney_prompt_builder_ai_err_generic: 'لم يستجب الذكاء الاصطناعي هذه المرة؛ ومحتوى المُخرج كما هو.',
  tool_midjourney_prompt_builder_ai_err_rate: 'نفدت حصة الذكاء الاصطناعي. تابع التركيب هنا أو جرّب غداً بتوقيت UTC.',
  tool_midjourney_prompt_builder_ai_err_turnstile: 'أكمل فحص Turnstile قبل استخدام الذكاء الاصطناعي.',
  tool_midjourney_prompt_builder_ai_expand: 'توسيع بالذكاء الاصطناعي',
  tool_midjourney_prompt_builder_ai_panel_label: 'اختياري: Cloudflare AI (يلزم Turnstile)',
  tool_midjourney_prompt_builder_ai_polish: 'تنقيح بالذكاء الاصطناعي',
  tool_midjourney_prompt_builder_ai_working: 'يعمل Cloudflare AI الآن…',
  ...
  tool_midjourney_prompt_builder_aspect_label: 'نسبة الأبعاد',
  tool_midjourney_prompt_builder_aspect_ph: 'مثلاً 16:9 أو 9:16 أو 1:1…',
  tool_midjourney_prompt_builder_build: 'أنشئ البرومبت',
  tool_midjourney_prompt_builder_clear: 'تفريغ',
  ...
  tool_midjourney_prompt_builder_empty: 'املأ حقلاً واحداً على الأقل قبل إنشاء البرومبت.',
  ...
  tool_midjourney_prompt_builder_faq_q1: 'هل يُرسل ما أكتبه إلى أي خادم؟',
  tool_midjourney_prompt_builder_faq_q2: 'هل تستدعي هذه الصفحة واجهة ChatGPT أو نماذج أخرى؟',
  tool_midjourney_prompt_builder_faq_q3: 'ما الفرق بينها وبين منشئ قوالب البرومبت؟',
  tool_midjourney_prompt_builder_faq_q4: 'لماذا يلزم Turnstile لاستخدام الذكاء الاصطناعي؟',
  tool_midjourney_prompt_builder_faq_q5: 'هل أحصل على المُخرج بصيغة JSON؟',
  tool_midjourney_prompt_builder_faq_q6: 'هل تعمل مع ChatGPT وGemini وClaude وDeepSeek؟',
  tool_midjourney_prompt_builder_faq_q7: 'ما الفرق بين الوضع المحلي وذكاء Cloudflare الاختياري؟',
  tool_midjourney_prompt_builder_fmt_json: 'JSON',
  tool_midjourney_prompt_builder_fmt_label: 'صيغة المُخرج',
  ...
  tool_midjourney_prompt_builder_how_item_1: 'انقر «تحميل عيّنة» لإدخال الإعداد الافتراضي.',
  ...
  tool_midjourney_prompt_builder_how_title: 'طريقة الاستخدام',
  tool_midjourney_prompt_builder_lighting_label: 'الإضاءة',
  tool_midjourney_prompt_builder_lighting_ph: 'مثلاً: ضوء خلفي عند الشروق مع ضباب…',
  tool_midjourney_prompt_builder_load_sample: 'تحميل المثال',
  tool_midjourney_prompt_builder_mj_flags_label: 'معاملات MJ',
  tool_midjourney_prompt_builder_mj_flags_ph: 'مثلاً --v 6.1 --style raw --stylize 120…',
  tool_midjourney_prompt_builder_platforms_lead: 'المُخرج يُلصق كما هو في محادثة ChatGPT أو Gemini أو Claude أو DeepSeek.',
  tool_midjourney_prompt_builder_result_label: 'البرومبت الناتج',
  ...
  tool_midjourney_prompt_builder_rules_item_1: 'كل حقل في النموذج يستقرّ في أحد أقسام Markdown: Role أو Task أو Constraints أو Output.',
  tool_midjourney_prompt_builder_rules_item_2: 'التصدير الافتراضي Markdown، وJSON زرّ فوق حقل المُخرج نفسه.',
  tool_midjourney_prompt_builder_rules_item_3:
    'الذكاء الاصطناعي الاختياري خطوة إضافية لا بديل: الوضع المحلي متاح دائماً، ونص الذكاء الاصطناعي يستبدل محتوى المُخرج بالكامل، فراجعه قبل النسخ.',
  tool_midjourney_prompt_builder_rules_item_4: 'هذه الصفحة تجمع نصاً فقط: لا تولّد صوراً ولا تستدعي Midjourney ولا أي واجهة محادثة.',
  tool_midjourney_prompt_builder_rules_map_1_flag: '--ar 1:1',
  tool_midjourney_prompt_builder_rules_map_1_label: '1:1 مربّع',
  tool_midjourney_prompt_builder_rules_map_2_flag: '--ar 16:9',
  tool_midjourney_prompt_builder_rules_map_2_label: '16:9 أفقي',
  tool_midjourney_prompt_builder_rules_map_3_flag: '--ar 9:16',
  tool_midjourney_prompt_builder_rules_map_3_label: '9:16 رأسي',
  tool_midjourney_prompt_builder_rules_map_4_flag: '--v 6.1',
  tool_midjourney_prompt_builder_rules_map_4_label: 'إصدارة MJ v6 الافتراضية',
  tool_midjourney_prompt_builder_rules_table_ar: 'نسبة الأبعاد → --ar',
  tool_midjourney_prompt_builder_rules_table_note: 'إذا كتبت نسبة أبعاد تحولت إلى --ar في آخر السطر؛ وإن لم تحتوِ المعاملات على إصدارة يُضاف --v 6.1.',
  tool_midjourney_prompt_builder_rules_table_title: 'جدول مقابلات معاملات Midjourney',
  tool_midjourney_prompt_builder_rules_table_v: 'الإصدارة → --v',
  tool_midjourney_prompt_builder_rules_title: 'ما تفعله وما لا تفعله',
  ...
  tool_midjourney_prompt_builder_status_copied: 'تم النسخ إلى الحافظة.',
  tool_midjourney_prompt_builder_status_done: 'البرومبت جاهز.',
  tool_midjourney_prompt_builder_status_working: 'جارٍ التركيب…',
  tool_midjourney_prompt_builder_style_label: 'الأسلوب',
  tool_midjourney_prompt_builder_style_ph: 'مثلاً: حبر سينمائي بدرجات فحمية…',
  tool_midjourney_prompt_builder_subject_label: 'الموضوع',
  tool_midjourney_prompt_builder_subject_ph: 'مثلاً: ساموراي يستلّ سيفه على جسر…',
  tool_midjourney_prompt_builder_title: 'منشئ برومبت Midjourney — تركيب داخل المتصفح والذكاء الاصطناعي اختياري',
  tool_midjourney_prompt_builder_usecase_1: 'تسليم فريقك برومبت Midjourney جاهزاً للّصق في المحادثة، بدل إملاء المعاملات رسالة بعد رسالة.',
  ...
  tool_midjourney_prompt_builder_usecase_3: 'إن كان المطلوب الهيكل العام من أربعة أقسام لا صورة، فاستخدم منشئ قوالب البرومبت.',
  ...
  tool_midjourney_prompt_builder_usecases_title: 'متى تفيدك',
  tool_npv_article:
  ...
  tool_og_rules_item_1:
    'يشترط بروتوكول Open Graph أربعة حقول: og:title وog:type وog:image وog:url. أما og:description فهو اختياري في المواصفة، لكن كل المنصات الكبرى تعرضه؛ فإن أهملته كتبت المنصة ملخصها بنفسها من نص الصفحة.',
  ...
  tool_onpage_canonical_other:
    'يشير canonical إلى رابط مختلف، أي أنك تخبر جوجل بأن هذه الصفحة نسخة مكررة من ذلك الرابط. أبقِ ذلك فقط إن كان صحيحاً؛ فـ canonical تلميح، وقد تختار جوجل رابطاً آخر رغم ذلك.',
  ...
  tool_onpage_desc_missing:
    'لا يوجد وصف ميتا. في هذه الحالة تبني جوجل المقتطف من نص الصفحة نفسها. اكتب ملخصك بنفسك إذا أردت التحكم في هذه الصياغة.',
  ...
  tool_onpage_h1_multiple:
    'وُجد {n} من وسوم H1. جوجل ترتّب الصفحات بأي عدد من وسوم H1، فهذه ليست عقوبة. ومع ذلك يظل H1 واحد مع أقسام H2–H6 أوضح في قارئات الشاشة.',
  ...
  tool_open_pdf_in_browser_description:
    'فتح PDF في المتصفح. تبقى الملفات على جهازك دون رفع إلى خادم. يمكن تحميل المثال لمراجعة مدخل فعلي ونتيجته؛ وتوضح الصفحة الخطوات والحدود.',
  ...
  tool_open_pdf_in_browser_faq_a1: 'لا. العرض يعمل في تبويبك (تُحمَّل المكتبات من هذا الموقع). ملفك لا يُرفع إلى خوادمنا.',
  tool_open_pdf_in_browser_faq_a2: 'لا. لا تعتمد هذه العملية على استخراج طبقة النص من PDF.',
  ...
  tool_open_pdf_in_browser_faq_q2: 'هل يتطلب OCR أو نصاً قابلاً للتحديد؟',
  ...
  tool_open_pdf_in_browser_how_item_2: 'استخدم «Next» للتنقل بين صفحات PDF',
  ...
  tool_pdf_page_numbers_faq_a1: 'لا. مكتبة PDF يعمل في تبويبك (قد تُحمَّل السكربتات من هذا الموقع). PDF لا يُرفع إلى خوادمنا.',
  ...
  tool_pdf_to_markdown_faq_a1: 'لا. مُصيّر الصفحات يعمل في تبويبك (تُحمَّل السكربتات من هذا الموقع). PDF لا يُرفع إلى خوادمنا.',
  ...
  tool_pdf_watermark_faq_a1: 'لا. مكتبة PDF يعمل في تبويبك (قد تُحمّل المكتبات من هذا الموقع). PDF لا يُرفع إلى خوادمنا.',
  ...
  tool_print_pdf_description:
    'طباعة PDF. تبقى الملفات على جهازك دون رفع إلى خادم. يمكن تحميل المثال لمراجعة مدخل فعلي ونتيجته؛ وتوضح الصفحة الخطوات والحدود.',
  ...
  tool_print_pdf_faq_a1: 'لا. العرض يعمل في تبويبك (تُحمَّل المكتبات من هذا الموقع). ملفك لا يُرفع إلى خوادمنا.',
  tool_print_pdf_faq_a2: 'لا. لا تعتمد هذه العملية على استخراج طبقة النص من PDF.',
  ...
  tool_print_pdf_faq_q2: 'هل يتطلب OCR أو نصاً قابلاً للتحديد؟',
  ...
  tool_print_pdf_how_item_2: 'اضغط «Print» لتنفيذ العملية',
  ...
  tool_product_design_prompt_builder_ai_consent_body:
    'خطوة اختيارية: تُرسل مسودتك الحالية إلى Cloudflare Workers AI للاستدلال. ولا تُمرَّر من خوادمنا إلى OpenAI أو Google أو Anthropic أو DeepSeek. وبدون الذكاء الاصطناعي يظل التجميع داخل المتصفح متاحاً.',
  tool_product_design_prompt_builder_ai_consent_cancel: 'إلغاء',
  tool_product_design_prompt_builder_ai_consent_ok: 'متابعة',
  tool_product_design_prompt_builder_ai_consent_title: 'إرسال المسودة إلى Cloudflare Workers AI؟',
  tool_product_design_prompt_builder_ai_done: 'استبدل نص الذكاء الاصطناعي محتوى النتيجة. راجعه قبل النسخ.',
  tool_product_design_prompt_builder_ai_err_generic: 'فشل الذكاء الاصطناعي، والنتيجة كما هي.',
  tool_product_design_prompt_builder_ai_err_rate: 'نفد حد الذكاء الاصطناعي. استخدم الوضع المحلي أو عد غداً (UTC).',
  tool_product_design_prompt_builder_ai_err_turnstile: 'أكمل Turnstile قبل استخدام الذكاء الاصطناعي.',
  tool_product_design_prompt_builder_ai_expand: 'توسيع بالذكاء الاصطناعي',
  tool_product_design_prompt_builder_ai_panel_label: 'Cloudflare AI اختياري (Turnstile)',
  tool_product_design_prompt_builder_ai_polish: 'تنقيح بالذكاء الاصطناعي',
  tool_product_design_prompt_builder_ai_working: 'Cloudflare AI يعمل…',
  ...
  tool_product_design_prompt_builder_build: 'إنشاء البرومبت',
  tool_product_design_prompt_builder_clear: 'تفريغ',
  ...
  tool_product_design_prompt_builder_design_tokens_label: 'التصميم / رموز التصميم',
  tool_product_design_prompt_builder_design_tokens_ph: 'مثال: شبكة 8 نقاط، اللون الأساسي #2563eb، WCAG AA…',
  tool_product_design_prompt_builder_download: 'تنزيل',
  tool_product_design_prompt_builder_empty: 'املأ حقلاً واحداً على الأقل قبل الإنشاء.',
  ...
  tool_product_design_prompt_builder_faq_a7:
    'التجميع المحلي يرتّب حقولك فحسب: بلا طلبات وبلا حدود استخدام. أما «توسيع» و«تنقيح» فيرسلان المسودة إلى Cloudflare Workers AI (يلزم Turnstile وهناك حد للاستخدام)، والنص العائد يستبدل منطقة النتيجة بالكامل، فراجعه قبل النسخ. وعند الفشل أو نفاد الحد تابع بالوضع المحلي.',
  tool_product_design_prompt_builder_faq_q1: 'هل يُرفع ما أكتبه إلى خادم؟',
  tool_product_design_prompt_builder_faq_q2: 'هل تستدعي الصفحة واجهة ChatGPT أو نماذج أخرى؟',
  tool_product_design_prompt_builder_faq_q3: 'ما الفرق عن أداة قوالب البرومبت؟',
  tool_product_design_prompt_builder_faq_q4: 'لماذا يطلب الذكاء الاصطناعي الاختياري Turnstile؟',
  tool_product_design_prompt_builder_faq_q5: 'هل يمكن التصدير بصيغة JSON؟',
  tool_product_design_prompt_builder_faq_q6: 'هل تعمل مع ChatGPT و Gemini و Claude و DeepSeek؟',
  tool_product_design_prompt_builder_faq_q7: 'ما الفرق بين التجميع المحلي و Cloudflare AI الاختياري؟',
  ...
  tool_product_design_prompt_builder_how_body:
    'املأ الحقول الأربعة فتجمع الصفحة منها Markdown (أو JSON) داخل المتصفح؛ وإن أردت تفصيلاً أكثر اطلب من Cloudflare AI توسيع النص، ثم الصق البرومبت في محادثتك.',
  tool_product_design_prompt_builder_how_item_1: 'اضغط «تحميل المثال» فتُملأ الحقول ويُجمَّع برومبت جاهز، ثم ابدأ التعديل منه.',
  ...
  tool_product_design_prompt_builder_how_item_3: 'اختياري: أكمل Turnstile ثم اضغط «توسيع» أو «تنقيح»، فيحتل نص الذكاء الاصطناعي منطقة النتيجة.',
  tool_product_design_prompt_builder_how_item_4: 'انسخ النتيجة أو نزّلها، ثم الصقها في ChatGPT أو Gemini أو Claude أو DeepSeek.',
  tool_product_design_prompt_builder_how_title: 'طريقة الاستخدام',
  tool_product_design_prompt_builder_load_sample: 'تحميل المثال',
  tool_product_design_prompt_builder_persona_label: 'الشخصية المستهدفة',
  tool_product_design_prompt_builder_persona_ph: 'مثال: أبوان في حضانة مشتركة أسبوعية…',
  tool_product_design_prompt_builder_platforms_lead: 'البرومبت النهائي نص عادي، ويُلصق كما هو في ChatGPT أو Gemini أو Claude أو DeepSeek.',
  tool_product_design_prompt_builder_problem_label: 'المشكلة المطلوب حلّها',
  tool_product_design_prompt_builder_problem_ph: 'مثال: التقويم مزدحم، ويريدان الأسبوع في لمحة…',
  tool_product_design_prompt_builder_result_label: 'ناتج البرومبت',
  ...
  tool_product_design_prompt_builder_rules_item_1: 'كل حقل يذهب إلى كتلة خاصة في Markdown: Role و Task و Constraints و Output.',
  tool_product_design_prompt_builder_rules_item_2: 'الإخراج الافتراضي Markdown، ويمكن للمنطقة نفسها إظهار JSON بالحقول والبرومبت المجمَّع.',
  tool_product_design_prompt_builder_rules_item_3: 'لا يغني Cloudflare AI عن التجميع المحلي: جوابه يشغل منطقة النتيجة بالكامل، فراجعه قبل النسخ.',
  tool_product_design_prompt_builder_rules_item_4: 'الأداة تجمع النص فقط: لا تولّد شاشات ولا تقرأ ملفات تصميمك ولا تستدعي واجهات المحادثة بالنيابة عنك.',
  tool_product_design_prompt_builder_rules_title: 'حدود ينبغي توقعها',
  ...
  tool_product_design_prompt_builder_status_copied: 'تم النسخ إلى الحافظة.',
  tool_product_design_prompt_builder_status_done: 'البرومبت جاهز.',
  tool_product_design_prompt_builder_status_working: 'يجري تجميع البرومبت…',
  tool_product_design_prompt_builder_title: 'أداة إنشاء برومبت لتصميم المنتجات — تجميع محلي مع ذكاء اصطناعي اختياري',
  tool_product_design_prompt_builder_usecase_1: 'تحويل هدف التصميم الذي ذُكر شفهياً في اجتماع المتطلبات إلى برومبت يمكن لصقه في محادثة الفريق.',
  tool_product_design_prompt_builder_usecase_2: 'تصدير JSON لحفظ الشخصية والرموز في مستودع المتطلبات، ثم توسيع النص عبر Cloudflare AI عند الحاجة.',
  tool_product_design_prompt_builder_usecase_3: 'إن لم تحتج حقول UX وكفاك قالب عام من أربع كتل، فانتقل إلى أداة قوالب البرومبت.',
  tool_product_design_prompt_builder_usecase_4: 'صُغ فكرة منتج لم تُعلَن بعد داخل المتصفح، ثم قرر إن كان يصح إرسالها إلى الذكاء الاصطناعي الاختياري.',
  tool_product_design_prompt_builder_usecases_title: 'متى تفيد',
  tool_product_design_prompt_builder_wireframe_scope_label: 'الإطار السلكي / النطاق',
  tool_product_design_prompt_builder_wireframe_scope_ph: 'مثال: شريط أسبوعي، ورقة تفاصيل، دعوة SMS…',
  ...
  tool_prompt_template_builder_ai_done: 'كُتب نص الذكاء الاصطناعي كاملًا في صندوق النتيجة. راجعه قبل النسخ.',
  tool_prompt_template_builder_ai_err_generic: 'تعذّر الذكاء الاصطناعي. برومبتك المحلي كما هو دون تغيير.',
  tool_prompt_template_builder_ai_err_rate: 'نفدت حصة الذكاء الاصطناعي. استخدم الوضع المحلي أو جرّب غدًا (UTC).',
  tool_prompt_template_builder_ai_err_turnstile: 'أكمل Turnstile قبل استخدام الذكاء الاصطناعي.',
  tool_prompt_template_builder_ai_expand: 'توسيع بالذكاء الاصطناعي',
  tool_prompt_template_builder_ai_panel_label: 'ذكاء Cloudflare اختياري (Turnstile)',
  tool_prompt_template_builder_ai_polish: 'تحسين بالذكاء الاصطناعي',
  tool_prompt_template_builder_ai_working: 'ذكاء Cloudflare قيد المعالجة…',
  ...
  tool_prompt_template_builder_faq_q4: 'لماذا يطلب الذكاء الاختياري اجتياز Turnstile؟',
  ...
  tool_prompt_template_builder_faq_q7: 'ما الفرق بين الوضع المحلي وذكاء Cloudflare الاختياري؟',
  ...
  tool_prompt_template_builder_platforms_lead: 'مُصمَّم لـ ChatGPT وGemini وClaude وDeepSeek — انسخ القالب النهائي إلى أي من واجهات الدردشة تلك.',
  ...
  tool_prompt_template_builder_usecase_6: 'حمّل Android أو iOS لقوالب وكيل ترميز تراعي أعراف Kotlin/Swift، ثم أضف فوقها معايير فريقك.',
  ...
  tool_robots_faq_a1:
    'يخبر ذلك الزاحف بعدم جلب أي رابط تحت جذر الموقع. وإذا حصل Googlebot على Disallow: / فقد تختفي صفحاتك من نتائج جوجل. لكن Disallow يمنع الزحف لا الفهرسة: الرابط المحجوب الذي تشير إليه مواقع أخرى قد يظل مدرجًا في النتائج بدون مقتطف، ولإخراجه نهائيًا اجعل الصفحة قابلة للزحف وأضف إليها noindex. ولمسار تجريبي استخدم Disallow: /private/ بدلًا منه.',
  tool_robots_faq_a2:
  ...
  tool_robots_rules_item_1:
    'اختيار المجموعة: يلتزم الزاحف بالمجموعة الأكثر تحديدًا في مطابقة User-agent، فاسمه الصريح يتقدم على *، وترتيب المجموعات في الملف لا يحسم شيئًا. وإذا تكررت سطور User-agent لاسم الزاحف نفسه دُمجت في مجموعة واحدة (RFC 9309).',
  ...
  tool_robots_rules_item_3:
    'أولوية القواعد داخل المجموعة: يفوز أطول مسار مطابق، وعند تساوي طول المطابقة بين Allow وDisallow يفوز Allow. لذلك Disallow: /admin/ مع Allow: /admin/public/ يترك المجلد الفرعي العام قابلًا للزحف.',
  tool_robots_rules_item_4:
    'الموقع بالكامل وسطر Sitemap: يمنع Disallow: / الوكيل من كل الروابط، أما Disallow بقيمة فارغة فيسمح بكل شيء. وSitemap: امتداد خارج RFC 9309، لا يفرّق في حالة الأحرف ويجوز وضعه في أي مكان؛ ويضعه هذا المولّد في النهاية.',
  ...
  tool_robots_usecase_2:
    'التحكم بزواحف الذكاء الاصطناعي: أعطِ GPTBot أو ClaudeBot أو Google-Extended أو CCBot أو PerplexityBot مجموعة Disallow خاصة بها مع إبقاء زحف Googlebot. ولاحظ أن Google-Extended يشمل Gemini وربط الإجابات في Vertex AI، أما «نظرة عامة من الذكاء الاصطناعي» في بحث جوجل فما زالت تعتمد على Googlebot.',
  ...
  tool_rotate_pdf_faq_a1: 'لا. مكتبة PDF يعمل في تبويبك (قد تُحمَّل السكربتات من هذا الموقع). PDF لا يُرفع إلى خوادمنا.',
  ...
  tool_schema_how_item_1: 'اختر نوع Schema.org من القائمة.',
  tool_schema_how_item_2: 'املأ الحقول المطلوبة لذلك النوع.',
  tool_schema_how_item_3: 'انقر «توليد» لبناء JSON-LD.',
  tool_schema_how_item_4: 'انسخ كتلة script إلى صفحتك وابقها متسقة مع المحتوى الظاهر.',
  ...
  tool_serp_faq_a3:
    'لا. أداة فحص الروابط تعطيك حالة الزحف والفهرسة مع لقطة للصفحة بعد عرضها، واختبار النتائج المنسقة يتحقق من أهلية البيانات المنظمة، ولا يعاين أي منهما نص المقتطف. كما تعيد جوجل كتابة عنوان الرابط عندما لا يناسب العنوان عبارة البحث، فالتحقق الحقيقي الوحيد هو أن تبحث عن الرابط المنشور بنفسك.',
  ...
  tool_short_drama_prompt_generator_ai_consent_cancel: 'إلغاء',
  tool_short_drama_prompt_generator_ai_consent_ok: 'متابعة',
  tool_short_drama_prompt_generator_ai_consent_title: 'إرسال المسوّدة إلى Cloudflare Workers AI؟',
  tool_short_drama_prompt_generator_ai_done: 'نُسخ نص الذكاء الاصطناعي إلى المخرج. راجع قبل النسخ.',
  tool_short_drama_prompt_generator_ai_err_generic: 'فشل الذكاء الاصطناعي؛ البرومبت المحلي لم يتغيّر.',
  tool_short_drama_prompt_generator_ai_err_rate: 'نفدت حصة الذكاء الاصطناعي. تابع محلياً أو جرّب غداً (UTC).',
  tool_short_drama_prompt_generator_ai_err_turnstile: 'أكمل فحص Turnstile قبل استخدام الذكاء الاصطناعي.',
  tool_short_drama_prompt_generator_ai_expand: 'توسيع بالذكاء الاصطناعي',
  tool_short_drama_prompt_generator_ai_panel_label: 'اختياري: Cloudflare AI (يلزم Turnstile)',
  tool_short_drama_prompt_generator_ai_polish: 'تنقيح بالذكاء الاصطناعي',
  tool_short_drama_prompt_generator_ai_working: 'Cloudflare AI يعمل…',
  ...
  tool_short_drama_prompt_generator_build: 'أنشئ البرومبت',
  tool_short_drama_prompt_generator_clear: 'تفريغ',
  tool_short_drama_prompt_generator_cliffhanger_label: 'معلّق نهاية الحلقة',
  tool_short_drama_prompt_generator_cliffhanger_ph: 'مثال: الحلقة 6 تنتهي بمسح الرسالة…',
  ...
  tool_short_drama_prompt_generator_empty: 'املأ حقلاً واحداً على الأقل قبل إنشاء البرومبت.',
  tool_short_drama_prompt_generator_episodes_label: 'الحلقات والمدّة',
  tool_short_drama_prompt_generator_episodes_ph: 'مثال: 12 حلقة × 75 ث…',
  ...
  tool_short_drama_prompt_generator_faq_q1: 'هل يُرفع البرومبت الذي أكتبه؟',
  tool_short_drama_prompt_generator_faq_q2: 'هل تستدعي الصفحة واجهة ChatGPT أو نماذج أخرى؟',
  tool_short_drama_prompt_generator_faq_q3: 'ما الفرق بينها وبين منشئ قوالب البرومبت؟',
  tool_short_drama_prompt_generator_faq_q4: 'لماذا يلزم Turnstile للذكاء الاصطناعي الاختياري؟',
  tool_short_drama_prompt_generator_faq_q5: 'هل يمكن الحصول على المخرجات بصيغة JSON؟',
  tool_short_drama_prompt_generator_faq_q6: 'هل تناسب ChatGPT وGemini وClaude وDeepSeek؟',
  tool_short_drama_prompt_generator_faq_q7: 'ما الفرق بين الوضع المحلي وذكاء Cloudflare الاختياري؟',
  tool_short_drama_prompt_generator_fmt_json: 'JSON',
  tool_short_drama_prompt_generator_fmt_label: 'تنسيق الإخراج',
  tool_short_drama_prompt_generator_fmt_md: 'Markdown',
  tool_short_drama_prompt_generator_genre_label: 'النوع',
  tool_short_drama_prompt_generator_genre_ph: 'مثال: دراما مكتبية بسرّ عائلي…',
  tool_short_drama_prompt_generator_hook_label: 'خطّاف الافتتاح',
  tool_short_drama_prompt_generator_hook_ph: 'مثال: متدرّبة تكشف تسرّب رواتب…',
  ...
  tool_short_drama_prompt_generator_how_item_1: 'انقر «تحميل عيّنة» لإدخال الإعداد الافتراضي.',
  ...
  tool_short_drama_prompt_generator_how_item_4: 'انسخ أو نزّل ثم الصق في ChatGPT أو Gemini أو Claude أو DeepSeek ليكمل النموذج بهذا التقسيم الحلقي.',
  tool_short_drama_prompt_generator_how_title: 'طريقة الاستخدام',
  tool_short_drama_prompt_generator_load_sample: 'تحميل مثال',
  tool_short_drama_prompt_generator_platforms_lead: 'المخرج يُلصق كما هو في محادثة ChatGPT أو Gemini أو Claude أو DeepSeek.',
  tool_short_drama_prompt_generator_result_label: 'البرومبت الناتج',
  ...
  tool_short_drama_prompt_generator_rules_item_1: 'كل حقل في النموذج يقع في أحد أقسام Markdown: الدور أو المهمة أو القيود أو صيغة الإخراج.',
  tool_short_drama_prompt_generator_rules_item_2: 'التصدير الافتراضي Markdown؛ JSON زر فوق حقل المخرج نفسه.',
  ...
  tool_short_drama_prompt_generator_rules_item_4: 'الصفحة تجمع نصاً فقط: لا تولّد فيديو ولا تشغّل نموذجاً أو واجهة دردشة في متصفّحك.',
  tool_short_drama_prompt_generator_rules_title: 'ما تفعله وما لا تفعله',
  tool_short_drama_prompt_generator_sec_constraints: 'القيود',
  tool_short_drama_prompt_generator_sec_output: 'تنسيق الإخراج',
  tool_short_drama_prompt_generator_sec_role: 'الدور',
  tool_short_drama_prompt_generator_sec_task: 'المهمة',
  tool_short_drama_prompt_generator_status_copied: 'تم النسخ إلى الحافظة.',
  tool_short_drama_prompt_generator_status_done: 'البرومبت جاهز.',
  tool_short_drama_prompt_generator_status_working: 'جاري إنشاء البرومبت…',
  ...
  tool_short_drama_prompt_generator_usecase_2: 'صدّر JSON واحفظ خطّاف ومعلّق كل حلقة كحقول في جدول لمراجعة تكرار الحيل.',
  tool_short_drama_prompt_generator_usecase_3: 'إن احتجت الهيكل العام من أربعة أقسام لا حقول السلسلة العمودية، استخدم منشئ قوالب البرومبت.',
  ...
  tool_short_drama_prompt_generator_usecases_title: 'متى يفيد',
  tool_short_drama_prompt_generator_vertical_format_label: 'الصيغة العمودية',
  tool_short_drama_prompt_generator_vertical_format_ph: 'مثال: 9:16، ترجمة محروقة، افتتاح في ثانيتين…',
  ...
  tool_sign_pdf_document_description:
    'وقّع مستند PDF في المتصفح: ارسم علامة أو اكتب اسماً، ضعه عند X/Y في صفحة، ثم نزّل. تبقى الملفات على جهازك دون رفع إلى خادم. هذا ختم ظاهر وليس شهادة. تظهر عملية التوقيع ومثال عند تحميل العينة.',
  ...
  tool_sign_pdf_document_faq_a1:
    'لا. الصفحة تختم صورة فقط. لعلامة سلامة ببادئة تجزئة استخدم إضافة توقيع رقمي إلى PDF — وليست أيضاً PKI بشهادة.',
  ...
  tool_sitemap_usecase_2:
    'محتوى محدّث: أضف lastmod للصفحات التي تغيّرت فعلًا. لا تعتمد جوجل هذا الحقل إلا إذا كان التاريخ دقيقًا ومتسقًا في الملف كله، فوضع تاريخ اليوم لكل الروابط يجعلها تتجاهله تمامًا.',
  ...
  tool_sketch_prompt_generator_platforms_lead: 'مخصّص لـ ChatGPT وGemini وClaude وDeepSeek — انسخ الـ prompt ليقود الدردشة تشغيل Sketch.app.',
  ...
  tool_sketch_prompt_generator_rules_item_4: 'تجميع نص فقط؛ لا يشغّل Sketch.app أو الإضافات أو Midjourney أو واجهات الدردشة محليًا.',
  ...
  tool_sketch_prompt_generator_usecase_1: 'مرّر أحجام اللوحات وأسماء الرموز لدردشة الفريق لإعادة بناء شاشة في Sketch.app.',
  tool_sketch_prompt_generator_usecase_2: 'أعد قوائم تصدير (PNG وPDF) قبل مراجعة التصميم.',
  tool_sketch_prompt_generator_usecase_3: 'قارن مع Product design prompt builder عندما تحتاج شخصية/إطارًا سلكيًا بدل قوائم Sketch.app.',
  ...
  tool_spf_dkim_dmarc_checker_faq_a1: 'مزوّدو البريد يقيّمون الثلاثة عادةً معًا. فحص DMARC وحده قد يغفل SPF معطّلًا أو محدد DKIM خاطئًا.',
  tool_spf_dkim_dmarc_checker_faq_a2: 'google — شائع في Google Workspace. غيّره إن نشر مزوّدك محددًا آخر (مثل s1 أو k1).',
  tool_spf_dkim_dmarc_checker_faq_a3: 'لا. مصادقة DNS للنطاق فقط (استعلام SPF ومفتاح DKIM وسياسة DMARC). وجود الصناديق خارج النطاق.',
  tool_spf_dkim_dmarc_checker_faq_a4: 'لا. تشمل السجل وسطر توضيح لآليات SPF all وسياسة DMARC p=.',
  ...
  tool_spf_dkim_dmarc_checker_fetch_failed: 'فشل استعلام DNS. قد يكون المحلّل غير متاح أو الاسم محظورًا.',
  ...
  tool_spf_dkim_dmarc_checker_formula_item_1: 'SPF: TXT على النطاق يبدأ بـ v=spf1؛ نعرض مُؤهّل all النهائي (~all فشل مرن، -all صارم).',
  tool_spf_dkim_dmarc_checker_formula_item_2: 'DMARC: TXT على _dmarc.النطاق يبدأ بـ v=DMARC1؛ نبرز p= (none / quarantine / reject) وpct اختياريًا.',
  tool_spf_dkim_dmarc_checker_formula_item_3: 'DKIM: TXT على {selector}._domainkey.النطاق؛ نتحقق من وجود مفتاح عام p= غير فارغ.',
  tool_spf_dkim_dmarc_checker_formula_item_4: 'السجلات المفقودة تُعلن بوضوح. فشل DoH يظهر كخطأ — وليس اختبار توقيع حي من مزوّد البريد.',
  tool_spf_dkim_dmarc_checker_formula_item_5: 'لا فحص SMTP RCPT ولا تعديل للمنطقة. أداة «هل يوجد عنوان البريد؟» خارج النطاق.',
  ...
  tool_spf_dkim_dmarc_checker_privacy_note: 'يُرسل النطاق ومحدّد DKIM إلى Worker لإجراء DNS-over-HTTPS. لا نخزّنهما كقاعدة بيانات منتج.',
  ...
  tool_spf_dkim_dmarc_checker_usecase_1: 'قبل الإطلاق: بعد نشر DNS لمزوّد البريد، تأكد من وجود SPF وDKIM وDMARC لنطاق الإرسال.',
  tool_spf_dkim_dmarc_checker_usecase_2: 'فحص سجل DMARC: اقرأ p=none مقابل quarantine/reject بلغة واضحة دون الاعتماد على النص الخام فقط.',
  tool_spf_dkim_dmarc_checker_usecase_3: 'استعلام SPF عند وصول الرسائل للمزعجات: انظر ~all أو -all ثم وافق محدد DKIM مع مزوّدك.',
  ...
  tool_split_pdf_faq_a1: 'لا. يعمل pdf-lib وfflate في تبويبك (قد تُحمَّل السكربتات من هذا الموقع). لا نرفع ملفك إلى خوادمنا.',
  ...
  tool_turn_pdf_into_editable_document_article:
    'حوّل PDF إلى مستند قابل للتحرير: اسحب طبقة النص ثم صدّر PDF معاد البناء. بلا تعرّف ضوئي. تبقى الملفات على جهازك دون رفع إلى خادم.',
  ...
  tool_turn_pdf_into_editable_document_desc:
    'تحويل PDF إلى مستند قابل للتحرير — اجعل قابلًا للتحرير يسحب طبقة النص ثم تصدّر PDF معاد البناء. تبقى الملفات على جهازك دون رفع إلى خادم.',
  tool_turn_pdf_into_editable_document_description:
    'حوّل PDF إلى مستند قابل للتحرير في المتصفح: اضغط اجعل قابلًا للتحرير لسحب طبقة النص وعدّل ثم صدّر PDF معاد البناء. بلا تعرّف ضوئي. تبقى الملفات على جهازك دون رفع إلى خادم. تعرض الصفحة العملية والخطوات ومثالًا.',
  tool_turn_pdf_into_editable_document_download: 'تنزيل',
  tool_turn_pdf_into_editable_document_download_text: 'تنزيل .txt',
  ...
  tool_turn_pdf_into_editable_document_example:
    'تحميل المثال ينشئ PDF فيه «Hello editable PDF document sample.» ويشغّل اجعل قابلًا للتحرير ثم يصدّر PDF قابلًا للتنزيل.',
  ...
  tool_turn_pdf_into_editable_document_faq_a2:
    'تحفظ هذه الصفحة النص المستخرج كملف TXT قابل للتحرير مع خيار PDF معاد البناء؛ أما صفحة تحرير نص PDF فتركز على تعديل الكلمات وإرجاع PDF.',
  tool_turn_pdf_into_editable_document_faq_a3:
    'التصدير PDF معاد البناء وليس وورد. انسخ النص عبر استخراج النص من PDF أو اكتب ملفًا جديدًا عبر كتابة مستند PDF عبر الإنترنت.',
  tool_turn_pdf_into_editable_document_faq_a4:
    'بلا OCR — نفس حد طبقة النص كتحرير نص PDF. الفرق: التنزيل الرئيسي هنا .txt قابل للتحرير؛ في تحرير نص PDF هو PDF المعاد بناؤه.',
  ...
  tool_turn_pdf_into_editable_document_faq_q4: 'ما الفرق عن تحرير نص PDF عبر الإنترنت؟',
  ...
  tool_turn_pdf_into_word_document_desc:
    'حوّل PDF إلى مستند وورد في المتصفح — استخرج النص القابل للتحديد ثم نزّل .docx. يبقى الملف على جهازك دون رفع إلى خادم.',
  tool_turn_pdf_into_word_document_description:
    'حوّل PDF إلى مستند وورد في المتصفح: استخرج النص القابل للتحديد، راجعه، ثم نزّل .docx. تبقى الملفات على جهازك دون رفع إلى خادم. بلا OCR. تظهر عملية التحويل ومثال جاهز عند تحميل العينة.',
  ...
  tool_unlock_pdf_faq_a2: 'لا. مكتبة PDF يعمل في تبويبك (تُحمَّل السكربتات من هذا الموقع). PDF لا يُرفع إلى خوادمنا.',
  ...
  tool_validate_security_txt_faq_a1: 'الأفضل /.well-known/security.txt. /security.txt على نفس المضيف هو الاحتياطي الموثّق.',
  tool_validate_security_txt_faq_a2: 'Contact على الأقل. Expires متوقع في ممارسة RFC 9116؛ نعلّم الفجوات.',
  tool_validate_security_txt_faq_a3: 'لا. العنوان هو التحقق من security.txt. الـ RFC في القواعد والمراجع.',
  ...
  tool_validate_security_txt_fetch_failed: 'تعذر جلب security.txt. قد يكون المضيف غير متاح أو يحظر الروبوتات.',
  tool_validate_security_txt_formula_body: 'متوافق مع RFC 9116 وممارسات securitytxt.org الشائعة.',
  tool_validate_security_txt_formula_item_1: 'ترتيب الجلب: أولاً /.well-known/security.txt ثم /security.txt.',
  ...
  tool_validate_security_txt_formula_item_4: 'Preferred-Languages وCanonical يُعرضان إن وُجدا وليسا إلزاميين للقائمة.',
  ...
  tool_validate_security_txt_home_desc: 'تحقق مما إذا كان الموقع ينشر security.txt صالحًا يتضمن Contact وExpires.',
  tool_validate_security_txt_home_title: 'التحقق من security.txt',
  tool_validate_security_txt_how_body: 'يجيب المدقق عن سؤال واحد: هل ينشر الموقع ملف اكتشاف مع Contact صالح وExpires قابل للاستخدام؟',
  tool_validate_security_txt_how_item_1: 'أدخل نطاقًا أو رابط HTTPS.',
  tool_validate_security_txt_how_item_2: 'انقر تحقق؛ يجرّب Worker مسار /.well-known/security.txt ثم /security.txt.',
  tool_validate_security_txt_how_item_3: 'راجع Contact وExpires وPreferred-Languages وCanonical والمعاينة.',
  ...
  tool_validate_security_txt_privacy_note: 'يُرسل الرابط واسم المضيف إلى Worker لجلب security.txt. لا نخزنها كقاعدة بيانات منتج.',
  ...
  tool_validate_security_txt_usecase_1: 'فاحص security.txt قبل الإطلاق: هل well-known يصل وفيه Contact؟',
  tool_validate_security_txt_usecase_2: 'بعد تعديل Expires: تأكد أن التاريخ يُفهم ولم ينتهِ بعد.',
  tool_validate_security_txt_usecase_3: 'قبل التواصل مع مورد: تحقق أنه ينشر ملف الاكتشاف.',
  ...
  tool_wrap_formula_with_ifna_description:
    'غلّف الصيغة بـ IFNA. العملية: الصق الصيغة الداخلية والقيمة البديلة. مثال NA() مع 0. ليست IFERROR. الحساب في المتصفح. العملية والخطوات تطابق المثال الظاهر. دون رفع إلى خادم.',
  ...
  tool_write_countif_formula_in_excel_add: 'أضف صفاً',
  tool_write_countif_formula_in_excel_alt: 'إذا #N/A',
  tool_write_countif_formula_in_excel_article: 'أنجز صيغة COUNTIF في المتصفح دون رفع.',
  tool_write_countif_formula_in_excel_bar: 'أعمدة',
  tool_write_countif_formula_in_excel_buyer: 'المشتري',
  tool_write_countif_formula_in_excel_cell: 'خلية',
  tool_write_countif_formula_in_excel_clear: 'مسح',
  tool_write_countif_formula_in_excel_copy: 'نسخ',
  tool_write_countif_formula_in_excel_count: 'عد',
  tool_write_countif_formula_in_excel_criteria: 'معيار',
  tool_write_countif_formula_in_excel_csv: 'لصق CSV',
  ...
  tool_write_countif_formula_in_excel_description:
    'اكتب صيغة COUNTIF. العملية: نطاق A1 والمعيار مع * ?. مثال A2:A6 وWest. الحساب في المتصفح. العملية والخطوات تطابق المثال الظاهر. دون رفع إلى خادم.',
  tool_write_countif_formula_in_excel_download: 'تنزيل xlsx',
  tool_write_countif_formula_in_excel_draw: 'رسم',
  tool_write_countif_formula_in_excel_else: 'وإلا',
  tool_write_countif_formula_in_excel_empty: 'حمّل المثال أو املأ الحقول.',
  tool_write_countif_formula_in_excel_err_read: 'تعذر القراءة. جرّب xlsx أو csv.',
  tool_write_countif_formula_in_excel_example: 'A2:A6 + West → =COUNTIF(A2:A6,"West").',
  tool_write_countif_formula_in_excel_example_title: 'مثال',
  tool_write_countif_formula_in_excel_faq_a1: 'لا. تبقى على الجهاز دون رفع إلى خادم.',
  tool_write_countif_formula_in_excel_faq_a2: 'لا.',
  tool_write_countif_formula_in_excel_faq_a3: 'زر المثال يملأ الحقول.',
  tool_write_countif_formula_in_excel_faq_a4: 'حسب الأداة؛ العارض للقراءة فقط.',
  tool_write_countif_formula_in_excel_faq_q1: 'هل تُرفع الملفات عند صيغة COUNTIF؟',
  tool_write_countif_formula_in_excel_faq_q2: 'هل هذا Excel Online؟',
  tool_write_countif_formula_in_excel_faq_q3: 'أين المثال؟',
  tool_write_countif_formula_in_excel_faq_q4: 'هل يمكن التحرير؟',
  tool_write_countif_formula_in_excel_file: 'ملف',
  tool_write_countif_formula_in_excel_filter: 'تصفية',
  tool_write_countif_formula_in_excel_formula: 'صيغة',
  tool_write_countif_formula_in_excel_how_body: 'أنجز صيغة COUNTIF في المتصفح دون رفع.',
  tool_write_countif_formula_in_excel_how_item_1: 'ابدأ بإدخال بيانات صيغة COUNTIF.',
  tool_write_countif_formula_in_excel_how_item_2: 'املأ الحقول بالترتيب الظاهر.',
  tool_write_countif_formula_in_excel_how_item_3: 'حمّل المثال وقارن النتيجة.',
  tool_write_countif_formula_in_excel_how_item_4: 'انسخ الصيغة أو نزّل ملف xlsx.',
  tool_write_countif_formula_in_excel_how_title: 'كيف يعمل',
  tool_write_countif_formula_in_excel_inner: 'الصيغة الداخلية',
  tool_write_countif_formula_in_excel_line: 'خط',
  tool_write_countif_formula_in_excel_lines: 'وصف,كمية,سعر',
  tool_write_countif_formula_in_excel_need_lib: 'تعذر تحميل المكتبة. تحقق من الشبكة.',
  tool_write_countif_formula_in_excel_note_2016: 'تحتاج IFS إلى Excel 2019 أو Microsoft 365 أو إصدار أحدث.',
  tool_write_countif_formula_in_excel_op_blank: 'فارغ',
  tool_write_countif_formula_in_excel_op_contains: 'يحتوي',
  tool_write_countif_formula_in_excel_op_eq: 'يساوي',
  tool_write_countif_formula_in_excel_range: 'نطاق',
  tool_write_countif_formula_in_excel_row_field: 'حقل الصف',
  tool_write_countif_formula_in_excel_rules_body: 'تحقق من ترتيب الشروط والمراجع قبل النسخ. تستخدم الصيغة أسماء الدوال الإنجليزية والفواصل.',
  tool_write_countif_formula_in_excel_rules_item_1: 'تحقق من ترتيب الشروط والمراجع قبل النسخ.',
  tool_write_countif_formula_in_excel_rules_item_2: 'تستخدم الصيغة أسماء الدوال الإنجليزية والفواصل.',
  tool_write_countif_formula_in_excel_rules_item_3: 'قد يحتاج Excel المحلي إلى أسماء مترجمة أو فاصلة منقوطة.',
  tool_write_countif_formula_in_excel_rules_item_4: 'تبقى المدخلات على الجهاز دون رفع إلى خادم.',
  tool_write_countif_formula_in_excel_rules_title: 'القواعد',
  tool_write_countif_formula_in_excel_sample: 'تحميل مثال',
  tool_write_countif_formula_in_excel_seller: 'البائع',
  tool_write_countif_formula_in_excel_sheet: 'ورقة',
  tool_write_countif_formula_in_excel_sum: 'جمع',
  tool_write_countif_formula_in_excel_tax: 'ضريبة ٪',
  tool_write_countif_formula_in_excel_title: 'اكتب صيغة COUNTIF في إكسل',
  tool_write_countif_formula_in_excel_trial: 'تجربة',
  tool_write_countif_formula_in_excel_usecase_1: 'واجب صف.',
  tool_write_countif_formula_in_excel_usecase_2: 'مسودة سريعة.',
  tool_write_countif_formula_in_excel_usecase_3: 'تحقق قبل اللصق في إكسل.',
  tool_write_countif_formula_in_excel_usecases_title: 'متى يفيد',
  tool_write_countif_formula_in_excel_val_field: 'حقل القيمة',
  tool_write_countif_formula_in_excel_write: 'اكتب الصيغة',
  ...
  tool_write_ifs_formula_in_excel_description:
    'اكتب صيغة IFS باختبارات مرتبة ونتيجة أخيرة مع TRUE. مثال: West يعطي A وEast يعطي B والباقي Other. تحتاج Excel 2019 أو Microsoft 365 أو إصداراً أحدث.',
  ...
  tool_write_nested_if_formula_for_excel_description:
    'اكتب صيغة IF متداخلة لإكسل في المتصفح. العملية: صفوف يساوي/يحتوي/فارغ ثم انسخ الصيغة. مثال: A1=West يعطي A. الحساب في المتصفح. العملية والخطوات تطابق المثال الظاهر. دون رفع إلى خادم.',
  ...
  tool_write_pdf_document_online_description:
    'كتابة مستند PDF عبر الإنترنت. تبقى الملفات على جهازك دون رفع إلى خادم. يمكن تحميل المثال لمراجعة مدخل فعلي ونتيجته؛ وتوضح الصفحة الخطوات والحدود.',
  ...
  tool_write_pdf_document_online_faq_a4:
    'إضافة نص تطبع على PDF موجود. تحرير نص PDF يغيّر صياغة طبقة النص. هذه الصفحة تنشئ PDF جديداً من النص المكتوب فقط.',
  ...
  tool_write_pdf_document_online_how_body:
    'اكتب فقرات نصاً عادياً، حدّد حجم الخط، أنشئ PDF متعدد الصفحات مع التفاف تلقائي، اعرض المعاينة ثم نزّل. كل شيء يبقى في هذا التبويب.',
  ...
  tool_writing_prompt_generator_ai_consent_body:
    'هذه الخطوة الاختيارية ترسل مسودتك الحالية إلى Cloudflare Workers AI للاستدلال. ولا يذهب من خوادمنا شيء إلى OpenAI أو Google أو Anthropic أو DeepSeek. وبدون الذكاء الاصطناعي يبقى البناء المحلي كما هو.',
  tool_writing_prompt_generator_ai_consent_cancel: 'إلغاء',
  tool_writing_prompt_generator_ai_consent_ok: 'متابعة',
  tool_writing_prompt_generator_ai_consent_title: 'إرسال النص إلى Cloudflare Workers AI؟',
  tool_writing_prompt_generator_ai_done: 'كُتب نص الذكاء الاصطناعي كاملًا في صندوق النتيجة. راجعه قبل النسخ.',
  tool_writing_prompt_generator_ai_err_generic: 'تعذّر الذكاء الاصطناعي. برومبتك المحلي كما هو دون تغيير.',
  tool_writing_prompt_generator_ai_err_rate: 'نفدت حصة الذكاء الاصطناعي. استخدم الوضع المحلي أو جرّب غدًا (UTC).',
  tool_writing_prompt_generator_ai_err_turnstile: 'أكمل Turnstile قبل استخدام الذكاء الاصطناعي.',
  tool_writing_prompt_generator_ai_expand: 'توسيع بالذكاء الاصطناعي',
  tool_writing_prompt_generator_ai_panel_label: 'ذكاء Cloudflare اختياري (Turnstile)',
  tool_writing_prompt_generator_ai_polish: 'تحسين بالذكاء الاصطناعي',
  tool_writing_prompt_generator_ai_working: 'ذكاء Cloudflare قيد المعالجة…',
  ...
  tool_writing_prompt_generator_faq_q4: 'هل يعمل مولّد البرومبتات العشوائي هنا؟',
  ...
  tool_writing_prompt_generator_faq_q7: 'هل يمكن استخدامه مع ChatGPT وGemini وClaude وDeepSeek؟',
  tool_writing_prompt_generator_faq_q8: 'ما الفرق بين الوضع المحلي وذكاء Cloudflare الاختياري؟',
  ...
  tool_yaml_json_faq_a2:
    'التحويل يبقى في التبويب. قد يقدّم هذا الموقع مكتبة js-yaml؛ ذلك تنزيل كود فقط — ليس رفعًا لنص YAML أو JSON.',
