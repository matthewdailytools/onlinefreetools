...
const ar: SiteLangDict = {
  ...
  tool_image_format_converter_err_mime_mismatch:
    'المتصفح لم يُرجع الصيغة المطلوبة. غيّر الهدف أو استخدم Chromium لـ AVIF.',
  ...
  tool_image_exif_how_body: 'تختار صورة فتُقرأ العلامات محليًا مع تمييز الخصوصية. الحذف يعيد الرسم على لوحة ويصدّر ملفًا بلا EXIF مع تحقق من GPS.',
  ...
  tool_image_compress_description: 'اضغط الصور في المتصفح مع أطول ضلع والجودة وحد كيلوبايت اختياري. الخطوات: اختر صورة، اضبط التحجيم/الجودة أو السقف، نزّل WebP أو JPEG. مثال: تصغير صورة هاتف نحو ~200 كيلوبايت للبريد — بلا رفع؛ إعادة الترميز تزيل EXIF غالبًا.',
  ...
  tool_image_compress_how_body: 'اختر صورة، قيّد الضلع الطويل إن لزم، عيّن الجودة أو الكيلوبايت والصيغة. فك الترميز محليًا ثم التحجيم واللوحة وtoBlob. سقف الكيلوبايت يخفض الجودة. إعادة الترميز تزيل EXIF غالبًا.',
  ...
  tool_image_compress_example: 'JPEG هاتف ~4 ميغابايت بضلع 1920 وWebP ~0.8 غالبًا يصل لمئات الكيلوبايت. هدف 200 كيلوبايت يكرر الجودة؛ وإلا تحذير.',
  ...
  tool_image_optimizer_description: 'حسّن صور الويب في المتصفح باستخدام MozJPEG أو WebP أو AVIF أو OxiPNG. الخطوات: اختر صورة، حمّل المحرك، اختر الترميز والإعدادات، قارن قبل/بعد بالمنزلق، ثم نزّل. مثال: حوّل JPEG كبيرًا لصورة رئيسية إلى WebP أخف — الملفات تبقى على جهازك بعد تحميل المحرك.',
  tool_image_optimizer_article: 'محسّن صور محلي بـ WASM: اختيار الترميز، الجودة/الجهد، حد اختياري لأطول ضلع، مقارنة منزلقة، وتنبيه صادق لبطء AVIF.',
  ...
  tool_image_optimizer_how_body: 'اختر صورة، حمّل المحرك مرة، اختر MozJPEG أو WebP أو AVIF أو OxiPNG، اضبط الجودة أو الجهد، ويمكنك تقييد أطول ضلع، ثم حرّك المنزلق للمقارنة. الترميز محلي. إن أردت تصغيرًا سريعًا بلا اختيار ترميز، استخدم ضاغط الصور الخفيف.',
  ...
  tool_image_optimizer_rules_item_4: 'OxiPNG: تصغير PNG بلا فقدان. الصور تبقى كبيرة؛ أنسب لواجهات حادة بشفافية. إعادة الترميز تزيل EXIF عادة؛ والبايتات لا تغادر الصفحة.',
  tool_image_optimizer_example_title: 'مثال',
  tool_image_optimizer_example: 'نفس JPEG هاتف (~3–4 MB): MozJPEG غالبًا أصغر من JPEG متصفح عادي؛ WebP يقلّص أكثر بمظهر قريب؛ AVIF قد يصغّر أكثر لكنه قد يستغرق ثوانٍ على إطار كبير. الأرقام تقريبية — اعتمد المنزلق على ملفك.',
  ...
  tool_image_optimizer_faq_a1: 'لا. بعد تحميل المحرك يبقى فك الترميز والترميز في هذه الصفحة. تحقق من Network أن الصورة لا تُرسل بـ POST.',
  ...
  tool_image_optimizer_faq_a3: 'الضاغط مرور سريع للحجم/الجودة (مناسب لهدف بالكيلوبايت). هنا تحمّل محركًا لاختيار MozJPEG أو WebP أو AVIF أو OxiPNG والمقارنة بالمنزلق.',
  tool_image_optimizer_faq_q4: 'لماذا يجب تحميل محرك أولًا؟',
  tool_image_optimizer_faq_a4: 'ملفات الترميز كبيرة. ننتظر نقرة حتى تبقى الصفحة خفيفة — تُحمَّل فقط عند الحاجة لتحسين بمستوى الترميز.',
  ...
  tool_image_optimizer_faq_a6: 'عندما يكون الهدف تغيير النوع (بما فيه خلفية JPEG للشفافية). استخدم هذا المحسّن عندما يهمك الحجم والتحكم بالترميز أكثر من تبديل سريع للصيغة.',




  tool_image_crop_title: 'قص الصورة وتغيير الحجم — محليًا',
  tool_image_crop_description: 'قص أو غيّر الحجم في المتصفح بتحديد حر ونسب (1:1 و16:9…) وأحجام شائعة. الخطوات: اختر صورة، حدّد الإطار أو إعدادًا مسبقًا، عيّن العرض×الارتفاع، ثم نزّل JPEG/WebP/PNG. مثال: قص مربع 512×512 للصورة الشخصية — محليًا؛ التصدير يزيل EXIF عادة.',
  ...
  tool_image_crop_how_body: 'اختر صورة، اقفل النسبة أو ارسم بحرية، عيّن العرض×الارتفاع (أو إعدادًا مسبقًا) ثم صدّر. يُعاد تعيين الإطار على الشاشة إلى بكسلات المصدر، يُرسم على لوحة ثم toBlob. وضع تغيير الحجم فقط يستخدم الاحتواء/التغطية. بلا رفع؛ إعادة الترميز تزيل EXIF عادة.',
  ...
  tool_image_crop_example: 'عينة 1600×1000 بنسبة 1:1 تصدّر JPEG 512×512 بجودة ~0.9. بدّل إلى 16:9 و1920×1080 للغلاف (يُقيَّد إن كان القص أصغر). أطول ضلع 1200 يصغّر الصورة كاملة.',
  ...
  tool_color_from_image_article:
    'لوحة ألوان سائدة محلياً مع متوسط منطقة بالنقر ونسخ HEX/RGB/HSL.',
  ...
  tool_color_from_image_rules_item_3:
    'يمكن طلب 2–12 لوناً للوحة؛ الصور المسطحة قد تعيد أقل. الألوان مرتّبة حسب نسبة العينات.',
  ...
  tool_color_from_image_rules_item_5:
    'الخصوصية: فك الترميز وحساب اللوحة والعيّن بالنقر كلها محلياً في هذا التبويب.',
  ...
  tool_color_from_image_faq_a2: 'الصفحة تصغّر الصورة، تزيل البكسل منخفض الشفافية، تقسّم فضاء اللون بـ median-cut، تُوسط كل مجموعة وترتّب حسب عدد العينات.',
  tool_color_from_image_faq_q3: 'ماذا يحدث عند النقر على الصورة؟',
  tool_color_from_image_faq_a3: 'الأداة تعيد النقرة إلى بكسل المصدر وتُوسط الألوان المعتمة في مربع صغير (~7×7). تحصل على HEX/RGB/HSL لتلك المنطقة، منفصلة عن قائمة اللوحة.',
  ...
  tool_image_merge_rules_body: 'حجم اللوحة يتبع الصيغ أدناه. في الشبكة الخلايا بعرض وارتفاع موحّد؛ الاحتواء يترك هامشًا والتغطية تقص.',
  tool_image_merge_rules_item_1:
    'أفقي: الارتفاع = أقصى ارتفاع للمصادر؛ كل صورة تُقاس له؛ العرض = مجموع العروض المقاسة + (n−1)×فراغ.',
  tool_image_merge_rules_item_2:
    'عمودي: العرض = أقصى عرض للمصادر؛ كل صورة تُقاس له؛ الارتفاع = مجموع الارتفاعات المقاسة + (n−1)×فراغ.',
  ...
  tool_image_merge_faq_a2: 'الأفقي يوحّد الارتفاع ويمتد بالعرض؛ العمودي يوحّد العرض ويمتد بالارتفاع. الشبكة خلايا ثابتة مع احتواء أو تغطية.',
  ...
  tool_image_merge_faq_a5: 'حواف لوحة فوق ~8192 px أو مصادر ضخمة قد تتجاوز ذاكرة المتصفح. قلّل العدد أو الأعمدة أو قصّ المصدر أولًا.',
  ...
  tool_image_overlay_faq_a2: 'الدمج يرتّب عدة صور أفقيًا أو عموديًا أو شبكة. التراكب يبقي أساسًا واحدًا ويرسم طبقة بشفافية وموضع ومزج.',
  tool_image_overlay_faq_q3: 'ماذا تفعل أوضاع المزج؟',
  tool_image_overlay_faq_a3: 'قواعد Canvas: العادي يتراكب؛ Multiply يُظلم؛ Screen يُضيء؛ Overlay يزيد التباين؛ Darken/Lighten يختار min/max.',
...
tool_ip_address_title: 'ما هو عنوان IP الخاص بي — IP عام (IPv4/IPv6)',
  ...
  tool_ip_address_rules_item_5: 'الموقع ومزود الخدمة من بيانات IP على الطرف — غالبًا مستوى المدينة؛ الجوال/CGNAT قد يخطئ؛ VPN يظهر عقدة الخروج.',
  ...
  tool_ip_address_faq_a2:
    'عادة ترى IP خروج VPN/البروكسي لا عنوان النطاق المنزلي. حدّث بعد التبديل للتأكد.',
  ...
  tool_ip_address_faq_a5:
    'الاستعلام طلب قصير على الطرف الطرفي. لا سجل عناوين؛ اعتبر النتيجة عرضًا مؤقتًا.',
