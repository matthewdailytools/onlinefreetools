...
const ar: SiteLangDict = {
  ...
  tool_batch_convert_web_pages_to_jpg_desc: 'حوّل عدة صفحات ويب إلى JPG من قائمة روابط ثم نزّل ZIP. يُجلب كل عنوان مرة ولا يُخزَّن.',
  ...
  tool_batch_convert_web_pages_to_pdf_desc: 'حوّل عدة صفحات ويب إلى PDF من قائمة روابط ونزّل ZIP؛ يُجلب كل عنوان مرة ولا يُحفظ.',
  ...
  tool_batch_convert_web_pages_to_pdf_faq_a5: 'حتى 10 روابط http(s). تُتجاهل الأسطر الزائدة. تُتجاوز الصفوف الفاشلة ليكمل الباقي.',
  ...
  tool_batch_convert_web_pages_to_pdf_how_body: 'الصق قائمة صفحات عامة، حوّلها تباعًا، ثم خذ ZIP لملفات PDF التي نجحت.',
  ...
  tool_batch_convert_web_pages_to_pdf_rules_body: 'رابط http(s) واحد في كل سطر، حتى 10. تحويل متسلسل. الفشل يُتجاوز. ملفات PDF الناجحة تدخل ZIP.',
  tool_batch_convert_web_pages_to_pdf_rules_item_1: 'يُرسل كل رابط مرة لجلب HTML ولا يُخزَّن. يُبنى PDF في هذا التبويب.',
  tool_batch_convert_web_pages_to_pdf_rules_item_2: 'الشبكات الخاصة وتسجيل الدخول والصفحات المفقودة تفشل ذلك الصف فقط ويكمل الباقي.',
  tool_batch_convert_web_pages_to_pdf_rules_item_3: 'الأسماء المكررة في ZIP تصبح name (2).pdf. تُحذف النصوص البرمجية قبل الالتقاط.',
  tool_batch_convert_web_pages_to_pdf_rules_item_4: 'ليست زاحفًا لموقع كامل. الصق الروابط التي لديك.',
  ...
  tool_batch_convert_web_pages_to_pdf_wait_hint: 'ثوانٍ إضافية بعد بدء تحميل الصور. الافتراضي 1. ارفعه إن ظهر مربع صورة فارغ في PDF.',
