...
const ar: SiteLangDict = {
  ...
  tool_add_text_to_pdf_file_description:
    'إضافة نص إلى ملف PDF. تبقى الملفات على جهازك دون رفع إلى خادم. El ejemplo al entrar يعرض نتيجة حقيقية عند الدخول. un resultado real يعرض العملية والخطوات والمثال في الصفحة.',
  ...
  tool_check_pdf_a_compliance_description:
    'فحص توافق PDF/A. تبقى الملفات على جهازك دون رفع إلى خادم. El ejemplo al entrar يعرض نتيجة حقيقية عند الدخول. un resultado real يعرض العملية والخطوات والمثال في الصفحة.',
  ...
  tool_combine_files_into_one_pdf_description:
    'دمج ملفات في PDF واحد. تبقى الملفات على جهازك دون رفع إلى خادم. El ejemplo al entrar يعرض نتيجة حقيقية عند الدخول. un resultado real يعرض العملية والخطوات والمثال في الصفحة.',
  ...
  tool_compare_two_pdfs_description:
    'مقارنة ملفي PDF. تبقى الملفات على جهازك دون رفع إلى خادم. El ejemplo al entrar يعرض نتيجة حقيقية عند الدخول. un resultado real يعرض العملية والخطوات والمثال في الصفحة.',
  ...
  tool_convert_html_to_pdf_description:
    'تحويل HTML إلى PDF. تبقى الملفات على جهازك دون رفع إلى خادم. El ejemplo al entrar يعرض نتيجة حقيقية عند الدخول. un resultado real يعرض العملية والخطوات والمثال في الصفحة.',
  ...
  tool_extract_text_from_pdf_description:
    'استخراج نص من PDF. تبقى الملفات على جهازك دون رفع إلى خادم. El ejemplo al entrar يعرض نتيجة حقيقية عند الدخول. un resultado real يعرض العملية والخطوات والمثال في الصفحة.',
  ...
  tool_make_pdf_flipbook_description:
    'إنشاء كتاب PDF تفاعلي. تبقى الملفات على جهازك دون رفع إلى خادم. El ejemplo al entrar يعرض نتيجة حقيقية عند الدخول. un resultado real يعرض العملية والخطوات والمثال في الصفحة.',
  ...
  tool_open_pdf_in_browser_description:
    'فتح PDF في المتصفح. تبقى الملفات على جهازك دون رفع إلى خادم. El ejemplo al entrar يعرض نتيجة حقيقية عند الدخول. un resultado real يعرض العملية والخطوات والمثال في الصفحة.',
  ...
  tool_print_pdf_description:
    'طباعة PDF. تبقى الملفات على جهازك دون رفع إلى خادم. El ejemplo al entrar يعرض نتيجة حقيقية عند الدخول. un resultado real يعرض العملية والخطوات والمثال في الصفحة.',
  ...
  tool_turn_pdf_into_editable_document_faq_a2:
    'هذه الصفحة تفتح نسخة قابلة للتحرير من طبقة النص. تحرير نص PDF عبر الإنترنت يغيّر الصياغة بزر رئيسي مختلف.',
  ...
  tool_write_pdf_document_online_description:
    'كتابة مستند PDF عبر الإنترنت. تبقى الملفات على جهازك دون رفع إلى خادم. El ejemplo al entrar يعرض نتيجة حقيقية عند الدخول. un resultado real يعرض العملية والخطوات والمثال في الصفحة.',
