...
const ar: SiteLangDict = {
  ...
  tool_text_diff_example:
    'مثال (وضع الكلمات): A = "Hello world", B = "Hello there" → تغيير واحد (world → there). إذا تغيّر السطر الأوسط فقط من ثلاثة أسطر، وضع الأسطر يُميّز ذلك السطر.',
  ...
  tool_text_diff_how_body:
    'الصق نسختين، اختر الدقة (سطر أو كلمة أو حرف)، ثم راجع الإضافات بالأخضر والحذف بالأحمر. المقارنة محلية في المتصفح؛ لا نخزّن نصك.',
  ...
  tool_text_diff_faq_a2: 'لا. كل شيء في المتصفح. إغلاق التبويب يمسح اللصق؛ لا نخزّنه.',
