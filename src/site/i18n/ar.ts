...
const ar: SiteLangDict = {
  ...
  tool_edit_pdf_text_online_faq_a4:
    'إضافة نص تطبع سطرًا عند إحداثي. استخراج النص ينسخ الصياغة فقط. هذه الصفحة تغيّر النص الموجود وتعيد بناء الصفحات.',
  ...
  tool_extract_text_from_pdf_how_body: 'كيف يعمل: تبقى الملفات على جهازك دون رفع إلى خادم.',
  ...
  tool_extract_text_from_pdf_rules_item_1: 'استخراج نص من PDF.',
  ...
  tool_write_pdf_document_online_faq_a2: 'لا. لا تعتمد هذه العملية على استخراج طبقة النص من PDF.',
  ...
  tool_write_pdf_document_online_how_item_2: 'اضغط «Create PDF» لتنفيذ العملية',
