...
const ar: SiteLangDict = {
  ...
  tool_convert_html_to_pdf_description:
    'حوّل HTML إلى PDF: الصق مقطعًا أو حمّل عنوان الصفحة، أزل السكربتات والسمات الخطرة، راجع المعاينة ونزّل ملف A4. عند تحميل رابط يجلب الخادم HTML مرة واحدة دون حفظه؛ التحويل يبقى في التبويب. المواقع المعتمدة على جافاسكربت وتنسيقات الطباعة والصور من نطاق آخر قد لا تطابق الصفحة الحية.',
