...
const ar: SiteLangDict = {
  ...
  tool_yaml_json_rules_body:
    'الافتراضي يطابق أنواع js-yaml الكلاسيكية ما لم تفعّل الأنواع الآمنة لـ JSON. الاتجاهان في صفحة واحدة حتى لا يصبح «json إلى yaml» رابط doorway منفصل.',
  ...
  tool_csv_json_rules_body:
    'افتراضيًا تبقى كل خلية نصًا كي لا تتلف المعرّفات. نُبقي الاتجاهين في صفحة واحدة كي لا يكون «json إلى csv» صفحة بوابة.',
