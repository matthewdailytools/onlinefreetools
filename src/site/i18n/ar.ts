...
const ar: SiteLangDict = {
  ...
  tool_edit_pdf_text_online_article:
    'حرّر نص PDF عبر الإنترنت: استخرج طبقة النص وعدّلها ثم أعد بناء الصفحات بتخطيط بسيط. تبقى الملفات على جهازك دون رفع إلى خادم.',
  ...
  tool_edit_pdf_text_online_desc:
    'تحرير نص PDF عبر الإنترنت — استخراج طبقة النص وتعديلها ثم إعادة بناء بسيطة. تبقى الملفات على جهازك دون رفع إلى خادم.',
  tool_edit_pdf_text_online_description:
    'حرّر نص PDF عبر الإنترنت في المتصفح: استخرج طبقة النص وعدّلها في المحرر ثم طبّق إعادة بناء بسيطة. تبقى الملفات على جهازك دون رفع إلى خادم. تعرض الصفحة العملية والخطوات ومثالًا.',
  ...
  tool_edit_pdf_text_online_example:
    'تحميل المثال ينشئ PDF من صفحة واحدة فيه «Hello edit PDF text sample.» ويملأ المحرر ثم تطبيق يُنتج PDF قابلًا للتنزيل.',
  ...
  tool_edit_pdf_text_online_faq_a2:
    'لا. هذا ليس تعديلًا للرموز في موضعها. يُستخرج النص وتعدّله ثم تُعاد رسم الصفحات بتخطيط بسيط. لا تُحفظ الخطوط والأعمدة الدقيقة.',
  ...
  tool_edit_pdf_text_online_faq_a4:
    'إضافة نص تختم سطرًا عند X/Y. تحويل PDF إلى مستند قابل للتحرير يعطي أولوية لتنزيل .txt القابل للتحرير (وPDF معاد البناء اختياريًا). هنا التنزيل الأساسي هو .pdf المعاد بناؤه بعد تحرير طبقة النص.',
