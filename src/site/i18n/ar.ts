...
const ar: SiteLangDict = {
  ...
  tool_prompt_template_builder_desc: 'منشئ قوالب Prompt لـ ChatGPT وGemini وClaude وDeepSeek — Markdown/JSON؛ يبقى على الجهاز.',
  ...
  tool_writing_prompt_generator_desc: 'مولّد prompts الكتابة للحوار والشخصية والسيناريو والعشوائي — Markdown/JSON؛ يبقى على الجهاز.',
