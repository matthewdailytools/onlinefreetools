...
const ar: SiteLangDict = {
  ...
  tool_batch_checksum_release_files_rules_item_1: 'SHA-256 يعمل دائماً. MD5 اختياري ويحمّل crypto-js من CDN؛ البايتات تبقى في التبويب.',
  ...
  tool_combine_files_into_one_pdf_faq_a1: 'لا. العرض يعمل في تبويبك (قد تُحمَّل المكتبات من CDN). ملفك لا يُرفع إلى خوادمنا.',
  ...
  tool_convert_html_to_pdf_description:
    'تحويل HTML إلى PDF. تبقى الملفات على جهازك دون رفع إلى خادم. يمكن تحميل المثال لمراجعة مدخل فعلي ونتيجته؛ وتوضح الصفحة الخطوات والحدود.',
  ...
  tool_convert_html_to_pdf_faq_a2: 'لا. لا تعتمد هذه العملية على استخراج طبقة النص من PDF.',
  ...
  tool_convert_html_to_pdf_faq_q2: 'هل يتطلب OCR أو نصاً قابلاً للتحديد؟',
  ...
  tool_convert_html_to_pdf_how_item_2: 'اضغط «Convert» لتنفيذ العملية',
