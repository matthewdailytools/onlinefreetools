...
tool_ip_address_title: 'ما هو عنوان IP الخاص بي — IP عام (IPv4/IPv6)',
  tool_ip_address_description:
    'اعرض عنوان IP العام كما يراه طرفنا الطرفي لهذا الاتصال — IPv4 أو IPv6 حسب المسار. العملية: افتح الصفحة أو اضغط تحديث؛ يقرأ العامل عنوان العميل الموثوق. مثال: قد يظهر 203.0.113.10. مع VPN/بروكسي يظهر IP الخروج لا 192.168 على الموجّه. مفيد للقوائم البيضاء والوصول عن بُعد والتحقق من VPN.',
