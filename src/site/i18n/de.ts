...
const de: SiteLangDict = {
  ...
  tool_sketch_prompt_generator_empty: 'Mindestens ein Feld ausfüllen, bevor Sie erstellen.',
  ...
  tool_sketch_prompt_generator_faq_q3: 'How is this different from Skizzen-Prompt-Generator?',
  ...
  tool_sketch_prompt_generator_platforms_lead: 'Für ChatGPT, Gemini, Claude, DeepSeek — fertigen Prompt in jeden Chat kopieren.',
  ...
  tool_sketch_prompt_generator_status_copied: 'In Zwischenablage kopiert.',
  ...
  tool_sketch_prompt_generator_title: 'Skizzen-Prompt-Generator — Lokal + optionale KI',
  ...
  tool_sketch_prompt_generator_usecases_title: 'Gute Einsätze',
