...
const de: SiteLangDict = {
  ...
  tool_add_digital_signature_to_pdf_article:
    'Stempeln Sie einen sichtbaren Integritätskasten mit SHA-256-Präfix. Dateien bleiben auf Ihrem Gerät, ohne Server-Upload.',
  ...
  tool_add_digital_signature_to_pdf_example:
    'Beispiel laden erzeugt eine „Sample record“-Seite, hasht sie und stempelt „Digital markiert“ mit 16 Hex bei etwa X=48, Y=48.',
  ...
  tool_add_digital_signature_to_pdf_how_body:
    'Wählen Sie das PDF, setzen Seite sowie X/Y, markieren und laden herunter. Dateien bleiben auf Ihrem Gerät, ohne Server-Upload.',
  ...
  tool_add_digital_signature_to_pdf_rules_body:
    'Der Hash gilt für die Quellbytes vor dem Stempel. Der Kasten ist sichtbare Tinte, kein Signaturdictionary.',
  ...
  tool_add_text_to_pdf_file_description:
    'Text zu PDF hinzufügen. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload. El ejemplo al entrar Beim Laden wird ein echtes Ergebnis gezeigt. un resultado real Zeigt Prozess, Schritte und ein Beispiel auf der Seite.',
  ...
  tool_android_prompt_builder_build: 'Prompt erstellen',
  tool_android_prompt_builder_clear: 'Leeren',
  tool_android_prompt_builder_compose_ui_label: 'Compose / Ui',
  tool_android_prompt_builder_compose_ui_ph: 'Sample compose ui…',
  tool_android_prompt_builder_copy: 'Kopieren',
  ...
  tool_android_prompt_builder_download: 'Herunterladen',
  tool_android_prompt_builder_empty: 'Mindestens ein Feld ausfüllen, bevor Sie erstellen.',
  ...
  tool_android_prompt_builder_example_title: 'Beispiel',
  ...
  tool_android_prompt_builder_faq_q3: 'How is this different from Android-Prompt-Builder?',
  ...
  tool_android_prompt_builder_fmt_label: 'Ausgabeformat',
  ...
  tool_android_prompt_builder_how_title: 'So funktioniert es',
  ...
  tool_android_prompt_builder_load_sample: 'Beispiel laden',
  tool_android_prompt_builder_platforms_lead: 'Für ChatGPT, Gemini, Claude, DeepSeek — fertigen Prompt in jeden Chat kopieren.',
  tool_android_prompt_builder_result_label: 'Prompt-Ausgabe',
  ...
  tool_android_prompt_builder_rules_title: 'Erwartete Regeln',
  ...
  tool_android_prompt_builder_status_copied: 'In Zwischenablage kopiert.',
  tool_android_prompt_builder_status_done: 'Prompt bereit.',
  tool_android_prompt_builder_status_working: 'Prompt wird erstellt…',
  tool_android_prompt_builder_title: 'Android-Prompt-Builder — Lokal + optionale KI',
  ...
  tool_android_prompt_builder_usecases_title: 'Gute Einsätze',
  ...
  tool_batch_checksum_release_files_drop_hint:
    'Release-Dateien ablegen (bis 20). Das Hashen bleibt in diesem Tab. Diese Seite packt die Originale nicht ins ZIP.',
  ...
  tool_batch_checksum_release_files_faq_a4: 'Schalten Sie Auch MD5 ein. SHA-256 läuft immer. MD5 ist extra für ältere Listen, keine zweite URL.',
  ...
  tool_batch_checksum_release_files_how_item_5:
    'CSV oder SUMS exportieren, sobald mindestens ein Hash geklappt hat. Nur eine Datei? Nutzen Sie Datei-Hash.',
  ...
  tool_batch_checksum_release_files_rules_item_4: 'Die Dateien bleiben auf dem Gerät und werden nicht auf einen Server hochgeladen.',
  ...
  tool_batch_compress_pdfs_for_email_how_item_2:
    'Behalten Sie die E-Mail-Voreinstellung, außer Sie brauchen Druck (schärfer) oder Maximal verkleinern.',
  ...
  tool_batch_compress_pdfs_for_email_how_item_5:
    'ZIP herunterladen, sobald mindestens eine Datei geklappt hat. Nur eine PDF? Nutzen Sie PDF komprimieren.',
  ...
  tool_batch_compress_pdfs_for_email_rules_item_3: 'Reine Textdateien werden oft kaum kleiner. Das ist erwartet; die Tabelle meldet die Größen trotzdem.',
  tool_batch_compress_pdfs_for_email_rules_item_4: 'Die Dateien bleiben auf dem Gerät und werden nicht auf einen Server hochgeladen.',
  ...
  tool_batch_watermark_product_photos_how_item_4:
    'Drücken Sie Auf alle anwenden. Leinwände kürzer als 64 px werden übersprungen. JPEG malt zuerst weiß.',
  tool_batch_watermark_product_photos_how_item_5:
    'ZIP herunterladen, sobald mindestens eine Datei gelungen ist. Ein Foto nachziehen: Textwasserzeichen hinzufügen.',
  ...
  tool_batch_watermark_product_photos_rules_item_3: 'Schräges DRAFT kachelt das Wort. Doppelte ZIP-Namen werden Name (2).jpg oder .png.',
  tool_batch_watermark_product_photos_rules_item_4: 'Dateien bleiben auf Ihrem Gerät, ohne Server-Upload.',
  ...
  tool_bulk_compress_png_images_faq_a5: 'Nein. Nur das erste Bild wird als stilles PNG gespeichert.',
  ...
  tool_bulk_compress_png_images_how_item_2:
    'Den 1024-px-Chip nutzen, wenn Icons schrumpfen sollen; Nur neu kodieren, wenn die Pixelgröße bleiben muss.',
  tool_bulk_compress_png_images_how_item_3:
    'Alle komprimieren drücken. Jede Zeile bleibt PNG. Fehler werden übersprungen, der Rest kommt ins Paket.',
  tool_bulk_compress_png_images_how_item_4:
    'Wenn ein fotoähnliches PNG kaum schrumpft, warnt die Tabelle — JPEG auf der Produktfoto-Seite ist oft kleiner.',
  tool_bulk_compress_png_images_how_item_5:
    'ZIP herunterladen, sobald mindestens eine Datei geklappt hat. Beispiel laden lief schon beim ersten Zeichnen.',
  ...
  tool_bulk_compress_png_images_rules_item_4: 'Dateien bleiben auf Ihrem Gerät, ohne Server-Upload.',
  ...
  tool_bulk_compress_png_images_warn_same:
    'Manche PNG sind kaum kleiner geworden. Längste Kante verkleinern, oder Produktfoto-Komprimierung nutzen wenn JPEG geht.',
  ...
  tool_bulk_compress_product_photos_drop_hint: 'JPEG, PNG oder WebP ablegen (max. 20). Die Kompression bleibt in diesem Tab.',
  ...
  tool_bulk_compress_product_photos_faq_a5: 'Nein. Nur das erste Bild wird als Standfoto komprimiert.',
  ...
  tool_bulk_compress_product_photos_how_body: 'Listing-Fotos sammeln, eine Größengrenze teilen, hier komprimieren, ZIP der Treffer mitnehmen.',
  ...
  tool_bulk_convert_images_to_jpg_drop_hint: 'PNG, JPEG, WebP, GIF oder HEIC ablegen (bis 20). Die Umwandlung bleibt in diesem Tab.',
  ...
  tool_bulk_convert_images_to_jpg_faq_a4: 'Nein. JPEG und JPG sind dieselbe Ausgabe. Dateien heißen .jpg.',
  ...
  tool_bulk_convert_images_to_jpg_how_item_3:
    'Qualität etwas senken, wenn der Mailanhang klein bleiben muss — die Aufgabe bleibt JPG, keine 200-KB-Jagd.',
  ...
  tool_bulk_convert_images_to_jpg_rules_item_1: 'Ausgabenamen enden immer auf .jpg.',
  ...
  tool_bulk_convert_images_to_jpg_rules_item_4: 'Dateien bleiben auf Ihrem Gerät, ohne Server-Upload.',
  ...
  tool_bulk_convert_images_to_png_faq_a5: 'Nein. Nur das erste Bild wird als stilles PNG gespeichert, und die Zeile wird vermerkt.',
  ...
  tool_bulk_convert_images_to_png_how_item_3:
    'Drücken Sie Alle umwandeln. JPEG wird undurchsichtiges PNG; die Tabelle warnt, wenn die Datei gewachsen ist.',
  ...
  tool_bulk_convert_images_to_png_rules_body: 'Die Ausgabe ist immer PNG. Diese Seite flacht Transparenz nicht auf eine JPEG-Unterlage.',
  tool_bulk_convert_images_to_png_rules_item_1: 'Alpha bleibt, wenn die Quelle es hat. Eine JPEG-Quelle hat kein Alpha zum Behalten.',
  ...
  tool_bulk_convert_images_to_png_rules_item_4: 'Dateien bleiben auf Ihrem Gerät, ohne Server-Upload.',
  ...
  tool_bulk_convert_images_to_webp_err_unsupported: 'Dieser Browser hat kein WebP-Blob zurückgegeben. Die Zeile wird übersprungen, kein JPEG geschrieben.',
  ...
  tool_bulk_convert_images_to_webp_faq_a5: 'Nein. Nur das erste Bild wird als stilles WebP gespeichert, und die Zeile wird vermerkt.',
  ...
  tool_bulk_convert_images_to_webp_how_item_4:
    'JPG für E-Mail? Bilder in Masse nach JPG umwandeln. Verlustfreies PNG? Bilder in Masse nach PNG umwandeln.',
  ...
  tool_bulk_convert_images_to_webp_rules_item_1: 'Alpha bleibt, wenn die Quelle es hat. Eine JPEG-Quelle hat kein Alpha zum Behalten.',
  ...
  tool_bulk_convert_images_to_webp_rules_item_4: 'Dateien bleiben auf Ihrem Gerät, ohne Server-Upload.',
  ...
  tool_check_pdf_a_compliance_description:
    'PDF/A-Konformität prüfen. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload. El ejemplo al entrar Beim Laden wird ein echtes Ergebnis gezeigt. un resultado real Zeigt Prozess, Schritte und ein Beispiel auf der Seite.',
  ...
  tool_check_robots_txt_url_blocked_faq_a1: 'Nein. Es prüft nur die Sperre. Zum Schreiben von Regeln den robots.txt-Generator nutzen.',
  ...
  tool_check_robots_txt_url_blocked_fetch_failed: 'robots.txt konnte nicht geladen werden. Host offline oder Bot-Abweisung möglich.',
  ...
  tool_check_robots_txt_url_blocked_formula_item_5:
    'Nur /robots.txt wird angefragt; private Hosts abgelehnt. Kein Ersatz für den offiziellen Search-Console-Tester.',
  tool_check_robots_txt_url_blocked_formula_title: 'Matching-Regeln',
  tool_check_robots_txt_url_blocked_home_desc: 'Seiten-URL einfügen und prüfen, ob robots.txt den Pfad für Googlebot oder andere Bots sperrt.',
  ...
  tool_check_robots_txt_url_blocked_usecase_2: 'robots.txt-Tester/Validator: nach einem Disallow prüfen, ob die Ziel-URL wirklich trifft.',
  ...
  tool_check_ssl_certificate_expiration_faq_a3: 'Fokus ist der Ablauf des neuesten Treffers. Ein reiner Chain-Checker ist sekundär — nicht der H1.',
  tool_check_ssl_certificate_expiration_faq_a4: 'Nein. Der H1 lautet SSL-Zertifikatsablauf prüfen. Der breitere Head ist nicht der alleinige Titel.',
  ...
  tool_check_ssl_certificate_expiration_fetch_failed: 'crt.sh konnte nicht abgefragt werden. Rate-Limits oder Ausfall möglich.',
  ...
  tool_check_ssl_certificate_expiration_home_desc: 'Sehen Sie, wann das neueste CT-Zertifikat eines Hostnamens abläuft (crt.sh — kein Live-Handshake).',
  ...
  tool_combine_files_into_one_pdf_description:
    'Dateien zu einem PDF kombinieren. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload. El ejemplo al entrar Beim Laden wird ein echtes Ergebnis gezeigt. un resultado real Zeigt Prozess, Schritte und ein Beispiel auf der Seite.',
  ...
  tool_compare_two_pdfs_description:
    'Zwei PDFs vergleichen. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload. El ejemplo al entrar Beim Laden wird ein echtes Ergebnis gezeigt. un resultado real Zeigt Prozess, Schritte und ein Beispiel auf der Seite.',
  ...
  tool_convert_html_to_pdf_description:
    'HTML in PDF umwandeln. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload. El ejemplo al entrar Beim Laden wird ein echtes Ergebnis gezeigt. un resultado real Zeigt Prozess, Schritte und ein Beispiel auf der Seite.',
  ...
  tool_convert_pdf_to_dwg_desc:
    'PDF im Browser Richtung DWG umwandeln — ASCII-DXF mit Text und Seitenrahmen. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload.',
  tool_convert_pdf_to_dwg_description:
    'Wandeln Sie ein PDF im Browser Richtung DWG um: ASCII-DXF mit TEXT-Objekten und Seitenrahmen, das AutoCAD öffnet. Der Browser kann kein proprietäres DWG schreiben. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload. Prozess, Schritte und ein Beispiel stehen auf dieser Seite.',
  ...
  tool_convert_pdf_to_dwg_example:
    'Beispiel laden erzeugt ein PDF mit „Hello PDF to DWG sample.“, wandelt es in ASCII-DXF und aktiviert Download .dxf.',
  tool_convert_pdf_to_dwg_example_title: 'Beispiel',
  tool_convert_pdf_to_dwg_faq_a1:
    'Nein. Ein Browser kann kein proprietäres DWG schreiben. Der Download ist ASCII-DXF, der übliche CAD-Austausch, den AutoCAD öffnet.',
  tool_convert_pdf_to_dwg_faq_a2: 'Nein. Die Umwandlung bleibt in diesem Tab. Das PDF geht nicht auf unsere Server.',
  tool_convert_pdf_to_dwg_faq_a3:
    'Nur TEXT aus der Textebene plus ein LINE-Seitenrahmen. Zeichnungen und Scans werden nicht nachgezeichnet.',
  ...
  tool_convert_pdf_to_dwg_how_body:
    'PDF mit Textebene wählen, Umwandeln klicken, DXF herunterladen. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload.',
  ...
  tool_convert_pdf_to_pdf_a_article:
    'PDF im Browser Richtung PDF/A bringen: Titel und Ersteller setzen und eine Standardschrift einbetten. Kein von veraPDF zertifiziertes Archiv. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload.',
  ...
  tool_convert_pdf_to_pdf_a_desc:
    'PDF im Browser Richtung PDF/A umwandeln — Titel und Ersteller setzen, Standardschrift einbetten. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload.',
  tool_convert_pdf_to_pdf_a_description:
    'Wandeln Sie ein PDF im Browser Richtung PDF/A um: Titel und Ersteller setzen und eine Standardschrift einbetten. Das ist kein von veraPDF zertifiziertes PDF/A. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload. Prozess, Schritte und ein Beispiel stehen auf dieser Seite.',
  ...
  tool_convert_pdf_to_pdf_a_example:
    'Beispiel laden erzeugt eine Seite mit „Hello PDF/A sample.“, führt Umwandeln aus und bietet eine archivnahe Datei zum Download.',
  ...
  tool_convert_pdf_to_pdf_a_faq_a2:
    'Nein. Das ist ein Best-Effort: Titel, Ersteller und eingebettete Standardschrift. Kein von veraPDF zertifiziertes PDF/A.',
  tool_convert_pdf_to_pdf_a_faq_a3:
    'Nutzen Sie PDF/A-Konformität prüfen auf dieser Site. Diese Seite bereitet nur eine Best-Effort-Datei vor.',
  ...
  tool_convert_pdf_to_pdf_a_how_body:
    'PDF wählen, Umwandeln klicken, umgeschriebene Datei herunterladen. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload.',
  ...
  tool_convert_word_document_to_pdf_desc:
    'Wandeln Sie ein Word-Dokument im Browser in PDF um — .docx wählen, HTML prüfen, exportieren. Dateien bleiben auf Ihrem Gerät, ohne Server-Upload.',
  tool_convert_word_document_to_pdf_description:
    'Wandeln Sie ein Word-Dokument im Browser in PDF um: Wählen Sie eine .docx, prüfen Sie die HTML-Vorschau und folgen Sie den Schritten des Prozesses zum druckbaren PDF. Dateien bleiben auf Ihrem Gerät, ohne Server-Upload. Ein Beispiel startet beim Laden der Probe.',
  ...
  tool_convert_word_document_to_pdf_how_body:
    'Wählen Sie die .docx, prüfen Sie HTML, dann umwandeln. Dateien bleiben auf Ihrem Gerät, ohne Server-Upload.',
  ...
  tool_create_pdf_form_article:
    'Starten Sie leer, benennen Sie Text oder Kästchen und laden Sie ein echtes Formular herunter. Felder auf eine vorhandene Datei legen Sie unter PDF ausfüllbar machen.',
  tool_create_pdf_form_choose_file: 'PDF wählen',
  tool_create_pdf_form_clear: 'Leeren',
  tool_create_pdf_form_desc:
    'Ein PDF-Formular von einer leeren Seite anlegen. Dateien bleiben auf Ihrem Gerät, ohne Server-Upload.',
  tool_create_pdf_form_description:
    'Erstellen Sie ein PDF-Formular von einer leeren Seite: benannte Textfelder oder Kästchen bei X/Y mit Breite und Höhe setzen, dann herunterladen. Nichts wird auf einen Server hochgeladen; die Datei entsteht in diesem Tab. Das Einstiegsbeispiel ist Name plus Email — ein Prozess mit Schritten und einem Beispiel, das Sie vor dem Export erweitern können.',
  ...
  tool_create_pdf_form_how_body:
    'Benennen Sie ein Feld, wählen Sie Text oder Kästchen, platzieren Sie es, fügen Sie weitere hinzu und laden Sie herunter. Das Beispiel startet mit Name und Email.',
  ...
  tool_edit_pdf_form_fields_article:
    'Listen Sie AcroForm-Namen, benennen Sie sie um oder entfernen Sie überzählige Kästen und laden Sie herunter. Antworten tippen Sie unter PDF-Formular ausfüllen.',
  ...
  tool_edit_pdf_form_fields_description:
    'Bearbeiten Sie PDF-Formularfelder in diesem Tab: Die Seite listet vorhandene Namen, Sie benennen einen Kasten um oder markieren ihn zum Entfernen und laden herunter. Dateien bleiben auf Ihrem Gerät und werden nicht auf einen Server hochgeladen. Das Einstiegsbeispiel ist ein Name-+-Email-Formular, damit die Liste sofort sichtbar ist — ein Prozess mit Schritten und einem Beispiel, bevor Sie eine echte Datei anfassen.',
  ...
  tool_edit_pdf_form_fields_how_body:
    'Öffnen Sie eine Formular-PDF, prüfen Sie die Namensliste, benennen Sie um oder markieren Sie Entfernen, übernehmen Sie und laden Sie herunter. Das Beispiel listet Name und Email beim Einstieg.',
  ...
  tool_edit_pdf_text_online_article:
    'PDF-Text online bearbeiten: Textebene holen, im Editor ändern, Seiten einfach neu setzen. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload.',
  ...
  tool_edit_pdf_text_online_desc:
    'PDF-Text online im Browser bearbeiten — Textebene holen, ändern, einfach neu setzen. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload.',
  tool_edit_pdf_text_online_description:
    'Bearbeiten Sie PDF-Text online im Browser: Textebene holen, im Editor ändern, dann einfach neu setzen. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload. Prozess, Schritte und ein Beispiel stehen auf dieser Seite.',
  ...
  tool_edit_pdf_text_online_faq_a3:
    'Gescannte PDFs sind Bilder ohne Textebene. Dieses Werkzeug macht kein OCR und scheitert mit einer klaren Meldung.',
  tool_edit_pdf_text_online_faq_a4:
    'Text hinzufügen setzt eine neue Zeile an X/Y. Text extrahieren kopiert nur den Wortlaut. Hier ändern Sie vorhandenen Wortlaut und setzen Seiten neu.',
  ...
  tool_edit_pdf_text_online_faq_q4: 'Unterschied zu Text hinzufügen oder Text extrahieren?',
  tool_edit_pdf_text_online_faq_q5: 'Sind große Dateien möglich?',
  tool_edit_pdf_text_online_how_body:
    'Wählen Sie ein PDF mit Textebene, ändern Sie den Wortlaut, dann Übernehmen. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload.',
  ...
  tool_extract_text_from_pdf_description:
    'Text aus PDF extrahieren. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload. El ejemplo al entrar Beim Laden wird ein echtes Ergebnis gezeigt. un resultado real Zeigt Prozess, Schritte und ein Beispiel auf der Seite.',
  ...
  tool_extract_text_from_pdf_how_body: 'So funktioniert es: Dateien bleiben auf Ihrem Gerät; ohne Server-Upload.',
  ...
  tool_extract_text_from_pdf_rules_item_1: 'Text aus PDF extrahieren.',
  ...
  tool_fill_out_pdf_form_article:
    'Wenn das PDF schon ausfüllbar ist und Sie nur Antworten tippen wollen. Ein Scan ohne Felder hat keine. Verschlüsselte Dateien scheitern mit lesbarer Meldung.',
  ...
  tool_fill_out_pdf_form_how_body:
    'Öffnen Sie ein ausfüllbares PDF, tippen Sie in die erkannten Felder und laden Sie herunter. Das Beispiel zeigt Name und Email bereits gefüllt.',
  ...
  tool_film_prompt_builder_build: 'Prompt erstellen',
  tool_film_prompt_builder_character_arc_label: 'Character / Arc',
  tool_film_prompt_builder_character_arc_ph: 'Sample character arc…',
  tool_film_prompt_builder_clear: 'Leeren',
  tool_film_prompt_builder_copy: 'Kopieren',
  ...
  tool_film_prompt_builder_download: 'Herunterladen',
  tool_film_prompt_builder_empty: 'Mindestens ein Feld ausfüllen, bevor Sie erstellen.',
  ...
  tool_film_prompt_builder_example_title: 'Beispiel',
  ...
  tool_film_prompt_builder_faq_q3: 'How is this different from Film-Prompt-Builder?',
  ...
  tool_film_prompt_builder_fmt_label: 'Ausgabeformat',
  ...
  tool_film_prompt_builder_how_title: 'So funktioniert es',
  tool_film_prompt_builder_load_sample: 'Beispiel laden',
  tool_film_prompt_builder_logline_label: 'Logline',
  tool_film_prompt_builder_logline_ph: 'Sample logline…',
  tool_film_prompt_builder_platforms_lead: 'Für ChatGPT, Gemini, Claude, DeepSeek — fertigen Prompt in jeden Chat kopieren.',
  tool_film_prompt_builder_result_label: 'Prompt-Ausgabe',
  ...
  tool_film_prompt_builder_rules_title: 'Erwartete Regeln',
  ...
  tool_film_prompt_builder_status_copied: 'In Zwischenablage kopiert.',
  tool_film_prompt_builder_status_done: 'Prompt bereit.',
  tool_film_prompt_builder_status_working: 'Prompt wird erstellt…',
  tool_film_prompt_builder_title: 'Film-Prompt-Builder — Lokal + optionale KI',
  ...
  tool_film_prompt_builder_usecases_title: 'Gute Einsätze',
  ...
  tool_find_and_validate_xml_sitemap_faq_a1: 'Nein — nur Finden und Prüfen. Zum Erzeugen aus einer URL-Liste den XML-Sitemap-Generator nutzen.',
  tool_find_and_validate_xml_sitemap_faq_a2: 'Zuerst Sitemap:-Zeilen in robots.txt, dann /sitemap.xml und gängige Index-Pfade auf demselben Host.',
  ...
  tool_find_and_validate_xml_sitemap_fetch_failed: 'Sitemap-Kandidaten konnten nicht geladen werden. Host offline oder Bots blockiert.',
  ...
  tool_find_and_validate_xml_sitemap_formula_item_2: 'Struktur gültig, wenn die Antwort nach Sitemap-XML aussieht und HTTP OK ist.',
  tool_find_and_validate_xml_sitemap_formula_item_3: 'sitemapindex listet Kind-Sitemaps; urlset listet Seiten-locs — beides wird gemeldet.',
  tool_find_and_validate_xml_sitemap_formula_item_4: 'Wir zählen <loc> und zeigen bis zu 10 Samples; wir crawlen nicht jede gelistete URL.',
  tool_find_and_validate_xml_sitemap_formula_item_5: 'Gzip, riesige Bodies, Redirects und Nicht-XML können scheitern. Private Hosts werden abgelehnt.',
  ...
  tool_find_and_validate_xml_sitemap_how_item_3: 'Prüfen Sie in der Tabelle Root-Typ, URL-Anzahl und <loc>-Samples.',
  tool_find_and_validate_xml_sitemap_how_item_4: 'Beheben Sie XML- oder Discovery-Probleme vor IndexNow oder Search Console.',
  ...
  tool_find_and_validate_xml_sitemap_references: 'sitemaps.org-Protokoll; Google Search Central — Sitemaps-Übersicht.',
  ...
  tool_find_and_validate_xml_sitemap_usecase_1: 'Sitemap-Finder: nach CMS- oder CDN-Umzug prüfen, wo die Karte veröffentlicht ist.',
  ...
  tool_ios_prompt_builder_build: 'Prompt erstellen',
  tool_ios_prompt_builder_clear: 'Leeren',
  tool_ios_prompt_builder_copy: 'Kopieren',
  ...
  tool_ios_prompt_builder_download: 'Herunterladen',
  tool_ios_prompt_builder_empty: 'Mindestens ein Feld ausfüllen, bevor Sie erstellen.',
  ...
  tool_ios_prompt_builder_example_title: 'Beispiel',
  ...
  tool_ios_prompt_builder_faq_q3: 'How is this different from iOS-Prompt-Builder?',
  ...
  tool_ios_prompt_builder_fmt_label: 'Ausgabeformat',
  ...
  tool_ios_prompt_builder_how_title: 'So funktioniert es',
  tool_ios_prompt_builder_load_sample: 'Beispiel laden',
  tool_ios_prompt_builder_platforms_lead: 'Für ChatGPT, Gemini, Claude, DeepSeek — fertigen Prompt in jeden Chat kopieren.',
  tool_ios_prompt_builder_result_label: 'Prompt-Ausgabe',
  ...
  tool_ios_prompt_builder_rules_title: 'Erwartete Regeln',
  ...
  tool_ios_prompt_builder_status_copied: 'In Zwischenablage kopiert.',
  tool_ios_prompt_builder_status_done: 'Prompt bereit.',
  tool_ios_prompt_builder_status_working: 'Prompt wird erstellt…',
  ...
  tool_ios_prompt_builder_title: 'iOS-Prompt-Builder — Lokal + optionale KI',
  ...
  tool_ios_prompt_builder_usecases_title: 'Gute Einsätze',
  ...
  tool_make_pdf_fillable_article:
    'Wenn die PDF wie ein Formular aussieht, die Kästen aber nur gezeichnet sind. Hier kommen echte Felder dazu. Antworten tippen Sie unter PDF-Formular ausfüllen.',
  ...
  tool_make_pdf_fillable_description:
    'Machen Sie eine PDF in diesem Tab ausfüllbar: Öffnen Sie eine statische Seite, setzen Sie Textfelder bei X/Y mit Breite und Höhe oder legen Sie N Standardfelder ab und laden Sie herunter. Dateien bleiben auf Ihrem Gerät und werden nicht auf einen Server hochgeladen. Das Einstiegsbeispiel ist eine leere Seite plus ein FullName-Feld — ein Prozess mit Schritten und einem Beispiel für Ihre Datei.',
  ...
  tool_make_pdf_fillable_faq_a4:
    'PDF-Formular erstellen startet leer und benennt Text oder Kästchen. Hier legen Sie Felder auf eine Datei, die Sie schon haben.',
  ...
  tool_make_pdf_fillable_how_body:
    'Öffnen Sie eine statische PDF, setzen Sie Name und Kasten, fügen Sie ein Feld oder N Standardfelder hinzu und laden Sie herunter. Das Beispiel setzt FullName auf eine leere Seite.',
  ...
  tool_make_pdf_flipbook_description:
    'PDF-Flipbook erstellen. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload. El ejemplo al entrar Beim Laden wird ein echtes Ergebnis gezeigt. un resultado real Zeigt Prozess, Schritte und ein Beispiel auf der Seite.',
  ...
  tool_midjourney_prompt_builder_build: 'Prompt erstellen',
  tool_midjourney_prompt_builder_clear: 'Leeren',
  tool_midjourney_prompt_builder_copy: 'Kopieren',
  ...
  tool_midjourney_prompt_builder_download: 'Herunterladen',
  tool_midjourney_prompt_builder_empty: 'Mindestens ein Feld ausfüllen, bevor Sie erstellen.',
  ...
  tool_midjourney_prompt_builder_example_title: 'Beispiel',
  ...
  tool_midjourney_prompt_builder_faq_q3: 'How is this different from Midjourney-Prompt-Builder?',
  ...
  tool_midjourney_prompt_builder_fmt_label: 'Ausgabeformat',
  ...
  tool_midjourney_prompt_builder_how_title: 'So funktioniert es',
  tool_midjourney_prompt_builder_lighting_label: 'Lighting',
  tool_midjourney_prompt_builder_lighting_ph: 'Sample lighting…',
  tool_midjourney_prompt_builder_load_sample: 'Beispiel laden',
  tool_midjourney_prompt_builder_mj_flags_label: 'Mj / Flags',
  tool_midjourney_prompt_builder_mj_flags_ph: 'Sample mj flags…',
  tool_midjourney_prompt_builder_platforms_lead: 'Für ChatGPT, Gemini, Claude, DeepSeek — fertigen Prompt in jeden Chat kopieren.',
  tool_midjourney_prompt_builder_result_label: 'Prompt-Ausgabe',
  ...
  tool_midjourney_prompt_builder_rules_title: 'Erwartete Regeln',
  ...
  tool_midjourney_prompt_builder_status_copied: 'In Zwischenablage kopiert.',
  tool_midjourney_prompt_builder_status_done: 'Prompt bereit.',
  tool_midjourney_prompt_builder_status_working: 'Prompt wird erstellt…',
  ...
  tool_midjourney_prompt_builder_title: 'Midjourney-Prompt-Builder — Lokal + optionale KI',
  ...
  tool_midjourney_prompt_builder_usecases_title: 'Gute Einsätze',
  tool_npv_article:
  ...
  tool_open_pdf_in_browser_description:
    'PDF im Browser öffnen. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload. El ejemplo al entrar Beim Laden wird ein echtes Ergebnis gezeigt. un resultado real Zeigt Prozess, Schritte und ein Beispiel auf der Seite.',
  ...
  tool_print_pdf_description:
    'PDF drucken. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload. El ejemplo al entrar Beim Laden wird ein echtes Ergebnis gezeigt. un resultado real Zeigt Prozess, Schritte und ein Beispiel auf der Seite.',
  ...
  tool_product_design_prompt_builder_build: 'Prompt erstellen',
  tool_product_design_prompt_builder_clear: 'Leeren',
  tool_product_design_prompt_builder_copy: 'Kopieren',
  ...
  tool_product_design_prompt_builder_download: 'Herunterladen',
  tool_product_design_prompt_builder_empty: 'Mindestens ein Feld ausfüllen, bevor Sie erstellen.',
  ...
  tool_product_design_prompt_builder_example_title: 'Beispiel',
  ...
  tool_product_design_prompt_builder_faq_q3: 'How is this different from Produktdesign-Prompt-Builder?',
  ...
  tool_product_design_prompt_builder_fmt_label: 'Ausgabeformat',
  ...
  tool_product_design_prompt_builder_how_title: 'So funktioniert es',
  tool_product_design_prompt_builder_load_sample: 'Beispiel laden',
  tool_product_design_prompt_builder_persona_label: 'Persona',
  tool_product_design_prompt_builder_persona_ph: 'Sample persona…',
  tool_product_design_prompt_builder_platforms_lead: 'Für ChatGPT, Gemini, Claude, DeepSeek — fertigen Prompt in jeden Chat kopieren.',
  tool_product_design_prompt_builder_problem_label: 'Problem',
  tool_product_design_prompt_builder_problem_ph: 'Sample problem…',
  tool_product_design_prompt_builder_result_label: 'Prompt-Ausgabe',
  ...
  tool_product_design_prompt_builder_rules_title: 'Erwartete Regeln',
  ...
  tool_product_design_prompt_builder_status_copied: 'In Zwischenablage kopiert.',
  tool_product_design_prompt_builder_status_done: 'Prompt bereit.',
  tool_product_design_prompt_builder_status_working: 'Prompt wird erstellt…',
  tool_product_design_prompt_builder_title: 'Produktdesign-Prompt-Builder — Lokal + optionale KI',
  ...
  tool_product_design_prompt_builder_usecases_title: 'Gute Einsätze',
  ...
  tool_short_drama_prompt_generator_build: 'Prompt erstellen',
  tool_short_drama_prompt_generator_clear: 'Leeren',
  ...
  tool_short_drama_prompt_generator_copy: 'Kopieren',
  ...
  tool_short_drama_prompt_generator_download: 'Herunterladen',
  tool_short_drama_prompt_generator_empty: 'Mindestens ein Feld ausfüllen, bevor Sie erstellen.',
  ...
  tool_short_drama_prompt_generator_example_title: 'Beispiel',
  ...
  tool_short_drama_prompt_generator_faq_q3: 'How is this different from Kurzdrama-Prompt-Generator?',
  ...
  tool_short_drama_prompt_generator_fmt_label: 'Ausgabeformat',
  ...
  tool_short_drama_prompt_generator_how_title: 'So funktioniert es',
  tool_short_drama_prompt_generator_load_sample: 'Beispiel laden',
  tool_short_drama_prompt_generator_platforms_lead: 'Für ChatGPT, Gemini, Claude, DeepSeek — fertigen Prompt in jeden Chat kopieren.',
  tool_short_drama_prompt_generator_result_label: 'Prompt-Ausgabe',
  ...
  tool_short_drama_prompt_generator_rules_title: 'Erwartete Regeln',
  ...
  tool_short_drama_prompt_generator_status_copied: 'In Zwischenablage kopiert.',
  tool_short_drama_prompt_generator_status_done: 'Prompt bereit.',
  tool_short_drama_prompt_generator_status_working: 'Prompt wird erstellt…',
  tool_short_drama_prompt_generator_title: 'Kurzdrama-Prompt-Generator — Lokal + optionale KI',
  ...
  tool_short_drama_prompt_generator_usecases_title: 'Gute Einsätze',
  ...
  tool_sign_pdf_document_article:
    'Setzen Sie einen gezeichneten oder getippten Namen auf eine PDF-Seite. Dateien bleiben auf Ihrem Gerät, ohne Server-Upload.',
  ...
  tool_sign_pdf_document_description:
    'Unterschreiben Sie ein PDF-Dokument im Browser: zeichnen oder tippen Sie einen Namen, setzen ihn auf X/Y einer Seite und laden herunter. Dateien bleiben auf Ihrem Gerät, ohne Server-Upload. Das ist ein sichtbarer Stempel, kein Zertifikat. Prozessschritte und ein Beispiel starten beim Laden der Probe.',
  tool_sign_pdf_document_disclaimer:
    'Nur sichtbare Erscheinung — keine zertifikatsbasierte digitale Signatur und keine Rechtsberatung. Nutzen Sie den Stempel nicht als Identitätsnachweis.',
  ...
  tool_sign_pdf_document_faq_a4:
    'Dieses Browser-Werkzeug setzt keine PKCS#7-/PAdES-Zertifikate. Nutzen Sie spezielle Signatursoftware.',
  ...
  tool_sketch_prompt_generator_rules_item_4: 'Nur Textzusammenbau; kein lokales Ausführen von Sketch.app, Plugins, Midjourney oder Chat-APIs.',
  ...
  tool_sketch_prompt_generator_usecase_1: 'Artboard-Größen und Symbolnamen an die Team-Chat-KI geben, um Screens in Sketch.app nachzubauen.',
  ...
  tool_spf_dkim_dmarc_checker_faq_a4: 'Nein. Ergebnisse enthalten den Eintrag plus eine Erklärzeile zu SPF-all-Mechanismen und DMARC p=.',
  ...
  tool_spf_dkim_dmarc_checker_fetch_failed: 'DNS-Abfrage fehlgeschlagen. Resolver unerreichbar oder Name blockiert.',
  ...
  tool_spf_dkim_dmarc_checker_how_item_1: 'Absenderdomain und optionalen DKIM-Selektor eingeben (Standard google).',
  tool_spf_dkim_dmarc_checker_how_item_2: 'Auf Prüfen klicken; der Worker fragt TXT per DoH für SPF, _dmarc und selector._domainkey ab.',
  tool_spf_dkim_dmarc_checker_how_item_3: 'Jeden Eintrag sowie die Erklärung zu ~all/-all und DMARC p= lesen.',
  tool_spf_dkim_dmarc_checker_how_item_4: 'DNS beim Provider korrigieren und erneut prüfen — diese Seite schreibt die Zone nicht um.',
  ...
  tool_spf_dkim_dmarc_checker_usecase_2: 'DMARC-Record prüfen: p=none vs. quarantine/reject verständlich lesen, nicht nur Roh-TXT.',
  tool_spf_dkim_dmarc_checker_usecase_3: 'SPF-Lookup, wenn Mail im Spam landet: ~all oder -all sehen und den DKIM-Selektor zum ESP ausrichten.',
  ...
  tool_turn_pdf_into_editable_document_article:
    'Machen Sie aus einem PDF ein bearbeitbares Dokument: Textebene in den Editor, dann neu gesetztes PDF exportieren. Kein OCR. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload.',
  ...
  tool_turn_pdf_into_editable_document_desc:
    'PDF in ein bearbeitbares Dokument verwandeln — Bearbeitbar machen holt die Textebene, danach exportieren Sie ein neu gesetztes PDF. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload.',
  tool_turn_pdf_into_editable_document_description:
    'Verwandeln Sie ein PDF im Browser in ein bearbeitbares Dokument: Bearbeitbar machen holt die Textebene, Sie ändern den Wortlaut und exportieren ein neu gesetztes PDF. Kein OCR. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload. Prozess, Schritte und ein Beispiel stehen auf dieser Seite.',
  ...
  tool_turn_pdf_into_editable_document_example:
    'Beispiel laden erzeugt ein PDF mit „Hello editable PDF document sample.“, führt Bearbeitbar machen aus und exportiert ein herunterladbares PDF.',
  ...
  tool_turn_pdf_into_editable_document_faq_a2:
    'Diese Seite holt eine bearbeitbare Kopie aus der Textebene. PDF-Text online bearbeiten ändert Wortlaut mit anderem Hauptknopf.',
  tool_turn_pdf_into_editable_document_faq_a3:
    'Export ist ein neu gesetztes PDF, kein Word. Text kopieren mit Text aus PDF extrahieren oder neu schreiben mit PDF-Dokument online schreiben.',
  tool_turn_pdf_into_editable_document_faq_a4: 'Kein OCR. Fehlt die Textebene, scheitert Bearbeitbar machen statt Buchstaben vom Scan zu raten.',
  ...
  tool_turn_pdf_into_editable_document_faq_q4: 'Macht Bearbeitbar machen OCR?',
  ...
  tool_turn_pdf_into_editable_document_how_body:
    'Öffnen Sie ein PDF mit Textebene, klicken Sie Bearbeitbar machen, dann exportieren. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload.',
  ...
  tool_turn_pdf_into_editable_document_title: 'PDF in ein bearbeitbares Dokument verwandeln',
  ...
  tool_turn_pdf_into_editable_document_word_note:
    'Word nötig? Text mit Text aus PDF extrahieren kopieren oder neu schreiben mit PDF-Dokument online schreiben.',
  ...
  tool_turn_pdf_into_word_document_desc:
    'Wandeln Sie ein PDF im Browser in ein Word-Dokument um — Textschicht übernehmen, .docx laden. Dateien bleiben auf Ihrem Gerät, ohne Server-Upload.',
  tool_turn_pdf_into_word_document_description:
    'Wandeln Sie ein PDF im Browser in ein Word-Dokument um: übernehmbare Textschicht auslesen, prüfen und .docx herunterladen. Dateien bleiben auf Ihrem Gerät, ohne Server-Upload. Kein OCR. Prozessschritte und ein Beispiel starten beim Laden der Probe.',
  ...
  tool_turn_pdf_into_word_document_how_body:
    'Wählen Sie ein PDF mit Textschicht, wandeln um, prüfen und laden herunter. Dateien bleiben auf Ihrem Gerät, ohne Server-Upload.',
  ...
  tool_validate_security_txt_faq_a2: 'Mindestens Contact. Expires wird in der RFC-9116-Praxis stark erwartet; Lücken markieren wir.',
  tool_validate_security_txt_faq_a3: 'Nein. Der H1 lautet security.txt prüfen. Die RFC steht in Regeln und Referenzen.',
  tool_validate_security_txt_faq_a4: 'Nein. Wir holen und parsen nur die veröffentlichte Datei. Kein Disclosure-Postfach.',
  ...
  tool_validate_security_txt_fetch_failed: 'security.txt konnte nicht geladen werden. Host offline oder blockiert Bots.',
  tool_validate_security_txt_formula_body: 'Abgestimmt auf RFC 9116 und übliche Praxis von securitytxt.org.',
  tool_validate_security_txt_formula_item_1: 'Reihenfolge: zuerst /.well-known/security.txt, dann /security.txt.',
  tool_validate_security_txt_formula_item_2: 'Contact ist Pflicht; wir listen Werte und markieren Fehlen.',
  tool_validate_security_txt_formula_item_3: 'Expires wird stark erwartet; Fehlen oder Datum in der Vergangenheit = Lücke.',
  tool_validate_security_txt_formula_item_4: 'Preferred-Languages und Canonical werden bei Vorhandensein gezeigt; für die Checklist nicht Pflicht.',
  tool_validate_security_txt_formula_item_5: 'Nur Abruf und Parsing — kein Vulnerability-Postfach und kein Pentest.',
  tool_validate_security_txt_formula_title: 'RFC-9116-Feldregeln',
  tool_validate_security_txt_home_desc: 'Prüfen Sie, ob eine Website eine gültige security.txt mit Contact und Expires veröffentlicht.',
  ...
  tool_validate_security_txt_how_item_2: 'Auf Prüfen klicken; der Worker versucht /.well-known/security.txt, dann /security.txt.',
  tool_validate_security_txt_how_item_3: 'Contact, Expires, Preferred-Languages, Canonical und die Vorschau prüfen.',
  tool_validate_security_txt_how_item_4: 'Markierte Lücken beheben, bevor Sie Ihre eigene security.txt veröffentlichen.',
  ...
  tool_validate_security_txt_usecase_1: 'security.txt-Checker vor dem Launch: antwortet well-known und gibt es Contact?',
  tool_validate_security_txt_usecase_2: 'Nach Expires-Änderung: prüfen, ob das Datum lesbar und noch nicht abgelaufen ist.',
  tool_validate_security_txt_usecase_3: 'Vor Kontakt zu einem Anbieter: prüfen, ob die Discovery-Datei veröffentlicht ist.',
  ...
  tool_write_pdf_document_online_description:
    'PDF-Dokument online schreiben. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload. El ejemplo al entrar Beim Laden wird ein echtes Ergebnis gezeigt. un resultado real Zeigt Prozess, Schritte und ein Beispiel auf der Seite.',
  ...
  tool_writing_prompt_generator_rules_item_2: 'Der Zufallsmodus integriert den Zufalls-Prompt-Generator unter dieser URL — ohne separate Seite.',
  tool_writing_prompt_generator_rules_item_3: 'Standardexport ist Markdown. JSON ist ein Chip auf derselben Leinwand.',
