...
const de: SiteLangDict = {
  ...
  tool_prompt_template_builder_desc: 'Strukturierte Prompt-Vorlage (Markdown/JSON) — bleibt auf dem Gerät, ohne Server-Upload.',
  ...
  tool_prompt_template_builder_rules_body: 'Eine wiederverwendbare Vorlage braucht klare Blöcke und ehrliche Grenzen — kein zweiter Generator.',
  ...
  tool_prompt_template_builder_usecase_1: 'System-Prompt für Code-Review veröffentlichen, den das Team in jede Chat-UI einfügen kann.',
  tool_prompt_template_builder_usecase_2: 'Meeting-Notizen in Role/Task/Constraints-Blöcke vor dem API-Anschluss umwandeln.',
  tool_prompt_template_builder_usecase_3: 'JSON exportieren und JSON-Schema-Validator für Config-Dateien öffnen.',
