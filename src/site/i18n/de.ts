...
const de: SiteLangDict = {
  ...
  tool_text_diff_example:
    'Beispiel (Wortmodus): A = "Hello world", B = "Hello there" → eine Änderung (world → there). Ändert sich nur die mittlere von drei Zeilen, markiert der Zeilenmodus genau diese Zeile.',
  ...
  tool_text_diff_how_body:
    'Zwei Versionen einfügen, Feinheit wählen (Zeile, Wort oder Zeichen), dann grüne Zusätze und rote Löschungen prüfen. Der Vergleich läuft nur im Browser; wir speichern Ihren Text nicht.',
  ...
  tool_text_diff_faq_a2: 'Nein. Alles bleibt im Browser. Tab schließen löscht den Text; wir speichern nichts.',
