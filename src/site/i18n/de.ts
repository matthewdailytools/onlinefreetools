...
const de: SiteLangDict = {
  ...
  tool_image_format_converter_article: 
    'Lokale Formatumwandlung mit klaren Regeln plus BMP/GIF/ICO/SVG-Export.',
  ...
  tool_image_format_converter_drop_hint: 'Oder PNG, JPEG, WebP, AVIF, GIF, BMP, ICO oder SVG hierher ziehen. Die Umwandlung bleibt in diesem Tab.',
  ...
  tool_image_format_converter_err_mime_mismatch:
    'Der Browser lieferte nicht das gewünschte Format. Ziel wechseln oder Chromium für AVIF nutzen.',
  ...
  tool_image_exif_how_body: 'Foto wählen; die Seite liest EXIF/GPS lokal und markiert Risiken. Entfernen richtet aus, zeichnet auf Canvas und exportiert ohne diese Tags.',
  ...
  tool_image_exif_example: 'JPEG mit GPS und Make erscheint in den Gruppen. Nach dem Entfernen kein GPS. Das eingebaute Beispiel hat absichtlich kein EXIF.',
  ...
  tool_image_compress_description: 'Fotos im Browser komprimieren: max. Seite, Qualität und optionales KB-Ziel. Schritte: Bild wählen, Skalierung/Qualität oder Größenlimit setzen, WebP oder JPEG laden. Beispiel: Handy-JPEG Richtung ~200 KB für E-Mail — keine Upload; Neuencodierung entfernt meist EXIF.',
  ...
  tool_image_compress_how_body: 'Bild wählen, optional längste Seite begrenzen, Qualität oder KB-Ziel und Format setzen. Lokal dekodieren, skalieren, Canvas, toBlob. KB-Ziel sucht Qualität nach unten. Neuencode entfernt meist EXIF.',
  ...
  tool_image_compress_example: '~4-MB-Handy-JPEG, Seite 1920, WebP ~0,8 → oft hunderte KB. Mit 200-KB-Ziel Qualität iterieren; sonst Warnung.',
  ...
  tool_image_optimizer_description: 'Optimieren Sie Bilder fürs Web im Browser mit MozJPEG, WebP, AVIF oder OxiPNG. Schritte: Bild wählen, Engine laden, Codec und Einstellungen wählen, Vorher/Nachher per Schieberegler vergleichen, herunterladen. Beispiel: großes Hero-JPEG zu kleinerem WebP — Dateien bleiben nach dem Laden der Engine auf dem Gerät.',
  tool_image_optimizer_article: 'Lokaler WASM-Bildoptimierer: Codec-Wahl, Qualität/Aufwand, optionale Max-Seite, Vergleichsregler und ehrliche Hinweise zur AVIF-Dauer.',
  ...
  tool_image_optimizer_drop_hint: 'Oder JPEG, PNG oder WebP hier ablegen. Nach dem Laden der Engine bleibt die Optimierung in diesem Tab.',
  ...
  tool_image_optimizer_how_body: 'Bild wählen, Engine einmal laden, MozJPEG, WebP, AVIF oder OxiPNG wählen, Qualität oder Aufwand einstellen, optional die längste Seite begrenzen und per Regler vergleichen. Encoding bleibt lokal. Für schnelles Verkleinern ohne Codec-Wahl den leichten Kompressor nutzen.',
  tool_image_optimizer_rules_title: 'Was Sie erwarten sollten',
  tool_image_optimizer_rules_body: 'Codecs tauschen Größe, Eindruck, Transparenz und Zeit unterschiedlich. Vor dem Jagd nach der kleinsten Datei lesen.',
  tool_image_optimizer_rules_item_1: 'MozJPEG: verlustbehaftetes JPEG, oft kleiner als typischer Browser-JPEG-Export — sinnvoll, wenn .jpg bleiben muss.',
  ...
  tool_image_optimizer_rules_item_4: 'OxiPNG: verlustfrei PNG verkleinern. Fotos bleiben groß; stark bei scharfer UI mit Alpha. Re-Encode entfernt meist EXIF; Bytes verlassen den Tab nicht.',
  tool_image_optimizer_example_title: 'Beispiel',
  tool_image_optimizer_example: 'Dasselbe Handy-JPEG (~3–4 MB): MozJPEG landet oft unter einem beiläufigen Browser-JPEG; WebP spart bei ähnlichem Eindruck meist weiter; AVIF kann noch kleiner werden, braucht bei großen Frames aber Sekunden. Zahlen sind Größenordnungen — vertrauen Sie dem Regler an Ihrer Datei.',
  ...
  tool_image_optimizer_faq_a1: 'Nein. Nach dem Laden der Engine bleiben Dekodieren und Encodieren hier. In Network sehen Sie, dass das Bild nicht per POST geht.',
  tool_image_optimizer_faq_q2: 'Warum zuerst eine Engine laden?',
  tool_image_optimizer_faq_a2: 'Codecs sind groß. Wir warten auf den Klick, damit der erste Paint leicht bleibt — Download nur bei Codec-Optimierung.',
  tool_image_optimizer_faq_q3: 'Unterschied zum Bildkompressor?',
  tool_image_optimizer_faq_a3: 'Der Kompressor ist ein schneller Größen-/Qualitätsdurchlauf (gut für Ziel-KB). Hier laden Sie eine Engine, wählen MozJPEG, WebP, AVIF oder OxiPNG und vergleichen per Regler.',
  tool_image_optimizer_faq_q4: 'Warum ist AVIF so langsam?',
  tool_image_optimizer_faq_a4: 'AVIF-Encoding belastet die CPU stark, besonders bei großen Fotos. Wir zeigen Fortschritt und erlauben Abbrechen statt „sofort fertig“ vorzutäuschen.',
  tool_image_optimizer_faq_q5: 'Wann den Formatkonverter?',
  tool_image_optimizer_faq_a5: 'Wenn Sie vor allem den Typ wechseln wollen (inkl. JPEG-Hintergrund für Transparenz). Diesen Optimierer nutzen, wenn Größe und Codec-Kontrolle wichtiger sind als ein schneller Formatwechsel.',
  tool_image_optimizer_faq_q6: 'Animation und EXIF?',
  tool_image_optimizer_faq_a6: 'Animationen werden zum ersten Standbild. Re-Encode entfernt EXIF meist; Tags vorher mit dem EXIF-Tool prüfen, falls nötig.',




  tool_image_crop_title: 'Bild zuschneiden & Größe ändern — lokal',
  tool_image_crop_description: 'Zuschneiden oder skalieren im Browser: freie Auswahl, Seitenverhältnisse (1:1, 16:9…) und gängige Ausgabegrößen. Schritte: Bild wählen, Rahmen oder Preset, Breite×Höhe setzen, JPEG/WebP/PNG laden. Beispiel: Quadrat 512×512 fürs Avatar — lokal; Export entfernt meist EXIF.',
  ...
  tool_image_crop_how_body: 'Foto wählen, Seitenverhältnis sperren oder frei zeichnen, Breite×Höhe (oder Preset) setzen und exportieren. Der Bildschirmrahmen wird auf Quellpixel gemappt, auf ein Canvas gezeichnet und per toBlob kodiert. Nur-Skalieren nutzt contain/cover. Kein Upload; Re-Encode entfernt meist EXIF.',
  tool_image_crop_rules_title: 'Erwartete Regeln',
  tool_image_crop_rules_body: 'Zuschneiden und Skalieren teilen eine Pipeline. Lesen Sie dies, bevor Sie mehr Pixel als die Auswahl verlangen.',
  ...
  tool_image_crop_example: 'Ein 1600×1000-Beispiel mit 1:1 exportiert JPEG 512×512 ~0,9. Wechsel zu 16:9 und 1920×1080 fürs Cover (begrenzt, wenn der Schnitt kleiner ist). Längste Seite 1200 verkleinert das ganze Foto.',
  ...
  tool_color_from_image_article:
    'Lokale Dominantfarben-Palette plus Regionalmittel per Klick, mit kopierbaren HEX/RGB/HSL.',
  ...
  tool_color_from_image_rules_item_5:
    'Datenschutz: Dekodierung, Palettenrechnung und Klick-Sampling laufen lokal in diesem Tab.',
  ...
  tool_color_from_image_faq_a1: 'Nein. Palettenrechnung und Klick-Sampling laufen lokal. Network-Tab prüfen — das Bild wird nicht per POST gesendet.',
  tool_color_from_image_faq_q2: 'Wie werden die Hauptfarben gewählt?',
  tool_color_from_image_faq_a2: 'Die Seite verkleinert das Bild, verwirft niedrig-alpha Pixel, teilt den Farbraum mit Median-Cut, mittelt jede Gruppe und sortiert nach Stichprobenzahl.',
  tool_color_from_image_faq_q3: 'Was passiert, wenn ich ins Bild klicke?',
  tool_color_from_image_faq_a3: 'Das Tool mappt den Klick auf Quellpixel und mittelt undurchsichtige Farben in einem kleinen Quadrat (~7×7). Sie erhalten HEX/RGB/HSL für diese Region, getrennt von der Palettenliste.',
  tool_color_from_image_faq_q4: 'Warum ist ein Klick kein einzelnes Pixel?',
  tool_color_from_image_faq_a4: 'Fotos und UI-Shots sind bei 1×1 verrauscht. Ein kleiner Regionsmittelwert ist stabiler für CSS-Akzente und folgt trotzdem dem Klickpunkt.',
  ...
  tool_image_merge_rules_body: 'Die Canvas-Größe folgt den Formeln unten. Im Raster teilen Zellen Breite und Höhe; Einpassen lässt Ränder, Füllen schneidet zu.',
  ...
  tool_image_merge_faq_a2: 'Horizontal vereinheitlicht die Höhe und wächst in der Breite; vertikal die Breite und in der Höhe. Raster nutzt feste Zellen mit Einpassen oder Füllen.',
  tool_image_merge_faq_q3: 'Garantieren 1080- oder 1200-Presets Instagram/Facebook-Freigabe?',
  tool_image_merge_faq_a3: 'Nein. Nur übliche Ausgabegrößen. Plattformregeln ändern sich — prüfen Sie die App, in der Sie posten.',
  ...
  tool_image_merge_faq_a5: 'Kanten über ~8192 px oder zu viele Megapixel können den Browser-Speicher sprengen. Weniger Bilder, Raster-Spalten oder vorher zuschneiden.',
  ...
  tool_image_overlay_article: 'Lokale Zwei-Ebenen-Komposition: Deckkraft, Anker oben links, Skalierung, Blend-Modi, JPEG-Hintergrund beim Abflachen.',
  ...
  tool_image_overlay_rules_body: 'Ausgabe-Leinwand = natürliche Pixelgröße der Basis. Ebene wird skaliert mit Anker oben links bei (x, y) gezeichnet.',
  tool_image_overlay_rules_item_1: 'Leinwand Breite × Höhe = natürliche Basismaße; Basis bei (0, 0).',
  tool_image_overlay_rules_item_2: 'Ebenengröße = natürliche Breite × Höhe × (Skalierung% ÷ 100); Position in Basis-Pixeln, Anker oben links.',
  ...
  tool_image_overlay_faq_a2: 'Zusammenfügen reiht mehrere Fotos horizontal, vertikal oder im Raster. Überlagern behält eine Basis und malt eine Ebene mit Deckkraft, Position und Blend darüber.',
  tool_image_overlay_faq_q3: 'Was machen die Blend-Modi?',
  tool_image_overlay_faq_a3: 'Canvas-Regeln: Normal stapelt; Multiplizieren dunkelt; Screen hellt; Overlay erhöht Kontrast; Abdunkeln/Aufhellen wählen Kanal-Min/Max.',
  tool_image_overlay_faq_q4: 'Warum JPEG-Hintergrundfarbe?',
  tool_image_overlay_faq_a4: 'JPEG hat keine Transparenz. Vor dem Export füllt das Tool die Leinwand, damit transparente PNG-Bereiche nicht schwarz werden.',
