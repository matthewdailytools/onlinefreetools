...
const en: SiteLangDict = {
  ...
  tool_batch_checksum_release_files_rules_item_1: 'SHA-256 always runs. MD5 is opt-in and lazy-loads crypto-js from a CDN; file bytes stay in the tab.',
  ...
  tool_batch_checksum_release_files_rules_item_3: 'Read failures skip that row. Duplicate queue names get a suffix. Empty queue disables export.',
  tool_batch_checksum_release_files_rules_item_4: 'Files stay on your device and are not uploaded to a server.',
  ...
  tool_batch_compress_pdfs_for_email_faq_a5: 'That row is skipped and the rest continue. Unlock it elsewhere, then add it again.',
  ...
  tool_batch_compress_pdfs_for_email_rules_body: 'Each PDF is rasterized to JPEG pages and rebuilt. Output is always a ZIP of separate PDFs.',
  ...
  tool_batch_compress_pdfs_for_email_rules_item_3: 'Text-only files may barely shrink. That is expected; the table still reports the sizes.',
  tool_batch_compress_pdfs_for_email_rules_item_4: 'Files stay on your device and are not uploaded to a server.',
  ...
  tool_batch_watermark_product_photos_how_item_2:
    'Set the text, corner, and short-edge percent. Default is SAMPLE at bottom right, 8% of the short side.',
  ...
  tool_batch_watermark_product_photos_rules_item_2: 'A short side under 64 px fails that row. Empty text disables Apply all. Decode failures skip.',
  tool_batch_watermark_product_photos_rules_item_3: 'Diagonal DRAFT tiles the word across the frame. Duplicate ZIP names become name (2).jpg or .png.',
  tool_batch_watermark_product_photos_rules_item_4: 'Files stay on your device and are not uploaded to a server.',
  ...
  tool_bulk_compress_png_images_faq_a3: 'Yes. Pixels are drawn without a solid backdrop, then saved as PNG, so holes should still be holes.',
  ...
  tool_bulk_compress_png_images_faq_a5: 'No. Only the first frame is saved as a still PNG.',
  ...
  tool_bulk_compress_png_images_rules_item_1: 'Output MIME is PNG. Alpha is not flattened. There is no quality slider because PNG here is lossless.',
  ...
  tool_bulk_compress_png_images_rules_item_4: 'Files stay on your device and are not uploaded to a server.',
  ...
  tool_bulk_compress_png_images_warn_same:
    'Some PNGs barely shrank. Shrink the longest edge, or use product-photo compress if JPEG is acceptable.',
  ...
  tool_bulk_compress_product_photos_drop_hint: 'Drop JPEG, PNG, or WebP listing photos (up to 20). Compression stays in this tab.',
  ...
  tool_bulk_compress_product_photos_how_item_3: 'Optionally cap the longest edge so huge phone photos shrink before quality does the rest.',
  ...
  tool_bulk_compress_product_photos_rules_item_3: 'A decode or encode failure skips that row and continues. Duplicate ZIP names become name (2).jpg.',
  tool_bulk_compress_product_photos_rules_item_4: 'Photos stay on your device and are not uploaded to a server. Re-encoding usually drops EXIF.',
  ...
  tool_bulk_compress_product_photos_usecase_1: 'Listing day: shrink a folder of SKU photos toward a 200 KB marketplace cap before upload.',
  tool_bulk_compress_product_photos_usecase_2: 'Email a buyer a pack of product shots without bouncing on attachment limits.',
  tool_bulk_compress_product_photos_usecase_3: 'Hand a designer compressed JPEGs of the same shoot so the ZIP is small enough to share.',
  ...
  tool_bulk_convert_images_to_jpg_drop_hint: 'Drop PNG, JPEG, WebP, GIF, or HEIC (up to 20). Conversion stays in this tab.',
  ...
  tool_bulk_convert_images_to_jpg_faq_a4: 'No. JPEG and JPG are the same output. Files are named .jpg.',
  ...
  tool_bulk_convert_images_to_jpg_how_item_3:
    'Optionally lower quality if the email attachment must stay small — conversion is still the job, not a 200 KB hunt.',
  ...
  tool_bulk_convert_images_to_jpg_rules_body: 'JPG has no alpha. Every file is drawn on the same matte, then saved as .jpg.',
  tool_bulk_convert_images_to_jpg_rules_item_1: 'Output names always end in .jpg. A search for jpeg lands on this page, not a second tool.',
  ...
  tool_bulk_convert_images_to_jpg_rules_item_4: 'Files stay on your device and are not uploaded to a server.',
  ...
  tool_bulk_convert_images_to_png_faq_a5: 'No. Only the first frame is saved as a still PNG, and that row is noted.',
  ...
  tool_bulk_convert_images_to_png_rules_body: 'Output is always PNG. This page does not flatten transparency onto a JPEG matte.',
  tool_bulk_convert_images_to_png_rules_item_1: 'Alpha is kept when the source has it. A JPEG source has no alpha to keep.',
  tool_bulk_convert_images_to_png_rules_item_2: 'Optional longest-edge shrink is off by default so conversion does not secretly resize.',
  ...
  tool_bulk_convert_images_to_png_rules_item_4: 'Files stay on your device and are not uploaded to a server.',
  ...
  tool_bulk_convert_images_to_webp_err_unsupported: 'This browser did not return a WebP blob. That row is skipped instead of writing JPEG.',
  ...
  tool_bulk_convert_images_to_webp_faq_a4: 'That row is skipped. This page does not secretly write JPEG. Try a current Chrome, Edge, or Firefox.',
  tool_bulk_convert_images_to_webp_faq_a5: 'No. Only the first frame is saved as a still WebP, and that row is noted.',
  ...
  tool_bulk_convert_images_to_webp_how_item_4:
    'Need JPG for email? Use Bulk convert images to JPG. Need lossless PNG? Use Bulk convert images to PNG.',
  ...
  tool_bulk_convert_images_to_webp_rules_item_1: 'Alpha is kept when the source has it. A JPEG source has no alpha to keep.',
  tool_bulk_convert_images_to_webp_rules_item_2: 'Quality defaults to 0.8. Lower it only if the site budget needs a smaller file.',
  ...
  tool_bulk_convert_images_to_webp_rules_item_4: 'Files stay on your device and are not uploaded to a server.',
  ...
  tool_check_robots_txt_url_blocked_fetch_failed: 'Could not fetch robots.txt. The host may be offline, block bots, or reject the request.',
  ...
  tool_check_robots_txt_url_blocked_formula_item_1: 'Pick the group whose User-agent matches the selected crawler; if none, fall back to the * group.',
  tool_check_robots_txt_url_blocked_formula_item_2: 'Among Allow/Disallow lines that match the path, the longest prefix wins.',
  tool_check_robots_txt_url_blocked_formula_item_3: 'At equal length, Allow beats Disallow (Google’s documented preference).',
  tool_check_robots_txt_url_blocked_formula_item_4: 'Missing robots.txt or empty groups are treated as allow-all; the HTTP status is still shown.',
  ...
  tool_check_robots_txt_url_blocked_home_desc: 'Paste a page URL and see if robots.txt blocks it for Googlebot or other crawlers.',
  ...
  tool_check_robots_txt_url_blocked_how_item_1: 'Paste the full page URL you care about (the path matters, not only the domain).',
  tool_check_robots_txt_url_blocked_how_item_2: 'Pick a user-agent (default Googlebot; also * , Bingbot, or GPTBot).',
  tool_check_robots_txt_url_blocked_how_item_3: 'Click Check and wait for the Worker to fetch origin /robots.txt.',
  tool_check_robots_txt_url_blocked_how_item_4: 'Read Allowed or Blocked, the matched rule line, and the fetch HTTP status.',
  tool_check_robots_txt_url_blocked_how_item_5: 'Skim the robots.txt preview if you need to confirm which group applied.',
  ...
  tool_check_ssl_certificate_expiration_faq_a5: 'Private or blocked hosts are rejected. Use the private CIDR ranges tool for private-space context.',
  ...
  tool_check_ssl_certificate_expiration_fetch_failed: 'Could not query crt.sh. The service may be rate-limiting or unreachable.',
  ...
  tool_check_ssl_certificate_expiration_formula_item_1: 'Query crt.sh with the hostname and parse the JSON certificate list.',
  tool_check_ssl_certificate_expiration_formula_item_2: 'Sort by notBefore descending and take the newest row as the primary match.',
  tool_check_ssl_certificate_expiration_formula_item_3: 'Show notBefore, notAfter, issuer, daysLeft, and expired derived from notAfter vs now.',
  tool_check_ssl_certificate_expiration_formula_item_4: 'CT logs can lag behind live issuance or renewal — never treat this as a handshake verdict.',
  tool_check_ssl_certificate_expiration_formula_item_5: 'Private or blocked hosts are rejected. This is not a full chain walker or CA order tool.',
  tool_check_ssl_certificate_expiration_formula_title: 'CT query rules (not live TLS)',
  tool_check_ssl_certificate_expiration_home_desc: 'See when a hostname’s newest Certificate Transparency cert expires (crt.sh — not a live handshake).',
  ...
  tool_check_ssl_certificate_expiration_how_item_2: 'Click Check; the Worker queries crt.sh JSON for matching certificates.',
  tool_check_ssl_certificate_expiration_how_item_3: 'Read notBefore, notAfter, issuer, and days left for the newest match.',
  tool_check_ssl_certificate_expiration_how_item_4: 'Treat dates as CT-published — confirm with a live handshake if timing-critical.',
  tool_check_ssl_certificate_expiration_how_title: 'How it works',
  tool_check_ssl_certificate_expiration_privacy_note: 'The hostname is sent to our Worker so it can query crt.sh. We do not keep it as a product database.',
  ...
  tool_check_ssl_certificate_expiration_references: 'crt.sh Certificate Search; Certificate Transparency project.',
  ...
  tool_check_ssl_certificate_expiration_result_disclaimer: 'CT log lag — not a live TLS handshake peer certificate. Dates can lag behind issuance or renewal.',
  ...
  tool_check_ssl_certificate_expiration_usecase_1: 'SSL certificate expiry checker before renewals: see how many days remain on the newest CT leaf.',
  tool_check_ssl_certificate_expiration_usecase_2: 'SSL expiry date checker after a CDN cutover: confirm CT shows a new notAfter for the hostname.',
  ...
  tool_find_and_validate_xml_sitemap_fetch_failed: 'Could not fetch sitemap candidates. The host may be offline, block bots, or reject the request.',
  ...
  tool_find_and_validate_xml_sitemap_formula_item_2: 'A candidate is “valid structure” when the response looks like sitemap XML and HTTP status is OK.',
  tool_find_and_validate_xml_sitemap_formula_item_3: 'Root kind: sitemapindex lists child sitemaps; urlset lists page locs — both are reported.',
  tool_find_and_validate_xml_sitemap_formula_item_4: 'We count <loc> tags and show up to 10 samples; we do not crawl every listed URL.',
  ...
  tool_find_and_validate_xml_sitemap_how_item_3: 'Review root type (urlset vs sitemapindex), URL count, and sample <loc> values in the findings table.',
  tool_find_and_validate_xml_sitemap_how_item_4: 'Fix XML or discovery issues flagged here before submitting IndexNow or Search Console.',
  ...
  tool_find_and_validate_xml_sitemap_references: 'sitemaps.org protocol; Google Search Central — sitemaps overview.',
  ...
  tool_find_and_validate_xml_sitemap_usecase_1: 'Sitemap finder: confirm where a site publishes its sitemap after a CMS migrate or CDN cutover.',
  ...
  tool_sketch_prompt_generator_faq_a5:
    'Yes. Complete the Turnstile widget in the optional AI panel before Expand or Polish. Without a valid token, AI buttons show an error and local mode still works.',
  tool_sketch_prompt_generator_faq_a6: 'Yes. The JSON chip emits structured fields plus assembled prompt text for tests or config pipelines.',
  ...
  tool_sketch_prompt_generator_usecase_2: 'Draft export and handoff checklists (PNG slices, PDF review) before design QA.',
  ...
  tool_spf_dkim_dmarc_checker_fetch_failed: 'DNS lookup failed. The resolver may be unreachable, or the name may be blocked.',
  ...
  tool_spf_dkim_dmarc_checker_formula_item_3: 'DKIM: TXT on {selector}._domainkey.domain; we check whether a non-empty public key (p=) is present.',
  ...
  tool_spf_dkim_dmarc_checker_formula_item_5: 'No SMTP RCPT probing and no zone edits. An “email address exists” checker is out of scope.',
  ...
  tool_spf_dkim_dmarc_checker_how_item_1: 'Enter the sending domain and optional DKIM selector (default google).',
  tool_spf_dkim_dmarc_checker_how_item_2: 'Click Check; the Worker queries DNS TXT via DoH for SPF, _dmarc, and selector._domainkey.',
  tool_spf_dkim_dmarc_checker_how_item_3: 'Read each record plus plain-language SPF mechanisms (~all / -all) and DMARC p= policy.',
  tool_spf_dkim_dmarc_checker_how_item_4: 'Fix DNS at your provider, then re-check — this page does not rewrite your zone.',
  ...
  tool_validate_security_txt_faq_a4: 'No. We only fetch and parse the published file via the Worker. We are not a disclosure mailbox.',
  ...
  tool_validate_security_txt_fetch_failed: 'Could not fetch security.txt. The host may be offline, block bots, or reject the request.',
  ...
  tool_validate_security_txt_formula_item_1: 'Discovery order: https://host/.well-known/security.txt first, then https://host/security.txt.',
  tool_validate_security_txt_formula_item_2: 'Contact is required; we list every Contact value and flag when it is missing.',
  tool_validate_security_txt_formula_item_3: 'Expires is strongly expected; missing or past Expires is reported as a gap.',
  ...
  tool_validate_security_txt_formula_item_5: 'This is a fetch-and-parse checker only — not a vulnerability mailbox and not a full pentest.',
  tool_validate_security_txt_formula_title: 'RFC 9116 field rules we check',
  tool_validate_security_txt_home_desc: 'Check whether a site publishes a valid security.txt with Contact and Expires fields.',
  ...
  tool_validate_security_txt_how_item_2: 'Click Validate; the Worker fetches /.well-known/security.txt, then falls back to /security.txt.',
  tool_validate_security_txt_how_item_3: 'Review parsed fields: Contact, Expires, Preferred-Languages, Canonical, and extras in the preview.',
  tool_validate_security_txt_how_item_4: 'Fix missing required fields before publishing your own security.txt.',
