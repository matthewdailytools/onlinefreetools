...
const en: SiteLangDict = {
  ...
  tool_image_overlay_faq_a5: 'This page layers image files only. For typed text, prepare a PNG in another app or use a dedicated text-watermark tool if we add one later.',
