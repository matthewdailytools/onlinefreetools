...
const es: SiteLangDict = {
  ...
  pdf_work_preview: 'Vista previa del PDF',
  pdf_work_progress: 'Progreso',
  ...
  tool_add_digital_signature_to_pdf_article:
    'Sella un recuadro visible con prefijo SHA-256. Los archivos no salen del dispositivo; no se suben al servidor.',
  ...
  tool_add_digital_signature_to_pdf_desc:
    'Añade una apariencia de firma digital a un PDF — SHA-256 y un recuadro visible. Los archivos no salen del dispositivo; no se suben al servidor.',
  tool_add_digital_signature_to_pdf_description:
    'Añade una apariencia de firma digital a un PDF en el navegador: calcula el SHA-256, sella un recuadro “Marcado digitalmente” con marca de tiempo y prefijo hash, y descarga. Los archivos permanecen en tu dispositivo; no se suben al servidor. El proceso y un ejemplo se ejecutan con la muestra. Es apariencia de integridad, no firma PKI con certificado.',
  tool_add_digital_signature_to_pdf_disclaimer:
    'Solo apariencia de integridad — no es una firma digital con certificado (sin PKCS#7 / PAdES) ni asesoramiento jurídico. Tras sellar, el hash del archivo cambia.',
  ...
  tool_add_digital_signature_to_pdf_example:
    'Cargar ejemplo crea un “registro de muestra”, lo hashea y sella “Marcado digitalmente” con 16 hex cerca de X=48, Y=48.',
  tool_add_digital_signature_to_pdf_example_title: 'Ejemplo',
  tool_add_digital_signature_to_pdf_faq_a1:
    'No. La página hashea el PDF y dibuja un recuadro. No incrusta PKCS#7 / PAdES. Para un sello de nombre a mano, usa Firmar un documento PDF.',
  tool_add_digital_signature_to_pdf_faq_a2:
    'No. El hash y el sello ocurren en tu pestaña (las bibliotecas pueden venir de un CDN). El PDF no se envía a nuestros servidores.',
  tool_add_digital_signature_to_pdf_faq_a3:
    'El SHA-256 mostrado es del origen antes del recuadro. Guardar añade bytes; un hash posterior del descargado será distinto.',
  ...
  tool_add_digital_signature_to_pdf_how_body:
    'Elige el PDF, fija página y X/Y, márcalo y descarga. Los archivos permanecen en tu dispositivo; no se suben al servidor.',
  ...
  tool_add_digital_signature_to_pdf_rules_body:
    'El hash es de los bytes de origen antes del sello. El recuadro es tinta visible, no un diccionario de firma.',
  ...
  tool_add_text_to_pdf_file_description:
    'Añadir texto a un PDF. Los archivos permanecen en tu dispositivo; no se suben al servidor. El ejemplo al entrar muestra un resultado real.',
  ...
  tool_batch_checksum_release_files_drop_hint:
    'Suelta archivos de release (hasta 20). El hash queda en esta pestaña. Esta página no empaqueta los originales en ZIP.',
  ...
  tool_batch_checksum_release_files_faq_a4: 'Activa También MD5. SHA-256 siempre corre. MD5 es extra para listas viejas; no hay una segunda URL.',
  ...
  tool_batch_checksum_release_files_rules_item_4: 'Los archivos no salen del dispositivo y no se suben al servidor.',
  ...
  tool_batch_compress_pdfs_for_email_faq_a5: 'Esa fila se omite y el resto sigue. Desbloquéalo en otra parte y vuelve a añadirlo.',
  ...
  tool_batch_compress_pdfs_for_email_rules_body: 'Cada PDF se rasteriza a páginas JPEG y se rearma. La salida es siempre un ZIP de PDF sueltos.',
  ...
  tool_batch_compress_pdfs_for_email_rules_item_3: 'Un archivo solo de texto puede apenas encogerse. Es esperable; la tabla igual informa los tamaños.',
  tool_batch_compress_pdfs_for_email_rules_item_4: 'Los archivos no salen del dispositivo y no se suben al servidor.',
  ...
  tool_batch_watermark_product_photos_how_item_5:
    'Descarga el ZIP cuando haya al menos un acierto. ¿Un ajuste de una sola foto? Usa Añadir marca de agua.',
  ...
  tool_batch_watermark_product_photos_rules_item_3: 'DRAFT en diagonal tesela la palabra. Nombres repetidos en el ZIP pasan a nombre (2).jpg o .png.',
  tool_batch_watermark_product_photos_rules_item_4: 'Los archivos no salen del dispositivo y no se suben al servidor.',
  ...
  tool_bulk_compress_png_images_faq_a5: 'No. Solo se guarda el primer fotograma como PNG estático.',
  ...
  tool_bulk_compress_png_images_how_item_2:
    'Usa el chip de 1024 px si los iconos deben encogerse; Solo recodificar si el tamaño en píxeles no puede cambiar.',
  ...
  tool_bulk_compress_png_images_how_item_4:
    'Si un PNG tipo foto casi no baja, la tabla avisa: JPEG en la página de fotos de producto suele pesar menos.',
  ...
  tool_bulk_compress_png_images_rules_item_4: 'Los archivos no salen del dispositivo y van sin subir al servidor.',
  ...
  tool_bulk_compress_png_images_warn_same:
    'Algunos PNG apenas bajaron. Recorta el lado más largo, o usa la compresión de fotos de producto si el JPEG te vale.',
  ...
  tool_bulk_compress_product_photos_faq_a3: 'No hace falta otra página. JPEG y JPG son la misma salida; el nombre usa .jpg.',
  ...
  tool_bulk_compress_product_photos_faq_a5: 'No. Solo se comprime el primer fotograma y se avisa en la alerta.',
  ...
  tool_bulk_convert_images_to_jpg_drop_hint: 'Suelta PNG, JPEG, WebP, GIF o HEIC (hasta 20). La conversión queda en esta pestaña.',
  ...
  tool_bulk_convert_images_to_jpg_faq_a4: 'No. JPEG y JPG son la misma salida. Los archivos se llaman .jpg.',
  ...
  tool_bulk_convert_images_to_jpg_how_item_3:
    'Baja un poco la calidad si el correo debe pesar poco; la tarea sigue siendo pasar a JPG, no cazar 200 KB.',
  ...
  tool_bulk_convert_images_to_jpg_rules_body: 'JPG no tiene canal alfa. Cada archivo se pinta sobre el mismo fondo y se guarda como .jpg.',
  tool_bulk_convert_images_to_jpg_rules_item_1: 'Los nombres de salida terminan siempre en .jpg.',
  ...
  tool_bulk_convert_images_to_jpg_rules_item_4: 'Los archivos no salen del dispositivo y no se suben al servidor.',
  ...
  tool_bulk_convert_images_to_png_faq_a5: 'No. Solo el primer fotograma se guarda como PNG estático, y esa fila se anota.',
  ...
  tool_bulk_convert_images_to_png_how_item_4:
    '¿Quieres JPG? Usa Convertir imágenes a JPG en lote. ¿PNG más pequeño? Usa Comprimir imágenes PNG en lote.',
  ...
  tool_bulk_convert_images_to_png_rules_body: 'La salida es siempre PNG. Esta página no aplana la transparencia sobre un fondo JPEG.',
  tool_bulk_convert_images_to_png_rules_item_1: 'Se conserva el alfa si el origen lo tiene. Un JPEG no tiene alfa que guardar.',
  tool_bulk_convert_images_to_png_rules_item_2: 'El recorte opcional del lado largo está apagado por defecto para no redimensionar a escondidas.',
  ...
  tool_bulk_convert_images_to_png_rules_item_4: 'Los archivos no salen del dispositivo y no se suben al servidor.',
  ...
  tool_bulk_convert_images_to_webp_err_unsupported: 'Este navegador no devolvió un blob WebP. Esa fila se omite; no se escribe JPEG.',
  ...
  tool_bulk_convert_images_to_webp_faq_a3: 'Algunos correos y CMS aún rechazan WebP. Para esos adjuntos usa Convertir imágenes a JPG en lote.',
  tool_bulk_convert_images_to_webp_faq_a4: 'Esa fila se omite. Esta página no escribe JPEG a escondidas. Prueba Chrome, Edge o Firefox actuales.',
  tool_bulk_convert_images_to_webp_faq_a5: 'No. Solo el primer fotograma se guarda como WebP estático, y esa fila se anota.',
  ...
  tool_bulk_convert_images_to_webp_how_item_4:
    '¿JPG para el correo? Usa Convertir imágenes a JPG en lote. ¿PNG sin pérdida? Usa Convertir imágenes a PNG en lote.',
  ...
  tool_bulk_convert_images_to_webp_rules_body: 'La salida es siempre WebP. Esta página no aplana la transparencia sobre un fondo JPEG ni cae a JPEG.',
  tool_bulk_convert_images_to_webp_rules_item_1: 'Se conserva el alfa si el origen lo tiene. Un JPEG no tiene alfa que guardar.',
  tool_bulk_convert_images_to_webp_rules_item_2: 'La calidad por defecto es 0.8. Bájala solo si el presupuesto del sitio pide un archivo más pequeño.',
  ...
  tool_bulk_convert_images_to_webp_rules_item_4: 'Los archivos no salen del dispositivo y no se suben al servidor.',
  ...
  tool_check_pdf_a_compliance_description:
    'Comprobar cumplimiento PDF/A. Los archivos permanecen en tu dispositivo; no se suben al servidor. El ejemplo al entrar muestra un resultado real.',
  ...
  tool_check_robots_txt_url_blocked_faq_a1: 'No. Solo comprueba si una URL está bloqueada. Para escribir reglas usa el generador de robots.txt.',
  ...
  tool_check_robots_txt_url_blocked_fetch_failed: 'No se pudo obtener robots.txt. El host puede estar caído, bloquear bots o rechazar la petición.',
  ...
  tool_check_robots_txt_url_blocked_formula_item_1: 'Se elige el grupo cuyo User-agent coincide; si no hay, se usa el grupo *.',
  tool_check_robots_txt_url_blocked_formula_item_2: 'Entre Allow/Disallow que encajan con la ruta, gana el prefijo más largo.',
  tool_check_robots_txt_url_blocked_formula_item_3: 'A igual longitud, Allow tiene prioridad sobre Disallow.',
  tool_check_robots_txt_url_blocked_formula_item_4: 'Sin robots.txt o sin reglas se interpreta como permitir todo; igual se muestra el estado HTTP.',
  ...
  tool_check_robots_txt_url_blocked_home_desc: 'Pega la URL de una página y comprueba si robots.txt la bloquea para Googlebot u otros bots.',
  ...
  tool_check_robots_txt_url_blocked_usecase_2: 'Probador / validador robots.txt: tras un Disallow, verifica que la URL objetivo realmente encaja.',
  tool_check_robots_txt_url_blocked_usecase_3: 'Reglas de crawlers IA: elige GPTBot (o *) y comprueba rutas sensibles sin generar el archivo.',
  ...
  tool_check_ssl_certificate_expiration_faq_a1: 'No. Workers no leen el certificado del peer en fetch; consultamos Certificate Transparency (crt.sh).',
  ...
  tool_check_ssl_certificate_expiration_faq_a3: 'El foco es la caducidad del match más reciente. Un checker solo de cadena es secundario, no el H1.',
  tool_check_ssl_certificate_expiration_faq_a4: 'No. El H1 es Comprobar la caducidad del certificado SSL. El head más amplio no es el título único.',
  tool_check_ssl_certificate_expiration_faq_a5: 'Se rechazan hosts privados o bloqueados. Use la herramienta de rangos CIDR privados para contexto.',
  ...
  tool_check_ssl_certificate_expiration_fetch_failed: 'No se pudo consultar crt.sh. Puede haber límite de tasa o estar inaccesible.',
  ...
  tool_check_ssl_certificate_expiration_formula_item_1: 'Consultar crt.sh con el hostname y parsear la lista JSON.',
  tool_check_ssl_certificate_expiration_formula_item_2: 'Ordenar por notBefore descendente y tomar la fila más nueva.',
  tool_check_ssl_certificate_expiration_formula_item_3: 'Mostrar notBefore, notAfter, emisor, daysLeft y expired frente a ahora.',
  tool_check_ssl_certificate_expiration_formula_item_4: 'Los logs CT pueden retrasarse respecto a la emisión o renovación en vivo.',
  tool_check_ssl_certificate_expiration_formula_item_5: 'Hosts privados o bloqueados se rechazan. No es un walker de cadena completa ni un pedido a la CA.',
  ...
  tool_check_ssl_certificate_expiration_how_item_2: 'Pulse Comprobar; el Worker consulta el JSON de crt.sh.',
  tool_check_ssl_certificate_expiration_how_item_3: 'Lea notBefore, notAfter, emisor y días restantes del match más reciente.',
  tool_check_ssl_certificate_expiration_how_item_4: 'Trate las fechas como publicadas en CT — confirme con handshake local si el timing importa.',
  ...
  tool_check_ssl_certificate_expiration_usecase_1: 'Checker de caducidad SSL antes de renovar: cuántos días quedan en la hoja CT más nueva.',
  tool_check_ssl_certificate_expiration_usecase_2: 'Tras un cambio de CDN: confirmar que CT muestra un notAfter nuevo.',
  tool_check_ssl_certificate_expiration_usecase_3: 'Inventario rápido de dominios de proveedores cuando solo necesita fechas de caducidad.',
  ...
  tool_combine_files_into_one_pdf_description:
    'Combinar archivos en un PDF. Los archivos permanecen en tu dispositivo; no se suben al servidor. El ejemplo al entrar muestra un resultado real.',
  ...
  tool_compare_two_pdfs_description:
    'Comparar dos PDF. Los archivos permanecen en tu dispositivo; no se suben al servidor. El ejemplo al entrar muestra un resultado real.',
  ...
  tool_convert_html_to_pdf_description:
    'Convertir HTML a PDF. Los archivos permanecen en tu dispositivo; no se suben al servidor. El ejemplo al entrar muestra un resultado real.',
  ...
  tool_convert_pdf_to_dwg_article:
    'Convierte un PDF hacia DWG exportando DXF ASCII: entidades TEXT y un borde de página que AutoCAD puede abrir. El navegador no puede escribir DWG propietario. Los archivos no salen del dispositivo; no se suben al servidor.',
  ...
  tool_convert_pdf_to_dwg_desc:
    'Convertir un PDF hacia DWG — exporta DXF ASCII con texto y un borde de página. Los archivos no salen del dispositivo; no se suben al servidor.',
  tool_convert_pdf_to_dwg_description:
    'Convierte un PDF hacia DWG en el navegador exportando DXF ASCII: entidades TEXT y un borde de página que AutoCAD abre. El navegador no puede escribir DWG propietario. Los archivos no salen del dispositivo; no se suben al servidor. Aquí hay proceso, pasos y un ejemplo.',
  ...
  tool_convert_pdf_to_dwg_example:
    'Cargar ejemplo crea un PDF con "Hello PDF to DWG sample.", lo convierte a DXF ASCII y activa Descargar .dxf.',
  tool_convert_pdf_to_dwg_example_title: 'Ejemplo',
  tool_convert_pdf_to_dwg_faq_a1:
    'No. Un navegador no puede escribir el binario propietario DWG. La descarga es DXF ASCII, el intercambio CAD que AutoCAD abre.',
  ...
  tool_convert_pdf_to_dwg_how_body:
    'Elige un PDF con capa de texto, pulsa Convertir y descarga el DXF. Los archivos no salen del dispositivo; no se suben al servidor.',
  ...
  tool_convert_pdf_to_pdf_a_article:
    'Convierte un PDF hacia PDF/A en el navegador: escribe título y creador e incrusta una fuente estándar. No es un archivo certificado por veraPDF. Los archivos no salen del dispositivo; no se suben al servidor.',
  ...
  tool_convert_pdf_to_pdf_a_desc:
    'Convertir un PDF hacia PDF/A — escribe metadatos de título y creador e incrusta una fuente estándar. Los archivos no salen del dispositivo; no se suben al servidor.',
  tool_convert_pdf_to_pdf_a_description:
    'Convierte un PDF hacia PDF/A en el navegador: escribe título y creador e incrusta una fuente estándar. No es un PDF/A certificado por veraPDF. Los archivos no salen del dispositivo; no se suben al servidor. En esta página hay proceso, pasos y un ejemplo.',
  ...
  tool_convert_pdf_to_pdf_a_example:
    'Cargar ejemplo crea un PDF con "Hello PDF/A sample.", ejecuta Convertir y ofrece una copia orientada a archivo.',
  tool_convert_pdf_to_pdf_a_example_title: 'Ejemplo',
  tool_convert_pdf_to_pdf_a_faq_a1:
    'Usa Comprobar cumplimiento PDF/A en este sitio para revisar reglas de archivo. Esta página solo prepara un archivo de mejor esfuerzo.',
  ...
  tool_convert_pdf_to_pdf_a_faq_a3:
    'No. Es una reescritura de mejor esfuerzo: metadatos de título y creador más una fuente estándar incrustada. No es un PDF/A certificado por veraPDF.',
  ...
  tool_convert_pdf_to_pdf_a_how_body:
    'Elige un PDF, pulsa Convertir y descarga el archivo reescrito. Los archivos no salen del dispositivo; no se suben al servidor.',
  ...
  tool_convert_word_document_to_pdf_article:
    'Convierte un .docx a PDF en esta pestaña. Los archivos no salen del dispositivo; no se suben al servidor.',
  ...
  tool_convert_word_document_to_pdf_desc:
    'Convierte un documento Word a PDF en el navegador: sube .docx, revisa el HTML y exporta. Los archivos no salen del dispositivo; no se suben al servidor.',
  tool_convert_word_document_to_pdf_description:
    'Convierte un documento Word a PDF en el navegador: elige un .docx, revisa la vista HTML y sigue los pasos para exportar un PDF imprimible. Los archivos permanecen en tu dispositivo; no se suben al servidor. El proceso y un ejemplo se ejecutan al cargar la muestra.',
  ...
  tool_convert_word_document_to_pdf_faq_a1:
    'No. La conversión ocurre en tu pestaña (las bibliotecas pueden venir de un CDN). El archivo no se envía a nuestros servidores.',
  tool_convert_word_document_to_pdf_faq_a2:
    'El flujo es .docx → HTML → PDF. Encabezados y objetos flotantes se aplanan. Si ya tienes HTML, usa Convertir HTML a PDF.',
  ...
  tool_convert_word_document_to_pdf_how_body:
    'Elige el .docx, confirma la vista HTML y convierte. Los archivos permanecen en tu dispositivo; no se suben al servidor.',
  ...
  tool_create_pdf_form_article:
    'Parte de una página en blanco, nombra texto o casillas y descarga un formulario real. Superponer campos a un archivo existente está en Hacer un PDF rellenable.',
  tool_create_pdf_form_choose_file: 'Elegir un PDF',
  tool_create_pdf_form_clear: 'Borrar',
  tool_create_pdf_form_desc:
    'Crea un formulario PDF desde una página en blanco. Los archivos permanecen en tu dispositivo; no se suben al servidor.',
  tool_create_pdf_form_description:
    'Crea un formulario PDF desde una página en blanco: añade campos de texto o casillas con nombre en X/Y y un tamaño, luego descarga. Nada se sube al servidor; el archivo se construye en esta pestaña. El ejemplo de entrada es Name más Email: un proceso con pasos y un ejemplo que puedes ampliar antes de exportar.',
  ...
  tool_create_pdf_form_example:
    'Cargar ejemplo crea una página en blanco con Name y Email, lista ambos nombres, muestra la vista previa y activa pdf-form.pdf.',
  tool_create_pdf_form_example_title: 'Ejemplo',
  tool_create_pdf_form_faq_a1:
    'No. La página y los campos se construyen en esta pestaña. Pueden cargarse scripts de un CDN; tu formulario no va a nuestros servidores.',
  tool_create_pdf_form_faq_a2:
    'Usa Hacer un PDF rellenable para poner campos sobre un archivo que ya tienes. Esta página empieza vacía.',
  ...
  tool_create_pdf_form_how_body:
    'Nombra un campo, elige texto o casilla, colócalo, añade más y descarga. El ejemplo empieza con Name y Email.',
  ...
  tool_edit_pdf_form_fields_article:
    'Lista nombres AcroForm, renómbralos o quita cajas que sobran y descarga. Escribir respuestas está en Rellenar un formulario PDF.',
  ...
  tool_edit_pdf_form_fields_desc:
    'Cambia el nombre o elimina campos de un formulario PDF. Los archivos permanecen en tu dispositivo; no se suben al servidor.',
  tool_edit_pdf_form_fields_description:
    'Edita los campos de un formulario PDF en esta pestaña: la página lista los nombres, renombras una caja o la marcas para borrar y descargas. Los archivos permanecen en tu dispositivo; no se suben al servidor. El ejemplo de entrada es un formulario Name + Email para ver la lista al instante: un proceso con pasos y un ejemplo antes de tocar un archivo real.',
  ...
  tool_edit_pdf_form_fields_example:
    'Cargar ejemplo crea un PDF con Name y Email, lista ambas filas, muestra la vista previa y permite renombrar o borrar antes de descargar.',
  tool_edit_pdf_form_fields_example_title: 'Ejemplo',
  tool_edit_pdf_form_fields_faq_a1:
    'No. El listado y las ediciones ocurren en esta pestaña. Pueden cargarse bibliotecas de un CDN; tu PDF no va a nuestros servidores.',
  tool_edit_pdf_form_fields_faq_a2:
    'Renombrar escribe un nombre interno nuevo. Eliminar quita el control. Los valores ya escritos pueden perderse al borrar.',
  ...
  tool_edit_pdf_form_fields_how_body:
    'Abre un PDF con formulario, revisa la lista, renombra o marca borrar, aplica y descarga. El ejemplo lista Name y Email al entrar.',
  ...
  tool_edit_pdf_text_online_article:
    'Edita el texto de un PDF en el navegador: extrae la capa de texto, cámbiala y reconstruye las páginas con un maquetado simple. Los archivos no salen del dispositivo; no se suben al servidor.',
  ...
  tool_edit_pdf_text_online_desc:
    'Editar texto de un PDF en línea — extrae la capa, cambia el redactado y aplica un rearmado simple. Los archivos no salen del dispositivo; no se suben al servidor.',
  tool_edit_pdf_text_online_description:
    'Edita texto de un PDF en línea en el navegador: extrae la capa de texto, cámbiala en el editor y aplica un rearmado simple. Los archivos no salen del dispositivo; no se suben al servidor. En esta página hay proceso, pasos y un ejemplo.',
  ...
  tool_edit_pdf_text_online_example:
    'Cargar ejemplo crea un PDF de una página con "Hello edit PDF text sample.", llena el editor y Aplicar genera un PDF descargable.',
  tool_edit_pdf_text_online_example_title: 'Ejemplo',
  tool_edit_pdf_text_online_faq_a1:
    'Añadir texto estampa una línea en X/Y. Extraer texto solo copia el redactado. Esta página cambia el texto existente y rearma las páginas.',
  tool_edit_pdf_text_online_faq_a2:
    'No. Las bibliotecas pueden llegar por CDN, pero tu PDF permanece en esta pestaña y no se sube a nuestros servidores.',
  tool_edit_pdf_text_online_faq_a3:
    'No. No es edición de glifos en su sitio. Se extrae el texto, lo editas y se redibuja con un maquetado simple. No se conservan fuentes ni columnas exactas.',
  tool_edit_pdf_text_online_faq_a4:
    'Los PDF escaneados son imágenes sin capa de texto. Este herramienta no hace OCR y falla con un error claro.',
  ...
  tool_edit_pdf_text_online_faq_q4: '¿Por qué fallan los PDF escaneados?',
  tool_edit_pdf_text_online_faq_q5: '¿Hay límite de tamaño?',
  tool_edit_pdf_text_online_how_body:
    'Elige un PDF con capa de texto, corrige el redactado y pulsa Aplicar. Los archivos no salen del dispositivo; no se suben al servidor.',
  ...
  tool_extract_text_from_pdf_description:
    'Extraer texto de un PDF. Los archivos permanecen en tu dispositivo; no se suben al servidor. El ejemplo al entrar muestra un resultado real.',
  ...
  tool_fill_out_pdf_form_example:
    'Cargar ejemplo crea un PDF con Name y Email, escribe Ada Lovelace / ada@example.com, muestra la vista previa y activa la descarga.',
  tool_fill_out_pdf_form_example_title: 'Ejemplo',
  tool_fill_out_pdf_form_faq_a1:
    'No. El relleno ocurre en esta pestaña. Las bibliotecas pueden venir de un CDN, pero tu PDF no va a nuestros servidores.',
  ...
  tool_fill_out_pdf_form_faq_a3:
    'Sí. Las casillas aparecen como ticks; listas y radios, como una elección corta si el PDF expone opciones.',
  tool_fill_out_pdf_form_faq_a4:
    'Crear un formulario PDF parte de una página en blanco. Aquí solo se escriben valores en campos que ya existen.',
  ...
  tool_fill_out_pdf_form_how_body:
    'Abre un PDF rellenable, escribe en los campos detectados y descarga. El ejemplo de entrada muestra Name y Email ya escritos.',
  ...
  tool_find_and_validate_xml_sitemap_faq_a2: 'Primero las líneas Sitemap: de robots.txt; luego /sitemap.xml e índices habituales en el mismo host.',
  ...
  tool_find_and_validate_xml_sitemap_formula_item_2: 'Estructura válida si la respuesta parece XML de sitemap y el HTTP es correcto.',
  tool_find_and_validate_xml_sitemap_formula_item_3: 'sitemapindex lista sitemaps hijos; urlset lista locs de páginas — ambos se muestran.',
  tool_find_and_validate_xml_sitemap_formula_item_4: 'Contamos <loc> y mostramos hasta 10 muestras; no rastreamos cada URL listada.',
  tool_find_and_validate_xml_sitemap_formula_item_5: 'Gzip, cuerpos enormes, redirecciones y no-XML pueden fallar. Se rechazan hosts privados.',
  tool_find_and_validate_xml_sitemap_formula_title: 'Reglas de descubrimiento y validación',
  tool_find_and_validate_xml_sitemap_home_desc: 'Descubre el sitemap desde robots.txt o /sitemap.xml y comprueba estructura, tipo y locs de muestra.',
  ...
  tool_find_and_validate_xml_sitemap_how_item_3: 'Revisa en la tabla el tipo raíz, el recuento de URLs y las <loc> de muestra.',
  tool_find_and_validate_xml_sitemap_how_item_4: 'Corrige los problemas de XML o descubrimiento antes de IndexNow o Search Console.',
  ...
  tool_find_and_validate_xml_sitemap_references: 'Protocolo sitemaps.org; Google Search Central — resumen de sitemaps.',
  ...
  tool_find_and_validate_xml_sitemap_usecase_1: 'Buscador de sitemap: tras migrar el CMS o el CDN, confirma dónde se publica el mapa.',
  ...
  tool_images_to_pdf_example_title: 'Convertir JPG en PDF',
  ...
  tool_make_pdf_fillable_article:
    'Úsalo cuando el PDF parece un formulario pero las cajas son solo tinta. Aquí se añaden campos reales. Escribir respuestas está en Rellenar un formulario PDF.',
  tool_make_pdf_fillable_choose_file: 'Elegir un PDF',
  tool_make_pdf_fillable_clear: 'Borrar',
  tool_make_pdf_fillable_desc:
    'Añade campos de texto a un PDF estático. Los archivos permanecen en tu dispositivo; no se suben al servidor.',
  tool_make_pdf_fillable_description:
    'Haz un PDF rellenable en esta pestaña: abre una página estática, coloca campos de texto en X/Y con ancho y alto, o deja N campos por defecto, y descarga. Los archivos permanecen en tu dispositivo; no se suben al servidor. El ejemplo de entrada es una página en blanco más un campo FullName: un proceso con pasos y un ejemplo para copiar en tu archivo.',
  ...
  tool_make_pdf_fillable_example:
    'Cargar ejemplo crea una página en blanco, añade FullName en 48,220 de 220×22, muestra la vista previa y activa la descarga.',
  tool_make_pdf_fillable_example_title: 'Ejemplo',
  tool_make_pdf_fillable_faq_a1:
    'No. La colocación ocurre en esta pestaña. Pueden cargarse scripts de un CDN; tu PDF no va a nuestros servidores.',
  ...
  tool_make_pdf_fillable_faq_a4:
    'Crear un formulario PDF parte vacío y nombra texto o casillas. Aquí se superponen campos a un archivo que ya tienes.',
  ...
  tool_make_pdf_fillable_how_body:
    'Abre un PDF estático, pon nombre y caja, añade un campo o N por defecto y descarga. El ejemplo coloca FullName en una página en blanco.',
  ...
  tool_make_pdf_flipbook_description:
    'Crear flipbook de PDF. Los archivos permanecen en tu dispositivo; no se suben al servidor. El ejemplo al entrar muestra un resultado real.',
  ...
  tool_open_pdf_in_browser_description:
    'Abrir un PDF en el navegador. Los archivos permanecen en tu dispositivo; no se suben al servidor. El ejemplo al entrar muestra un resultado real.',
  ...
  tool_print_pdf_description:
    'Imprimir un PDF. Los archivos permanecen en tu dispositivo; no se suben al servidor. El ejemplo al entrar muestra un resultado real.',
  ...
  tool_sign_pdf_document_description:
    'Firma un documento PDF en el navegador: dibuja o escribe un nombre, colócalo en X/Y de una página y descarga. Los archivos permanecen en tu dispositivo; no se suben al servidor. Es un sello visible, no un certificado. El proceso y un ejemplo se ejecutan al cargar la muestra.',
  tool_sign_pdf_document_disclaimer:
    'Solo es una apariencia visible, no una firma digital con certificado ni asesoramiento jurídico. No la uses como prueba de identidad.',
  ...
  tool_sign_pdf_document_faq_a2:
    'No. El sellado ocurre en tu pestaña (las bibliotecas pueden venir de un CDN). El PDF no se envía a nuestros servidores.',
  ...
  tool_sketch_prompt_generator_rules_item_4: 'Solo ensambla texto; no ejecuta Sketch.app, plugins, Midjourney ni APIs de chat en local.',
  ...
  tool_spf_dkim_dmarc_checker_faq_a2: 'google — habitual en Google Workspace. Cámbialo si tu ESP publica otro (por ejemplo s1 o k1).',
  ...
  tool_spf_dkim_dmarc_checker_faq_a4: 'No. Incluyen el registro y una línea de explicación de mecanismos SPF all y de la política DMARC p=.',
  ...
  tool_spf_dkim_dmarc_checker_fetch_failed: 'Falló la consulta DNS. El resolvedor puede estar inaccesible o el nombre bloqueado.',
  ...
  tool_spf_dkim_dmarc_checker_formula_item_1: 'SPF: TXT del dominio con v=spf1; mostramos el calificador all final (~all fallo suave, -all duro).',
  ...
  tool_spf_dkim_dmarc_checker_formula_item_3: 'DKIM: TXT en {selector}._domainkey.dominio; comprobamos si hay clave pública p= no vacía.',
  ...
  tool_spf_dkim_dmarc_checker_formula_item_5: 'Sin sondeo SMTP RCPT ni edición de zona. Un validador de «¿existe el email?» queda fuera de alcance.',
  ...
  tool_spf_dkim_dmarc_checker_how_item_1: 'Escribe el dominio de envío y el selector DKIM opcional (por defecto google).',
  tool_spf_dkim_dmarc_checker_how_item_2: 'Pulsa Comprobar; el Worker consulta TXT por DoH para SPF, _dmarc y selector._domainkey.',
  tool_spf_dkim_dmarc_checker_how_item_3: 'Lee cada registro y la explicación de ~all/-all y de la política DMARC p=.',
  tool_spf_dkim_dmarc_checker_how_item_4: 'Corrige el DNS en tu proveedor y vuelve a comprobar: esta página no reescribe tu zona.',
  ...
  tool_spf_dkim_dmarc_checker_usecase_3: 'Consulta SPF si el correo cae en spam: mira ~all o -all y alinea el selector DKIM con tu ESP.',
  ...
  tool_turn_pdf_into_editable_document_article:
    'Convierte un PDF en un documento editable: saca la capa de texto al editor y exporta un PDF rearmado. Sin OCR. Los archivos no salen del dispositivo; no se suben al servidor.',
  ...
  tool_turn_pdf_into_editable_document_desc:
    'Convertir un PDF en un documento editable — Hacer editable saca la capa de texto y luego exportas un PDF rearmado. Los archivos no salen del dispositivo; no se suben al servidor.',
  tool_turn_pdf_into_editable_document_description:
    'Convierte un PDF en un documento editable en el navegador: pulsa Hacer editable para sacar la capa de texto, cámbiala y exporta un PDF rearmado. Sin OCR. Los archivos no salen del dispositivo; no se suben al servidor. Aquí hay proceso, pasos y un ejemplo.',
  ...
  tool_turn_pdf_into_editable_document_example:
    'Cargar ejemplo crea un PDF con "Hello editable PDF document sample.", ejecuta Hacer editable y exporta un PDF rearmado descargable.',
  tool_turn_pdf_into_editable_document_example_title: 'Ejemplo',
  tool_turn_pdf_into_editable_document_export_pdf: 'Exportar PDF',
  tool_turn_pdf_into_editable_document_faq_a1:
    'Esta página desbloquea una copia editable desde la capa de texto. Editar texto de PDF en línea cambia el redactado con otra etiqueta principal.',
  ...
  tool_turn_pdf_into_editable_document_faq_a3:
    'Se exporta un PDF rearmado, no un Word. Copia el texto con Extraer texto o escribe uno nuevo con Escribir un documento PDF en línea.',
  ...
  tool_turn_pdf_into_editable_document_how_body:
    'Abre un PDF que ya tenga capa de texto, pulsa Hacer editable y exporta un PDF rearmado. Los archivos no salen del dispositivo; no se suben al servidor.',
  ...
  tool_turn_pdf_into_editable_document_word_note:
    '¿Necesitas Word? Copia el texto con Extraer texto de un PDF o escribe uno nuevo con Escribir un documento PDF en línea.',
  tool_turn_pdf_into_word_document_article:
    'Pasa un PDF a .docx desde su capa de texto. Los archivos no salen del dispositivo; no se suben al servidor.',
  ...
  tool_turn_pdf_into_word_document_desc:
    'Convierte un PDF en documento Word en el navegador — extrae texto seleccionable y descarga .docx. Los archivos no salen del dispositivo; no se suben al servidor.',
  tool_turn_pdf_into_word_document_description:
    'Convierte un PDF en documento Word en el navegador: extrae el texto seleccionable, revísalo y descarga un .docx. Los archivos permanecen en tu dispositivo; no se suben al servidor. Sin OCR. El proceso y un ejemplo se ejecutan al cargar la muestra.',
  ...
  tool_turn_pdf_into_word_document_example:
    'Cargar ejemplo crea un PDF de una página con una frase, la extrae y genera un .docx con el mismo párrafo.',
  tool_turn_pdf_into_word_document_example_title: 'Ejemplo',
  tool_turn_pdf_into_word_document_faq_a1:
    'No. La extracción y el zip .docx ocurren en tu pestaña (las bibliotecas pueden venir de un CDN). El PDF no se envía a nuestros servidores.',
  tool_turn_pdf_into_word_document_faq_a2:
    'Las páginas escaneadas son imágenes. No hay OCR. Usa Extraer texto de PDF si solo quieres un .txt de la capa de texto.',
  ...
  tool_turn_pdf_into_word_document_how_body:
    'Elige un PDF con capa de texto, convierte, revisa y descarga. Los archivos permanecen en tu dispositivo; no se suben al servidor.',
  ...
  tool_validate_security_txt_faq_a1: 'Preferible en /.well-known/security.txt. /security.txt en el mismo host es el respaldo documentado.',
  tool_validate_security_txt_faq_a2: 'Al menos Contact. Expires se espera en la práctica de RFC 9116; esta herramienta marca huecos.',
  tool_validate_security_txt_faq_a3: 'No. El H1 es Validar security.txt. El RFC va en Reglas y Referencias.',
  tool_validate_security_txt_faq_a4: 'No. Solo descargamos y parseamos el archivo publicado. No somos un buzón de divulgación.',
  ...
  tool_validate_security_txt_fetch_failed: 'No se pudo descargar security.txt. El host puede estar caído, bloquear bots o rechazar la petición.',
  tool_validate_security_txt_formula_body: 'Alineado con RFC 9116 y la práctica habitual de securitytxt.org.',
  tool_validate_security_txt_formula_item_1: 'Orden: primero /.well-known/security.txt, después /security.txt.',
  tool_validate_security_txt_formula_item_2: 'Contact es obligatorio; listamos todos los valores y avisamos si falta.',
  tool_validate_security_txt_formula_item_3: 'Expires se espera con fuerza; falta o fecha pasada = hueco.',
  tool_validate_security_txt_formula_item_4: 'Preferred-Languages y Canonical se muestran si existen; no son obligatorios para el checklist.',
  tool_validate_security_txt_formula_item_5: 'Solo descarga y analiza: no es un buzón de vulnerabilidades ni un pentest.',
  tool_validate_security_txt_formula_title: 'Reglas de campos RFC 9116',
  tool_validate_security_txt_home_desc: 'Comprueba si un sitio publica un security.txt válido con Contact y Expires.',
  ...
  tool_validate_security_txt_how_item_2: 'Pulsa Validar; el Worker prueba /.well-known/security.txt y luego /security.txt.',
  tool_validate_security_txt_how_item_3: 'Revisa Contact, Expires, Preferred-Languages, Canonical y la vista previa.',
  tool_validate_security_txt_how_item_4: 'Corrige los campos marcados antes de publicar tu propio security.txt.',
  ...
  tool_validate_security_txt_usecase_1: 'Comprobador de security.txt antes del lanzamiento: ¿well-known responde y hay Contact?',
  tool_validate_security_txt_usecase_2: 'Pase de validador tras editar Expires: confirma que la fecha se entiende y no está vencida.',
  tool_validate_security_txt_usecase_3: 'Antes de contactar a un proveedor: verifica que publique el archivo de descubrimiento.',
  ...
  tool_write_pdf_document_online_article:
    'Escribir un documento PDF en línea. Los archivos permanecen en tu dispositivo; no se suben al servidor.',
  ...
  tool_write_pdf_document_online_desc:
    'Escribir un documento PDF en línea — Los archivos permanecen en tu dispositivo; no se suben al servidor.',
  tool_write_pdf_document_online_description:
    'Escribir un documento PDF en línea. Los archivos permanecen en tu dispositivo; no se suben al servidor. El ejemplo al entrar muestra un resultado real.',
