...
const es: SiteLangDict = {
  ...
  tool_color_from_image_pick_hint: 'Haz clic en la imagen para promediar una región pequeña alrededor del punto (unos 7×7 píxeles de origen).',
  ...
  tool_color_from_image_usecase_2: 'Capturas de UI: repasa la paleta de interfaz y luego haz clic en un chip o icono para el color exacto de esa región.',
  tool_color_from_image_usecase_3: 'Ideas de degradado: toma dos acentos de la paleta o haciendo clic, luego abre la calculadora de gradientes.',
  tool_color_from_image_faq_q1: '¿Mi imagen sale del navegador?',
  tool_color_from_image_faq_a1: 'No. El cálculo de paleta y el muestreo por clic corren en local. Revisa la pestaña Red — la imagen no se envía por POST.',
  tool_color_from_image_faq_q2: '¿Cómo se eligen los colores principales?',
  tool_color_from_image_faq_a2: 'La página reduce la imagen, descarta píxeles de baja opacidad, divide el espacio de color con median-cut, promedia cada grupo y ordena por cuántas muestras cayó en cada uno.',
  tool_color_from_image_faq_q3: '¿Qué pasa cuando hago clic en la imagen?',
  tool_color_from_image_faq_a3: 'La herramienta mapea el clic a píxeles de origen y promedia colores opacos en un cuadrado pequeño (~7×7). Obtienes HEX/RGB/HSL de esa región, aparte de la lista de paleta.',
  tool_color_from_image_faq_q4: '¿Por qué un clic no es un solo píxel?',
  tool_color_from_image_faq_a4: 'Fotos y capturas de UI son ruidosas en 1×1. Un promedio de región pequeña es más estable para acentos CSS y sigue reflejando dónde hiciste clic.',
  tool_color_from_image_faq_q5: '¿Los GIF animados se analizan enteros?',
  tool_color_from_image_faq_a5: 'Solo se dibuja el primer fotograma, se usa para la paleta y está disponible para tomar color con clic.',
  ...
  tool_image_merge_article: 'Collage local de varias imágenes con diseño, espacio, fondo, ajuste en cuadrícula, formato y presets de tamaño.',
  ...
  tool_image_merge_rules_body: 'El tamaño del lienzo sigue las fórmulas siguientes. En cuadrícula las celdas comparten ancho y alto; contener deja bandas, cubrir recorta.',
  ...
  tool_image_merge_faq_a1: 'No. Decodificar, maquetar y exportar ocurre en tu navegador. Revisa la pestaña Red — no hay POST de imágenes.',
  tool_image_merge_faq_q2: '¿En qué se diferencia horizontal de vertical?',
  tool_image_merge_faq_a2: 'Horizontal unifica altura y crece en ancho; vertical unifica ancho y crece en alto. La cuadrícula usa celdas fijas con contener o cubrir.',
  tool_image_merge_faq_q3: '¿Los presets 1080 o 1200 garantizan aprobación en Instagram/Facebook?',
  tool_image_merge_faq_a3: 'No. Son tamaños de salida habituales. Las reglas de cada app cambian; consulta la plataforma donde publiques.',
  ...
  tool_image_merge_faq_a5: 'Bordes de lienzo por encima de ~8192 px o muchos megapíxeles pueden superar la memoria del navegador. Reduce imágenes, columnas de cuadrícula o recorta antes con la herramienta de crop.',
  ...
  tool_image_overlay_article: 'Composición local de dos capas: opacidad, ancla superior izquierda, escala, modos de mezcla y fondo JPEG al aplanar transparencia.',
  ...
  tool_image_overlay_rules_body: 'El lienzo de salida coincide con los píxeles naturales de la base. La capa se dibuja con ancla superior izquierda en (x, y) tras escalar.',
  tool_image_overlay_rules_item_1: 'Ancho × alto del lienzo = ancho × alto natural de la base; la base se dibuja en (0, 0).',
  tool_image_overlay_rules_item_2: 'Tamaño de la capa = ancho × alto natural × (escala% ÷ 100); posición en píxeles de la base con ancla superior izquierda.',
  tool_image_overlay_rules_item_3: 'globalAlpha = opacidad ÷ 100; globalCompositeOperation = mezcla elegida; ambos se restablecen tras dibujar la capa.',
  tool_image_overlay_rules_item_4: 'JPEG: primero se rellena el lienzo con el color de fondo, luego base y capa. PNG/WebP conservan alpha donde exista.',
  ...
  tool_image_overlay_faq_a2: 'Unir concatena varias fotos en horizontal, vertical o cuadrícula. Superponer mantiene una base y pinta una capa encima con opacidad, posición y mezcla.',
  tool_image_overlay_faq_q3: '¿Qué hacen los modos de mezcla?',
  tool_image_overlay_faq_a3: 'Siguen las reglas de Canvas: Normal apila; Multiplicar oscurece; Trama aclara; Superponer aumenta contraste; Oscurecer/Aclarar eligen min/max por canal.',
  tool_image_overlay_faq_q4: '¿Por qué un color de fondo JPEG?',
  tool_image_overlay_faq_a4: 'JPEG no tiene transparencia. Antes de exportar se rellena el lienzo para que las zonas transparentes no queden negras.',
