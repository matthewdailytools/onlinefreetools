...
const es: SiteLangDict = {
  ...
  tool_prompt_template_builder_faq_a2: 'No. Esta página solo formatea tu texto en bloques. No llama a ningún modelo ni inventa texto nuevo.',
  ...
  tool_prompt_template_builder_rules_body: 'Una plantilla reutilizable necesita bloques claros y límites honestos — no un segundo generador.',
  ...
  tool_prompt_template_builder_usecase_1: 'Publica un system prompt de revisión de código que el equipo pueda pegar en cualquier chat.',
  tool_prompt_template_builder_usecase_2: 'Convierte notas de reunión en bloques Role/Task/Constraints antes de conectar la API.',
  tool_prompt_template_builder_usecase_3: 'Exporta JSON y abre el validador JSON Schema para comprobar archivos de configuración.',
