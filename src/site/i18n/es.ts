...
const es: SiteLangDict = {
  ...
  tool_image_format_converter_title: 'Convertir imagen — PNG, JPEG, WebP, AVIF (local)',
  tool_image_format_converter_description:
    'Convierte imágenes entre PNG, JPEG, WebP y AVIF en el navegador. Pasos: elige el archivo, el formato de destino, ajusta la calidad (y un fondo si vas a JPEG) y descarga. Ejemplo: pasa una captura PNG con transparencia a WebP para la web — el archivo no se sube.',
  tool_image_format_converter_article:
    'Conversión local de formatos con reglas claras de calidad, transparencia y soporte de codificación del navegador.',
  ...
  tool_image_format_converter_drop_hint: 'O suelta aquí PNG, JPEG, WebP, AVIF, GIF o BMP. Todo ocurre en esta pestaña.',
  ...
  tool_image_format_converter_how_body:
    'Eliges imagen y formato. La página decodifica píxeles aquí, los dibuja en un canvas y llama al codificador del navegador. En JPEG puede rellenar un fondo sólido antes. Comprobamos el MIME de salida para no dar por bueno un fallback silencioso.',
  ...
  tool_image_format_converter_rules_item_1:
    'Proceso: decodificar → fondo opcional (JPEG) → dibujar → toBlob. PNG ignora la calidad. WebP a 1.0 puede ser sin pérdida.',
