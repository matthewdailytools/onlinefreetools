...
const fr: SiteLangDict = {
  ...
  tool_roi_initial_label: "Investissement initial",
  tool_roi_initial_placeholder: "Saisissez le montant de l'investissement initial",
  tool_roi_final_label: 'Valeur finale',
  tool_roi_final_placeholder: 'Saisissez la valeur finale ou le produit de vente',
  tool_roi_gain_label: 'Gain net (optionnel)',
  tool_roi_gain_placeholder: 'Saisissez le gain net si connu',
  tool_roi_calculate: 'Calculer le ROI',
  tool_roi_result_label: 'ROI',
  tool_roi_example: 'Exemple : Initial 1000$, Final 1250$ → ROI = ((1250 - 1000) / 1000) × 100 = 25%',
  tool_roi_interpret_positive: 'Gain positif',
  tool_roi_interpret_zero: 'Aucun gain ni perte',
  tool_roi_interpret_negative: 'Perte (rendement négatif)',
  ...
  tool_gradient_example:
    "Exemple : f(x,y)=x^2 y + 3y. ∂f/∂x = 2xy, ∂f/∂y = x^2 + 3. Donc ∇f = (2xy, x^2 + 3). En (1,2) : ∇f = (4,4).",

  tool_text_diff_title: 'Comparer deux textes en ligne — Voir les différences',
  ...
  tool_text_diff_example:
    'Exemple (mode mot) : A = "Hello world", B = "Hello there" → un changement (world → there). Si seule la ligne du milieu change dans un bloc de trois, le mode ligne la marque.',
  ...
  tool_text_diff_how_body:
    'Collez deux versions, choisissez la finesse (ligne, mot ou caractère), puis regardez les ajouts en vert et les suppressions en rouge. La comparaison se fait dans le navigateur ; nous ne stockons pas votre texte.',
  ...
  tool_text_diff_faq_a2: 'Non. Tout reste dans le navigateur. Fermer l’onglet efface le collage ; nous ne le conservons pas.',
