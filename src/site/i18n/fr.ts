...
const fr: SiteLangDict = {
  ...
  tool_image_format_converter_article: 
    'Conversion locale de formats avec regles claires et export BMP/GIF/ICO/SVG.',
  ...
  tool_image_optimizer_drop_hint: 'Ou déposez un JPEG, PNG ou WebP ici. Après chargement du moteur, l’optimisation reste dans cet onglet.',
  ...
  tool_image_optimizer_how_body: 'Choisissez une photo, chargez le moteur une fois, sélectionnez MozJPEG, WebP, AVIF ou OxiPNG, réglez qualité ou effort, limitez éventuellement le côté le plus long, puis glissez pour comparer. Tout reste local. Pour une réduction rapide sans choisir de codec, préférez le compresseur léger.',
  tool_image_optimizer_rules_title: 'Ce qu’il faut anticiper',
  tool_image_optimizer_rules_body: 'Chaque codec arbitre poids, rendu, transparence et temps. À lire avant de viser le plus petit fichier possible.',
  tool_image_optimizer_rules_item_1: 'MozJPEG : JPEG avec pertes, souvent plus léger qu’un JPEG navigateur classique — utile si vous devez garder .jpg.',
  tool_image_optimizer_rules_item_2: 'WebP : photos plus légères à rendu comparable ; gère la transparence. Bon défaut pour beaucoup de sites.',
  tool_image_optimizer_rules_item_3: 'AVIF : souvent le plus petit en lossy, mais plus lent — progression et annulation font partie du parcours.',
  tool_image_optimizer_rules_item_4: 'OxiPNG : réduit le PNG sans perte. Les photos restent lourdes ; idéal pour une UI nette avec alpha. Le ré-encodage retire souvent l’EXIF ; les octets ne quittent pas l’onglet.',
  tool_image_optimizer_example_title: 'Exemple',
  tool_image_optimizer_example: 'Le même JPEG téléphone (~3–4 Mo) : MozJPEG est souvent plus léger qu’un JPEG navigateur banal ; WebP réduit encore avec un rendu proche ; AVIF peut descendre plus bas mais prend des secondes sur un grand cadre. Ordres de grandeur seulement — faites confiance au curseur sur votre fichier.',
  ...
  tool_image_optimizer_faq_a1: 'Les codecs sont volumineux. On attend un clic pour garder le premier affichage léger — vous ne les téléchargez que pour une optimisation au niveau codec.',
  tool_image_optimizer_faq_q2: 'Mes fichiers quittent-ils le navigateur ?',
  tool_image_optimizer_faq_a2: 'Non. Après chargement du moteur, décodage et encodage restent ici. Vérifiez dans Network que l’image n’est pas envoyée en POST.',
  tool_image_optimizer_faq_q3: 'En quoi cela diffère-t-il du compresseur d’images ?',
  tool_image_optimizer_faq_a3: 'Le compresseur est un passage rapide taille/qualité (idéal pour viser des Ko). Ici vous chargez un moteur pour choisir MozJPEG, WebP, AVIF ou OxiPNG et comparer au curseur.',
  tool_image_optimizer_faq_q4: 'Pourquoi AVIF est-il si lent ?',
  tool_image_optimizer_faq_a4: 'L’encodage AVIF sollicite fortement le CPU, surtout sur de grandes photos. Nous affichons la progression et permettons d’annuler plutôt que de prétendre que c’est instantané.',
  tool_image_optimizer_faq_q5: 'Animation et EXIF ?',
  tool_image_optimizer_faq_a5: 'Les entrées animées deviennent une image fixe de la première frame. Le ré-encodage retire souvent l’EXIF — inspectez d’abord avec l’outil EXIF si besoin.',
  tool_image_optimizer_faq_q6: 'Quand utiliser le convertisseur de format ?',
  tool_image_optimizer_faq_a6: 'Quand l’essentiel est de changer de type (y compris fond JPEG pour la transparence). Utilisez cet optimiseur quand le poids et le contrôle du codec priment sur un simple changement de format.',
  ...
  tool_color_from_image_article:
    'Palette de couleurs dominantes en local plus moyenne régionale au clic, HEX/RGB/HSL copiables.',
  ...
  tool_color_from_image_usecase_2: 'Captures d’UI : parcourez la palette d’interface puis cliquez une puce ou icône pour la couleur exacte de la région.',
  tool_color_from_image_usecase_3: 'Idées de dégradé : prenez deux accents depuis la palette ou au clic, puis ouvrez le calculateur de dégradés.',
  tool_color_from_image_faq_q1: 'Mon image quitte-t-elle le navigateur ?',
  tool_color_from_image_faq_a1: 'Non. Calcul de palette et prélèvement au clic tournent en local. Vérifiez l’onglet Réseau — l’image n’est pas POSTée.',
  tool_color_from_image_faq_q2: 'Comment sont choisies les couleurs principales ?',
  tool_color_from_image_faq_a2: 'La page réduit l’image, écarte les pixels peu opaques, partage l’espace couleur avec median-cut, moyenne chaque groupe et trie par nombre d’échantillons.',
  tool_color_from_image_faq_q3: 'Que se passe-t-il quand je clique l’image ?',
  tool_color_from_image_faq_a3: 'L’outil remappe le clic vers les pixels source et moyenne les couleurs opaques dans un petit carré (~7×7). Vous obtenez HEX/RGB/HSL pour cette région, séparé de la liste palette.',
  tool_color_from_image_faq_q4: 'Pourquoi un clic n’est-il pas un seul pixel ?',
  tool_color_from_image_faq_a4: 'Photos et captures UI sont bruitées en 1×1. Une moyenne de petite région est plus stable pour les accents CSS tout en suivant où vous avez cliqué.',
  tool_color_from_image_faq_q5: 'Les GIF animés sont-ils entièrement analysés ?',
  tool_color_from_image_faq_a5: 'Seule la première image est dessinée, utilisée pour la palette et disponible pour le prélèvement au clic.',
  ...
  tool_image_merge_article: 'Collage local multi-images avec disposition, espacement, fond, ajustement grille, format et presets de taille.',
  ...
  tool_image_merge_rules_body: 'La taille du canevas suit les formules ci-dessous. En grille les cellules partagent largeur et hauteur ; contenir laisse des bandes, couvrir rogne.',
  ...
  tool_image_merge_faq_a1: 'Non. Décodage, mise en page et export restent dans le navigateur. Onglet Réseau — pas de POST d’images.',
  tool_image_merge_faq_q2: 'Différence horizontal / vertical ?',
  tool_image_merge_faq_a2: 'Horizontal unifie la hauteur et grandit en largeur ; vertical unifie la largeur et grandit en hauteur. La grille utilise des cellules fixes avec contenir ou couvrir.',
  ...
  tool_image_merge_faq_a5: 'Des bords au-delà de ~8192 px ou trop de mégapixels peuvent dépasser la mémoire du navigateur. Réduisez le nombre, les colonnes grille ou recadrez d’abord.',
  ...
  tool_image_overlay_article: 'Composition locale à deux calques : opacité, ancrage haut-gauche, échelle, modes de fusion, fond JPEG pour aplatir la transparence.',
  ...
  tool_image_overlay_rules_body: 'Le canevas de sortie correspond aux pixels naturels de la base. Le calque est dessiné avec ancrage haut-gauche en (x, y) après mise à l’échelle.',
  tool_image_overlay_rules_item_1: 'Largeur × hauteur du canevas = dimensions naturelles de la base ; la base est dessinée en (0, 0).',
  tool_image_overlay_rules_item_2: 'Taille du calque = largeur × hauteur naturelle × (échelle% ÷ 100) ; position en pixels base, ancrage haut-gauche.',
  tool_image_overlay_rules_item_3: 'globalAlpha = opacité ÷ 100 ; globalCompositeOperation = fusion choisie ; réinitialisation après le calque.',
  ...
  tool_image_overlay_faq_a2: 'Fusionner assemble plusieurs photos en horizontal, vertical ou grille. Superposer garde une base et peint une couche avec opacité, position et fusion.',
  tool_image_overlay_faq_q3: 'Que font les modes de fusion ?',
  tool_image_overlay_faq_a3: 'Règles Canvas : Normal empile ; Produit assombrit ; Écran éclaircit ; Superposition renforce le contraste ; Obscurcir/Éclaircir prennent min/max par canal.',
...
tool_ip_address_title: 'Quelle est mon adresse IP — IP publique (IPv4/IPv6)',
  ...
  tool_ip_address_rules_item_5: 'Lieu et ISP viennent des métadonnées IP edge — souvent niveau ville ; mobile/CGNAT peut fausser ; VPN montre le nœud de sortie.',
