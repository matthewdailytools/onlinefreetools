...
const fr: SiteLangDict = {
  ...
  tool_prompt_template_builder_faq_a4: 'Oui. La puce JSON émet {role,task,constraints,output}. Associez le validateur JSON Schema si besoin.',
  ...
  tool_prompt_template_builder_rules_body: 'Un modèle réutilisable exige des blocs clairs et des limites honnêtes — pas un second générateur.',
  ...
  tool_prompt_template_builder_usecase_1: 'Publiez un system prompt de revue de code que l’équipe peut coller dans n’importe quelle UI de chat.',
  tool_prompt_template_builder_usecase_2: 'Transformez des notes de réunion en blocs Role/Task/Constraints avant de brancher l’API.',
  tool_prompt_template_builder_usecase_3: 'Exportez du JSON puis ouvrez le validateur JSON Schema pour vérifier les fichiers de config.',
