...
const id: SiteLangDict = {
  ...
  tool_color_from_image_article:
    'Palet warna dominan lokal plus rata-rata region saat klik, dengan HEX/RGB/HSL siap salin.',
  ...
  tool_color_from_image_rules_item_5:
    'Privasi: decode, perhitungan palet, dan sampling klik berjalan lokal di tab ini.',
  ...
  tool_color_from_image_faq_a2: 'Halaman mengecilkan gambar, membuang piksel alpha rendah, membagi ruang warna dengan median-cut, merata-ratakan tiap bucket, dan mengurutkan menurut jumlah sampel.',
  tool_color_from_image_faq_q3: 'Apa yang terjadi saat saya klik gambar?',
  tool_color_from_image_faq_a3: 'Alat memetakan klik ke piksel sumber dan merata-ratakan warna opaque dalam kotak kecil (~7×7). Anda dapat HEX/RGB/HSL untuk region itu, terpisah dari daftar palet.',
  tool_color_from_image_faq_q4: 'Mengapa klik bukan satu piksel?',
  tool_color_from_image_faq_a4: 'Foto dan screenshot UI berisik pada 1×1. Rata-rata region kecil lebih stabil untuk aksen CSS sambil tetap melacak tempat Anda klik.',
  ...
  tool_image_merge_rules_body: 'Ukuran kanvas mengikuti rumus di bawah. Di kisi, sel berbagi lebar & tinggi; muat penuh beri pinggir, isi crop memotong.',
  ...
  tool_image_merge_faq_a2: 'Horizontal menyamakan tinggi dan melebar; vertikal menyamakan lebar dan memanjang. Kisi pakai sel tetap dengan muat penuh atau isi crop.',
  ...
  tool_image_merge_faq_a5: 'Sisi kanvas di atas ~8192 px atau sumber terlalu besar bisa melebihi memori browser. Kurangi jumlah, kolom kisi, atau crop dulu.',
  ...
  tool_image_overlay_article: 'Komposisi lokal dua lapisan: opasitas, anchor kiri atas, skala, mode blend, latar JPEG saat ratakan transparansi.',
  ...
  tool_image_overlay_rules_body: 'Kanvas keluaran = piksel alami dasar. Lapisan digambar dengan anchor kiri atas di (x, y) setelah skala.',
  ...
  tool_image_overlay_faq_a2: 'Gabung menyusun banyak foto horizontal, vertikal, atau kisi. Timpa mempertahankan satu dasar dan melukis satu lapisan dengan opasitas, posisi, dan blend.',
  tool_image_overlay_faq_q3: 'Apa fungsi mode blend?',
  tool_image_overlay_faq_a3: 'Aturan Canvas: Normal menumpuk; Multiply gelap; Screen terang; Overlay kontras; Darken/Lighten min/maks kanal.',
