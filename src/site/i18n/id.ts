...
const id: SiteLangDict = {
  ...
  tool_prompt_template_builder_desc: 'Pembuat templat Prompt untuk ChatGPT, Gemini, Claude & DeepSeek — Markdown/JSON; tetap di perangkat.',
  ...
  tool_writing_prompt_generator_desc: 'Generator prompt menulis untuk dialog, karakter, skrip & acak — Markdown/JSON; tetap di perangkat.',
