...
const id: SiteLangDict = {
  ...
  tool_add_digital_signature_to_pdf_article:
    'Cap kotak integritas terlihat dengan awalan SHA-256. File tetap di perangkat; tanpa unggah ke server.',
  ...
  tool_add_digital_signature_to_pdf_desc:
    'Tambahkan tampilan tanda tangan digital ke PDF — SHA-256 dan kotak terlihat. File tetap di perangkat; tanpa unggah ke server.',
  tool_add_digital_signature_to_pdf_description:
    'Tambahkan tampilan tanda tangan digital ke PDF di peramban: hitung SHA-256, cap kotak “Ditandai secara digital” berisi cap waktu dan awalan hash, lalu unduh. File tetap di perangkat; tanpa unggah ke server. Proses dan contoh berjalan pada sampel. Ini tampilan integritas, bukan penandatanganan PKI bersertifikat.',
  tool_add_digital_signature_to_pdf_disclaimer:
    'Hanya tampilan integritas — bukan tanda tangan digital bersertifikat (tanpa PKCS#7 / PAdES) dan bukan nasihat hukum. Setelah dicap, hash berkas berubah.',
  ...
  tool_add_digital_signature_to_pdf_example:
    'Muat sampel membuat “catatan sampel”, menghitung hash, dan mencap “Ditandai secara digital” dengan 16 hex di sekitar X=48, Y=48.',
  ...
  tool_add_digital_signature_to_pdf_how_body:
    'Pilih PDF, atur halaman dan X/Y, tandai, lalu unduh. File tetap di perangkat; tanpa unggah ke server.',
  ...
  tool_add_text_to_pdf_file_description:
    'Tambahkan teks ke PDF. Berkas tetap di perangkat; tanpa unggah ke server. Contoh memperlihatkan masukan dan keluaran nyata; langkah serta batas dijelaskan di halaman.',
  ...
  tool_add_text_to_pdf_file_how_item_2: 'Klik “Add & download” untuk menjalankan proses',
  ...
  tool_check_pdf_a_compliance_description:
    'Memeriksa secara lokal header PDF, ID PDF/A dalam XMP tak terkompresi, output intent, penanda font tertanam, dan enkripsi. Contoh memberi petunjuk, bukan sertifikat.',
  ...
  tool_check_pdf_a_compliance_warn:
    'Hanya penyaringan: halaman ini tidak menyertifikasi PDF/A. Gunakan validator berbasis profil seperti veraPDF untuk keputusan arsip atau hukum.',
  ...
  tool_combine_files_into_one_pdf_description:
    'Gabungkan berkas jadi satu PDF. Berkas tetap di perangkat; tanpa unggah ke server. Contoh memperlihatkan masukan dan keluaran nyata; langkah serta batas dijelaskan di halaman.',
  ...
  tool_compare_two_pdfs_description:
    'Bandingkan dua PDF. Berkas tetap di perangkat; tanpa unggah ke server. Contoh memperlihatkan masukan dan keluaran nyata; langkah serta batas dijelaskan di halaman.',
  ...
  tool_compare_two_pdfs_how_item_2: 'Klik “Compare” untuk menjalankan proses',
  ...
  tool_convert_pdf_to_dwg_desc:
    'Konversi PDF ke arah DWG — ekspor DXF ASCII berisi teks dan bingkai halaman. Berkas tetap di perangkat; tanpa unggah ke server.',
  tool_convert_pdf_to_dwg_description:
    'Konversi PDF ke arah DWG di peramban dengan mengekspor DXF ASCII: entitas TEXT dan bingkai halaman yang AutoCAD buka. Peramban tidak bisa menulis DWG proprietary. Berkas tetap di perangkat; tanpa unggah ke server. Halaman ini menampilkan proses, langkah, dan contoh.',
  ...
  tool_convert_pdf_to_dwg_example:
    'Muat contoh membuat PDF bertuliskan "Hello PDF to DWG sample.", mengubahnya ke DXF ASCII, dan mengaktifkan Unduh .dxf.',
  tool_convert_pdf_to_dwg_example_title: 'Contoh',
  tool_convert_pdf_to_dwg_faq_a1:
    'Tidak. Peramban tidak bisa menulis biner DWG proprietary. Unduhan adalah DXF ASCII, tukar CAD yang dibuka AutoCAD.',
  ...
  tool_convert_pdf_to_dwg_how_body:
    'Pilih PDF yang punya lapisan teks, klik Konversi, lalu unduh DXF. Berkas tetap di perangkat; tanpa unggah ke server.',
  ...
  tool_convert_pdf_to_pdf_a_article:
    'Konversi PDF ke arah PDF/A di peramban: tulis judul dan pembuat serta sematkan font standar. Ini bukan arsip tersertifikasi veraPDF. Berkas tetap di perangkat; tanpa unggah ke server.',
  ...
  tool_convert_pdf_to_pdf_a_desc:
    'Konversi PDF ke arah PDF/A — tulis judul dan pembuat serta sematkan font standar. Berkas tetap di perangkat; tanpa unggah ke server.',
  tool_convert_pdf_to_pdf_a_description:
    'Konversi PDF ke arah PDF/A di peramban: tulis judul dan pembuat serta sematkan font standar. Ini bukan PDF/A tersertifikasi veraPDF. Berkas tetap di perangkat; tanpa unggah ke server. Halaman ini menampilkan proses, langkah, dan contoh.',
  ...
  tool_convert_pdf_to_pdf_a_example:
    'Muat contoh membuat PDF bertuliskan "Hello PDF/A sample.", menjalankan Konversi, dan menawarkan salinan berorientasi arsip.',
  ...
  tool_convert_pdf_to_pdf_a_faq_a2:
    'Tidak. Ini penulisan ulang sebisanya: judul, pembuat, dan font standar tersemat. Bukan PDF/A tersertifikasi veraPDF.',
  ...
  tool_convert_pdf_to_pdf_a_how_body:
    'Pilih PDF, klik Konversi, lalu unduh berkas yang ditulis ulang. Berkas tetap di perangkat; tanpa unggah ke server.',
  ...
  tool_convert_word_document_to_pdf_desc:
    'Ubah dokumen Word menjadi PDF di peramban — pilih .docx, pratinjau HTML, lalu ekspor. File tetap di perangkat; tanpa unggah ke server.',
  tool_convert_word_document_to_pdf_description:
    'Ubah dokumen Word menjadi PDF di peramban: pilih .docx, tinjau pratinjau HTML, lalu ikuti langkah proses untuk mengekspor PDF siap cetak. File tetap di perangkat; tanpa unggah ke server. Contoh otomatis berjalan saat Anda memuat sampel.',
  ...
  tool_create_budget_spreadsheet_description:
    'Buat anggaran dan unduh xlsx. Proses: kategori dan jumlah. Contoh sewa 1200 + makanan 400. Proses dan contoh sama dengan sampel. Rumus dihitung di tab ini, tanpa unggah ke server.',
  ...
  tool_create_excel_timesheet_description:
    'Buat timesheet dan unduh xlsx. Proses: tanggal, proyek, jam. Contoh 5×8 → 40. Proses dan contoh sama dengan sampel. Rumus dihitung di tab ini, tanpa unggah ke server.',
  ...
  tool_create_invoice_spreadsheet_description:
    'Buat spreadsheet faktur dan unduh xlsx. Proses: penjual, baris, pajak. Contoh 2×10 pajak 10% → 22. Proses dan contoh sama dengan sampel. Rumus dihitung di tab ini, tanpa unggah ke server.',
  ...
  tool_create_pdf_form_article:
    'Mulai dari halaman kosong, beri nama teks atau centang, lalu unduh formulir sungguhan. Menempel kolom pada berkas yang sudah ada ada di Jadikan PDF bisa diisi.',
  ...
  tool_create_pdf_form_description:
    'Buat formulir PDF dari halaman kosong: tambah kolom teks atau centang bernama di X/Y dengan lebar dan tinggi, lalu unduh. Tidak diunggah ke server; berkas dirakit di tab ini. Contoh masuk adalah Name plus Email — proses dengan langkah dan contoh yang bisa ditambah sebelum ekspor.',
  ...
  tool_create_pdf_form_how_body:
    'Beri nama kolom, pilih teks atau centang, letakkan, tambah lagi, lalu unduh. Contoh mulai dari Name dan Email.',
  ...
  tool_edit_pdf_form_fields_article:
    'Daftar nama AcroForm, ganti nama, atau buang kotak sisa, lalu unduh. Mengetik jawaban ada di Isi formulir PDF.',
  ...
  tool_edit_pdf_form_fields_description:
    'Edit kolom formulir PDF di tab ini: halaman menampilkan nama, Anda mengganti nama kotak atau menandainya untuk dihapus, lalu mengunduh. Berkas tetap di perangkat; tidak diunggah ke server. Contoh masuk adalah formulir Name + Email agar daftar langsung terlihat — proses dengan langkah dan contoh sebelum menyentuh berkas nyata.',
  ...
  tool_edit_pdf_form_fields_how_body:
    'Buka PDF berformular, tinjau daftar nama, ganti nama atau tandai hapus, terapkan, lalu unduh. Contoh menampilkan Name dan Email saat masuk.',
  ...
  tool_edit_pdf_text_online_article:
    'Edit teks PDF secara daring: ambil lapisan teks, ubah, lalu susun ulang halaman dengan tata letak sederhana. Berkas tetap di perangkat; tanpa unggah ke server.',
  ...
  tool_edit_pdf_text_online_desc:
    'Edit teks PDF secara daring — ambil lapisan teks, ubah, lalu susun ulang sederhana. Berkas tetap di perangkat; tanpa unggah ke server.',
  tool_edit_pdf_text_online_description:
    'Edit teks PDF secara daring di peramban: ambil lapisan teks, ubah di editor, lalu terapkan penyusunan ulang sederhana. Berkas tetap di perangkat; tanpa unggah ke server. Halaman ini menampilkan proses, langkah, dan contoh.',
  ...
  tool_edit_pdf_text_online_faq_a4:
    'Tambah teks menempelkan satu baris di X/Y. Ekstrak teks hanya menyalin kata. Halaman ini mengubah teks yang ada dan menyusun ulang halaman.',
  ...
  tool_edit_pdf_text_online_faq_q4: 'Bedanya dengan Tambah teks atau Ekstrak teks?',
  tool_edit_pdf_text_online_faq_q5: 'Apakah berkas besar didukung?',
  tool_edit_pdf_text_online_how_body:
    'Pilih PDF yang punya lapisan teks, ubah kata, lalu Terapkan. Berkas tetap di perangkat; tanpa unggah ke server.',
  ...
  tool_excel_formulas_cheat_sheet_description:
    'Salin rumus dari lembar ringkas. Proses: saring lalu salin. Contoh kartu IF. Bukan pembangun IF bersarang. Proses dan contoh sama dengan sampel. Rumus dihitung di tab ini, tanpa unggah ke server.',
  ...
  tool_extract_text_from_pdf_description:
    'Ekstrak teks dari PDF. Berkas tetap di perangkat; tanpa unggah ke server. Contoh memperlihatkan masukan dan keluaran nyata; langkah serta batas dijelaskan di halaman.',
  ...
  tool_fill_out_pdf_form_article:
    'Pakai jika PDF sudah bisa diisi dan Anda hanya perlu mengetik. Hasil pindaian tanpa kolom gagal. Berkas terenkripsi menampilkan error yang jelas.',
  ...
  tool_fill_out_pdf_form_description:
    'Isi formulir PDF di peramban: halaman mendeteksi kotak teks dan kotak centang, Anda mengetik nilai, lalu mengunduh. Berkas tetap di perangkat; tidak diunggah ke server. Contoh saat masuk adalah formulir dua kolom (Name, Email) yang sudah terisi — proses dengan langkah dan contoh yang bisa diulang pada PDF Anda.',
  ...
  tool_fill_out_pdf_form_faq_a4:
    'Buat formulir PDF mulai dari halaman kosong. Halaman ini hanya menulis nilai ke kolom yang sudah ada.',
  ...
  tool_fill_out_pdf_form_how_body:
    'Buka PDF yang bisa diisi, ketik di kolom terdeteksi, lalu unduh. Contoh awal menampilkan Name dan Email terisi.',
  ...
  tool_make_pdf_fillable_article:
    'Pakai jika PDF tampak formulir tetapi kotaknya hanya gambar. Halaman ini menambah kolom sungguhan. Mengetik jawaban ada di Isi formulir PDF.',
  ...
  tool_make_pdf_fillable_faq_a4:
    'Buat formulir PDF mulai kosong dan menamai teks atau centang. Halaman ini menempel kolom pada berkas yang sudah Anda punya.',
  ...
  tool_make_pdf_fillable_how_body:
    'Buka PDF statis, isi nama dan kotak, tambah satu kolom atau N bawaan, lalu unduh. Contoh menaruh FullName di halaman kosong.',
  ...
  tool_make_pdf_flipbook_description:
    'Buat flipbook PDF. Berkas tetap di perangkat; tanpa unggah ke server. Contoh memperlihatkan masukan dan keluaran nyata; langkah serta batas dijelaskan di halaman.',
  ...
  tool_open_pdf_in_browser_description:
    'Buka PDF di browser. Berkas tetap di perangkat; tanpa unggah ke server. Contoh memperlihatkan masukan dan keluaran nyata; langkah serta batas dijelaskan di halaman.',
  ...
  tool_organize_pdf_article:
    'Urutkan, hapus, atau pilih halaman dari satu PDF di browser—file tetap di perangkat, tidak diunggah ke server.',
  ...
  tool_organize_pdf_faq_a3:
    'Gunakan tombol Naik/Turun pada setiap baris halaman. Terapkan menyalin halaman sesuai urutan daftar dari atas ke bawah.',
  tool_organize_pdf_faq_a4: 'PDF berpassword biasanya gagal di sini. Hapus kata sandi dulu.',
  tool_organize_pdf_faq_a5:
    'Klik Hapus pada baris atau hilangkan centang Cantumkan sebelum Terapkan—keduanya mengeluarkan halaman dari PDF hasil.',
  ...
  tool_organize_pdf_how_body:
    'Pilih PDF, urutkan atau hapus halaman dari daftar, klik Terapkan lalu Unduh. Urutan keluaran mengikuti daftar dari atas ke bawah. Semuanya di tab ini—file tidak diunggah ke server.',
  ...
  tool_print_pdf_description:
    'Cetak PDF. Berkas tetap di perangkat; tanpa unggah ke server. Contoh memperlihatkan masukan dan keluaran nyata; langkah serta batas dijelaskan di halaman.',
  ...
  tool_sign_pdf_document_article:
    'Cap nama yang digambar atau diketik pada halaman PDF. File tetap di perangkat; tanpa unggah ke server.',
  ...
  tool_sign_pdf_document_description:
    'Tanda tangani dokumen PDF di peramban: gambar atau ketik nama, letakkan di X/Y pada sebuah halaman, lalu unduh. File tetap di perangkat; tanpa unggah ke server. Ini cap terlihat, bukan sertifikat. Proses dan contoh berjalan saat Anda memuat sampel.',
  tool_sign_pdf_document_disclaimer:
    'Hanya tampilan terlihat — bukan tanda tangan digital bersertifikat dan bukan nasihat hukum. Jangan anggap cap sebagai bukti identitas.',
  ...
  tool_sign_pdf_document_faq_a4:
    'Alat peramban ini tidak menerapkan sertifikat PKCS#7 / PAdES. Gunakan perangkat lunak penandatanganan khusus.',
  ...
  tool_turn_pdf_into_editable_document_article:
    'Ubah PDF jadi dokumen yang bisa diedit: tarik lapisan teks, lalu ekspor PDF yang disusun ulang. Tanpa OCR. Berkas tetap di perangkat; tanpa unggah ke server.',
  ...
  tool_turn_pdf_into_editable_document_desc:
    'Ubah PDF jadi dokumen yang bisa diedit — Jadikan bisa diedit menarik lapisan teks, lalu Anda ekspor PDF yang disusun ulang. Berkas tetap di perangkat; tanpa unggah ke server.',
  tool_turn_pdf_into_editable_document_description:
    'Ubah PDF jadi dokumen yang bisa diedit di peramban: klik Jadikan bisa diedit untuk menarik lapisan teks, ubah kata, lalu ekspor PDF yang disusun ulang. Tanpa OCR. Berkas tetap di perangkat; tanpa unggah ke server. Halaman ini menampilkan proses, langkah, dan contoh.',
  ...
  tool_turn_pdf_into_editable_document_example:
    'Muat contoh membuat PDF bertuliskan "Hello editable PDF document sample.", menjalankan Jadikan bisa diedit, lalu mengekspor PDF yang bisa diunduh.',
  ...
  tool_turn_pdf_into_editable_document_faq_a2:
    'Halaman ini menyimpan teks hasil ekstraksi sebagai TXT UTF-8 yang dapat diedit, dengan PDF hasil susun ulang sebagai opsi; Edit PDF Text berfokus mengubah kata lalu mengembalikan PDF.',
  tool_turn_pdf_into_editable_document_faq_a3:
    'Ekspor adalah PDF yang disusun ulang, bukan Word. Salin teks dengan Ekstrak teks dari PDF, atau tulis baru dengan Tulis dokumen PDF daring.',
  tool_turn_pdf_into_editable_document_faq_a4:
    'Tanpa OCR. Jika tidak ada lapisan teks, Jadikan bisa diedit gagal, bukan menebak huruf dari pindaian.',
  ...
  tool_turn_pdf_into_editable_document_faq_q4: 'Apakah Jadikan bisa diedit menjalankan OCR?',
  ...
  tool_turn_pdf_into_editable_document_how_body:
    'Buka PDF yang sudah punya lapisan teks, klik Jadikan bisa diedit, lalu ekspor. Berkas tetap di perangkat; tanpa unggah ke server.',
  ...
  tool_turn_pdf_into_editable_document_word_note:
    'Butuh Word? Salin teks dengan Ekstrak teks dari PDF, atau tulis baru dengan Tulis dokumen PDF daring.',
  ...
  tool_turn_pdf_into_word_document_desc:
    'Ubah PDF menjadi dokumen Word di peramban — ekstrak teks yang bisa dipilih, lalu unduh .docx. File tetap di perangkat; tanpa unggah ke server.',
  tool_turn_pdf_into_word_document_description:
    'Ubah PDF menjadi dokumen Word di peramban: ekstrak teks yang bisa dipilih, tinjau, lalu unduh .docx. File tetap di perangkat; tanpa unggah ke server. Tanpa OCR. Proses dan contoh berjalan saat Anda memuat sampel.',
  ...
  tool_turn_pdf_into_word_document_how_body:
    'Pilih PDF berlapisan teks, konversi, tinjau, lalu unduh. File tetap di perangkat; tanpa unggah ke server.',
  ...
  tool_wrap_formula_with_ifna_description:
    'Bungkus rumus dengan IFNA. Proses: tempel rumus dalam dan cadangan. Contoh NA() dan 0. Proses dan contoh sama dengan sampel. Rumus dihitung di tab ini, tanpa unggah ke server.',
  ...
  tool_write_countif_formula_in_excel_add: 'Tambah baris',
  tool_write_countif_formula_in_excel_alt: 'Jika #N/A',
  tool_write_countif_formula_in_excel_article: 'Kerjakan COUNTIF di browser, tanpa unggah ke server.',
  tool_write_countif_formula_in_excel_bar: 'Batang',
  tool_write_countif_formula_in_excel_buyer: 'Pembeli',
  tool_write_countif_formula_in_excel_cell: 'Sel',
  tool_write_countif_formula_in_excel_clear: 'Hapus',
  tool_write_countif_formula_in_excel_copy: 'Salin',
  tool_write_countif_formula_in_excel_count: 'Hitung',
  tool_write_countif_formula_in_excel_criteria: 'Kriteria',
  tool_write_countif_formula_in_excel_csv: 'Tempel CSV',
  ...
  tool_write_countif_formula_in_excel_description:
    'Tulis rumus COUNTIF. Proses: rentang A1 dan kriteria * ?. Contoh A2:A6 dan West. Proses dan contoh sama dengan sampel. Rumus dihitung di tab ini, tanpa unggah ke server.',
  tool_write_countif_formula_in_excel_download: 'Unduh xlsx',
  tool_write_countif_formula_in_excel_draw: 'Gambar',
  tool_write_countif_formula_in_excel_else: 'Jika tidak',
  tool_write_countif_formula_in_excel_empty: 'Muat contoh atau isi kolom dulu.',
  tool_write_countif_formula_in_excel_err_read: 'Gagal membaca. Coba xlsx/csv.',
  tool_write_countif_formula_in_excel_example: 'A2:A6 + West → =COUNTIF(A2:A6,"West").',
  tool_write_countif_formula_in_excel_example_title: 'Contoh',
  tool_write_countif_formula_in_excel_faq_a1: 'Tidak. Tetap di perangkat, tanpa unggah ke server.',
  tool_write_countif_formula_in_excel_faq_a2: 'Bukan.',
  tool_write_countif_formula_in_excel_faq_a3: 'Tombol contoh mengisi kolom.',
  tool_write_countif_formula_in_excel_faq_a4: 'Viewer hanya baca; yang lain menulis rumus atau xlsx.',
  tool_write_countif_formula_in_excel_faq_q1: 'Apakah berkas diunggah saat COUNTIF?',
  tool_write_countif_formula_in_excel_faq_q2: 'Ini Excel Online?',
  tool_write_countif_formula_in_excel_faq_q3: 'Contoh di mana?',
  tool_write_countif_formula_in_excel_faq_q4: 'Bisa edit sel?',
  tool_write_countif_formula_in_excel_file: 'Berkas',
  tool_write_countif_formula_in_excel_filter: 'Saring',
  tool_write_countif_formula_in_excel_formula: 'Rumus',
  tool_write_countif_formula_in_excel_how_body: 'Kerjakan COUNTIF di browser, tanpa unggah ke server.',
  tool_write_countif_formula_in_excel_how_item_1: 'Mulai dengan data untuk COUNTIF.',
  tool_write_countif_formula_in_excel_how_item_2: 'Isi kolom sesuai urutan yang ditampilkan.',
  tool_write_countif_formula_in_excel_how_item_3: 'Muat contoh dan periksa hasilnya.',
  tool_write_countif_formula_in_excel_how_item_4: 'Salin rumus atau unduh xlsx.',
  tool_write_countif_formula_in_excel_how_title: 'Cara kerja',
  tool_write_countif_formula_in_excel_inner: 'Rumus dalam',
  tool_write_countif_formula_in_excel_line: 'Garis',
  tool_write_countif_formula_in_excel_lines: 'desc,qty,harga',
  tool_write_countif_formula_in_excel_need_lib: 'Pustaka gagal dimuat. Periksa jaringan.',
  tool_write_countif_formula_in_excel_note_2016: 'IFS memerlukan Excel 2019, Microsoft 365, atau versi lebih baru.',
  tool_write_countif_formula_in_excel_op_blank: 'kosong',
  tool_write_countif_formula_in_excel_op_contains: 'berisi',
  tool_write_countif_formula_in_excel_op_eq: 'sama',
  tool_write_countif_formula_in_excel_range: 'Rentang',
  tool_write_countif_formula_in_excel_row_field: 'Bidang baris',
  tool_write_countif_formula_in_excel_rules_body: 'Periksa urutan kondisi dan referensi sebelum menyalin. Rumus memakai nama fungsi Inggris dan koma.',
  tool_write_countif_formula_in_excel_rules_item_1: 'Periksa urutan kondisi dan referensi sebelum menyalin.',
  tool_write_countif_formula_in_excel_rules_item_2: 'Rumus memakai nama fungsi Inggris dan koma.',
  tool_write_countif_formula_in_excel_rules_item_3: 'Excel lokal mungkin memerlukan nama terjemahan atau titik koma.',
  tool_write_countif_formula_in_excel_rules_item_4: 'Input tetap di perangkat tanpa unggah ke server.',
  tool_write_countif_formula_in_excel_rules_title: 'Aturan',
  tool_write_countif_formula_in_excel_sample: 'Muat contoh',
  tool_write_countif_formula_in_excel_seller: 'Penjual',
  tool_write_countif_formula_in_excel_sheet: 'Sheet',
  tool_write_countif_formula_in_excel_sum: 'Jumlah',
  tool_write_countif_formula_in_excel_tax: 'Pajak %',
  tool_write_countif_formula_in_excel_title: 'Tulis rumus COUNTIF di Excel',
  tool_write_countif_formula_in_excel_trial: 'Uji',
  tool_write_countif_formula_in_excel_usecase_1: 'Tugas kelas.',
  tool_write_countif_formula_in_excel_usecase_2: 'Draf cepat.',
  tool_write_countif_formula_in_excel_usecase_3: 'Cek sebelum tempel ke Excel.',
  tool_write_countif_formula_in_excel_usecases_title: 'Cocok untuk',
  tool_write_countif_formula_in_excel_val_field: 'Bidang nilai',
  tool_write_countif_formula_in_excel_write: 'Tulis rumus',
  tool_write_ifs_formula_in_excel_add: 'Tambah baris',
  tool_write_ifs_formula_in_excel_alt: 'Jika #N/A',
  tool_write_ifs_formula_in_excel_article: 'Kerjakan IFS di browser, tanpa unggah ke server.',
  tool_write_ifs_formula_in_excel_bar: 'Batang',
  tool_write_ifs_formula_in_excel_buyer: 'Pembeli',
  tool_write_ifs_formula_in_excel_cell: 'Sel',
  tool_write_ifs_formula_in_excel_clear: 'Hapus',
  tool_write_ifs_formula_in_excel_copy: 'Salin',
  tool_write_ifs_formula_in_excel_count: 'Hitung',
  tool_write_ifs_formula_in_excel_criteria: 'Kriteria',
  tool_write_ifs_formula_in_excel_csv: 'Tempel CSV',
  ...
  tool_write_ifs_formula_in_excel_description:
    'Tulis rumus IFS dengan pengujian berurutan dan hasil akhir TRUE. Contoh: West → A, East → B, selain itu Other. Memerlukan Excel 2019, Microsoft 365, atau versi lebih baru.',
  tool_write_ifs_formula_in_excel_download: 'Unduh xlsx',
  tool_write_ifs_formula_in_excel_draw: 'Gambar',
  tool_write_ifs_formula_in_excel_else: 'Jika tidak',
  tool_write_ifs_formula_in_excel_empty: 'Muat contoh atau isi kolom dulu.',
  tool_write_ifs_formula_in_excel_err_read: 'Gagal membaca. Coba xlsx/csv.',
  tool_write_ifs_formula_in_excel_example: 'A1=West → A; East → B; else Other: =IFS(A1="West","A",A1="East","B",TRUE,"Other").',
  tool_write_ifs_formula_in_excel_example_title: 'Contoh',
  tool_write_ifs_formula_in_excel_faq_a1: 'Tidak. Tetap di perangkat, tanpa unggah ke server.',
  tool_write_ifs_formula_in_excel_faq_a2: 'Bukan.',
  tool_write_ifs_formula_in_excel_faq_a3: 'Tombol contoh mengisi kolom.',
  tool_write_ifs_formula_in_excel_faq_a4: 'Viewer hanya baca; yang lain menulis rumus atau xlsx.',
  tool_write_ifs_formula_in_excel_faq_q1: 'Apakah berkas diunggah saat IFS?',
  tool_write_ifs_formula_in_excel_faq_q2: 'Ini Excel Online?',
  tool_write_ifs_formula_in_excel_faq_q3: 'Contoh di mana?',
  tool_write_ifs_formula_in_excel_faq_q4: 'Bisa edit sel?',
  tool_write_ifs_formula_in_excel_file: 'Berkas',
  tool_write_ifs_formula_in_excel_filter: 'Saring',
  tool_write_ifs_formula_in_excel_formula: 'Rumus',
  tool_write_ifs_formula_in_excel_how_body: 'Kerjakan IFS di browser, tanpa unggah ke server.',
  tool_write_ifs_formula_in_excel_how_item_1: 'Mulai dengan data untuk IFS.',
  tool_write_ifs_formula_in_excel_how_item_2: 'Isi kolom sesuai urutan yang ditampilkan.',
  tool_write_ifs_formula_in_excel_how_item_3: 'Muat contoh dan periksa hasilnya.',
  tool_write_ifs_formula_in_excel_how_item_4: 'Salin rumus atau unduh xlsx.',
  tool_write_ifs_formula_in_excel_how_title: 'Cara kerja',
  tool_write_ifs_formula_in_excel_inner: 'Rumus dalam',
  tool_write_ifs_formula_in_excel_line: 'Garis',
  tool_write_ifs_formula_in_excel_lines: 'desc,qty,harga',
  tool_write_ifs_formula_in_excel_need_lib: 'Pustaka gagal dimuat. Periksa jaringan.',
  tool_write_ifs_formula_in_excel_note_2016: 'IFS memerlukan Excel 2019, Microsoft 365, atau versi lebih baru.',
  tool_write_ifs_formula_in_excel_op_blank: 'kosong',
  tool_write_ifs_formula_in_excel_op_contains: 'berisi',
  tool_write_ifs_formula_in_excel_op_eq: 'sama',
  tool_write_ifs_formula_in_excel_range: 'Rentang',
  tool_write_ifs_formula_in_excel_row_field: 'Bidang baris',
  tool_write_ifs_formula_in_excel_rules_body: 'Periksa urutan kondisi dan referensi sebelum menyalin. Rumus memakai nama fungsi Inggris dan koma.',
  tool_write_ifs_formula_in_excel_rules_item_1: 'Periksa urutan kondisi dan referensi sebelum menyalin.',
  tool_write_ifs_formula_in_excel_rules_item_2: 'Rumus memakai nama fungsi Inggris dan koma.',
  tool_write_ifs_formula_in_excel_rules_item_3: 'Excel lokal mungkin memerlukan nama terjemahan atau titik koma.',
  tool_write_ifs_formula_in_excel_rules_item_4: 'Input tetap di perangkat tanpa unggah ke server.',
  tool_write_ifs_formula_in_excel_rules_title: 'Aturan',
  tool_write_ifs_formula_in_excel_sample: 'Muat contoh',
  tool_write_ifs_formula_in_excel_seller: 'Penjual',
  tool_write_ifs_formula_in_excel_sheet: 'Sheet',
  tool_write_ifs_formula_in_excel_sum: 'Jumlah',
  tool_write_ifs_formula_in_excel_tax: 'Pajak %',
  tool_write_ifs_formula_in_excel_title: 'Tulis rumus IFS di Excel',
  tool_write_ifs_formula_in_excel_trial: 'Uji',
  tool_write_ifs_formula_in_excel_usecase_1: 'Tugas kelas.',
  tool_write_ifs_formula_in_excel_usecase_2: 'Draf cepat.',
  tool_write_ifs_formula_in_excel_usecase_3: 'Cek sebelum tempel ke Excel.',
  tool_write_ifs_formula_in_excel_usecases_title: 'Cocok untuk',
  tool_write_ifs_formula_in_excel_val_field: 'Bidang nilai',
  tool_write_ifs_formula_in_excel_write: 'Tulis rumus',
  ...
  tool_write_nested_if_formula_for_excel_description:
    'Tulis rumus IF bersarang untuk Excel. Proses: baris sama/berisi/kosong lalu salin IF(IF()). Contoh: A1=West → A. Proses dan contoh sama dengan sampel. Rumus dihitung di tab ini, tanpa unggah ke server.',
  ...
  tool_write_pdf_document_online_description:
    'Tulis dokumen PDF online. Berkas tetap di perangkat; tanpa unggah ke server. Contoh memperlihatkan masukan dan keluaran nyata; langkah serta batas dijelaskan di halaman.',
  ...
  tool_write_pdf_document_online_faq_a1:
    'Tidak. Render berjalan di tab Anda (pustaka mungkin dari CDN). PDF Anda tidak diunggah ke server kami.',
  tool_write_pdf_document_online_faq_a2: 'Tidak. Operasi ini tidak bergantung pada ekstraksi lapisan teks PDF.',
  ...
  tool_write_pdf_document_online_how_item_2: 'Klik “Create PDF” untuk menjalankan proses',
