...
const id: SiteLangDict = {
  ...
  tool_prompt_template_builder_desc: 'Templat Prompt terstruktur (Markdown/JSON) — tetap di perangkat, tanpa unggah ke server.',
  ...
  tool_prompt_template_builder_faq_a1: 'Tidak. Templat dibuat di tab browser ini. Tidak diunggah ke OpenAI, Anthropic, atau server kami.',
  ...
  tool_prompt_template_builder_how_item_1: 'Tempel draf atau isi Role, Task, Constraints, dan Output — tujuannya templat prompt terstruktur.',
  ...
  tool_prompt_template_builder_rules_body: 'Templat yang bisa dipakai ulang butuh blok jelas dan batas jujur — bukan generator kedua.',
  ...
  tool_prompt_template_builder_usecase_1: 'Bagikan system prompt review kode yang tim bisa tempel di UI chat mana pun.',
  tool_prompt_template_builder_usecase_2: 'Ubah catatan rapat jadi blok Role/Task/Constraints sebelum sambungkan API.',
  tool_prompt_template_builder_usecase_3: 'Ekspor JSON lalu buka validator JSON Schema untuk cek file konfigurasi.',
