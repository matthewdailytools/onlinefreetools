...
const id: SiteLangDict = {
  ...
  tool_text_diff_title: 'Bandingkan dua teks online — Lihat perbedaannya',
  ...
  tool_text_diff_example:
    'Contoh (mode kata): A = "Hello world", B = "Hello there" → satu perubahan (world → there). Jika hanya baris tengah dari tiga baris yang berubah, mode baris menandai baris itu.',
  ...
  tool_text_diff_how_body:
    'Tempel dua versi, pilih ketelitian (baris, kata, atau karakter), lalu lihat penambahan hijau dan penghapusan merah. Perbandingan hanya di browser; kami tidak menyimpan teks Anda.',
  ...
  tool_text_diff_faq_a2: 'Tidak. Semua di browser. Menutup tab menghapus tempelan; kami tidak menyimpannya.',
