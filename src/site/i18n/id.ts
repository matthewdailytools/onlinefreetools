...
const id: SiteLangDict = {
  ...
  tool_add_text_to_pdf_file_description:
    'Tambahkan teks ke PDF. Berkas tetap di perangkat; tanpa unggah ke server. El ejemplo al entrar menampilkan hasil nyata saat masuk. un resultado real Menampilkan proses, langkah, dan contoh di halaman.',
  ...
  tool_check_pdf_a_compliance_article: 'Periksa kepatuhan PDF/A. Berkas tetap di perangkat; tanpa unggah ke server.',
  ...
  tool_check_pdf_a_compliance_desc: 'Periksa kepatuhan PDF/A — Berkas tetap di perangkat; tanpa unggah ke server.',
  tool_check_pdf_a_compliance_description:
    'Periksa kepatuhan PDF/A. Berkas tetap di perangkat; tanpa unggah ke server. El ejemplo al entrar menampilkan hasil nyata saat masuk. un resultado real Menampilkan proses, langkah, dan contoh di halaman.',
  ...
  tool_check_pdf_a_compliance_title: 'Periksa kepatuhan PDF/A',
  ...
  tool_combine_files_into_one_pdf_description:
    'Gabungkan berkas jadi satu PDF. Berkas tetap di perangkat; tanpa unggah ke server. El ejemplo al entrar menampilkan hasil nyata saat masuk. un resultado real Menampilkan proses, langkah, dan contoh di halaman.',
  ...
  tool_compare_two_pdfs_description:
    'Bandingkan dua PDF. Berkas tetap di perangkat; tanpa unggah ke server. El ejemplo al entrar menampilkan hasil nyata saat masuk. un resultado real Menampilkan proses, langkah, dan contoh di halaman.',
  ...
  tool_convert_html_to_pdf_description:
    'Konversi HTML ke PDF. Berkas tetap di perangkat; tanpa unggah ke server. El ejemplo al entrar menampilkan hasil nyata saat masuk. un resultado real Menampilkan proses, langkah, dan contoh di halaman.',
  ...
  tool_extract_text_from_pdf_description:
    'Ekstrak teks dari PDF. Berkas tetap di perangkat; tanpa unggah ke server. El ejemplo al entrar menampilkan hasil nyata saat masuk. un resultado real Menampilkan proses, langkah, dan contoh di halaman.',
  ...
  tool_make_pdf_flipbook_description:
    'Buat flipbook PDF. Berkas tetap di perangkat; tanpa unggah ke server. El ejemplo al entrar menampilkan hasil nyata saat masuk. un resultado real Menampilkan proses, langkah, dan contoh di halaman.',
  ...
  tool_open_pdf_in_browser_description:
    'Buka PDF di browser. Berkas tetap di perangkat; tanpa unggah ke server. El ejemplo al entrar menampilkan hasil nyata saat masuk. un resultado real Menampilkan proses, langkah, dan contoh di halaman.',
  ...
  tool_print_pdf_description:
    'Cetak PDF. Berkas tetap di perangkat; tanpa unggah ke server. El ejemplo al entrar menampilkan hasil nyata saat masuk. un resultado real Menampilkan proses, langkah, dan contoh di halaman.',
  ...
  tool_turn_pdf_into_editable_document_faq_a2:
    'Halaman ini membuka salinan yang bisa diedit dari lapisan teks. Edit teks PDF secara daring mengubah kata dengan tombol utama yang berbeda.',
  ...
  tool_turn_pdf_into_editable_document_title: 'Ubah PDF jadi dokumen yang bisa diedit',
  ...
  tool_write_pdf_document_online_description:
    'Tulis dokumen PDF online. Berkas tetap di perangkat; tanpa unggah ke server. El ejemplo al entrar menampilkan hasil nyata saat masuk. un resultado real Menampilkan proses, langkah, dan contoh di halaman.',
