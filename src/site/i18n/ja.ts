...
const ja: SiteLangDict = {
  ...
  tool_add_text_to_pdf_file_description:
    'PDF にテキストを追加. ファイルは端末内に留まり、サーバーにアップロードしません。 El ejemplo al entrar 入場時のサンプルで実結果を表示。 un resultado real このページではプロセス、手順、例を示します。',
  ...
  tool_check_pdf_a_compliance_description:
    'PDF/A 準拠を確認. ファイルは端末内に留まり、サーバーにアップロードしません。 El ejemplo al entrar 入場時のサンプルで実結果を表示。 un resultado real このページではプロセス、手順、例を示します。',
  ...
  tool_combine_files_into_one_pdf_description:
    'ファイルを1つの PDF に結合. ファイルは端末内に留まり、サーバーにアップロードしません。 El ejemplo al entrar 入場時のサンプルで実結果を表示。 un resultado real このページではプロセス、手順、例を示します。',
  ...
  tool_combine_files_into_one_pdf_how_item_2: 'メインボタンで実行',
  ...
  tool_compare_two_pdfs_description:
    '2 つの PDF を比較. ファイルは端末内に留まり、サーバーにアップロードしません。 El ejemplo al entrar 入場時のサンプルで実結果を表示。 un resultado real このページではプロセス、手順、例を示します。',
  ...
  tool_convert_html_to_pdf_description:
    'HTML を PDF に変換. ファイルは端末内に留まり、サーバーにアップロードしません。 El ejemplo al entrar 入場時のサンプルで実結果を表示。 un resultado real このページではプロセス、手順、例を示します。',
  ...
  tool_extract_text_from_pdf_description:
    'PDF からテキストを抽出. ファイルは端末内に留まり、サーバーにアップロードしません。 El ejemplo al entrar 入場時のサンプルで実結果を表示。 un resultado real このページではプロセス、手順、例を示します。',
  ...
  tool_extract_text_from_pdf_how_item_2: 'メインボタンで実行',
  ...
  tool_make_pdf_flipbook_description:
    'PDF フリップブックを作成. ファイルは端末内に留まり、サーバーにアップロードしません。 El ejemplo al entrar 入場時のサンプルで実結果を表示。 un resultado real このページではプロセス、手順、例を示します。',
  ...
  tool_open_pdf_in_browser_description:
    'ブラウザで PDF を開く. ファイルは端末内に留まり、サーバーにアップロードしません。 El ejemplo al entrar 入場時のサンプルで実結果を表示。 un resultado real このページではプロセス、手順、例を示します。',
  ...
  tool_print_pdf_description:
    'PDF を印刷. ファイルは端末内に留まり、サーバーにアップロードしません。 El ejemplo al entrar 入場時のサンプルで実結果を表示。 un resultado real このページではプロセス、手順、例を示します。 このページではプロセス、手順、例を示します。',
  ...
  tool_print_pdf_how_item_2: 'メインボタンで実行',
  ...
  tool_turn_pdf_into_editable_document_faq_a2: 'いいえ。処理はこのタブ内です。ファイルは当サイトのサーバーに上がりません。',
  ...
  tool_turn_pdf_into_editable_document_title: 'PDFを編集できる文書にする',
  ...
  tool_write_pdf_document_online_description:
    'オンラインで PDF 文書を作成. ファイルは端末内に留まり、サーバーにアップロードしません。 El ejemplo al entrar 入場時のサンプルで実結果を表示。 un resultado real このページではプロセス、手順、例を示します。',
