...
const ja: SiteLangDict = {
  ...
  tool_batch_checksum_release_files_rules_item_1: 'SHA-256 は常に走る。MD5 は任意で、CDN から crypto-js を遅延読み込みする。バイトはタブ内。',
  ...
  tool_batch_watermark_product_photos_faq_a1: '送りません。読み取りと Canvas の透かしはこのタブ内です。ファイルは端末に留まり、サーバーにアップロードしません。ZIP 用スクリプトが CDN から来ることはありますが、写真はタブを出ません。',
  ...
  tool_bulk_compress_png_images_faq_a1: 'いいえ。読み取りと PNG 書き出しはこのタブ内です。ファイルは端末に残り、サーバーにアップロードしません。ZIP 用スクリプトが CDN から来ることはありますが、画像はタブを出ません。',
  ...
  tool_bulk_compress_product_photos_faq_a1: 'いいえ。復号と再エンコードはこのタブ内です。ファイルは端末に留まり、サーバーにはアップロードしません。ZIP 用スクリプトが CDN から来ることはありますが、写真自体は送りません。',
  ...
  tool_bulk_convert_images_to_jpg_faq_a1: '送りません。読み取りと .jpg 書き出しはこのタブ内です。ファイルは端末に留まり、サーバーにアップロードしません。ZIP 用スクリプトが CDN から来ることはありますが、画像はタブを出ません。',
  ...
  tool_bulk_convert_images_to_png_faq_a1: '送りません。読み取りと PNG 書き出しはこのタブ内です。ファイルは端末に留まり、サーバーにアップロードしません。ZIP 用スクリプトが CDN から来ることはありますが、画像はタブを出ません。',
  ...
  tool_bulk_convert_images_to_webp_faq_a1: '送りません。読み取りと WebP 書き出しはこのタブ内です。ファイルは端末に留まり、サーバーにアップロードしません。ZIP 用スクリプトが CDN から来ることはありますが、画像はタブを出ません。',
  ...
  tool_combine_files_into_one_pdf_faq_a1: 'いいえ。レンダリングはタブ内で行われます（ライブラリは CDN から読み込まれる場合があります）。PDF は当社サーバーに送られません。',
  ...
  tool_convert_html_to_pdf_description:
    'HTML を PDF に変換. ファイルは端末内に留まり、サーバーにアップロードしません。 サンプルで実際の入力と出力を確認でき、手順と制限は本文で説明します。 手順は HTML を貼り付け、スクリプトや危険な属性を除去したプレビューを確認し、A4 PDF を出力します。例は見出しと段落です。複雑な印刷 CSS、外部フォント、クロスオリジン画像は完全に再現できない場合があり、URL 取得機能はありません。',
  ...
  tool_make_pdf_flipbook_description:
    'PDF フリップブックを作成. ファイルは端末内に留まり、サーバーにアップロードしません。 サンプルで実際の入力と出力を確認でき、手順と制限は本文で説明します。 手順は PDF を選び、前へ・次へで短いページめくり表示を確認し、PDF を内蔵した単体 HTML を保存します。例は1ページの flipbook です。出力 HTML は開くときに PDF.js を CDN から読むためネット接続が必要ですが、文書は当サイトへ送信しません。',
  ...
  tool_print_pdf_faq_a1: 'いいえ。レンダリングはタブ内で行われます（ライブラリは CDN から読み込まれる場合があります）。PDF は当社サーバーに送られません。',
