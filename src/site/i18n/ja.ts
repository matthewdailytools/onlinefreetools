...
const ja: SiteLangDict = {
  ...
  tool_convert_an_m4a_file_to_mp3_desc: 'M4AまたはAACの録音をMP3にします。ファイルは端末に残り、サーバーへアップロードしません。',
  tool_convert_an_m4a_file_to_mp3_description: 'ブラウザでM4AファイルをMP3に変換します。M4AまたはAACを選び、変換、試聴、ダウンロードします。ファイルは端末内に留まり、サーバーへ送信しません。',
