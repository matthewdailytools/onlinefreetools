...
const ja: SiteLangDict = {
  ...
  tool_text_diff_title: 'テキスト比較ツール — 2つの文章の差分を確認',
  ...
  tool_text_diff_example:
    '例（単語モード）: A = "Hello world", B = "Hello there" → 変更は1か所（world → there）。3行のうち真ん中だけ変えた場合、行モードではその行だけがマークされます。',
  ...
  tool_text_diff_how_body:
    '2つの版を貼り付け、行・単語・文字のどれで見るかを選び、緑の追加と赤の削除を確認します。比較はブラウザ内だけで行い、入力内容は保存しません。',
  ...
  tool_text_diff_faq_a2: 'いいえ。ブラウザ内だけで比較します。タブを閉じれば消えます。保存もしません。',
