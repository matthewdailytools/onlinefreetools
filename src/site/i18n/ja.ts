...
const ja: SiteLangDict = {
  ...
  tool_sketch_prompt_generator_desc: 'Sketch.appプロンプトジェネレーター — 既定はローカル、任意で Cloudflare AI の Expand/Polish（Turnstile）。Markdown/JSON は端末内。',
  ...
  tool_sketch_prompt_generator_faq_a8: 'ローカルはタブ内整形のみ（非アップロード）。任意 Expand/Polish は Cloudflare Workers AI（Turnstile・上限）。失敗時はローカルを継続。',
