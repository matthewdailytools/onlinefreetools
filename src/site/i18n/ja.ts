...
const ja: SiteLangDict = {
  ...
  tool_convert_html_web_pages_to_word_document_how_item_3: 'HTML 内の <img> も入れたい場合は詳細設定を開きます。埋め込みは既定オンで、ブロックされた画像はスキップします。',
  ...
  tool_convert_html_web_pages_to_word_document_opts_hint: '「画像を含める」は HTML の絵を埋め込もうとします。CSS の配置はマップしません。出力は常に1つの .docx です。',
  ...
  tool_convert_html_web_pages_to_word_document_rules_item_2: 'h1–h6 は Word 見出し。ul/ol はリスト。table は表。a はハイパーリンク。',
