...
const ja: SiteLangDict = {
  ...
  note_title: '注意',
  pdf_work_next: '次へ',
  pdf_work_page: '{n} / {total} ページ',
  pdf_work_prev: '前へ',
  pdf_work_preview: 'PDFプレビュー',
  pdf_work_progress: '進捗',
  result_title: '結果',
  sqft_unit: 'sq ft',
  status_label: 'ステータス',
  theme_amber: 'アンバー',
  ...
  tool_add_digital_signature_to_pdf_description:
    'ブラウザで PDF にデジタル署名の見た目を付けます。ファイルの SHA-256 を計算し、時刻とハッシュ接頭辞の「デジタル標記済み」枠を押して保存します。端末内で処理し、サーバーにアップロードしません。入場時のサンプルでプロセスと手順の例が動きます。完全性の見た目であり、証明書 PKI 署名ではありません。',
  ...
  tool_add_text_to_pdf_file_description:
    'PDF にテキストを追加. ファイルは端末内に留まり、サーバーにアップロードしません。 サンプルで実際の入力と出力を確認でき、手順と制限は本文で説明します。 手順は PDF を選び、文字、X/Y 座標、文字サイズを設定してからプレビューとダウンロードを行います。例では全ページの指定位置に「CONFIDENTIAL」を追加します。既存文字の検索・置換や OCR は行わず、スキャンページにも新しい文字を重ねられます。',
  ...
  tool_android_prompt_builder_ai_consent_title: '下書きを Cloudflare Workers AI に送りますか？',
  tool_android_prompt_builder_ai_done: 'AI の文章で結果欄を置き換えました。コピー前に確認してください。',
  tool_android_prompt_builder_ai_err_generic: 'AI に失敗しました。結果欄は変わっていません。',
  tool_android_prompt_builder_ai_err_rate: 'AI の利用上限に達しました。ローカル生成を使うか、翌日（UTC）に再試行してください。',
  tool_android_prompt_builder_ai_err_turnstile: 'AI を使う前に Turnstile を通してください。',
  tool_android_prompt_builder_ai_expand: 'AI で拡張',
  tool_android_prompt_builder_ai_panel_label: '任意の Cloudflare AI（Turnstile）',
  tool_android_prompt_builder_ai_polish: 'AI で仕上げ',
  tool_android_prompt_builder_ai_working: 'Cloudflare AI が処理中…',
  ...
  tool_android_prompt_builder_build: 'プロンプトを作成',
  tool_android_prompt_builder_clear: 'クリア',
  tool_android_prompt_builder_compose_ui_label: 'Compose / 画面',
  tool_android_prompt_builder_compose_ui_ph: '例：日付固定ヘッダー付き LazyColumn…',
  ...
  tool_android_prompt_builder_empty: '少なくとも 1 つの項目を入力してください。',
  ...
  tool_android_prompt_builder_example_title: '入出力の例',
  ...
  tool_android_prompt_builder_faq_a4: '必要です。「AI で拡張」「AI で仕上げ」の前に、AI パネルの Turnstile を通してください。有効なトークンがないとボタンはエラーを返しますが、ローカル生成はそのまま使えます。',
  tool_android_prompt_builder_faq_a5: 'できます。出力形式を JSON にすると、各項目の原文と組み立て済みのプロンプト本文が同時に出力され、テストや設定パイプラインに流し込めます。',
  tool_android_prompt_builder_faq_a6: '使えます。出力はプレーンテキストなので、コピーして ChatGPT・Gemini・Claude・DeepSeek の入力欄に貼るだけです。このページが代わりに API を呼ぶことはありません。',
  ...
  tool_android_prompt_builder_faq_q1: '入力した内容はアップロードされますか？',
  tool_android_prompt_builder_faq_q2: 'ChatGPT などのモデル API を呼び出しますか？',
  tool_android_prompt_builder_faq_q3: 'プロンプトテンプレート作成ツールとの違いは？',
  tool_android_prompt_builder_faq_q4: '任意の AI に Turnstile が必要な理由は？',
  tool_android_prompt_builder_faq_q5: 'JSON で書き出せますか？',
  tool_android_prompt_builder_faq_q6: 'ChatGPT・Gemini・Claude・DeepSeek で使えますか？',
  tool_android_prompt_builder_faq_q7: 'ローカル生成と任意の Cloudflare AI はどう違いますか？',
  tool_android_prompt_builder_feature_spec_label: '機能 / 仕様',
  tool_android_prompt_builder_feature_spec_ph: '例：オフライン閲覧リスト＋全文検索…',
  ...
  tool_android_prompt_builder_gradle_constraints_label: 'Gradle / 制約',
  tool_android_prompt_builder_gradle_constraints_ph: '例：minSdk 26、targetSdk 35、:core:data 分離…',
  ...
  tool_android_prompt_builder_how_item_1: '「見本を読み込む」を押すと既定の入力が入り、プロンプトが 1 本できます。そこから書き換えてください。',
  tool_android_prompt_builder_how_item_2: '機能・Kotlin スタック・Compose・Gradle を書き換えて「プロンプトを作成」を押します。構造化して渡すなら JSON に切り替えます。',
  tool_android_prompt_builder_how_item_3: '任意：Turnstile を通してから「AI で拡張」または「AI で仕上げ」を押すと、返ってきた文章が結果欄を置き換えます。',
  tool_android_prompt_builder_how_item_4: '結果をコピーまたはダウンロードし、ChatGPT・Gemini・Claude・DeepSeek に貼って質問します。',
  tool_android_prompt_builder_how_title: '使い方',
  tool_android_prompt_builder_kotlin_stack_label: 'Kotlin / 技術スタック',
  tool_android_prompt_builder_kotlin_stack_ph: '例：Kotlin 2.0、Jetpack Compose、Room、Hilt…',
  tool_android_prompt_builder_load_sample: '見本を読み込む',
  tool_android_prompt_builder_platforms_lead: '出力はプレーンテキストなので、ChatGPT・Gemini・Claude・DeepSeek のどれにでもそのまま貼れます。',
  tool_android_prompt_builder_result_label: 'プロンプト出力',
  tool_android_prompt_builder_rules_body: 'このページは依頼文を整えるだけで、コードのコンパイルも Gradle の実行もしません。任意の AI には利用上限があり、Turnstile の通過が必要です。',
  tool_android_prompt_builder_rules_item_1: '4 つの項目は Markdown の Role・Task・Constraints・Output に分かれて入ります。',
  tool_android_prompt_builder_rules_item_2: '既定の出力は Markdown。同じ結果欄で JSON に切り替えると、項目の原文と完成した本文が並びます。',
  tool_android_prompt_builder_rules_item_3: '任意の Cloudflare AI はローカル生成の代わりではありません。返答は結果欄を丸ごと置き換えるので、コピー前に確認してください。',
  tool_android_prompt_builder_rules_item_4: 'このツールは文章を組み立てるだけで、Kotlin のビルドや Gradle の実行、チャット API の代理呼び出しはしません。',
  tool_android_prompt_builder_rules_title: '知っておきたい制限',
  ...
  tool_android_prompt_builder_status_done: 'プロンプトができました。',
  tool_android_prompt_builder_status_working: 'プロンプトを組み立て中…',
  tool_android_prompt_builder_title: 'Android プロンプト生成ツール — ブラウザ内で作成、AI 拡張は任意',
  tool_android_prompt_builder_usecase_1: 'スプリント会議で口頭に出た Android の要件を、チャットに貼れるプロンプトとしてまとめる。',
  tool_android_prompt_builder_usecase_2: 'JSON で書き出して回帰テストや設定パイプラインに項目を渡し、必要なら Cloudflare AI で拡張する。',
  tool_android_prompt_builder_usecase_3: 'Android 固有の項目が不要で汎用の 4 ブロックで足りるときは、プロンプトテンプレート作成ツールに切り替える。',
  tool_android_prompt_builder_usecase_4: '社内向けの機能説明をまずブラウザ内で仕上げ、外に出せると判断してから任意の AI を使う。',
  tool_android_prompt_builder_usecases_title: 'こんなときに',
  ...
  tool_archive_extractor_faq_a1: 'いいえ。アーカイブはブラウザタブ内で読み込まれ、展開されたデータも端末内に残ります。補助スクリプトはこのサイトから読みますが、あなたのファイルは当サイトのサーバーへアップロードされません。',
  ...
  tool_base64_how_item_1: '「エンコード」か「デコード」を選びます。',
  tool_base64_how_item_2: 'エンコードはテキストを貼るかファイルを選び、デコードは Base64 を貼ります。',
  tool_base64_how_item_3: 'JWT 形式の - と _（padding なし）が必要なら Base64url をオンにします。',
  tool_base64_how_item_4: '「変換」を押し、結果をコピーまたはダウンロードします。',
  ...
  tool_batch_checksum_release_files_example: 'サンプル読込は小さなバイナリ 2 件をハッシュし、SHA-256 行を埋め、先頭ファイルの SUMS 行を貼って一致を出し、CSV と SUMS を有効にします。',
  ...
  tool_batch_checksum_release_files_faq_a2: 'しません。書き出しは CSV の表と SHA256SUMS テキストです。バイナリを固めるのは ZIP 作成で、別作業です。',
  tool_batch_checksum_release_files_faq_a3: 'ファイルハッシュは 1 件または貼り付け向け。このページはリリース一式をハッシュし、貼った SHA256SUMS と照合し、CSV と SUMS を出します。',
  tool_batch_checksum_release_files_faq_a4: '「MD5 も計算」をオン。SHA-256 は常に実行。MD5 は古いリスト用で、別 URL はありません。',
  tool_batch_checksum_release_files_faq_a5: 'パス列は webkitRelativePath を優先。キュー内の同名は接尾辞を付け、SUMS 行がぶつからないようにします。',
  ...
  tool_batch_checksum_release_files_how_body: 'リリース資産を入れ、SHA-256 でそれぞれハッシュし、SHA256SUMS があれば貼って照合し、CSV または SUMS を書き出す。ファイルの ZIP ではない。',
  ...
  tool_batch_checksum_release_files_rules_body: 'SHA-256 は 4 MiB スライスで読んだバイトを結合して Web Crypto で計算する。出力は表と CSV と SUMS であり、原ファイルの ZIP ではない。',
  tool_batch_checksum_release_files_rules_item_1: 'SHA-256 は常に走る。MD5 は任意で、このサイトから crypto-js を遅延読み込みする。バイトはタブ内。',
  tool_batch_checksum_release_files_rules_item_2: 'SUMS 行は GNU sha256sum：16 進、空白 2 つか空白+星、その後に名前。貼り付けの余剰名は欠損。',
  tool_batch_checksum_release_files_rules_item_3: '読み取り失敗はその行をスキップ。キュー内の重複名は接尾辞。空キューでは書き出せない。',
  tool_batch_checksum_release_files_rules_item_4: 'ファイルは端末内に留まり、サーバーにアップロードしない。',
  ...
  tool_batch_compress_pdfs_for_email_example: 'サンプル読込は画像ページ付きの短い PDF を 2 件作り、メール用でそれぞれ圧縮し、ZIP 内は 2 件のまま節約バイトを出します。',
  ...
  tool_batch_compress_pdfs_for_email_faq_a2: 'しません。手に入るのは N 件の PDF の ZIP です。1 冊にまとめるのは PDF 結合で、別作業です。',
  tool_batch_compress_pdfs_for_email_faq_a3: '写真のスキャンは小さくなりやすいです。文字だけの PDF はほとんど動かないことがあります。表に前後サイズが出ます。',
  tool_batch_compress_pdfs_for_email_faq_a4: 'PDF 圧縮は 1 件向け。このページは束で同じメール用を共有し、成功分を ZIP に入れます。',
  tool_batch_compress_pdfs_for_email_faq_a5: 'その行だけ飛ばし、残りは続けます。別途ロックを外してから入れ直してください。',
  ...
  tool_batch_compress_pdfs_for_email_how_body: '添付の束を入れ、メール用を選び、それぞれ圧縮し、成功した PDF の ZIP を取る。',
  ...
  tool_batch_compress_pdfs_for_email_rules_body: '各 PDF は JPEG ページにラスタして再構築する。出力は常に別々の PDF の ZIP。',
  tool_batch_compress_pdfs_for_email_rules_item_1: 'メール用が初期値：拡大率およそ 1.0、JPEG 品質およそ 0.55。印刷用は弱め。最大限はさらに小さくする。',
  tool_batch_compress_pdfs_for_email_rules_item_2: '暗号化、破損、メモリ不足はその行だけスキップ。ZIP 内の重複名は 名前 (2).pdf になる。',
  tool_batch_compress_pdfs_for_email_rules_item_3: '文字だけのファイルはほとんど小さくならないことがある。想定どおりで、表にはサイズが出る。',
  tool_batch_compress_pdfs_for_email_rules_item_4: 'ファイルは端末内に留まり、サーバーにアップロードしない。',
  ...
  tool_batch_convert_jpg_to_editable_word_with_ocr_desc: '複数のJPGをOCRでまとめて編集できるWordにする：並べてすべて変換し、Wordをダウンロード。処理は端末内で、サーバーへは上がりません。',
  ...
  tool_batch_convert_jpg_to_editable_word_with_ocr_err_empty: '活字が見つかりませんでした。スキップしました。手書きではなく、はっきりした印刷ページを試してください。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_err_engine: 'OCRエンジンを読み込めませんでした。再読み込みしてからすべて変換を押してください。済んだ節はダウンロードできます。',
  ...
  tool_batch_convert_jpg_to_editable_word_with_ocr_faq_a1: '上がりません。写真はこのブラウザのタブに留まります。エンジンとWord用スクリプトはこのサイトから読み込み、ファイルは当社サーバーへ送りません。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_faq_a2: '「複数のJPGをOCRでまとめてテキストにする」はTXTのZIPです。こちらは写真ごとに節のある、編集できるWordを1つ作ります。エンジンは同じでも仕事が違います。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_faq_a3: '「画像をWordに」は写真を図として貼るだけなので文字を選べません。ここではOCRが段落を書くので編集できます。元画像は照合用の任意項目です。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_faq_a4: 'なりません。失敗した1枚はスキップし、残りは同じWordに入ります。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_faq_a5: '成功した写真ごとに1節です。見出しはファイル名、そのあと任意の元画像、OCRの段落、改ページです。段組や表は元のレイアウトどおりにはなりません。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_faq_a6: 'できません。このページはPDFを受けません。スキャンPDFは「スキャンしたPDFをOCRでまとめてWordにする」へ。文字レイヤー付きのデジタルPDFは「PDF を Word 文書にする」へ。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_faq_a7: '活字が向いています。崩した手書きはその行で失敗しがちです。手書き専用の製品ではありません。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_faq_a8: 'できます。JPEG・PNG・WebPは同じ待ち列です。1枚だけでもダウンロードはWordであり、TXTではありません。1枚の文字起こしは「OCRでJPGを文字にする」を使ってください。',
  ...
  tool_batch_convert_jpg_to_editable_word_with_ocr_how_body: '印刷写真の束を、編集できるWord 1つにします。画像を追加し、すべて変換（初回クリックでこのタブにエンジンを読み込み、一枚ずつ読む）のあと、Wordをダウンロードします。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_how_item_1: 'JPG・PNG・WebPを複数ドロップ（またはファイルを選択）。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_how_item_2: '任意：バッチ全体の言語チップを選ぶ（初期値は中国語＋英語）。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_how_item_3: '「すべて変換」を押すと、初回はこのタブでOCRエンジンを読み込み、その後一枚ずつ読みます。失敗した写真はスキップします。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_how_item_4: '「Wordをダウンロード」で、写真ごとに節のある文書（見出し、任意の画像、編集できる本文）を得ます。',
  ...
  tool_batch_convert_jpg_to_editable_word_with_ocr_photo_hint: '初期値はオン。各節でOCR段落の上に写真を置き、Word上で照合できます。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_photo_label: '本文の上に元の写真を入れる',
  tool_batch_convert_jpg_to_editable_word_with_ocr_rules_body: '待ち列は最大10枚。最長辺が上限を超えると縮小してから、見た目の順に読みます。OCRワーカーは1つ、直列です。失敗行はスキップし、成功行だけが1つのWordの節になります。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_rules_item_1: '成功した写真はWordの1節です。見出し1はファイル名、そのあと任意の画像、OCR段落、改ページ。これは束のJPGをOCRでWordにするもので、TXTのZIPではありません。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_rules_item_2: 'ファイルは端末に留まり、サーバーへは上がりません。スクリプトはこのサイトから読み込みます。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_rules_item_3: '手書き、強いボケ、強いパースはその行で失敗しやすいです。表は読み順の行になります。段組は元ページどおりになりません。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_rules_item_4: 'PDFは受けません。TXTのZIPは「複数のJPGをOCRでまとめてテキストにする」。OCRなしの貼り付けは「画像をWordに」。',
  ...
  tool_batch_convert_jpg_to_editable_word_with_ocr_usecase_1: '配布資料を連続撮影し、1つのWordをダウンロードして見出しを直す。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_usecase_2: 'メニュー写真を、照合用の画像付きOCR節が並ぶ1文書にする。',
  tool_batch_convert_jpg_to_editable_word_with_ocr_usecase_3: 'エラー画面のスクリーンショットを編集できるWordにまとめて同僚へ送る。',
  ...
  tool_batch_convert_jpg_to_text_with_ocr_combined_hint: '初期値はオン。ZIP に combined.txt が入り、各写真の間は --- ファイル名 --- です。',
  ...
  tool_batch_convert_jpg_to_text_with_ocr_desc: '複数のJPGをOCRでまとめてテキストにし、ZIP で保存。端末内で処理し、サーバーにアップロードしません。',
  ...
  tool_batch_convert_jpg_to_text_with_ocr_err_empty: '活字が見つかりません。スキップしました。手書きではなく、はっきりした印刷を試してください。',
  tool_batch_convert_jpg_to_text_with_ocr_err_engine: 'OCRエンジンを読み込めませんでした。更新して「すべて変換」を再実行。完了行はダウンロードできます。',
  ...
  tool_batch_convert_jpg_to_text_with_ocr_faq_a1: 'いいえ。写真はこのタブに留まります。エンジンと ZIP のスクリプトは本サイトから読みます。サーバーには上げません。',
  tool_batch_convert_jpg_to_text_with_ocr_faq_a2: '1枚用のページはコピーと単一 TXT です。こちらはキューです。すべて変換、失敗行スキップ、ZIP。エンジンは同じでも作業が違います。',
  tool_batch_convert_jpg_to_text_with_ocr_faq_a3: 'いいえ。その1枚をスキップして残りを続けます。成功分は ZIP に入ります。',
  tool_batch_convert_jpg_to_text_with_ocr_faq_a4: '元の名前の TXT が1枚ずつ（重複は stem (2).txt）。初期状態で combined.txt があり、--- ファイル名 --- で区切ります。',
  tool_batch_convert_jpg_to_text_with_ocr_faq_a5: '1枚なら「JPGをOCRでテキストにする」へ。ここでも1枚は置けますが、ボタンはすべて変換と ZIP です。',
  tool_batch_convert_jpg_to_text_with_ocr_faq_a6: 'はい。JPEG・PNG・WebP は同じ列です。複数画像の文字起こしを別 URL に分けません。',
  tool_batch_convert_jpg_to_text_with_ocr_faq_a7: '活字向きです。手書きや縦書きは失敗しやすく、その行はスキップします。スキャン業者向けではありません。日本語は大きめのモデルが必要なことがあります。',
  tool_batch_convert_jpg_to_text_with_ocr_faq_a8: 'PDF は不可。表計算も出しません。編集できる OCR の Word は「複数のJPGをOCRでまとめて編集できるWordにする」。文字レイヤー付き PDF は「PDFからテキストを抽出」。',
  ...
  tool_batch_convert_jpg_to_text_with_ocr_how_body: '印刷写真の束をテキストの ZIP にします。画像を追加し、すべて変換（初回でエンジンを読み、1枚ずつ認識）したあと、ZIPをダウンロードするか結合テキストをコピーします。',
  ...
  tool_batch_convert_jpg_to_text_with_ocr_how_item_3: '「すべて変換」を押すと、初回はこのタブで OCR エンジンを読み、1枚ずつ読みます。失敗した写真はスキップします。',
  tool_batch_convert_jpg_to_text_with_ocr_how_item_4: '「ZIPをダウンロード」（写真ごとの TXT と結合ファイル）または「結合テキストをコピー」。',
  ...
  tool_batch_convert_jpg_to_text_with_ocr_rules_body: '最大10枚。長辺が上限を超えると縮小してから、表示順に読みます。OCR ワーカーは1つを直列再利用。失敗行はスキップし、成功分を ZIP にします。',
  tool_batch_convert_jpg_to_text_with_ocr_rules_item_1: 'ZIP 名は元ファイルに合わせます。combined.txt（初期オン）は --- ファイル名 --- で区切り、連続撮影を1本の文書にします。',
  tool_batch_convert_jpg_to_text_with_ocr_rules_item_2: 'ファイルは端末に留まり、サーバーにアップロードしません。スクリプトは本サイトから読みます。',
  tool_batch_convert_jpg_to_text_with_ocr_rules_item_3: '手書き・強いボケ・大きな遠近は失敗しやすいです。表は読み順の行になり、CSV ではありません。',
  tool_batch_convert_jpg_to_text_with_ocr_rules_item_4: 'PDF・Word・検索可能PDF・表計算は対象外。1枚をコピーする作業は「JPGをOCRでテキストにする」へ。',
  ...
  tool_batch_convert_scanned_pdf_to_word_with_ocr_desc: 'スキャンしたPDFをOCRでまとめてWordにする：並べてすべて変換し、Wordをダウンロード。処理は端末内、サーバーへは上がりません。',
  ...
  tool_batch_convert_scanned_pdf_to_word_with_ocr_err_empty: '活字が見つかりませんでした。スキップしました。手書きではなく、はっきりした印刷スキャンを試してください。',
  tool_batch_convert_scanned_pdf_to_word_with_ocr_err_encrypted: 'そのPDFはパスワード付きです。追加していません。',
  tool_batch_convert_scanned_pdf_to_word_with_ocr_err_engine: 'PDFの描画またはOCRエンジンを読み込めませんでした。再読み込みしてからすべて変換を押してください。済んだページはダウンロードできます。',
  tool_batch_convert_scanned_pdf_to_word_with_ocr_err_fflate: 'このブラウザではZIPを組み立てられません。新しいブラウザで試してください。',
  tool_batch_convert_scanned_pdf_to_word_with_ocr_err_image: 'ここはスキャンPDF用で、写真は受けません。JPG・PNG・WebPは「複数のJPGをOCRでまとめて編集できるWordにする」へ。そのファイルは追加していません。',
  ...
  tool_batch_convert_scanned_pdf_to_word_with_ocr_faq_a1: '上がりません。PDFはこのブラウザのタブに留まります。描画・OCR・Word組み立てのスクリプトはこのサイトから読み込み、ファイルは当社サーバーへ送りません。',
  ...
  tool_batch_convert_scanned_pdf_to_word_with_ocr_faq_a2: '「PDF を Word 文書にする」は既存の文字レイヤーを写すだけで、OCRしません。こちらは各ページを絵にしてから読むので、選べないスキャンでも段落になります。すでに単語を選べるなら、そちらへ。',
  tool_batch_convert_scanned_pdf_to_word_with_ocr_faq_a3: '「複数のJPGをOCRでまとめて編集できるWordにする」は写真の列です。ここはPDFだけ。JPGを落とすと意図的に拒否します。',
  tool_batch_convert_scanned_pdf_to_word_with_ocr_faq_a4: 'なりません。失敗した1ページはスキップし、ほかのページとほかのPDFは同じWordに残ります。',
  ...
  tool_batch_convert_scanned_pdf_to_word_with_ocr_faq_a6: 'できません。写真は「複数のJPGをOCRでまとめて編集できるWordにする」へ。ここのドロップはPDF専用です。',
  tool_batch_convert_scanned_pdf_to_word_with_ocr_faq_a7: '活字がいちばん安定します。連筆の手書きは、そのページで失敗しがちです。手書き専用ではありません。',
  ...
  tool_batch_convert_scanned_pdf_to_word_with_ocr_faq_a9: 'PDFは最大5件、各12MB、まとめて20ページまで。1件だけでもすべて変換→Wordをダウンロードです。単ファイル用の別URLはありません。',
  ...
  tool_batch_convert_scanned_pdf_to_word_with_ocr_how_body: '紙のスキャンを、編集できるWord 1つにします。PDFを入れてすべて変換（初回クリックでこのタブに描画とOCRを読み込み、1ページずつ読む）し、Wordをダウンロードします。',
  ...
  tool_batch_convert_scanned_pdf_to_word_with_ocr_how_item_3: '任意：バッチ全体でWord 1つのままにするか、PDFごとにWord 1つにする（複数成功時はZIPをダウンロード）。',
  tool_batch_convert_scanned_pdf_to_word_with_ocr_how_item_4: '「すべて変換」を押す — 初回はこのタブでPDF描画とOCRエンジンを読み込み、そのあと1ページずつ読みます。失敗したページはスキップします。',
  tool_batch_convert_scanned_pdf_to_word_with_ocr_how_item_5: '「Wordをダウンロード」を押す — PDFごとに分けて2件以上成功した場合は「ZIPをダウンロード」になります。',
  ...
  tool_batch_convert_scanned_pdf_to_word_with_ocr_output_hint: '初期値はWord 1つ。PDFごとに分ける場合：成功1件ならWordをダウンロード、複数成功ならZIPをダウンロード。',
  ...
  tool_batch_convert_scanned_pdf_to_word_with_ocr_page_hint: '初期値オン。Wordの各ページで、OCR段落の上にスキャン画像を出して照合できます。',
  ...
  tool_batch_convert_scanned_pdf_to_word_with_ocr_rules_item_2: 'ファイルは端末に留まり、サーバーへは上がりません。スクリプトはこのサイトから読み込みます。',
  ...
  tool_batch_convert_scanned_pdf_to_word_with_ocr_rules_item_4: '写真入力はありません。JPGの束は「複数のJPGをOCRでまとめて編集できるWordにする」。検索可能なPDFは書きません。TXTもダウンロードしません。',
  ...
  tool_batch_convert_scanned_pdf_to_word_with_ocr_usecase_1: '講義のスキャンPDFを入れて、見出しを直せるWordを1つダウンロードする。',
  tool_batch_convert_scanned_pdf_to_word_with_ocr_usecase_2: '契約書のスキャン2件を、ページ画像つきの照合用Wordにまとめる。',
  tool_batch_convert_scanned_pdf_to_word_with_ocr_usecase_3: '複数ページの請求スキャンを、同僚が直せるWordにする（請求項目の抽出はしません）。',
  ...
  tool_batch_convert_web_pages_to_excel_desc: 'URL リストの HTML 表を 1 つの Excel にする。スクショでも PDF でも Word でもない。',
  ...
  tool_batch_convert_web_pages_to_excel_faq_a1: '貼った HTML はこのタブから出ません。URL を変換する場合、各アドレスを一度だけサーバーへ送って HTML を取得し、保存しません。.xlsx はブラウザ内で作ります。',
  tool_batch_convert_web_pages_to_excel_faq_a2: 'Word 側は見出し・リスト・段落を直せる .docx にします。こちらは本文を無視し、HTML 表のセルだけ Excel シートにします。取得は同じでも成果物が違います。',
  ...
  tool_batch_convert_web_pages_to_excel_faq_a4: 'できます。1 行でウェブページを Excel にできます。成功した URL は複数シートの 1 つの .xlsx に入ります。',
  tool_batch_convert_web_pages_to_excel_faq_a5: 'できません。OCR も PDF 解析もありません。HTML ページを変換するか、表のマークアップを貼ってください。既に CSV なら CSV ↔ JSON。',
  ...
  tool_batch_convert_web_pages_to_excel_how_body: 'HTML 表がある公開 URL を貼り、「すべて変換」のあと Excel を 1 冊ダウンロードします。本文は飛ばし、<table> のセルだけシートになります。',
  tool_batch_convert_web_pages_to_excel_how_item_1: '1 行に https の URL を 1 件（価格表や公開 HTML 表向き）。ウェブページを Excel にするなら 1 行で足ります。',
  tool_batch_convert_web_pages_to_excel_how_item_2: '「すべて変換」を押します。各公開 URL は一度取得し、使える表がない行はスキップ、残りは続きます。',
  tool_batch_convert_web_pages_to_excel_how_item_3: 'URL がなくマークアップだけ（HTMLをExcelに / HTMLテーブルをExcelに）なら「HTMLを貼る」に切って貼り、「すべて変換」。',
  tool_batch_convert_web_pages_to_excel_how_item_4: '表ごとではなく URL ごとに 1 シートにしたい、または小さいナビ表も残したいときは詳細設定。',
  tool_batch_convert_web_pages_to_excel_how_item_5: 'A4 印刷は「ウェブページをまとめて PDF にする」。見出しは「HTMLのウェブページをWord文書にする」。既に CSV なら CSV ↔ JSON。',
  ...
  tool_batch_convert_web_pages_to_excel_rules_item_1: '各 URL は HTML 取得のため一度だけ送り、保存しません。貼った HTML はタブ内に留まります。ブックはこの場で作ります。',
  tool_batch_convert_web_pages_to_excel_rules_item_2: '社内ネット、ログイン壁、<table> がないページはその行が失敗し、残りは続きます。',
  tool_batch_convert_web_pages_to_excel_rules_item_3: 'colspan は空セルで埋めます。rowspan は平らにします（各行は独立）。スクリプトは除去するので、JS だけの表は空になります。',
  tool_batch_convert_web_pages_to_excel_rules_item_4: 'サイト全体のクローラーでも Web 版 Excel でもありません。手元の URL か HTML を貼ってください。シート名は 31 文字までです。',
  ...
  tool_batch_convert_web_pages_to_excel_usecase_1: '公開の価格表や SKU の HTML 表を Excel に残し、数量を絞り込める数字のままにする。PNG だと画素だけです。',
  tool_batch_convert_web_pages_to_excel_usecase_2: 'ヘルプ 2 件のパラメータ表を 1 冊にまとめ、自分で SUM 列を足す。Word なら見出しが文章のままです。',
  tool_batch_convert_web_pages_to_excel_usecase_3: 'A4 印刷は PDF 一括、手元の CSV は CSV ↔ JSON。ソースがまだウェブの表ならこのページです。',
  ...
  tool_batch_convert_web_pages_to_jpg_desc: 'URL リストをデスクトップ／タブレット／スマホ幅の JPEG にして ZIP。A4 PDF ではない。',
  ...
  tool_batch_convert_web_pages_to_jpg_faq_a1: '変換はこのタブで行います。URL リストを変換するとき、各アドレスをサーバーへ一度送って HTML を取ります。ページは保存しません。JPEG は端末内で作り、ここで ZIP にします。',
  ...
  tool_batch_convert_web_pages_to_jpg_faq_a3: 'PDF を JPG にするツールは、アップロードした PDF が起点です。こちらはウェブページの URL が起点です。すでに PDF があるならそちら、リンクの一覧があるならこのページです。',
  tool_batch_convert_web_pages_to_jpg_faq_a4: '一致しません。スクリプトは削除されます。ログイン壁や有料壁、JavaScript で描画するアプリは本番と違うことが多いです。レスポンシブ CSS は選んだ表示幅に従います。',
  tool_batch_convert_web_pages_to_jpg_faq_a5: '成功した行はそれぞれ JPEG になり、1つの ZIP に入ります。1行だけでも構いません。複数画像を1枚に結合はしません。',
  ...
  tool_batch_convert_web_pages_to_jpg_how_body: '公開ページの URL リストを貼り、「すべて変換」を押します（初期値はデスクトップ 1280、JPEG 85%、ページ全体）。できた画像を ZIP で受け取ります。',
  ...
  tool_batch_convert_web_pages_to_jpg_how_item_6: '「サンプルを読み込む」でローカルの2ページを試せます。変換中は進捗パネルが出ます。',
  ...
  tool_batch_convert_web_pages_to_jpg_opts_hint: '表示幅でレイアウトが変わります。JPEG 品質でファイルサイズが変わります。全体は縦長の切り抜き、最初の画面はおおよそ1画面分です。',
  ...
  tool_batch_convert_web_pages_to_jpg_rules_body: 'http(s) URL を1行1件、最大10件。直列変換。失敗行はスキップ。できた JPEG は ZIP へ。表示幅・品質・範囲で画素が変わります。PDF の拡張子を変えたものではありません。',
  tool_batch_convert_web_pages_to_jpg_rules_item_1: '各 URL は HTML 取得のためサーバーへ一度だけ送り、保存しません。JPEG はこのタブで作ります。',
  tool_batch_convert_web_pages_to_jpg_rules_item_2: '社内網、ログイン、欠けたページはその行だけ失敗します。残りの行は続きます。',
  tool_batch_convert_web_pages_to_jpg_rules_item_3: 'ZIP 内の同名は name (2).jpg になります。スクリプトと noscript のリフレッシュ罠は削除します。極端に高いトップは上限をかけてタブが落ちないようにします。',
  tool_batch_convert_web_pages_to_jpg_rules_item_4: 'サイト全体のクローラーではありません。手元にある URL を貼ってください。',
  ...
  tool_batch_convert_web_pages_to_jpg_url_hint: '公開の http(s) URL を1行1件、最大10件。各ページを一度取得し、CSS と画像 URL を書き換えます。取り込み前にスクリプトは外します。',
  ...
  tool_batch_convert_web_pages_to_jpg_wait_hint: '画像の読み込みが始まったあと追加で待つ秒数。初期値は1。JPEG に空の枠が残るなら上げてください。',
  ...
  tool_batch_convert_web_pages_to_pdf_desc: 'URL リストを印刷向け A4 縦 PDF にして ZIP で渡す。ウェブの長尺スクショではない。',
  ...
  tool_batch_convert_web_pages_to_pdf_faq_a1: '用紙は常に A4 縦です。長いページは CSS の改ページ（従来モードのフォールバックあり）で切れます。無限に高い1枚にはなりません。長尺スクショが欲しいときは「ウェブページをまとめてJPGに変換」。',
  tool_batch_convert_web_pages_to_pdf_faq_a2: 'JPG 側は表示幅（1280 / 768 / 390）で JPEG 1枚を切り、画質と全体／最初の画面を選べます。こちらは印刷向けに A4 へ分割します。同じ URL リストでも成果物が違います。',
  tool_batch_convert_web_pages_to_pdf_faq_a3: 'こちらは URL リスト用（複数の公開ページ → 別々の A4 PDF → ZIP）です。HTML 断片やプレビュー付きの1件は「HTML を PDF に変換」。',
  tool_batch_convert_web_pages_to_pdf_faq_a4: '変換はこのタブです。各アドレスをサーバーへ一度送って HTML を取りますが、ページは保存しません。PDF は端末で作り、ここで ZIP にします。',
  tool_batch_convert_web_pages_to_pdf_faq_a5: '成功した行は別々の PDF として1つの ZIP に入ります。1冊への結合はしません。必要ならダウンロード後に「ファイルを1つの PDF に結合」。',
  tool_batch_convert_web_pages_to_pdf_faq_a6: 'なりません。スクリプトは削除します。ログイン壁・有料壁・JavaScript 描画は実サイトと一致しないことが多いです。印刷 CSS で切れ目もずれます。',
  ...
  tool_batch_convert_web_pages_to_pdf_how_body: '印刷や保管したい公開 URL を貼り、A4 縦の PDF にして、できたファイルを ZIP で持ち帰りましょう。',
  ...
  tool_batch_convert_web_pages_to_pdf_how_item_5: '1行以上成功したら ZIP をダウンロード。サンプル読込で改ページ付きのローカル A4 を2件試せます。',
  ...
  tool_batch_convert_web_pages_to_pdf_rules_body: 'http(s) URL は1行1件、最大10。出力は CSS 改ページ付き A4 縦で、全ページ JPEG ではありません。直列変換。失敗はスキップ。成功した PDF は ZIP へ。',
  tool_batch_convert_web_pages_to_pdf_rules_item_1: '各 URL は HTML 取得のためサーバーへ一度送り、保存しません。PDF はこのタブで A4 縦に作ります。',
  tool_batch_convert_web_pages_to_pdf_rules_item_2: '改ページは CSS（従来モードのフォールバックあり）。印刷スタイルは画面と違うことがあります。極端に高いページはタブ保護のため上限があります。',
  tool_batch_convert_web_pages_to_pdf_rules_item_3: 'プライベート網・ログイン・存在しないページはその行だけ失敗。ZIP 内の同名は name (2).pdf。取り込み前にスクリプトを外します。',
  tool_batch_convert_web_pages_to_pdf_rules_item_4: 'サイト全体のクローラーでもスクリーンショット専用でもありません。手元の公開 URL を貼ってください。',
  tool_batch_convert_web_pages_to_pdf_rules_item_5: '「ウェブページをまとめてJPGに変換」との差：あちらは表示幅の JPEG 1枚。HTML 側は貼り付け HTML。「ファイルを1つの PDF に結合」は出力の結合であり、本ページではしません。',
  tool_batch_convert_web_pages_to_pdf_rules_title: '想定されるルール',
  tool_batch_convert_web_pages_to_pdf_sample: 'サンプル読込',
  tool_batch_convert_web_pages_to_pdf_status_converting: 'PDF を描画中…数秒タブが止まることがあります',
  ...
  tool_batch_convert_web_pages_to_pdf_url_hint: '公開 http(s) URL を1行1件、最大10。各ページを一度取得し CSS と画像 URL を書き換えます。PDF 前にスクリプトを削除し、A4 縦＋CSS 改ページにします。',
  ...
  tool_batch_convert_web_pages_to_pdf_wait_hint: '画像の読み込み開始後に待つ秒数です。初期値は1。ある A4 ページに空の画像枠が出るときは増やしてください。',
  ...
  tool_batch_convert_web_pages_to_png_desc: 'URL リストをロスレス PNG に。透過と 2× は任意、ZIP でまとめる。JPEG でも A4 でもない。',
  ...
  tool_batch_convert_web_pages_to_png_faq_a2: '成功した行はそれぞれ別 PNG になり、1つの ZIP に入ります。1本の URL でもウェブページをPNGに変換できます。複数枚を1ファイルに合成はしません。',
  ...
  tool_batch_convert_web_pages_to_png_faq_a5: 'PDF 側は読む・印刷するための A4 分割です。こちらは URL ごとに 1 枚の PNG ラスタです。印刷用なら「複数のウェブページをPDFにまとめて変換」を使ってください。',
  tool_batch_convert_web_pages_to_png_faq_a6: '一致しません。スクリプトは除去されます。ログイン壁や JavaScript で描くアプリは、ログイン後の見た目と違うことが多いです。レスポンシブは選んだ幅に従います。',
  ...
  tool_batch_convert_web_pages_to_png_how_body: '文字がにじまない UI スクショを残したいとき向けです。URL を貼り、「すべて変換」を押すと（初期値はデスクトップ 1280・白背景・1×・ページ全体）、できた PNG を ZIP で受け取れます。',
  tool_batch_convert_web_pages_to_png_how_item_1: '1行に https URL を1つ（コンポーネントキットや公開 UI ドキュメント向き）。1行でもウェブページをPNGに変換できます。',
  tool_batch_convert_web_pages_to_png_how_item_2: '「すべて変換」を押します。初期値はデスクトップ 1280、白、1×、ページ全体。公開 URL は一度だけ取得し、失敗行は飛ばします。',
  tool_batch_convert_web_pages_to_png_how_item_3: '透過、2×、スマホ幅、最初の画面だけが必要なら「詳細設定（任意）」で幅・背景・倍率・範囲・読み込み待ちを変えます。',
  tool_batch_convert_web_pages_to_png_how_item_4: 'チャット用の小さい JPEG は「ウェブページをまとめてJPGに変換」。A4 は「複数のウェブページをPDFにまとめて変換」。手元の写真なら「画像を PNG に一括変換」。',
  tool_batch_convert_web_pages_to_png_how_item_5: '1行でも成功したら「ZIPをダウンロード」できます。',
  tool_batch_convert_web_pages_to_png_how_item_6: '「サンプルを読み込む」で端末内の UI 2件を試せます。変換中は進捗パネルが出ます。',
  ...
  tool_batch_convert_web_pages_to_png_opts_hint: '幅でレイアウトが変わります。透過はアルファを残します。2× は画素が倍です。ページ全体は縦長、最初の画面はだいたい1画面分の高さです。',
  tool_batch_convert_web_pages_to_png_progress_tpl: '{i} / {total}',
  tool_batch_convert_web_pages_to_png_rules_body: '1行1つの http(s)、最大 10。直列処理。失敗はスキップ。成功した PNG は ZIP へ。背景と倍率で画素が変わります。JPEG の拡張子替えでも PDF でもありません。',
  tool_batch_convert_web_pages_to_png_rules_item_1: '各 URL は HTML 取得のためサーバーへ一度送り、保存しません。PNG はこのタブで作ります。',
  tool_batch_convert_web_pages_to_png_rules_item_2: '社内ネット、ログイン必須、存在しない URL はその行だけ失敗し、残りは続きます。',
  tool_batch_convert_web_pages_to_png_rules_item_3: 'ZIP 内の同名は name (2).png になります。スクリプトと noscript のリロード罠は除去します。極端に高いキャプチャはタブが落ちないよう上限があります。',
  tool_batch_convert_web_pages_to_png_rules_item_4: 'サイト全体のクローラではありません。手元の URL を貼ってください。',
  tool_batch_convert_web_pages_to_png_rules_item_5: 'JPG 一括と比べ：ロスレス PNG、JPEG 画質なし、任意の透過。PDF 一括と比べ：A4 分割なし。画像一括 PNG と比べ：入力はウェブの URL であって端末の写真ではありません。',
  ...
  tool_batch_convert_web_pages_to_png_url_hint: '公開 http(s) を1行1件、最大 10。一度取得し、CSS と画像 URL を書き換えます。キャプチャ前にスクリプトを外します。レイアウトは選んだ幅に従います。',
  ...
  tool_batch_convert_web_pages_to_png_usecase_1: 'デザインプレビューやコンポーネントキットをシャープな PNG で残す。JPEG だと 1px の枠がにじみます。',
  tool_batch_convert_web_pages_to_png_usecase_2: '半透明オーバーレイを透過 PNG で書き出し、Figma に置く。塗りつぶされた白トップは白のままです。',
  tool_batch_convert_web_pages_to_png_usecase_3: 'チャット用 JPEG は JPG 一括、印刷用 A4 は PDF 一括へ。UI をロスレスで残すときだけこちらです。',
  ...
  tool_batch_convert_web_pages_to_png_wait_hint: '画像の読み込みが始まったあと、追加で待つ秒数です。初期値は 1。PNG に空の枠が出るときは増やしてください。',
  ...
  tool_batch_watermark_product_photos_example: 'サンプル読込は横の色面と縦の色面を入れ、SAMPLE を設定し、先頭をプレビューし、同じ相対位置を両方に適用して ZIP ダウンロードを有効にします。',
  tool_batch_watermark_product_photos_example_title: '例',
  tool_batch_watermark_product_photos_faq_a1: '送りません。読み取りと Canvas の透かしはこのタブ内です。ファイルは端末に留まり、サーバーにアップロードしません。ZIP 用スクリプトはこのサイトから読みますが、写真はタブを出ません。',
  tool_batch_watermark_product_photos_faq_a2: 'ずれません。字の大きさは各写真の短辺のパーセント、九つのアンカーはそのキャンバスの割合です。縦も横も同じ相対コーナーです。',
  tool_batch_watermark_product_photos_faq_a3: 'できません。このページは写真用です。PDF の透かしは別作業で、ページが必要なときは PDF 透かしツールを使ってください。',
  tool_batch_watermark_product_photos_faq_a4: '写真に文字の透かしは 1 枚のピクセル調整です。このページは束で一つの印を共有し、1 枚見てからすべて ZIP にします。',
  tool_batch_watermark_product_photos_faq_a5: '「まとめて透かし」でもここに来ます。このサイトに bulk-watermark の別 URL はありません。',
  ...
  tool_batch_watermark_product_photos_how_body: '束をキューへ入れ、一つの印を決め、1 枚プレビューしてから同じ相対位置をすべてに適用し、ZIP を持ち帰ります。',
  ...
  tool_batch_watermark_product_photos_rules_body: '字のピクセルは短辺×パーセントです。アンカーはそのキャンバスの割合であり、固定ピクセルではありません。',
  tool_batch_watermark_product_photos_rules_item_1: '初期の印：SAMPLE、右下、短辺の 8%、不透明度 45%。JPEG 出力は白マット。',
  tool_batch_watermark_product_photos_rules_item_2: '短辺 64 px 未満はその行が失敗。空文字ではすべて適用できません。読み取り失敗はスキップ。',
  tool_batch_watermark_product_photos_rules_item_3: '斜め DRAFT は文字を画面に敷きます。ZIP 内の重複名は 名前 (2).jpg または .png。',
  tool_batch_watermark_product_photos_rules_item_4: 'ファイルは端末内に留まり、サーバーにアップロードしません。',
  ...
  tool_bulk_compress_png_images_article: 'このタブでロゴや UI 素材の PNG をまとめ、透過を残し、失敗した分は飛ばして ZIP を受け取ります。端末内で処理し、サーバーにアップロードしません。',
  ...
  tool_bulk_compress_png_images_example: 'サンプル読込は透過の市松 PNG を 2 枚入れ、PNG として書き直し、表を埋め、ZIP をダウンロードできるようにします。同名は name (2).png になります。',
  tool_bulk_compress_png_images_example_title: '例',
  tool_bulk_compress_png_images_faq_a1: 'いいえ。読み取りと PNG 書き出しはこのタブ内です。ファイルは端末に残り、サーバーにアップロードしません。ZIP 用スクリプトはこのサイトから読みますが、画像はタブを出ません。',
  tool_bulk_compress_png_images_faq_a2: 'いいえ。出力は常に PNG です。JPEG の下地はありません。写真を小さくできて JPEG でよければ、商品写真の一括圧縮を使ってください。',
  tool_bulk_compress_png_images_faq_a3: 'はい。塗りつぶしなしで描いて PNG に保存するので、穴は穴のままです。',
  tool_bulk_compress_png_images_faq_a4: '最長辺を縮めていないと、よくあります。ここはパレット最適化ではありません。インデックスカラーは再エンコード後に縞が出ることがあります。',
  tool_bulk_compress_png_images_faq_a5: 'いいえ。最初のフレームだけを静止 PNG として残します。',
  ...
  tool_bulk_compress_png_images_how_body: '透過を捨てられない PNG なら、必要に応じて最長辺の上限を共有し、ここでまとめて処理し、成功分だけ ZIP に入れて持ち帰ります。',
  ...
  tool_bulk_compress_png_images_rules_body: 'JPEG の下地は塗りません。容量が落ちるのはたいてい最長辺を縮めたときで、保存し直すだけではほとんど変わりません。',
  tool_bulk_compress_png_images_rules_item_1: '出力の種類は PNG です。アルファは潰しません。ここは可逆なので画質スライダーはありません。',
  tool_bulk_compress_png_images_rules_item_2: '最長辺は比率を保って縮小するだけで、拡大はしません。再エンコードのみは画素サイズを維持し、バイト数はほぼ動かないことがあります。',
  tool_bulk_compress_png_images_rules_item_3: '読めない・書けない行は飛ばします。ZIP 内の同名は name (2).png になります。インデックスパレットは縞が出ることがあります。',
  tool_bulk_compress_png_images_rules_item_4: '端末内で処理し、サーバーにアップロードしません。',
  ...
  tool_bulk_compress_product_photos_article: '出品用の写真をこのタブでまとめ圧縮し、失敗したファイルは飛ばして ZIP にします。ファイルは端末内に留まり、サーバーにはアップロードしません。',
  ...
  tool_bulk_compress_product_photos_faq_a1: 'いいえ。復号と再エンコードはこのタブ内です。ファイルは端末に留まり、サーバーにはアップロードしません。ZIP 用スクリプトはこのサイトから読みますが、写真自体は送りません。',
  tool_bulk_compress_product_photos_faq_a2: '必ずではありません。画質 0.5 でも上限を超えると「未達」になりますが、いちばん近い結果は ZIP に残します。',
  tool_bulk_compress_product_photos_faq_a3: '別ページは不要です。JPEG も JPG も同じ出力で、拡張子は .jpg です。',
  ...
  tool_bulk_compress_product_photos_faq_a5: '動きは残りません。最初のフレームだけを静止画として圧縮し、警告に出します。',
  ...
  tool_bulk_compress_product_photos_how_body: '出品したい写真をまとめ、容量上限を共有してここで圧縮し、できた分だけ ZIP で持ち帰ります。',
  ...
  tool_bulk_compress_product_photos_jpeg_bg_hint: 'JPEG に透明度はありません。空洞だけがこの色になり、不透明な商品写真はそのままです。不要なら「指定しない」。',
  ...
  tool_bulk_compress_product_photos_quality_hint_target: '容量上限があるとき、スライダーは探索の起点であり最終画質ではありません。',
  tool_bulk_compress_product_photos_quality_label: '画質',
  tool_bulk_compress_product_photos_resize_on: '出力サイズを制限',
  tool_bulk_compress_product_photos_rules_body: '設定はバッチ全体で共有します。上限未達は成功バナーではなく表で示します。',
  ...
  tool_bulk_compress_product_photos_warn_png_target: 'PNG は KB 上限を探しません。PNG のままにするか、上限が要るなら JPEG / WebP に切り替えてください。',
  ...
  tool_bulk_convert_images_to_jpg_drop_hint: 'PNG、JPEG、WebP、GIF、HEIC をドロップ（最大 20）。変換はこのタブ内。',
  ...
  tool_bulk_convert_images_to_jpg_example: 'サンプル読込は不透明な色面と透明ロゴを白マットに載せ、二つの .jpg 名を出し、ZIP ダウンロードを有効にします。',
  tool_bulk_convert_images_to_jpg_example_title: '例',
  tool_bulk_convert_images_to_jpg_faq_a1: '送りません。読み取りと .jpg 書き出しはこのタブ内です。ファイルは端末に留まり、サーバーにアップロードしません。ZIP 用スクリプトはこのサイトから読みますが、画像はタブを出ません。',
  tool_bulk_convert_images_to_jpg_faq_a2: 'ここでできます。PNG を JPG にするにはファイルを選び、穴が黒くならないよう白マットのまま、すべて変換します。',
  tool_bulk_convert_images_to_jpg_faq_a3: 'このブラウザが HEIC を読めない行は飛ばし、残りは ZIP に入ります。Safari にするか、先にスマホ側で変換してください。',
  tool_bulk_convert_images_to_jpg_faq_a4: '不要です。JPEG も JPG も同じ出力で、ファイル名は .jpg です。',
  tool_bulk_convert_images_to_jpg_faq_a5: 'ここでは拡張子を JPG にします。出品写真を 200 KB 付近まで小さくするのは「商品写真を一括圧縮」です。',
  ...
  tool_bulk_convert_images_to_jpg_how_body: 'JPG しか受け付けない提出先向けに、対象をキューへ入れ、透明ピクセルは一つのマットで塗ってここで変換し、成功分の ZIP を持ち帰ります。',
  ...
  tool_bulk_convert_images_to_jpg_rules_body: 'JPG にアルファはありません。どのファイルも同じマットの上に描いて .jpg で保存します。',
  tool_bulk_convert_images_to_jpg_rules_item_1: '出力名は必ず .jpg で終わります。',
  tool_bulk_convert_images_to_jpg_rules_item_2: '透明ピクセルは書き出し前に共通マットで埋めます。「マットなし」はなく、穴が突然の黒塊になるのを避けます。',
  tool_bulk_convert_images_to_jpg_rules_item_3: '読み取りや書き出しの失敗はその行だけスキップ。ZIP 内の重複名は 名前 (2).jpg。アニメは先頭フレームだけ。',
  tool_bulk_convert_images_to_jpg_rules_item_4: 'ファイルは端末内に留まり、サーバーにアップロードしません。',
  ...
  tool_bulk_convert_images_to_png_example: 'サンプル読込は JPEG の色面と透明ロゴを入れ、二つの .png を書き、ZIP ダウンロードを有効にします。JPEG の行は PNG の方が大きいことがよくあります。',
  tool_bulk_convert_images_to_png_example_title: '例',
  tool_bulk_convert_images_to_png_faq_a1: '送りません。読み取りと PNG 書き出しはこのタブ内です。ファイルは端末に留まり、サーバーにアップロードしません。ZIP 用スクリプトはこのサイトから読みますが、画像はタブを出ません。',
  tool_bulk_convert_images_to_png_faq_a2: '戻りません。JPEG は穴を保存していません。jpg を png にしても包みが PNG になるだけで、背景は不透明のままです。本当の穴は、元ファイルにアルファがあったときだけ残ります。',
  tool_bulk_convert_images_to_png_faq_a3: 'PNG は可逆です。写真 JPEG は大きくなりがちです。表に「元より大きい」と出ます。画素を小さくするのは「PNG 画像を一括圧縮」。PNG が不要なら JPEG のまま。',
  tool_bulk_convert_images_to_png_faq_a4: 'PNG 圧縮は、すでに PNG で、PNG のまま小さくしたいファイル向けです。このページは拡張子を PNG に変えます。',
  tool_bulk_convert_images_to_png_faq_a5: '動きません。先頭フレームだけ静止 PNG になり、その行に注記します。',
  ...
  tool_bulk_convert_images_to_png_how_body: 'PNG にしたい画像を選び、マットを塗らずここで変換し、成功分の ZIP を持ち帰ります。',
  ...
  tool_bulk_convert_images_to_png_rules_body: '出力は常に PNG です。このページは透過を JPEG マットに潰しません。',
  tool_bulk_convert_images_to_png_rules_item_1: '元にアルファがあれば残します。JPEG 源に残せるアルファはありません。',
  tool_bulk_convert_images_to_png_rules_item_2: '最長辺の縮小は初期オフです。変換のついでにサイズを変えないためです。',
  tool_bulk_convert_images_to_png_rules_item_3: 'PNG が元より大きいとその行に出ます。読み取り失敗はスキップ。ZIP 内の重複名は 名前 (2).png。',
  tool_bulk_convert_images_to_png_rules_item_4: 'ファイルは端末内に留まり、サーバーにアップロードしません。',
  ...
  tool_bulk_convert_images_to_webp_err_unsupported: 'このブラウザは WebP を返しませんでした。その行はスキップし、JPEG にはしません。',
  tool_bulk_convert_images_to_webp_example: 'サンプル読込は不透明な色面と透明ロゴを入れ、二つの .webp を書き、ZIP ダウンロードを有効にします。ロゴの穴は残ります。',
  tool_bulk_convert_images_to_webp_example_title: '例',
  tool_bulk_convert_images_to_webp_faq_a1: '送りません。読み取りと WebP 書き出しはこのタブ内です。ファイルは端末に留まり、サーバーにアップロードしません。ZIP 用スクリプトはこのサイトから読みますが、画像はタブを出ません。',
  tool_bulk_convert_images_to_webp_faq_a2: 'ここでできます。png を webp にするにはファイルを選び、画質は 0.8 付近、すべて変換。PNG にアルファがあれば穴は残ります。',
  tool_bulk_convert_images_to_webp_faq_a3: 'メールや CMS がまだ WebP を拒むことがあります。その添付は「画像を JPG に一括変換」を使ってください。',
  tool_bulk_convert_images_to_webp_faq_a4: 'その行はスキップします。JPEG にすり替えません。新しい Chrome、Edge、Firefox を試してください。',
  tool_bulk_convert_images_to_webp_faq_a5: '動きません。先頭フレームだけ静止 WebP になり、その行に注記します。',
  ...
  tool_bulk_convert_images_to_webp_how_body: 'サイト用に WebP にしたい画像を選び、JPEG マットなしでここで変換し、成功分の ZIP を持ち帰ります。',
  ...
  tool_bulk_convert_images_to_webp_rules_body: '出力は常に WebP です。透過を JPEG マットに潰さず、JPEG にもフォールバックしません。',
  tool_bulk_convert_images_to_webp_rules_item_1: '元にアルファがあれば残します。JPEG 源に残せるアルファはありません。',
  tool_bulk_convert_images_to_webp_rules_item_2: '画質の初期値は 0.8。サイトの容量が足りないときだけ下げます。',
  tool_bulk_convert_images_to_webp_rules_item_3: 'このブラウザが WebP を書けない行はスキップ。読み取り失敗もスキップ。ZIP 内の重複名は 名前 (2).webp。',
  tool_bulk_convert_images_to_webp_rules_item_4: 'ファイルは端末内に留まり、サーバーにアップロードしません。',
  ...
  tool_chatgpt_export_to_markdown_faq_a3:
    'はい。Claude の chat_messages 配列（sender + text）も同じコンバーターが解析するので、一度貼り付けるだけで ChatGPT と Claude 両方のエクスポートを扱えます。',
  ...
  tool_chatgpt_export_to_markdown_rules_body: 'エクスポート変換にはフィールド対応表、既定の Markdown、端末内処理のプライバシー説明が必要です。',
  ...
  tool_check_pdf_a_compliance_description:
    'アーカイブ検証の前に PDF/A 指標をローカルで確認します。PDF ヘッダー、非圧縮 XMP の PDF/A 識別子、出力インテント、埋め込みフォント、暗号化辞書を調べます。結果は手掛かりであり認証ではありません。 手順は PDF ヘッダー、非圧縮 XMP の pdfaid、GTS_PDFA1 出力インテント、FontFile、Encrypt を確認します。通常 PDF の例では一部の指標だけが見つかります。圧縮オブジェクトでは未検出になるため、結果は適合・不適合の証明ではありません。',
  ...
  tool_check_robots_txt_url_blocked_faq_a1: 'いいえ。ブロック確認のみです。ルール作成は robots.txt ジェネレータを使ってください。',
  tool_check_robots_txt_url_blocked_faq_a2: 'Googlebot 専用グループがあればそれを使い、他の多くは * に落ちます。分けて確認しないと一つの規則で全ボットをカバーしたと誤解しやすいです。',
  tool_check_robots_txt_url_blocked_faq_a3: '一般的なクローラ慣行では全面許可とみなします。ツールは HTTP ステータスを表示するので 404 やリダイレクトも分かります。',
  tool_check_robots_txt_url_blocked_faq_a4: 'はい。UA 一覧から GPTBot を選べます。マッチングは RFC 9309 準拠のエッジ評価であり、公式クローラの判定ではありません。',
  tool_check_robots_txt_url_blocked_faq_a5: '/robots.txt 取得のため URL/ホスト名は Worker に届きます。製品用DBとして長期保存しません。エッジツールであり「アップロードなし」ではありません。',
  ...
  tool_check_robots_txt_url_blocked_fetch_failed: 'robots.txt を取得できませんでした。ホスト障害やボット拒否の可能性があります。',
  tool_check_robots_txt_url_blocked_formula_body: 'Google の robots.txt 解説と RFC 9309 に沿った一般的な評価：最長一致。同じ長さなら Allow が Disallow より優先。',
  ...
  tool_check_robots_txt_url_blocked_home_desc: 'ページURLを貼り、robots.txtがそのパスをブロックするか確認できます。',
  tool_check_robots_txt_url_blocked_home_title: 'robots.txt URLブロック確認',
  tool_check_robots_txt_url_blocked_how_body: '選んだクローラに対し、そのパスが robots.txt で許可かブロックかを判定します。取得するのは /robots.txt のみで、ページ本体は取りません。',
  ...
  tool_check_robots_txt_url_blocked_privacy_note: 'URLとホスト名は /robots.txt 取得のため Worker に送られます。製品用DBとして長期保存しません。',
  ...
  tool_check_robots_txt_url_blocked_usecase_1: '公開前チェック：/admin や /staging がブロックされ、公開ページはクロール可能なままかを確認。',
  tool_check_robots_txt_url_blocked_usecase_2: 'robots.txt テスター／検証：Disallow 変更後、意図した URL に本当に当たるか確かめる。',
  tool_check_robots_txt_url_blocked_usecase_3: 'AI クローラ規則：UA を GPTBot（または *）にして、学習系ボットが敏感パスを見られるか確認。',
  ...
  tool_check_ssl_certificate_expiration_example: 'サンプル入力 example.com。Worker が crt.sh を照会し、最新マッチの notBefore・notAfter・発行者・daysLeft と CT 遅延の注意を表示します。',
  tool_check_ssl_certificate_expiration_example_title: '例',
  tool_check_ssl_certificate_expiration_faq_a1: 'いいえ。Workers は fetch からピア証明書を読めません。Certificate Transparency（crt.sh）を照会します。',
  tool_check_ssl_certificate_expiration_faq_a2: 'CT ログは発行・更新より遅れることがあります。タイミングが重要なら手元の握手ツールで確認してください。',
  tool_check_ssl_certificate_expiration_faq_a3: '焦点は最新マッチの有効期限です。チェーン専用チェッカーは二次的なニーズで、本ページの H1 ではありません。',
  tool_check_ssl_certificate_expiration_faq_a4: 'いいえ。H1 は「SSL証明書の有効期限を確認」。より広いヘッド語は唯一のタイトルにしません。',
  tool_check_ssl_certificate_expiration_faq_a5: '私有・遮断ホストは拒否します。私有空間の文脈は private CIDR ツールを参照してください。',
  ...
  tool_check_ssl_certificate_expiration_fetch_failed: 'crt.sh を照会できませんでした。レート制限や一時不通の可能性があります。',
  tool_check_ssl_certificate_expiration_formula_body: 'Cloudflare Workers は fetch からピア証明書を読めません。代わりに crt.sh の公開 CT データを使います。',
  ...
  tool_check_ssl_certificate_expiration_formula_item_3: 'notBefore / notAfter / 発行者 / daysLeft / 期限切れフラグを表示。',
  ...
  tool_check_ssl_certificate_expiration_home_desc: 'ホスト名の最新 CT 証明書の有効期限を確認（crt.sh — ライブ握手ではありません）。',
  ...
  tool_check_ssl_certificate_expiration_how_body: 'このページが答えるのは一点: このホスト名の最新 CT マッチはいつ切れるか。ライブ SSL 握手監査ではありません。',
  ...
  tool_check_ssl_certificate_expiration_privacy_note: 'ホスト名は Worker が crt.sh を照会するために送信されます。製品データベースとしては保存しません。',
  ...
  tool_check_ssl_certificate_expiration_result_disclaimer: 'CT ログの遅延あり — ライブ TLS 握手のピア証明書ではありません。発行・更新より日付が遅れることがあります。',
  ...
  tool_combine_files_into_one_pdf_description:
    'ファイルを1つの PDF に結合. ファイルは端末内に留まり、サーバーにアップロードしません。 サンプルで実際の入力と出力を確認でき、手順と制限は本文で説明します。 手順は PDF と画像を追加し、キューで上移動、下移動、削除を行ってから結合、プレビュー、ダウンロードします。例では生成 PDF と画像を順番どおりにまとめます。スキャン PDF に OCR は不要で、画像は新しい PDF ページになります。',
  ...
  tool_compare_two_pdfs_description:
    '2 つの PDF を比較. ファイルは端末内に留まり、サーバーにアップロードしません。 サンプルで実際の入力と出力を確認でき、手順と制限は本文で説明します。 手順は PDF A と PDF B を選び、選択可能な文字を抽出して追加・削除語を強調し、HTML 差分を保存します。例では「Version A text」と「Version B text」を比較します。画像だけのスキャン文書は先に別の OCR が必要です。',
  ...
  tool_compare_two_text_files_online_faq_a1: '送りません。バイトは FileReader でこのタブ内だけ読みます。jsdiff はこのサイトからライブラリとして読みますが、あなたのファイルは当サイトのサーバーへ上がりません。',
  ...
  tool_compare_two_text_files_online_faq_a4: 'UTF-8 として読める .txt / .text が対象です。ファイルなしなら貼り付け比較を使い、.docx、xlsx、xls、csv は Word または表計算の比較ツールを使ってください。',
  ...
  tool_compare_two_text_files_online_how_item_3: '「比較する」を押して行差分を更新します。2つのファイルを選び終えた時点でも自動実行されます。',
  ...
  tool_compare_two_word_documents_for_differences_faq_a1: 'いいえ。このタブ内で読みます。mammoth と jsdiff はこのサイトから読みますが、文書は当社サーバーに送りません。',
  ...
  tool_compare_two_word_documents_for_differences_faq_a4: '2つの .docx から抽出した文言だけを比較します。PDF と旧形式の .doc は解析せず、書式や Word の変更履歴も結果に含みません。',
  ...
  tool_compare_two_word_documents_for_differences_how_item_3: '「比較」を押し、見えるテキストを抽出して文言差分を実行します。',
  ...
  tool_compress_pdf_faq_a1: 'いいえ。pdf.js と PDF ライブラリ はタブ内で動作します（ライブラリは このサイトから読み込みます）。PDF は当社サーバーにアップロードされません。',
  ...
  tool_convert_a_jpg_to_text_with_ocr_desc: 'JPG を OCR でテキストにする処理は端末内。サーバーにアップロードしません。',
  ...
  tool_convert_a_jpg_to_text_with_ocr_err_pdf: 'このページは写真用です。PDF は受けません。文字レイヤー付き PDF は「PDF からテキストを抽出」へ。',
  tool_convert_a_jpg_to_text_with_ocr_err_size: '12 MB を超えています。圧縮か切り抜きをしてください。',
  tool_convert_a_jpg_to_text_with_ocr_example: '「サンプルを読み込む」は ONLINEFREETOOLS、The quick brown fox、印刷体样例 の JPEG を描き、「変換」でその行を枠に入れます（中国語は既定チップのまま）。',
  tool_convert_a_jpg_to_text_with_ocr_example_title: '例',
  tool_convert_a_jpg_to_text_with_ocr_faq_a1: 'いいえ。写真は端末のタブに留まります。スクリプトはこのサイトから読み、ファイルはサーバーにアップロードしません。',
  tool_convert_a_jpg_to_text_with_ocr_faq_a2: 'PDF テキスト抽出は既存の文字レイヤーを読みます。こちらは画像の OCR です。スキャン PDF は受け付けません。',
  tool_convert_a_jpg_to_text_with_ocr_faq_a3: 'できます。画面キャプチャの PNG も同じ「変換」です。別 URL は作りません。',
  tool_convert_a_jpg_to_text_with_ocr_faq_a4: '活字向けです。連筆の手書きは失敗しやすく、手書き専用ではありません。縦書きも保証しません。',
  tool_convert_a_jpg_to_text_with_ocr_faq_a5: '既定は中国語と英語です。アラビア語はチップ。日本語チップは大きめの言語パックを読みます。言語ごとの別ページはありません。',
  tool_convert_a_jpg_to_text_with_ocr_faq_a6: '「オンラインOCR」は何でも屋の検索語です。ここは TXT だけです。Word や検索可能な PDF、表計算、インストール用ソフトではありません。',
  tool_convert_a_jpg_to_text_with_ocr_faq_a7: '文字認識は、印刷ピクセルをコピーできる行にすることです。変換は 1 枚ずつ。まとめて処理するなら「複数のJPGをOCRでまとめてテキストにする」を使います。',
  tool_convert_a_jpg_to_text_with_ocr_faq_a8: 'このページは 1 枚・テキストをコピー・1 つの TXT です。すべて変換、失敗行のスキップ、ZIP は「複数のJPGをOCRでまとめてテキストにする」へ。',
  ...
  tool_convert_a_jpg_to_text_with_ocr_how_body: '写真の活字をコピーできるテキストにします。JPG を置き、「変換」（初回だけエンジン読み込み）のあと「テキストをコピー」か「TXTをダウンロード」。',
  ...
  tool_convert_a_jpg_to_text_with_ocr_rules_body: '最長辺が上限を超えると縮小し、画面順に活字領域を UTF-8 へつなぎます。信頼度は目安であり校正ではありません。',
  ...
  tool_convert_a_wav_file_to_mp3_article:
    '録音したWAVが大きくて送りにくいときは、共有用のMP3を作成します。変換するのは音声全体で、切り取りやフェードは行いません。MP3は非可逆圧縮なので、後から編集するためのWAVは別に残してください。保存前に完成した音声を試聴できます。',
  ...
  tool_convert_a_wav_file_to_mp3_description:
    'WAVファイルをMP3に変換して録音や練習音源を共有しやすくします。手順はファイルの選択、ビットレートの調整、変換、試聴と保存です。音声は端末内で処理され、サーバーには送信されません。元のWAVと完成したMP3の実際の容量を比較してから保存できます。',
  ...
  tool_convert_a_wav_file_to_mp3_faq_a2:
    'Web Audioに対応した新しいブラウザで利用できます。Windows、Mac、Android、iPhoneで試せますが、スマートフォンはメモリ不足になりやすいため、まずサンプルで確認してください。上限は共通で40 MiB・10分です。インストールは不要です。',
  ...
  tool_convert_a_wav_file_to_mp3_faq_a4:
    'WAVでも圧縮形式や拡張形式、多チャンネルには対応していません。また、低いサンプリング周波数のWAVは、指定したMP3より小さいことがあります。実際の容量を比較し、必要なら128 kbpsで再変換してください。',
  ...
  tool_convert_an_m4a_file_to_mp3_article:
    'ボイスメモのM4Aを相手の機器で再生できないときは、MP3のコピーを作れます。録音全体を変換し、保存する前に音を確認できます。AACからMP3への再圧縮では情報が失われるため、サイズが増えても元の音質に戻るわけではありません。編集用の原本は別に残してください。',
  ...
  tool_convert_an_m4a_file_to_mp3_description:
    'M4AファイルをMP3に変換して、録音を共有しやすくします。手順はM4AまたはAACを選び、ビットレートを設定して変換し、試聴して保存するだけ。音声は端末内に留まり、サーバーにはアップロードしません。5秒のM4Aサンプルで動作を確かめ、変換前後の実際のサイズも比較できます。',
  ...
  tool_convert_an_mp3_file_to_wav_article:
    '録音したMP3が大きくて送りにくいときは、共有用のWAVを作成します。変換するのは音声全体で、切り取りやフェードは行いません。WAVは非可逆圧縮なので、後から編集するためのMP3は別に残してください。保存前に完成した音声を試聴できます。',
  ...
  tool_convert_an_mp3_file_to_wav_description:
    'MP3ファイルをWAVに変換して録音や練習音源を共有しやすくします。手順はファイルの選択、ビットレートの調整、変換、試聴と保存です。音声は端末内で処理され、サーバーには送信されません。元のMP3と完成したWAVの実際の容量を比較してから保存できます。',
  ...
  tool_convert_an_mp3_file_to_wav_faq_a4:
    'MP3でも圧縮形式や拡張形式、多チャンネルには対応していません。また、低いサンプリング周波数のMP3は、指定したWAVより小さいことがあります。実際の容量を比較し、必要なら128 kbpsで再変換してください。',
  ...
  tool_convert_audio_sample_rate_and_bit_depth_article:
    '配信規格では 44.1 kHz / 16-bit や 48 kHz WAV がよく求められます。本ページは OfflineAudioContext で全体を再サンプリングし、16/24-bit PCM を書き出します。MP3 の容量圧縮ではなく、再サンプリング後の聴感が無損失であることも約束しません。',
  ...
  tool_convert_audio_sample_rate_and_bit_depth_description:
    '録音を 44.1／48 kHz・16／24-bit の WAV に変える手順は変換・試聴・保存の三段階です。例では約2秒の48 kHz ステレオサンプルを既定の44.1 kHz/16-bitへ。端末内のみで処理し、サーバーへはアップロードしません。',
  ...
  tool_convert_audio_sample_rate_and_bit_depth_result:
    '{seconds}秒 · 元 {sourceRate} Hz / {sourceBit} → {targetRate} Hz / {targetBit}-bit · WAV {output} KiB · {channels} ch',
  ...
  tool_convert_html_to_pdf_description:
    'HTML を PDF にする手順は、断片を貼るかページ URL を読み込み、スクリプトを除いてプレビューし、A4 で保存することです。URL 読み込みはサーバーが HTML を一度だけ取得し、保存しません。変換はこのタブ内です。例として、見出しと一段落は 1 枚の A4 になります。ログインが必要なページや JS で描画するサイト、印刷用 CSS は実ページと違うことがあります。',
  ...
  tool_convert_html_web_pages_to_word_document_desc: 'HTML を貼るか URL を取得して、編集できる Word にする。PDF でもスクショでもない。',
  ...
  tool_convert_html_web_pages_to_word_document_faq_a3: '貼った HTML はこのタブから出ず、サーバーにもアップロードしません。URL 変換では、その住所を一度だけサーバーへ送って HTML を取り、保存しません。.docx の組み立てはブラウザ内です。',
  tool_convert_html_web_pages_to_word_document_faq_a4: '「HTML を PDF に変換」は A4 にページ割りして印刷向けです。こちらは見出し・リスト・表を編集できる Word にマップします。同じ HTML でも成果物が違います。',
  tool_convert_html_web_pages_to_word_document_faq_a5: '「PDF を Word 文書にする」は PDF ファイルと文字レイヤが起点です。こちらは貼った HTML かウェブの URL が起点です。すでに PDF ならそちらを使ってください。',
  tool_convert_html_web_pages_to_word_document_faq_a6: 'できません。HTML を書き出すかコピーしてください。Chrome の完全保存 / MHTML は別形式で、ここでは解析しません。',
  ...
  tool_convert_html_web_pages_to_word_document_how_body: '見出しと表を Word のスタイルにした編集用 .docx が欲しいときは、HTML を貼るか URL を入れて「変換」し、できたファイルを「ダウンロード」します。画面の絵ではありません。',
  tool_convert_html_web_pages_to_word_document_how_item_1: '手元のソースなら「HTML を貼る」のまま。公開 https をウェブページから Word にするなら URL タブへ。',
  tool_convert_html_web_pages_to_word_document_how_item_2: '「変換」を押します。スクリプトは除去。見出し・リスト・表・リンクを Word へマップ。読めない画像は飛ばします。',
  ...
  tool_convert_html_web_pages_to_word_document_how_item_4: 'A4 印刷は「HTML を PDF に変換」。見た目のスクショはウェブページをまとめて PNG / JPG。手元が PDF なら「PDF を Word 文書にする」。',
  ...
  tool_convert_html_web_pages_to_word_document_html_hint: '断片でも文書全体でも貼れます。変換前にスクリプトを除きます。CSS の見た目はピクセル単位では作り直しません。',
  ...
  tool_convert_html_web_pages_to_word_document_imgs_hint: 'オンだと、ブラウザが読める <img> を埋め込もうとします。壊れた画像やブロックされた画像は飛ばします。文字だけならオフ。',
  tool_convert_html_web_pages_to_word_document_imgs_label: '画像を含める',
  tool_convert_html_web_pages_to_word_document_opts_hint: '「画像を含める」は HTML の絵を埋め込もうとします。「プレーンテキスト」は見出し・表・リンクを普通の段落にします。CSS の配置はマップしません。出力は常に1つの .docx です。',
  tool_convert_html_web_pages_to_word_document_plain_hint: '編集できる段落だけ残します。Word の見出しスタイル、表オブジェクト、埋め込み画像は使いません。リンクは「文言 (URL)」、表のセルはタブ区切りの行になります。',
  tool_convert_html_web_pages_to_word_document_plain_label: 'プレーンテキスト',
  tool_convert_html_web_pages_to_word_document_rules_body: '変換1回で .docx が1つ。見出し・段落・リスト・表・リンクと任意の画像をマップします。絶対配置、固定バー、スクリプトは対象外です。',
  tool_convert_html_web_pages_to_word_document_rules_item_1: '貼った HTML はこのタブに留まり、サーバーには上げません。URL は一度取得して保存しません。',
  tool_convert_html_web_pages_to_word_document_rules_item_2: '既定では h1–h6 は Word 見出し、ul/ol はリスト、table は表、a はハイパーリンク。詳細設定の「プレーンテキスト」を入れると、どれも通常の段落になります。',
  tool_convert_html_web_pages_to_word_document_rules_item_3: 'ログイン壁、JavaScript アプリ、印刷 CSS は本番と食い違いやすいです。スクリーンショットのラスタではありません。',
  ...
  tool_convert_html_web_pages_to_word_document_url_hint: '公開の http(s) URL を1本。HTML を一度取得し、CSS と画像 URL を書き換えます。Word へマップする前にスクリプトを除きます。',
  ...
  tool_convert_html_web_pages_to_word_document_usecase_1: '公開リリースノートの URL を取り、表を本物の Word 表のまま残して直せるようにする。',
  tool_convert_html_web_pages_to_word_document_usecase_2: 'ヘルプセンターから書き出した HTML を、法務がコメントできる下書きにする。見出しは見出しのまま。',
  tool_convert_html_web_pages_to_word_document_usecase_3: 'A4 は「HTML を PDF に変換」、見た目の保存は PNG 一括。直せる .docx が要るときだけここを使う。',
  tool_convert_html_web_pages_to_word_document_usecases_title: '向いているとき',
  tool_convert_pdf_to_dwg_article:
    'PDFをDWG寄りにします。AutoCADが開けるASCII DXFとして、TEXTとページ枠を書き出します。ブラウザは独自DWGバイナリを書けません。ファイルは端末内に留まり、サーバーにアップロードしません。',
  ...
  tool_convert_pdf_to_dwg_description:
    'ブラウザでPDFをDWG寄りに変換します。AutoCADが開けるASCII DXFとして、TEXTとページ枠を書き出します。ブラウザは独自DWGバイナリを書けず、交換形式を渡します。ファイルは端末内に留まり、サーバーにアップロードしません。入場時のサンプルでプロセスと手順の例が動きます。スキャン頁は失敗します。',
  ...
  tool_convert_pdf_to_pdf_a_description:
    'ブラウザでPDFをPDF/A寄りに変換します。タイトルと作成者のメタデータを書き、標準フォントを埋めます。veraPDF認定のPDF/Aではなく、変換後は「PDF/A準拠を確認」で見直してください。ファイルは端末内に留まり、サーバーにアップロードしません。入場時のサンプルでプロセスと手順の例が動きます。',
  ...
  tool_convert_word_document_to_pdf_description:
    'ブラウザで Word 文書を PDF に変換します。.docx を選び、HTML プレビューを確認し、手順どおり印刷用 PDF を書き出します。ファイルは端末内に留まり、サーバーにアップロードしません。入場時のサンプルでプロセスと例が動きます。',
  ...
  tool_create_budget_spreadsheet_description:
    '予算表を作ってxlsxを保存。手順：費目と金額。例：家賃1200+食費400。会計ソフトではない。計算はブラウザ内。手順と例はサンプルと同じ方式です。ファイルは端末内で、サーバーにアップロードしません。いつでもサンプルを読めます。ページの例と同じです。',
  ...
  tool_create_excel_timesheet_description:
    '勤務表を作ってxlsxを保存。手順：日付・案件・時間。例：平日5日×8で40。給与計算ではない。計算はブラウザ内。手順と例はサンプルと同じ方式です。ファイルは端末内で、サーバーにアップロードしません。いつでもサンプルを読めます。ページの例と同じです。',
  ...
  tool_create_invoice_spreadsheet_description:
    '請求書表を作ってxlsxをダウンロード。手順：売主・行・税率。例：2行×10、税10%で22。電子インボイスではない。計算はブラウザ内。手順と例はサンプルと同じ方式です。ファイルは端末内で、サーバーにアップロードしません。いつでもサンプルを読めます。ページの例と同じです。',
  ...
  tool_create_pdf_form_description:
    '白紙から PDF フォームを作ります。名前付きのテキスト欄またはチェック欄を X/Y と幅・高さで追加してダウンロード。サーバーには送らず、このタブ内で組み立てます。入場サンプルは Name と Email。プロセス・手順・例を足してから書き出せます。',
  ...
  tool_create_zip_file_faq_a1: 'いいえ。バイトはこのタブ内で読みます。ZIP エンジンスクリプトはこのサイトから読みますが、ファイルは当サイトのサーバーには上がりません。',
  ...
  tool_crop_pdf_faq_a1: 'いいえ。PDF ライブラリ はタブ内で動作（スクリプトは このサイトから読み込みます）。PDF は当社サーバーに送られません。',
  ...
  tool_edit_pdf_form_fields_description:
    'このタブで PDF フォームの欄を編集します。既存の名前を一覧し、改名するか削除に印を付けてダウンロード。ファイルは端末内に留まり、サーバーにアップロードしません。入場サンプルは Name + Email なので、すぐに一覧が見えます。プロセス・手順・例を確認してから本番ファイルに触れてください。',
  ...
  tool_edit_pdf_text_online_description:
    'ブラウザでPDFのテキストをオンライン編集します。編集欄で直し、適用で元のページに書き戻すので、写真・図・直していない行が残ります。ファイルは端末内に留まり、サーバーにアップロードしません。入場時の例で手順が動きます：単語を1つ直しても画像が残ります。スキャン頁は失敗します。',
  ...
  tool_excel_compare_files_faq_a1: 'いいえ。このタブで SheetJS がバイトを読みます。ライブラリはこのサイトから読みますが、ファイルは当社サーバーに送りません。',
  tool_excel_compare_files_faq_a2: '既定では先頭シートが選ばれます。同じファイルの別タブが要るときはシート一覧を使います。選んでいないシートは比べません。',
  tool_excel_compare_files_faq_a3: 'できます。CSV は1枚のシートとして読み込むため、2つの CSV 同士や、CSV 書き出しと Excel シートをセル番地で比較できます。',
  ...
  tool_excel_formulas_cheat_sheet_description:
    '一覧からよく使うExcel数式をコピー。手順：名前で絞り、カードからコピー。例：IF。ネストIF作成器ではない。計算はブラウザ内。手順と例はサンプルと同じ方式です。ファイルは端末内で、サーバーにアップロードしません。いつでもサンプルを読めます。ページの例と同じです。',
  ...
  tool_extract_text_from_pdf_article: 'PDF からテキストを抽出. ファイルは端末内に留まり、サーバーにアップロードしません。',
  tool_extract_text_from_pdf_choose_file: 'PDF を選択',
  tool_extract_text_from_pdf_choose_files: 'ファイルを選択',
  tool_extract_text_from_pdf_clear: 'クリア',
  tool_extract_text_from_pdf_copy: 'コピー',
  tool_extract_text_from_pdf_desc: 'PDF からテキストを抽出 — ファイルは端末内に留まり、サーバーにアップロードしません。',
  tool_extract_text_from_pdf_description:
    'PDF からテキストを抽出. ファイルは端末内に留まり、サーバーにアップロードしません。 サンプルで実際の入力と出力を確認でき、手順と制限は本文で説明します。 手順は PDF を選び、各ページの選択可能な文字を抽出し、ページ数と文字数を確認してコピーまたは TXT 保存します。例では「Hello extract text sample」を取得します。画像だけのスキャン PDF は OCR せず、元の段組みも再構築しません。',
  tool_extract_text_from_pdf_download: 'ダウンロード',
  tool_extract_text_from_pdf_drop_hint: 'ここにドロップ。処理はこのタブ内で行われます。',
  tool_extract_text_from_pdf_empty: '先にファイルを選択してください。',
  tool_extract_text_from_pdf_err_convert: '処理に失敗しました。',
  tool_extract_text_from_pdf_err_encrypted: 'PDF にパスワードがある可能性があります。',
  tool_extract_text_from_pdf_err_load: 'ファイルを読めません。',
  tool_extract_text_from_pdf_err_notext: '選択可能なテキストがありません（OCR なし）。',
  tool_extract_text_from_pdf_err_pdfjs: 'PDF レンダラー読み込み失敗。',
  ...
  tool_extract_text_from_pdf_faq_a2:
    'Scanned PDFs are images without a text layer; this tool does not OCR. For a scanned PDF that needs Word, use Batch convert scanned PDF to Word with OCR.',
  ...
  tool_extract_text_from_pdf_faq_q1: 'ファイルはアップロードされますか？',
  ...
  tool_extract_text_from_pdf_how_body:
    'テキスト層のある PDF を選び、plain 段落を抽出（改ページは空行）、コピーまたは .txt をダウンロード。## Page N 見出し付き Markdown 草案は「PDF を Markdown に」を使ってください。',
  tool_extract_text_from_pdf_how_item_1: 'PDF を選択またはドロップ（またはサンプル読み込み）',
  tool_extract_text_from_pdf_how_item_2: '「抽出」を押して処理を実行',
  tool_extract_text_from_pdf_how_item_3: 'テキストプレビューを確認',
  tool_extract_text_from_pdf_how_item_4: '必要なら .txt をダウンロードまたはコピー',
  tool_extract_text_from_pdf_how_title: '使い方',
  tool_extract_text_from_pdf_pages_label: 'Pages',
  tool_extract_text_from_pdf_preview_label: 'Text preview',
  tool_extract_text_from_pdf_rules_body: 'ファイルは端末内に留まり、サーバーにアップロードしません。',
  tool_extract_text_from_pdf_rules_item_1: '出力はページ間に空行の plain UTF-8 テキスト（.txt）— Markdown 見出しなし。',
  ...
  tool_extract_text_from_pdf_rules_title: 'ルールと制限',
  tool_extract_text_from_pdf_sample: 'サンプルを読み込む',
  tool_extract_text_from_pdf_stats_tpl: '{n} page(s) · {chars} characters',
  tool_extract_text_from_pdf_status_done: '完了',
  tool_extract_text_from_pdf_status_working: '処理中…',
  ...
  tool_extract_text_from_pdf_usecases_title: '向いている用途',
  ...
  tool_file_hash_faq_a4: 'アップロードなし。テキストとファイルは端末内。SHA 系は Web Crypto。MD5 のみこのサイトから crypto-js を読みます — 内容は第三者に送りません。',
  ...
  tool_file_hash_rules_item_4: 'プライバシー：アップロードなし。本サイト読み込みは MD5 のみ；SHA 系は組み込み Web Crypto のみ。',
  ...
  tool_fill_out_pdf_form_description:
    'ブラウザで PDF フォームに入力します。テキスト欄とチェック欄を検出し、値を書いてダウンロード。ファイルは端末内に留まり、サーバーにアップロードしません。入場時のサンプルは Name と Email の 2 欄をあらかじめ埋めた例で、プロセス・手順・例をそのまま自分の PDF に繰り返せます。',
  ...
  tool_film_prompt_builder_act1_ph: '例：もめごとの発端と、受け入れざるを得ない条件…',
  tool_film_prompt_builder_act2_label: '第二幕',
  tool_film_prompt_builder_act2_ph: '例：短い成功のあと収拾がつかなくなる…',
  tool_film_prompt_builder_act3_label: '第三幕',
  tool_film_prompt_builder_act3_ph: '例：正面からの対決と、代償のある折り合い…',
  ...
  tool_film_prompt_builder_ai_consent_cancel: 'やめる',
  tool_film_prompt_builder_ai_consent_ok: '続ける',
  tool_film_prompt_builder_ai_consent_title: '下書きを Cloudflare Workers AI に送りますか',
  tool_film_prompt_builder_ai_done: 'AI の文章を全文そのまま出力欄に書き込みました。コピーする前に確認してください。',
  tool_film_prompt_builder_ai_err_generic: '今回は AI が応答しませんでした。出力欄の内容はそのままです。',
  tool_film_prompt_builder_ai_err_rate: 'AI の上限に達しました。ここでの組み立てを続けるか、UTC の翌日に試してください。',
  tool_film_prompt_builder_ai_err_turnstile: 'AI を使う前に Turnstile の確認を済ませてください。',
  tool_film_prompt_builder_ai_expand: 'AI で加筆',
  tool_film_prompt_builder_ai_panel_label: '任意：Cloudflare AI（Turnstile 必須）',
  tool_film_prompt_builder_ai_polish: 'AI で整える',
  tool_film_prompt_builder_ai_working: 'Cloudflare AI が処理しています…',
  ...
  tool_film_prompt_builder_build: 'プロンプトを作る',
  tool_film_prompt_builder_character_arc_label: '人物の変化',
  tool_film_prompt_builder_character_arc_ph: '例：矜持 → 渋々の協働 → 共同経営者…',
  tool_film_prompt_builder_clear: '消す',
  ...
  tool_film_prompt_builder_empty: 'どれか一つは入力してからプロンプトを作ってください。',
  ...
  tool_film_prompt_builder_example_title: '入力と出力の例',
  ...
  tool_film_prompt_builder_faq_a5: 'できます。JSON に切り替えると、同じ出力欄に項目化したデータと組み立て済みのプロンプト本文が並ぶので、稿ごとの三幕とシーンリストを表や版管理に残して見比べられます。',
  tool_film_prompt_builder_faq_a6: '使えます。出力をコピーして好きなチャット欄に貼ってください。このページは構成を整えるだけで API を呼ばないため、サービスごとに別 URL を用意していません。',
  ...
  tool_film_prompt_builder_faq_q1: '入力した脚本の内容はどこかに送信されますか',
  tool_film_prompt_builder_faq_q2: 'ChatGPT などのモデル API を呼びますか',
  tool_film_prompt_builder_faq_q3: 'プロンプトテンプレート作成ツールとの違いは何ですか',
  tool_film_prompt_builder_faq_q4: 'AI を使うのに Turnstile が必要なのはなぜですか',
  tool_film_prompt_builder_faq_q5: 'JSON で受け取れますか',
  tool_film_prompt_builder_faq_q6: 'ChatGPT・Gemini・Claude・DeepSeek で使えますか',
  tool_film_prompt_builder_faq_q7: 'ローカル動作と任意の Cloudflare AI はどう違いますか',
  tool_film_prompt_builder_fmt_json: 'JSON',
  tool_film_prompt_builder_fmt_label: '出力の形式',
  ...
  tool_film_prompt_builder_how_item_1: '「サンプルを読み込む」でデフォルトのプリセットを入れる。',
  tool_film_prompt_builder_how_item_2: 'ログライン・三幕・シーンリスト・人物の変化を直して「プロンプトを作る」を押します。項目ごとに書き出したいときは JSON へ。',
  tool_film_prompt_builder_how_item_3: '任意：AI 欄で Turnstile を済ませ、「AI で加筆」か「AI で整える」を押すと、返ってきた文章が出力欄に入ります。',
  tool_film_prompt_builder_how_item_4: 'コピーまたはダウンロードして ChatGPT・Gemini・Claude・DeepSeek に貼り、この構成のまま続きを書かせます。',
  tool_film_prompt_builder_how_title: '使い方',
  tool_film_prompt_builder_load_sample: '作例を読み込む',
  tool_film_prompt_builder_logline_label: 'ログライン',
  tool_film_prompt_builder_logline_ph: '例：いがみ合う二台のフードトラックが同じ厨房を使う…',
  tool_film_prompt_builder_platforms_lead: '出力はそのまま ChatGPT・Gemini・Claude・DeepSeek の入力欄に貼れます。',
  tool_film_prompt_builder_result_label: '出来上がったプロンプト',
  ...
  tool_film_prompt_builder_rules_item_1: '入力欄の項目は、Markdown の Role・Task・Constraints・Output のいずれかに振り分けられます。',
  tool_film_prompt_builder_rules_item_2: '既定の書き出しは Markdown。JSON は同じ出力欄の切り替えボタンです。',
  tool_film_prompt_builder_rules_item_3: '任意の AI は一手間を足すだけで、置き換えではありません。ローカル動作はいつでも使え、AI の文章は出力欄を全部入れ替えるので、コピー前に読み直してください。',
  tool_film_prompt_builder_rules_item_4: 'このページが作るのは文章だけです。脚本を代わりに書くことはなく、ブラウザー内でモデルやチャット API を動かすこともありません。',
  tool_film_prompt_builder_rules_title: 'できること・できないこと',
  tool_film_prompt_builder_scene_list_label: 'シーンリスト',
  tool_film_prompt_builder_scene_list_ph: '例：1. 路地の駐車争い 2. 二重の衛生検査…',
  ...
  tool_film_prompt_builder_status_done: 'プロンプトができました。',
  tool_film_prompt_builder_status_working: '組み立てています…',
  tool_film_prompt_builder_title: '映画脚本プロンプト作成ツール — 三幕とシーンリストをブラウザー内で',
  tool_film_prompt_builder_usecase_1: '打ち合わせ前に三幕の流れとシーンリストを一つのプロンプトにまとめ、ChatGPT・Gemini・Claude・DeepSeek にそのまま貼る。',
  tool_film_prompt_builder_usecase_2: 'JSON を書き出し、稿ごとのログライン・三幕・人物の変化を表や版管理の項目として残して見比べる。',
  tool_film_prompt_builder_usecase_3: '長編の三幕ではなく題材を問わない四段構成のひな型が欲しいときは、プロンプトテンプレート作成ツールを使う。',
  tool_film_prompt_builder_usecase_4: '契約前の企画はローカル動作だけで進める。確認ダイアログに同意しない限り、文章はブラウザーから出ません。',
  tool_film_prompt_builder_usecases_title: 'こんなときに',
  ...
  tool_find_and_validate_xml_sitemap_faq_a1: 'いいえ。既存のサイトマップを見つけて検証するだけです。URL一覧から作るなら XML Sitemap 生成ツールを使ってください。',
  tool_find_and_validate_xml_sitemap_faq_a2: 'まず robots.txt の Sitemap: 行、次に同じホストの /sitemap.xml と一般的なインデックスパスです。',
  tool_find_and_validate_xml_sitemap_faq_a3: 'sitemapindex は子サイトマップURL、urlset はページ loc。どちらもプロトコル上の正当なルートで、表に種類が出ます。',
  tool_find_and_validate_xml_sitemap_faq_a4: 'しません。<loc> の件数とサンプル、構造チェックのみで、各ページの生存確認はしません。',
  tool_find_and_validate_xml_sitemap_faq_a5: 'robots.txt とサイトマップ取得のため URL/ホスト名は Worker に届きます。チェック結果を業務DBとして長期保存はしません。エッジツールであり「アップロードなし」ではありません。',
  ...
  tool_find_and_validate_xml_sitemap_fetch_failed: 'サイトマップ候補を取得できませんでした。ホストがオフラインか、ボットを拒否している可能性があります。',
  tool_find_and_validate_xml_sitemap_formula_body: 'sitemaps.org プロトコルに沿います。整形式の XML で、ルートが urlset か sitemapindex、かつ <loc> を数えられること。',
  tool_find_and_validate_xml_sitemap_formula_item_1: '発見順：robots.txt の Sitemap: → /sitemap.xml → /sitemap_index.xml → /sitemap-index.xml。',
  tool_find_and_validate_xml_sitemap_formula_item_2: '応答がサイトマップXMLらしく、HTTPが成功なら「構造OK」とします。',
  tool_find_and_validate_xml_sitemap_formula_item_3: 'sitemapindex は子サイトマップ、urlset はページ loc。どちらも報告します。',
  tool_find_and_validate_xml_sitemap_formula_item_4: '<loc> を数え、最大10件のサンプルを表示。一覧の全URLはクロールしません。',
  tool_find_and_validate_xml_sitemap_formula_item_5: 'gzip・巨大本文・リダイレクト・非XMLは失敗し得ます。プライベートホストは拒否します。',
  tool_find_and_validate_xml_sitemap_formula_title: '発見と検証のルール',
  tool_find_and_validate_xml_sitemap_home_desc: 'robots.txt または /sitemap.xml からサイトマップを見つけ、構造・種類・loc サンプルを確認します。',
  tool_find_and_validate_xml_sitemap_home_title: 'XMLサイトマップの検索と検証',
  tool_find_and_validate_xml_sitemap_how_body: 'やることは一つだけです。サイトの XMLサイトマップを見つけ、urlset / sitemapindex として妥当かを見る——新しいファイルは作りません。',
  tool_find_and_validate_xml_sitemap_how_item_1: 'サイトのオリジンまたはトップページURLを入力します。',
  tool_find_and_validate_xml_sitemap_how_item_2: '「検索して検証」を押すと、Worker が robots.txt の Sitemap: を読み、続けて /sitemap.xml など一般的なパスを試します。',
  tool_find_and_validate_xml_sitemap_how_item_3: '結果表でルート種類（urlset / sitemapindex）、URL数、サンプル <loc> を確認します。',
  tool_find_and_validate_xml_sitemap_how_item_4: 'IndexNow や Search Console に送る前に、ここで出た XML / 発見の問題を直します。',
  tool_find_and_validate_xml_sitemap_how_title: '使い方',
  tool_find_and_validate_xml_sitemap_privacy_note: 'URL とホスト名は robots.txt / sitemap 取得のため Worker に送られます。業務DBとして長期保存しません。',
  ...
  tool_find_and_validate_xml_sitemap_references: 'sitemaps.org プロトコル；Google Search Central — サイトマップ概要。',
  ...
  tool_find_and_validate_xml_sitemap_usecase_1: 'サイトマップ検索：CMS移行やCDN切替のあと、公開場所を確認する。',
  tool_find_and_validate_xml_sitemap_usecase_2: 'XMLサイトマップ チェッカー / バリデータ：Search Console 提出前に整形式か、インデックスか urlset かを確認。',
  tool_find_and_validate_xml_sitemap_usecase_3: 'loc のざっと確認：大きなサイトマップ再生成後、サンプル <loc> だけ見て全体ダウンロードを避ける。',
  ...
  tool_images_to_pdf_example_title: 'JPG を PDF にまとめる',
  ...
  tool_ios_prompt_builder_ai_consent_title: '下書きを Cloudflare Workers AI に送りますか？',
  tool_ios_prompt_builder_ai_done: 'AI の文章で結果欄を置き換えました。コピー前に確認してください。',
  tool_ios_prompt_builder_ai_err_generic: 'AI に失敗しました。結果欄は変わっていません。',
  tool_ios_prompt_builder_ai_err_rate: 'AI の利用上限に達しました。ローカル生成を使うか、翌日（UTC）に再試行してください。',
  tool_ios_prompt_builder_ai_err_turnstile: 'AI を使う前に Turnstile を通してください。',
  tool_ios_prompt_builder_ai_expand: 'AI で拡張',
  tool_ios_prompt_builder_ai_panel_label: '任意の Cloudflare AI（Turnstile）',
  tool_ios_prompt_builder_ai_polish: 'AI で仕上げ',
  tool_ios_prompt_builder_ai_working: 'Cloudflare AI が処理中…',
  ...
  tool_ios_prompt_builder_build: 'プロンプトを作成',
  ...
  tool_ios_prompt_builder_empty: '少なくとも 1 つの項目を入力してください。',
  ...
  tool_ios_prompt_builder_example_title: '入出力の例',
  ...
  tool_ios_prompt_builder_faq_a4: '必要です。「AI で拡張」「AI で仕上げ」の前に、AI パネルの Turnstile を通してください。有効なトークンがないとボタンはエラーを返しますが、ローカル生成はそのまま使えます。',
  tool_ios_prompt_builder_faq_a5: 'できます。出力形式を JSON にすると、各項目の原文と組み立て済みのプロンプト本文が同時に出力され、XCTest のケースや設定パイプラインに流し込めます。',
  tool_ios_prompt_builder_faq_a6: '使えます。出力はプレーンテキストなので、コピーして ChatGPT・Gemini・Claude・DeepSeek の入力欄に貼るだけです。このページが代わりに API を呼ぶことはありません。',
  tool_ios_prompt_builder_faq_a7:
    'ローカル生成は入力を並べ替えるだけで、通信も回数制限もありません。任意の拡張・仕上げは下書きを Cloudflare Workers AI に送り（Turnstile 必須、利用上限あり）、返ってきた文章が結果欄を丸ごと置き換えます。コピーする前に必ず読み直してください。失敗したときや上限に達したときは、ローカル生成を続けてください。',
  tool_ios_prompt_builder_faq_q1: '入力した内容はアップロードされますか？',
  tool_ios_prompt_builder_faq_q2: 'ChatGPT などのモデル API を呼び出しますか？',
  tool_ios_prompt_builder_faq_q3: 'プロンプトテンプレート作成ツールとの違いは？',
  tool_ios_prompt_builder_faq_q4: '任意の AI に Turnstile が必要な理由は？',
  tool_ios_prompt_builder_faq_q5: 'JSON で書き出せますか？',
  tool_ios_prompt_builder_faq_q6: 'ChatGPT・Gemini・Claude・DeepSeek で使えますか？',
  tool_ios_prompt_builder_faq_q7: 'ローカル生成と任意の Cloudflare AI はどう違いますか？',
  tool_ios_prompt_builder_feature_spec_label: '機能 / 仕様',
  tool_ios_prompt_builder_feature_spec_ph: '例：週次歩数と安静時心拍の帯…',
  tool_ios_prompt_builder_fmt_json: 'JSON',
  tool_ios_prompt_builder_fmt_label: '出力形式',
  tool_ios_prompt_builder_fmt_md: 'Markdown',
  tool_ios_prompt_builder_hig_constraints_label: 'HIG / アクセシビリティ',
  tool_ios_prompt_builder_hig_constraints_ph: '例：Dynamic Type XXL、VoiceOver、強制アンラップ禁止…',
  tool_ios_prompt_builder_how_body:
    '4 つの項目を埋めると、ブラウザ内で Markdown（または JSON）に整形されます。もっと書き足したいときだけ Cloudflare AI に拡張させ、最後に ChatGPT・Gemini・Claude・DeepSeek へ貼ってください。',
  tool_ios_prompt_builder_how_item_1: '「見本を読み込む」を押すと既定の入力が入り、プロンプトが 1 本できます。そこから書き換えてください。',
  tool_ios_prompt_builder_how_item_2: '機能・Swift スタック・SwiftUI・HIG を書き換えて「プロンプトを作成」を押します。構造化して渡すなら JSON に切り替えます。',
  tool_ios_prompt_builder_how_item_3: '任意：Turnstile を通してから「AI で拡張」または「AI で仕上げ」を押すと、返ってきた文章が結果欄を置き換えます。',
  tool_ios_prompt_builder_how_item_4: '結果をコピーまたはダウンロードし、ChatGPT・Gemini・Claude・DeepSeek に貼って質問します。',
  tool_ios_prompt_builder_how_title: '使い方',
  tool_ios_prompt_builder_load_sample: '見本を読み込む',
  tool_ios_prompt_builder_platforms_lead: '出力はプレーンテキストなので、ChatGPT・Gemini・Claude・DeepSeek のどれにでもそのまま貼れます。',
  tool_ios_prompt_builder_result_label: 'プロンプト出力',
  tool_ios_prompt_builder_rules_body: 'このページは依頼文を整えるだけで、コードのコンパイルも Xcode のビルドもしません。任意の AI には利用上限があり、Turnstile の通過が必要です。',
  tool_ios_prompt_builder_rules_item_1: '4 つの項目は Markdown の Role・Task・Constraints・Output に分かれて入ります。',
  tool_ios_prompt_builder_rules_item_2: '既定の出力は Markdown。同じ結果欄で JSON に切り替えると、項目の原文と完成した本文が並びます。',
  tool_ios_prompt_builder_rules_item_3: '任意の Cloudflare AI はローカル生成の代わりではありません。返答は結果欄を丸ごと置き換えるので、コピー前に確認してください。',
  tool_ios_prompt_builder_rules_item_4: 'このツールは文章を組み立てるだけで、Swift のビルドや Xcode の実行、チャット API の代理呼び出しはしません。',
  tool_ios_prompt_builder_rules_title: '知っておきたい制限',
  ...
  tool_ios_prompt_builder_status_done: 'プロンプトができました。',
  tool_ios_prompt_builder_status_working: 'プロンプトを組み立て中…',
  tool_ios_prompt_builder_swift_stack_label: 'Swift / 技術スタック',
  tool_ios_prompt_builder_swift_stack_ph: '例：Swift 5.10、SwiftUI、iOS 17+、SwiftData…',
  tool_ios_prompt_builder_swiftui_ui_label: 'SwiftUI / 画面',
  tool_ios_prompt_builder_swiftui_ui_ph: '例：NavigationStack、Charts、権限説明シート…',
  tool_ios_prompt_builder_title: 'iOS プロンプト生成ツール — ブラウザ内で作成、AI 拡張は任意',
  tool_ios_prompt_builder_usecase_1: 'デザインレビューで口頭に出た iOS の要件を、チャットに貼れるプロンプトとしてまとめる。',
  tool_ios_prompt_builder_usecase_2: 'JSON で書き出して HIG の条件をチェックリストに移し、必要なら Cloudflare AI で拡張する。',
  tool_ios_prompt_builder_usecase_3: 'iOS 固有の項目が不要で汎用の 4 ブロックで足りるときは、プロンプトテンプレート作成ツールに切り替える。',
  tool_ios_prompt_builder_usecase_4: '未公表の機能説明をまずブラウザ内で仕上げ、外に出せると判断してから任意の AI を使う。',
  tool_ios_prompt_builder_usecases_title: 'こんなときに',
  ...
  tool_json_diff_checker_online_faq_a3: '通常は配列を添字ごとに比較します。順序を無視すると正規化した要素を並べ替えますが、重複は残ります。結果の添字は並べ替え後の順序で、id によるオブジェクト照合はしません。',
  tool_json_diff_checker_online_faq_a4: '有効な JSON だけを解析します。YAML や XML の構文は受け付けないため、YAML は先に JSON へ変換するか、形式専用の比較ツールを使ってください。',
  ...
  tool_json_diff_checker_online_rules_item_3: '配列順を無視すると正規化した要素を並べ替えますが重複は保持します。結果の添字は元の位置ではなく比較時の順序です。',
  ...
  tool_json_schema_validator_faq_a4: 'Schema と JSON はアップロードされません。このサイトは Ajv のコードだけを取得します。',
  ...
  tool_json_schema_validator_rules_item_4: 'プライバシー：貼り付けはタブ内。このサイトは Ajv コードのみ取得します。',
  ...
  tool_magnet_link_decoder_how_item_1: '完全な Magnet URI を 1 件貼り付けます。',
  tool_magnet_link_decoder_how_item_2: '「解析」を押します（またはサンプルを読み込む）。',
  tool_magnet_link_decoder_how_item_3: 'infohash、表示名、サイズ、tracker 一覧を確認します。',
  tool_magnet_link_decoder_how_item_4: '必要なら JSON または正規化 URI をコピーします。',
  ...
  tool_make_a_30_second_mp3_ringtone_desc: '手元で30秒のMP3着信音を作る：曲を切り、端をフェードして MP3 を書き出します。端末内で処理し、サーバーにアップロードしません。',
  ...
  tool_make_a_30_second_mp3_ringtone_disclaimer: 'そのファイルを処理する権利があることを確認してください。楽曲ライセンスは付与せず、M4R も配信の代行取得もしません。',
  ...
  tool_make_a_30_second_mp3_ringtone_duration_hint: '初期は30秒です。チップは今の開始位置から 15 / 20 / 30 / 40 秒にします。40秒超は拒否します。',
  tool_make_a_30_second_mp3_ringtone_empty: '先に音声ファイルを選んでください。',
  tool_make_a_30_second_mp3_ringtone_err_caps: 'このファイルは端末の上限を超えています（デスクトップ約 40 MB / 20 分、狭い画面は約 20 MB / 8 分）。先に短くするか、短いファイルを使ってください。',
  tool_make_a_30_second_mp3_ringtone_err_decode: 'このブラウザではそのファイルを復号できません。WAV や MP3、DRM のない素材を試してください。',
  tool_make_a_30_second_mp3_ringtone_err_empty: '着信音にする材料がありません。ファイルかサンプルを読み込んでください。',
  tool_make_a_30_second_mp3_ringtone_err_fade: 'フェードインとフェードアウトの合計は長さより短くしてください。フェードを短くするか、区間を長くしてください。',
  tool_make_a_30_second_mp3_ringtone_err_lame: 'MP3 エンコーダの読み込みに失敗しました。このタブに留まったまま、もう一度「MP3を書き出す」を押してください。',
  ...
  tool_make_a_30_second_mp3_ringtone_err_video: '動画を主入力にはできません。先に音声を取り出してから、その音で着信音を作ってください。',
  ...
  tool_make_a_30_second_mp3_ringtone_fade_hint: '初期はフェードイン 0.5秒、フェードアウト 1.5秒です。サビがブツ切りになりません。線形ゲインで、ファイルは短くなりません。',
  tool_make_a_30_second_mp3_ringtone_fade_in: 'フェードイン（秒）',
  tool_make_a_30_second_mp3_ringtone_fade_out: 'フェードアウト（秒）',
  tool_make_a_30_second_mp3_ringtone_faq_a1: 'いいえ。復号とフェードはこのタブ内です。スクリプトはこのサイトから読み込みます。ファイルはサーバーに送られません。',
  tool_make_a_30_second_mp3_ringtone_faq_a2: '別ツールではありません。着信音作成、MP3着信音、着メロ作成、30秒着信音、曲を着信音に、はすべて：約30秒を残し、端をフェードして「MP3を書き出す」です。',
  tool_make_a_30_second_mp3_ringtone_faq_a3: '着信音としてよく使われるのが30秒です。15・20・40秒のチップもあります。40秒超は拒否し、普通の長尺カットにはしません。',
  tool_make_a_30_second_mp3_ringtone_faq_a4: '選択区間に線形の音量ランプをかけます。初期は入り 0.5秒、終わり 1.5秒。長さは変わらず、音量だけ変わります。合計は長さより短くしてください。',
  ...
  tool_make_a_30_second_mp3_ringtone_faq_a6: 'Android では MP3 をダウンロードし、着信音フォルダへ置くか、設定 → 音で選びます。',
  tool_make_a_30_second_mp3_ringtone_faq_a7: '違います。任意長のトリムは別ページ、シームレスループは末尾を先頭へクロスフェードする作業です。波形スタジオでも YouTube 取得でもありません。',
  tool_make_a_30_second_mp3_ringtone_faq_a8: 'デスクトップは約 40 MB または 20 分、狭い画面は約 20 MB または 8 分。超えると復号前に拒否します。着信音区間自体も40秒までです。',
  ...
  tool_make_a_30_second_mp3_ringtone_how_body: '手元の曲からおよそ30秒を残し、端をフェードしてブツ切りを避け、MP3 をダウンロードします。ファイルはサーバーに上げません。',
  tool_make_a_30_second_mp3_ringtone_how_item_1: '音声ファイルを開く（または「サンプルを読み込む」）。',
  tool_make_a_30_second_mp3_ringtone_how_item_2: '波形をドラッグするか、開始と長さを入力（初期30秒、チップ 15 / 20 / 30 / 40）。0.5秒 / 1.5秒のフェードが合わなければ変更。',
  ...
  tool_make_a_30_second_mp3_ringtone_preview_hint: '波形をクリックまたはドラッグして開始と長さを決めます。「着信音を作る」のあと、「再生」はフェード済みクリップを着信のように繰り返します。',
  tool_make_a_30_second_mp3_ringtone_result_tpl: '着信音は {dur}秒（{start}〜{end}秒）、フェードイン {fadeIn}秒、フェードアウト {fadeOut}秒です。MP3を書き出せます。',
  tool_make_a_30_second_mp3_ringtone_rules_body: '開始＋長さ（最大40秒）で区間をコピーします。線形フェードはゲインだけ変え、書き出し長さは区間のままです。「MP3を書き出す」後に指定ビットレートの CBR になります。',
  tool_make_a_30_second_mp3_ringtone_rules_item_1: 'デスクトップは約 40 MB または 20 分、狭い画面は約 20 MB または 8 分。超過は拒否し、切り詰めません。着信音区間は40秒までです。',
  tool_make_a_30_second_mp3_ringtone_rules_item_2: 'ファイルは端末内に留まり、サーバーにアップロードしません。MP3 エンコーダはこのサイトから「MP3を書き出す」後にだけ読み込みます。',
  tool_make_a_30_second_mp3_ringtone_rules_item_3: '初期の長さは30秒。フェードイン 0.5秒とフェードアウト 1.5秒の合計は長さより短く。フェードでファイルは短くなりません。',
  tool_make_a_30_second_mp3_ringtone_rules_item_4: '復号はブラウザ次第です。DRM、一部コーデック、動画コンテナは明示エラーになります。',
  tool_make_a_30_second_mp3_ringtone_rules_item_5: 'M4R/M4A は書かず、iPhone に着信音を入れず、40秒上限なしのトリムもシームレスループも YouTube 取得もしません。ファイル1つ、窓1つ、MP3 1つです。',
  ...
  tool_make_a_30_second_mp3_ringtone_usecase_1: '権利のある曲のサビを30秒のMP3着信音にし、Android の着信音に設定する。',
  tool_make_a_30_second_mp3_ringtone_usecase_2: '15秒または20秒チップでアラームや通知用の短い音を作り、フェードアウトを残して MP3 にする。',
  tool_make_a_30_second_mp3_ringtone_usecase_3: '先に MP3 を書き出し、iPhone のカスタム着信音が必要なら GarageBand に渡す。このページは M4R を書きません。',
  tool_make_a_30_second_mp3_ringtone_usecases_title: '向いている場面',
  tool_make_a_30_second_mp3_ringtone_why_choose_body: '着信音の長さの MP3 専用です。フェードは耳で確認でき、40秒上限はページに書いてあります。',
  tool_make_a_30_second_mp3_ringtone_why_choose_item_1: '復号とフェードはこのタブ内。「MP3を書き出す」がエンコーダ読み込みの最初です。',
  tool_make_a_30_second_mp3_ringtone_why_choose_item_2: '長さの初期値は30秒。15 / 20 / 40秒チップあり。40秒超は拒否します。',
  tool_make_a_30_second_mp3_ringtone_why_choose_item_3: 'フェードイン 0.5秒・フェードアウト 1.5秒が最初の画面にあり、ブツ切りが初期値ではありません。',
  tool_make_a_30_second_mp3_ringtone_why_choose_item_4: 'M4R を書くふりをせず、ブラウザから iPhone に着信音を入れません。',
  ...
  tool_make_a_30_second_mp3_ringtone_zerocross_hint: '初期はオンです。フェード前の切れ目を整えます。サンプル精度が必要ならオフにしてください。',
  ...
  tool_make_a_seamless_audio_loop_crossfade_hint: '初期値は 50 ms。ドラムは 20 ms、パッドやドローン、環境音は 200–500 ms が向きます。',
  tool_make_a_seamless_audio_loop_desc: '手元でシームレスな音声ループを作る：末尾を先頭へクロスフェードし、WAV か MP3 を書き出します。端末内で処理し、サーバーにアップロードしません。',
  ...
  tool_make_a_seamless_audio_loop_disclaimer: 'そのファイルを処理する権利があることを確認してください。このページは楽曲ライセンスを付与せず、配信の代行取得もしません。',
  ...
  tool_make_a_seamless_audio_loop_equal_power_hint: '初期はオンです。継ぎ目の音量が落ちにくいです。オフにすると線形ミックスになります。',
  tool_make_a_seamless_audio_loop_err_bake: '焼き付け後が約 3 分を超えます。回数を減らすか範囲を短くしてください。',
  tool_make_a_seamless_audio_loop_err_caps: 'このファイルは端末の上限を超えています（デスクトップ約 40 MB / 20 分、狭い画面は約 20 MB / 8 分）。先に短くするか、短いファイルを使ってください。',
  tool_make_a_seamless_audio_loop_err_decode: 'このブラウザではそのファイルを復号できません。WAV や MP3、DRM のない素材を試してください。',
  tool_make_a_seamless_audio_loop_err_empty: 'ループする材料がありません。ファイルかサンプルを読み込んでください。',
  tool_make_a_seamless_audio_loop_err_fade: 'クロスフェードは選択範囲より短くしてください。ミリ秒を下げるか、開始〜終了を長くしてください。',
  tool_make_a_seamless_audio_loop_err_lame: 'MP3 エンコーダの読み込みに失敗しました。このタブに留まったまま、もう一度「MP3を書き出す」を押してください。',
  tool_make_a_seamless_audio_loop_err_range: '終了は開始より後で、復号した長さの内側にしてください。',
  tool_make_a_seamless_audio_loop_err_video: 'このページは動画を主入力にしません。先に音だけ取り出してからループを作ってください。',
  ...
  tool_make_a_seamless_audio_loop_faq_a1: 'いいえ。復号と巻き込みはこのタブ内です。スクリプトはこのサイトから読みます。ファイルをサーバーへ送りません。',
  tool_make_a_seamless_audio_loop_faq_a2: 'いいえ。音声ループ、ループ音源、シームレスループ、クロスフェード、ループメーカー、ループ作成は、範囲を決めて継ぎ目を溶かして書き出す、この同じ作業です。',
  tool_make_a_seamless_audio_loop_faq_a3: 'クロスフェードは範囲の末尾を先頭へ混ぜます。初期は 50 ms の等パワー。ドラムは約 20 ms、パッドは 200–500 ms が目安です。',
  tool_make_a_seamless_audio_loop_faq_a4: '書き出す1周は、開始〜終了よりクロスフェード分だけ短くなります。重なりを一度だけ混ぜるためです。2.00秒＋50 ms なら約 1.95秒です。',
  tool_make_a_seamless_audio_loop_faq_a5: 'ゲームエンジンがファイルを繰り返すなら WAV。配信ソフトがループしないなら詳細設定で 4 周や 8 周を焼き、MP3 にします。「MP3を書き出す」で初めてエンコーダが載ります。',
  tool_make_a_seamless_audio_loop_faq_a6: '回数の初期値は 1 です。詳細設定（任意）で 4 や 8 を焼けます。約 3 分を超える出力は拒否します。10時間版は作りません。',
  tool_make_a_seamless_audio_loop_faq_a7: '2曲をつなぐDJクロスフェードではありません。波形エディタでも、着信音の M4A でも、自動でループ点を探す機能でも、YouTube 取得でもありません。',
  tool_make_a_seamless_audio_loop_faq_a8: 'デスクトップは約 40 MB または 20 分。狭い画面は約 20 MB または 8 分。超えたファイルは拒否し、黙って切り詰めません。',
  ...
  tool_make_a_seamless_audio_loop_how_body: '繰り返したい範囲を決め、末尾を先頭へクロスフェードし、WAV か MP3 を保存します。ファイルは端末内に留まり、サーバーにアップロードしません。',
  tool_make_a_seamless_audio_loop_how_item_1: '音声ファイルを開く（または「サンプルを読み込む」）。',
  tool_make_a_seamless_audio_loop_how_item_2: '波形をクリックまたはドラッグ（あるいは開始と終了を入力）。50 ms で足りなければクロスフェードを変える（20 / 50 / 200 / 500 ms）。',
  ...
  tool_make_a_seamless_audio_loop_preview_hint: '波形をクリックまたはドラッグして開始と終了を決めます。ループを作ったあと「再生」は結果を繰り返し、継ぎ目を聞けます。',
  tool_make_a_seamless_audio_loop_repeats: '回数（焼き付けコピー）',
  tool_make_a_seamless_audio_loop_repeats_hint: 'ファイルを繰り返せる再生側なら初期の 1 周で十分です。繰り返せないときは 4 や 8。約 3 分超は拒否します。',
  tool_make_a_seamless_audio_loop_result_tpl: 'ループは {dur}秒（{start}〜{end}秒、クロスフェード {fade} ms、{n} 周）。書き出せます。',
  ...
  tool_make_a_seamless_audio_loop_rules_item_1: 'デスクトップ上限は約 40 MB または 20 分、狭い画面は約 20 MB または 8 分。超えたファイルは拒否し、切り詰めません。',
  tool_make_a_seamless_audio_loop_rules_item_2: 'ファイルは端末内に留まり、サーバーにアップロードしません。MP3 エンコーダはこのサイトから、「MP3を書き出す」のあとだけ読みます。',
  tool_make_a_seamless_audio_loop_rules_item_3: 'クロスフェードは範囲より短くします。書き出す1周はその重なり分だけ短くなります。曲線の初期は等パワーです。',
  tool_make_a_seamless_audio_loop_rules_item_4: '復号はブラウザ次第です。DRM、一部のコーデック、動画コンテナはエラーを出して失敗します。',
  tool_make_a_seamless_audio_loop_rules_item_5: '2曲のミックス、M4A、BPM 検出、自動ループ探し、YouTube 取得はしません。ファイル1つ、範囲1つ、ループ1つです。',
  ...
  tool_make_a_seamless_audio_loop_usecase_1: 'ゲームの2秒ベッドをシームレスな音声ループにして、ファイルを繰り返すエンジン向けに WAV を書き出す。',
  tool_make_a_seamless_audio_loop_usecase_2: '配信のBGM：フレーズを切り、50 ms のクロスフェードを残し、詳細設定で 8 周焼いて MP3 にする。',
  tool_make_a_seamless_audio_loop_usecase_3: '環境音やドローンを 200–500 ms のクロスフェードでつなぎ、継ぎ目をほとんど聞こえなくする。',
  tool_make_a_seamless_audio_loop_usecases_title: 'こんなときに',
  tool_make_a_seamless_audio_loop_why_choose_body: '「巻いて書き出す」一件に絞っています。フェードは耳で確認でき、上限はページに書いてあります。',
  tool_make_a_seamless_audio_loop_why_choose_item_1: '復号と巻き込みはこのタブ内。「MP3を書き出す」がエンコーダ読み込みの最初のタイミングです。',
  tool_make_a_seamless_audio_loop_why_choose_item_2: '等パワーのクロスフェードが初期オン。20 / 50 / 200 / 500 ms のチップでドラムとパッドを切り替えられます。',
  tool_make_a_seamless_audio_loop_why_choose_item_3: 'ループを作ったあと「再生」が結果を繰り返すので、保存前に継ぎ目を聴けます。',
  tool_make_a_seamless_audio_loop_why_choose_item_4: '大きすぎるファイルと、焼き付けが約 3 分を超える出力は拒否し、黙って切り詰めません。',
  ...
  tool_make_a_seamless_audio_loop_zerocross_hint: '初期はオンです。クロスフェードの前に端を安定させます。サンプル単位で切りたいときはオフにします。',
  ...
  tool_make_pdf_fillable_description:
    'このタブで PDF を入力可能にします。静的ページを開き、X/Y と幅・高さでテキスト欄を置くか、N 個の既定欄を足してダウンロード。ファイルは端末内に留まり、サーバーにアップロードしません。入場サンプルは白紙＋FullName 1 欄で、プロセス・手順・例を自分のファイルにコピーできます。',
  ...
  tool_make_pdf_flipbook_description:
    'ブラウザで PDF めくり冊子を作る手順は、PDF を選び、短いページめくりで確認し、各ページを画像として埋め込んだ単体 HTML を保存することです。出力はオフラインで開け、文書はサーバーにアップロードしません。例は A4 の 2 ページで、保存後も同じページサイズです。',
  ...
  tool_markdown_how_item_1: 'Markdown → HTML または HTML → Markdown タブを選びます。',
  tool_markdown_how_item_2: '左に入力を貼り付けます（またはサンプルを読み込む）。',
  tool_markdown_how_item_3: 'Markdown → HTML では必要なら最小の HTML ドキュメントで包みます。',
  tool_markdown_how_item_4: '右側の変換結果をコピーまたはダウンロードします。',
  ...
  tool_merge_pdf_faq_a1: 'いいえ。pdf-lib はタブ内で動作します（ライブラリはこのサイトから読みます）。PDFはサーバーに送られません。',
  ...
  tool_midjourney_prompt_builder_ai_consent_body:
    'この手順は任意です。いま入力欄にある下書きを Cloudflare Workers AI に送って推論します。当サイトのサーバーから OpenAI・Google・Anthropic・DeepSeek へ転送することはありません。AI を使わなくても、プロンプトはブラウザー内で組み立てられます。',
  tool_midjourney_prompt_builder_ai_consent_cancel: 'やめる',
  tool_midjourney_prompt_builder_ai_consent_ok: '続ける',
  tool_midjourney_prompt_builder_ai_consent_title: '下書きを Cloudflare Workers AI に送りますか',
  tool_midjourney_prompt_builder_ai_done: 'AI の文章を全文そのまま出力欄に書き込みました。コピーする前に確認してください。',
  tool_midjourney_prompt_builder_ai_err_generic: '今回は AI が応答しませんでした。出力欄の内容はそのままです。',
  tool_midjourney_prompt_builder_ai_err_rate: 'AI の上限に達しました。ここでの組み立てを続けるか、UTC の翌日に試してください。',
  tool_midjourney_prompt_builder_ai_err_turnstile: 'AI を使う前に Turnstile の確認を済ませてください。',
  tool_midjourney_prompt_builder_ai_expand: 'AI で加筆',
  tool_midjourney_prompt_builder_ai_panel_label: '任意：Cloudflare AI（Turnstile 必須）',
  tool_midjourney_prompt_builder_ai_polish: 'AI で整える',
  tool_midjourney_prompt_builder_ai_working: 'Cloudflare AI が処理しています…',
  ...
  tool_midjourney_prompt_builder_aspect_label: '画面比',
  tool_midjourney_prompt_builder_aspect_ph: '例：16:9、9:16、1:1…',
  tool_midjourney_prompt_builder_build: 'プロンプトを作る',
  tool_midjourney_prompt_builder_clear: '消す',
  ...
  tool_midjourney_prompt_builder_empty: 'どれか一つは入力してからプロンプトを作ってください。',
  ...
  tool_midjourney_prompt_builder_example_title: '入力と出力の例',
  ...
  tool_midjourney_prompt_builder_faq_a5: 'できます。JSON に切り替えると、同じ出力欄に項目化したデータと組み立て済みのプロンプト本文が並ぶので、連続生成のスクリプトやテスト、設定ファイルにそのまま回せます。',
  tool_midjourney_prompt_builder_faq_a6: '使えます。出力をコピーして好きなチャット欄に貼るか、Midjourney に直接貼ってください。このページは文章を整えるだけで API を呼ばないため、サービスごとに別 URL を用意していません。',
  ...
  tool_midjourney_prompt_builder_faq_q1: '入力した内容はどこかに送信されますか',
  tool_midjourney_prompt_builder_faq_q2: 'ChatGPT などのモデル API を呼びますか',
  tool_midjourney_prompt_builder_faq_q3: 'プロンプトテンプレート作成ツールとの違いは何ですか',
  tool_midjourney_prompt_builder_faq_q4: 'AI を使うのに Turnstile が必要なのはなぜですか',
  tool_midjourney_prompt_builder_faq_q5: 'JSON で受け取れますか',
  tool_midjourney_prompt_builder_faq_q6: 'ChatGPT・Gemini・Claude・DeepSeek で使えますか',
  tool_midjourney_prompt_builder_faq_q7: 'ローカル動作と任意の Cloudflare AI はどう違いますか',
  tool_midjourney_prompt_builder_fmt_json: 'JSON',
  tool_midjourney_prompt_builder_fmt_label: '出力の形式',
  tool_midjourney_prompt_builder_fmt_md: 'Markdown',
  tool_midjourney_prompt_builder_how_body: '項目を埋めてプロンプトを作り、ChatGPT・Gemini・Claude・DeepSeek に貼るまでの流れです。描写が足りないときは任意の Cloudflare AI で加筆・整えます。',
  tool_midjourney_prompt_builder_how_item_1: '「サンプルを読み込む」でデフォルトのプリセットを入れる。',
  tool_midjourney_prompt_builder_how_item_2: '被写体・画風・光・画面比・パラメーターを直して「プロンプトを作る」を押します。項目ごとに書き出したいときは JSON へ。',
  tool_midjourney_prompt_builder_how_item_3: '任意：AI 欄で Turnstile を済ませ、「AI で加筆」か「AI で整える」を押すと、返ってきた文章が出力欄に入ります。',
  tool_midjourney_prompt_builder_how_item_4: 'コピーまたはダウンロードして、ChatGPT・Gemini・Claude・DeepSeek で詰めるか、Midjourney にそのまま貼ります。',
  tool_midjourney_prompt_builder_how_title: '使い方',
  tool_midjourney_prompt_builder_lighting_label: '光',
  tool_midjourney_prompt_builder_lighting_ph: '例：日の出の逆光、体積霧…',
  tool_midjourney_prompt_builder_load_sample: '作例を読み込む',
  tool_midjourney_prompt_builder_mj_flags_label: 'MJ パラメーター',
  tool_midjourney_prompt_builder_mj_flags_ph: '例：--v 6.1 --style raw --stylize 120…',
  tool_midjourney_prompt_builder_platforms_lead: '出力はそのまま ChatGPT・Gemini・Claude・DeepSeek の入力欄に貼れます。',
  tool_midjourney_prompt_builder_result_label: '出来上がったプロンプト',
  ...
  tool_midjourney_prompt_builder_rules_item_1: '入力欄の項目は、Markdown の Role・Task・Constraints・Output のいずれかに振り分けられます。',
  tool_midjourney_prompt_builder_rules_item_2: '既定の書き出しは Markdown。JSON は同じ出力欄の切り替えボタンです。',
  tool_midjourney_prompt_builder_rules_item_3: '任意の AI は一手間を足すだけで、置き換えではありません。ローカル動作はいつでも使え、AI の文章は出力欄を全部入れ替えるので、コピー前に読み直してください。',
  tool_midjourney_prompt_builder_rules_item_4: 'このページが作るのは文章だけです。画像は生成せず、Midjourney やチャットの API も呼びません。',
  tool_midjourney_prompt_builder_rules_map_1_flag: '--ar 1:1',
  tool_midjourney_prompt_builder_rules_map_1_label: '1:1 正方形',
  tool_midjourney_prompt_builder_rules_map_2_flag: '--ar 16:9',
  tool_midjourney_prompt_builder_rules_map_2_label: '16:9 横長',
  tool_midjourney_prompt_builder_rules_map_3_flag: '--ar 9:16',
  tool_midjourney_prompt_builder_rules_map_3_label: '9:16 縦長',
  tool_midjourney_prompt_builder_rules_map_4_flag: '--v 6.1',
  tool_midjourney_prompt_builder_rules_map_4_label: 'MJ v6 の既定バージョン',
  tool_midjourney_prompt_builder_rules_table_ar: '画面比 → --ar',
  tool_midjourney_prompt_builder_rules_table_note: '画面比を入れると表のとおり --ar として行末に付き、パラメーターにバージョンがなければ --v 6.1 を補います。',
  tool_midjourney_prompt_builder_rules_table_title: 'Midjourney パラメーター対応表',
  tool_midjourney_prompt_builder_rules_table_v: 'バージョン → --v',
  tool_midjourney_prompt_builder_rules_title: 'できること・できないこと',
  ...
  tool_midjourney_prompt_builder_status_done: 'プロンプトができました。',
  tool_midjourney_prompt_builder_status_working: '組み立てています…',
  tool_midjourney_prompt_builder_style_label: '画風',
  tool_midjourney_prompt_builder_style_ph: '例：映画的な水墨、青灰と炭色…',
  tool_midjourney_prompt_builder_subject_label: '被写体',
  tool_midjourney_prompt_builder_subject_ph: '例：苔の橋で抜刀する武士…',
  tool_midjourney_prompt_builder_title: 'Midjourney プロンプト作成ツール — ブラウザー内で組み立て、AI は任意',
  tool_midjourney_prompt_builder_usecase_1: 'チームのチャットにそのまま貼れる Midjourney プロンプトを渡し、パラメーターを口頭で伝える手間をなくす。',
  tool_midjourney_prompt_builder_usecase_2: 'まとめて生成する前に JSON を書き出し、被写体・画風・画面比を自分のスクリプトや表の項目として持っておく。',
  tool_midjourney_prompt_builder_usecase_3: '画像ではなく題材を問わない四段構成のひな型が欲しいときは、プロンプトテンプレート作成ツールを使う。',
  tool_midjourney_prompt_builder_usecase_4: '未公開の案件の下書きはローカル動作だけで進める。確認ダイアログに同意しない限り、文章はブラウザーから出ません。',
  tool_midjourney_prompt_builder_usecases_title: 'こんなときに',
  ...
  tool_og_rules_item_1:
    'Open Graph プロトコルが必須とするのは og:title、og:type、og:image、og:url の 4 つです。og:description は仕様上は任意ですが主要プラットフォームはどこでも表示するため、書かないとプラットフォームがページ本文から独自の要約を作ります。',
  ...
  tool_onpage_canonical_other:
    'canonical が別の URL を指しています。これは「このページはそちらの重複」と Google に伝える指定です。本当に重複のときだけ残してください。canonical はヒントなので、Google が別の URL を選ぶこともあります。',
  ...
  tool_onpage_h1_multiple:
    'H1 が {n} 個見つかりました。Google は H1 の数に関係なくページを評価するので、これはペナルティではありません。それでも H1 を 1 つにして H2〜H6 で区切ったほうが、スクリーンリーダーには読みやすくなります。',
  ...
  tool_open_pdf_in_browser_description:
    'ブラウザで PDF を開く. ファイルは端末内に留まり、サーバーにアップロードしません。 サンプルで実際の入力と出力を確認でき、手順と制限は本文で説明します。 手順はローカル PDF を選ぶと canvas に自動表示され、前へ・次へでページ移動します。例の1ページ PDF も同じ操作を試せます。文字 PDF とスキャン画像 PDF の両方を表示できますが、編集、OCR、共有 URL、クラウド保存は行いません。',
  ...
  tool_organize_pdf_how_item_1: '「PDFを選ぶ」で入力ファイルを選択',
  tool_organize_pdf_how_item_2: 'オプションを設定し「適用」を押す',
  tool_organize_pdf_how_item_3: 'プレビュー、ページ数、ステータスを確認',
  tool_organize_pdf_how_item_4: '「ダウンロード」で結果を保存',
  ...
  tool_password_generator_rules_item_2: '乱数インデックスは crypto.getRandomValues のバイトで、Math.random は使いません。剰余に偏りを生むバイトは捨てて引き直すため、文字プール内の各文字は等確率です。',
  ...
  tool_pdf_page_numbers_faq_a1: 'いいえ。PDF ライブラリ はタブ内で動作（このサイトから読み込みます）。PDF は当社サーバーに送られません。',
  ...
  tool_pdf_page_to_image_sizes_faq_a1: 'いいえ。ページ描画・PDF ライブラリ・ZIP ライブラリ はタブ内で動作します（スクリプトは このサイトから読み込まれます）。PDF は当社サーバーにアップロードされません。',
  ...
  tool_pdf_to_jpg_faq_a1: 'いいえ。ページ描画 と ZIP ライブラリ はタブ内で動作します（スクリプトは このサイトから読み込まれます）。PDF は当社サーバーに送られません。',
  ...
  tool_pdf_to_markdown_faq_a1: 'いいえ。ページ描画 はタブ内で動作します（このサイトから読み込みます）。PDF は当社サーバーに送られません。',
  ...
  tool_pdf_to_markdown_how_body: 'テキスト層のある PDF を選び、変換し、ページ見出し付き Markdown 草案を確認して .md をダウンロード。テキストのないスキャンは明確に失敗 — OCR なし。',
  ...
  tool_pdf_to_markdown_rules_item_1: '各ページは ## Page N とテキスト行；ページは --- で Markdown エディタ向けに区切られます。',
  ...
  tool_pdf_watermark_faq_a1: 'いいえ。PDF ライブラリ はタブ内で動作（このサイトから読み込みます）。PDF は当社サーバーに送られません。',
  ...
  tool_print_pdf_description:
    'PDF を印刷. ファイルは端末内に留まり、サーバーにアップロードしません。 サンプルで実際の入力と出力を確認でき、手順と制限は本文で説明します。 手順は PDF を選び、ページプレビューを確認してからブラウザ標準の印刷画面を開き、用紙、倍率、部数、プリンター、PDF 保存を設定します。例は1ページ文書です。最終的な余白と改ページはブラウザやプリンタードライバーに依存します。',
  ...
  tool_product_design_prompt_builder_ai_consent_title: '下書きを Cloudflare Workers AI に送りますか？',
  tool_product_design_prompt_builder_ai_done: 'AI の文章で結果欄を置き換えました。コピー前に確認してください。',
  tool_product_design_prompt_builder_ai_err_generic: 'AI に失敗しました。結果欄は変わっていません。',
  tool_product_design_prompt_builder_ai_err_rate: 'AI の利用上限に達しました。ローカル生成を使うか、翌日（UTC）に再試行してください。',
  tool_product_design_prompt_builder_ai_err_turnstile: 'AI を使う前に Turnstile を通してください。',
  tool_product_design_prompt_builder_ai_expand: 'AI で拡張',
  tool_product_design_prompt_builder_ai_panel_label: '任意の Cloudflare AI（Turnstile）',
  tool_product_design_prompt_builder_ai_polish: 'AI で仕上げ',
  tool_product_design_prompt_builder_ai_working: 'Cloudflare AI が処理中…',
  ...
  tool_product_design_prompt_builder_build: 'プロンプトを作成',
  ...
  tool_product_design_prompt_builder_design_tokens_label: 'デザイン / トークン',
  tool_product_design_prompt_builder_design_tokens_ph: '例：8pt グリッド、主要色 #2563eb、WCAG AA…',
  tool_product_design_prompt_builder_download: 'ダウンロード',
  tool_product_design_prompt_builder_empty: '少なくとも 1 つの項目を入力してください。',
  ...
  tool_product_design_prompt_builder_example_title: '入出力の例',
  ...
  tool_product_design_prompt_builder_faq_a4: '必要です。「AI で拡張」「AI で仕上げ」の前に、AI パネルの Turnstile を通してください。有効なトークンがないとボタンはエラーを返しますが、ローカル生成はそのまま使えます。',
  tool_product_design_prompt_builder_faq_a5: 'できます。出力形式を JSON にすると、各項目の原文と組み立て済みのプロンプト本文が同時に出力され、要件リポジトリやデザインレビューのひな形に残せます。',
  tool_product_design_prompt_builder_faq_a6: '使えます。出力はプレーンテキストなので、コピーして ChatGPT・Gemini・Claude・DeepSeek の入力欄に貼るだけです。このページが代わりに API を呼ぶことはありません。',
  tool_product_design_prompt_builder_faq_a7:
    'ローカル生成は入力を並べ替えるだけで、通信も回数制限もありません。任意の拡張・仕上げは下書きを Cloudflare Workers AI に送り（Turnstile 必須、利用上限あり）、返ってきた文章が結果欄を丸ごと置き換えます。コピーする前に必ず読み直してください。失敗したときや上限に達したときは、ローカル生成を続けてください。',
  tool_product_design_prompt_builder_faq_q1: '入力した内容はアップロードされますか？',
  tool_product_design_prompt_builder_faq_q2: 'ChatGPT などのモデル API を呼び出しますか？',
  tool_product_design_prompt_builder_faq_q3: 'プロンプトテンプレート作成ツールとの違いは？',
  tool_product_design_prompt_builder_faq_q4: '任意の AI に Turnstile が必要な理由は？',
  tool_product_design_prompt_builder_faq_q5: 'JSON で書き出せますか？',
  tool_product_design_prompt_builder_faq_q6: 'ChatGPT・Gemini・Claude・DeepSeek で使えますか？',
  tool_product_design_prompt_builder_faq_q7: 'ローカル生成と任意の Cloudflare AI はどう違いますか？',
  ...
  tool_product_design_prompt_builder_how_body:
    '4 つの項目を埋めると、ブラウザ内で Markdown（または JSON）に整形されます。もっと書き足したいときだけ Cloudflare AI に拡張させ、最後に ChatGPT・Gemini・Claude・DeepSeek へ貼ってください。',
  tool_product_design_prompt_builder_how_item_1: '「見本を読み込む」を押すと既定の入力が入り、プロンプトが 1 本できます。そこから書き換えてください。',
  tool_product_design_prompt_builder_how_item_2: 'ターゲット像・課題・ワイヤー範囲・デザイントークンを書き換えて「プロンプトを作成」を押します。構造化して渡すなら JSON に切り替えます。',
  tool_product_design_prompt_builder_how_item_3: '任意：Turnstile を通してから「AI で拡張」または「AI で仕上げ」を押すと、返ってきた文章が結果欄を置き換えます。',
  tool_product_design_prompt_builder_how_item_4: '結果をコピーまたはダウンロードし、ChatGPT・Gemini・Claude・DeepSeek に貼って相談します。',
  tool_product_design_prompt_builder_how_title: '使い方',
  tool_product_design_prompt_builder_load_sample: '見本を読み込む',
  tool_product_design_prompt_builder_persona_label: 'ターゲット像 / ペルソナ',
  tool_product_design_prompt_builder_persona_ph: '例：週ごとに交代する共同養育の親…',
  tool_product_design_prompt_builder_platforms_lead: '出力はプレーンテキストなので、ChatGPT・Gemini・Claude・DeepSeek のどれにでもそのまま貼れます。',
  tool_product_design_prompt_builder_problem_label: '解きたい課題',
  tool_product_design_prompt_builder_problem_ph: '例：カレンダーが騒がしく今週分を一画面で見たい…',
  tool_product_design_prompt_builder_result_label: 'プロンプト出力',
  tool_product_design_prompt_builder_rules_body: 'このページは依頼文を整えるだけで、ワイヤーフレームを描いたり Figma ファイルを書き出したりはしません。任意の AI には利用上限があり、Turnstile の通過が必要です。',
  tool_product_design_prompt_builder_rules_item_1: '4 つの項目は Markdown の Role・Task・Constraints・Output に分かれて入ります。',
  tool_product_design_prompt_builder_rules_item_2: '既定の出力は Markdown。同じ結果欄で JSON に切り替えると、項目の原文と完成した本文が並びます。',
  tool_product_design_prompt_builder_rules_item_3: '任意の Cloudflare AI はローカル生成の代わりではありません。返答は結果欄を丸ごと置き換えるので、コピー前に確認してください。',
  tool_product_design_prompt_builder_rules_item_4: 'このツールは文章を組み立てるだけで、画面を生成したり、あなたのデザインファイルを読んだり、チャット API を代理で呼んだりはしません。',
  tool_product_design_prompt_builder_rules_title: '知っておきたい制限',
  ...
  tool_product_design_prompt_builder_status_done: 'プロンプトができました。',
  tool_product_design_prompt_builder_status_working: 'プロンプトを組み立て中…',
  tool_product_design_prompt_builder_title: 'プロダクトデザイン向けプロンプト生成ツール — ブラウザ内で作成、AI 拡張は任意',
  tool_product_design_prompt_builder_usecase_1: '要件会議で口頭に出たデザインの狙いを、チャットに貼れるプロンプトとしてまとめる。',
  tool_product_design_prompt_builder_usecase_2: 'JSON で書き出してターゲット像とトークンを要件リポジトリに残し、必要なら Cloudflare AI で拡張する。',
  tool_product_design_prompt_builder_usecase_3: 'UX 固有の項目が不要で汎用の 4 ブロックで足りるときは、プロンプトテンプレート作成ツールに切り替える。',
  tool_product_design_prompt_builder_usecase_4: '未公表のプロダクト構想をまずブラウザ内で仕上げ、外に出せると判断してから任意の AI を使う。',
  tool_product_design_prompt_builder_usecases_title: 'こんなときに',
  tool_product_design_prompt_builder_wireframe_scope_label: 'ワイヤーフレーム / 範囲',
  tool_product_design_prompt_builder_wireframe_scope_ph: '例：週バー、詳細シート、SMS 招待の 3 画面…',
  ...
  tool_prompt_template_builder_ai_done: 'AI の文章を結果欄にそのまま書き出しました。コピー前に確認してください。',
  ...
  tool_prompt_template_builder_faq_a4: '必要です。任意 AI パネルの Turnstile を通してから拡張または推敲を押してください。トークンがないとボタンはエラーになりますが、ローカルの組み立てはそのまま使えます。',
  ...
  tool_prompt_template_builder_rules_body: '再利用できるテンプレートには、はっきりしたブロック分け、フィールドの優先順位、そして「このページがやらないこと」の明示が要ります。',
  ...
  tool_prompt_template_builder_rules_item_4: 'シーンチップは映画・ショートドラマ・モバイル開発でよく使う項目を先に埋めます。切り替えた後も手で書き換えられます。',
  ...
  tool_prompt_template_builder_usecase_6: 'Android や iOS のチップから Kotlin/Swift 前提のコーディング Agent 用テンプレートを作り、社内のコーディング規約を足す。',
  ...
  tool_protect_pdf_faq_a1: 'いいえ。PDF ライブラリ はタブ内で動作（スクリプトは このサイトから読み込みます）。PDF は当社サーバーに送られません。',
  ...
  tool_record_a_voiceover_with_a_teleprompter_description:
    'プロンプターを見ながらナレーションを録音できます。原稿を貼り付け、リハーサルでスクロール速度を調整してから録音を開始。一時停止すると文字と録音が一緒に止まります。3段落の例文と3秒の確認音も用意しています。原稿と音声は端末のブラウザ内で処理され、サーバーには送信されません。終了前に録音を保存してください。',
  ...
  tool_reduce_an_mp3_file_size_article:
    'MP3はすでに圧縮された音声です。さらに容量を減らすと音の細部が失われるため、元ファイルは残しておきましょう。録音全体を再圧縮し、処理前後の実際の容量を表示します。元のビットレートによっては、出力が大きくなることもあります。',
  ...
  tool_reduce_an_mp3_file_size_description:
    'メールに添付できない大きなMP3を、ビットレートを下げて圧縮できます。ファイルを選び、処理後に試聴して保存してください。3秒の例では約71 KiBから48 KiBになり、実測の削減率も表示します。音声は端末内で処理し、サーバーにはアップロードしません。再圧縮には音質の劣化が伴います。',
  ...
  tool_reduce_an_mp3_file_size_rules_item_3:
    '出力は44.1 kHzのMP3で、タグやジャケットは引き継ぎません。余白で再生時間が少し延びる場合があります。標準Layer III・1/2チャンネル・40 MiB・10分以内に対応。破損、フリーフォーマット、チャンネル変化は受け付けません。',
  ...
  tool_remove_silence_from_a_recording_desc: '録音の無音を切って短い WAV または MP3 を書き出します。端末内で処理し、サーバーにアップロードしません。',
  ...
  tool_remove_silence_from_a_recording_err_caps: 'この端末の上限を超えています（デスクトップ約 40 MB / 20 分、狭い画面は約 20 MB / 8 分）。先に短くするか、短いファイルを使ってください。',
  tool_remove_silence_from_a_recording_err_decode: 'このブラウザでは復号できませんでした。WAV か MP3、または DRM のない素材を試してください。',
  tool_remove_silence_from_a_recording_err_empty: '処理するものがありません。ファイルかサンプルを読み込んでください。',
  tool_remove_silence_from_a_recording_err_empty_keep: '残す音がありません。しきい値をより小さく（より負に）するか、最小無音を長くして、発話を無音扱いしないでください。',
  tool_remove_silence_from_a_recording_err_lame: 'MP3 エンコーダの読み込みに失敗しました。このタブのまま、もう一度「MP3を書き出す」を押してください。',
  tool_remove_silence_from_a_recording_err_video: 'このツールは動画を主入力にしません。音声ファイルを短くするだけで、ミュートやジャンプカットはしません。',
  ...
  tool_remove_silence_from_a_recording_faq_a1: 'いいえ。復号とカットはこのタブ内です。スクリプトはこのサイトから読みます。ファイルはサーバーに送りません。',
  ...
  tool_remove_silence_from_a_recording_faq_a4: '手動の切り出しは開始と終了を自分で指定します。こちらは途中の空白も切って1本に繋ぎます。手で前後だけ切るなら、トリム用のツールを使ってください。',
  tool_remove_silence_from_a_recording_faq_a5: 'いいえ。無音で複数ファイルや ZIP に分ける作業ではありません。常に1つのファイルを書き出します。',
  tool_remove_silence_from_a_recording_faq_a6: 'いいえ。ノイズ除去は長さを変えません。「えー」の削除は書き起こしが要ります。動画ミュートや YouTube の取り込みは対象外です。権利のある音声だけを使ってください。',
  ...
  tool_remove_silence_from_a_recording_how_body: '十分に長い静かな区間を見つけて短くし、発話を1本に繋いで WAV または MP3 を書き出します。サーバーには上げません。',
  ...
  tool_remove_silence_from_a_recording_result_tpl: '{orig}秒 → {next}秒。{gaps}か所で {removed}秒（{pct}%）切りました。書き出せます。',
  ...
  tool_remove_silence_from_a_recording_rules_item_1: '話し声：−40 dB、最小 0.5 秒、残し 0.15 秒。騒がしい部屋：−30 dB / 0.8 秒 / 0.20 秒。静かなスタジオ：−50 dB / 0.4 秒 / 0.15 秒。',
  tool_remove_silence_from_a_recording_rules_item_2: 'デスクトップ上限は約 40 MB または 20 分、狭い画面は約 20 MB または 8 分。超えると拒否し、黙って切り詰めません。',
  tool_remove_silence_from_a_recording_rules_item_3: 'ファイルは端末に留まり、サーバーにアップロードしません。MP3 エンコーダはこのサイトから、「MP3を書き出す」のあとだけ読み込みます。',
  tool_remove_silence_from_a_recording_rules_item_4: '復号はブラウザ次第です。DRM、一部のコーデック、動画コンテナは明示エラーになります。',
  tool_remove_silence_from_a_recording_rules_item_5: '書き出すのは1ファイルです。ZIP 分割、ノイズ除去、フィラー削除、動画ミュート、YouTube 取得はしません。',
  ...
  tool_remove_silence_from_a_recording_usecase_1: '対談ポッドキャストの長い間を切って、1本の短い回として書き出す。',
  tool_remove_silence_from_a_recording_usecase_2: '会議録音の無人区間を削り、1つの MP3 にして聞き返す。',
  tool_remove_silence_from_a_recording_usecase_3: 'ボイスメモの考え込みを切って、送る用の1ファイルにする。',
  tool_remove_silence_from_a_recording_usecases_title: 'こんなときに',
  tool_remove_silence_from_a_recording_why_choose_body: '「短くした1本」向けです。しきい値の目安と切った秒数をページ上で確認できます。',
  tool_remove_silence_from_a_recording_why_choose_item_1: '無音を切って発話を1本に繋ぎます。クリップの ZIP は配りません。',
  tool_remove_silence_from_a_recording_why_choose_item_2: '話し声の初期値（−40 dB / 0.5 秒 / 0.15 秒残し）は音声向きで、結果行に切った秒数が出ます。',
  tool_remove_silence_from_a_recording_why_choose_item_3: 'ファイルはこのブラウザタブに留まり、サーバーに上げません。MP3 エンコーダは書き出し時だけ読みます。',
  tool_remove_silence_from_a_recording_why_choose_item_4: '大きすぎ・長すぎは復号前に拒否します。1 GB を謳ってタブを落とすことはしません。',
  ...
  tool_robots_faq_a1:
    'そのクローラーにサイトルート配下の URL を取得しないよう伝えます。Googlebot に Disallow: / を設定すると、ページが Google 検索から消える可能性があります。ただし Disallow が止めるのはクロールで、インデックス登録ではありません。ブロックした URL でも外部からリンクされていればスニペットなしで結果に残ることがあるので、確実に消したいときはページをクロールできる状態にして noindex を付けます。ステージングなら Disallow: /private/ のように具体的なパスで指定してください。',
  tool_robots_faq_a2:
  ...
  tool_robots_rules_item_1:
    'グループの選び方：クローラーは User-agent が最も具体的に一致するグループに従います。自分の名前が書かれていれば * より優先され、ファイル内の記述順は判断材料になりません。同じクローラー名の User-agent 行が複数あれば 1 つのグループに統合されます（RFC 9309）。',
  ...
  tool_robots_rules_item_3:
    'グループ内の優先順位：一致したパスのうち最も長いものが勝ちます。Allow と Disallow の一致長が同じときは Allow が勝ちます。つまり Disallow: /admin/ と Allow: /admin/public/ を併記すれば、public 配下だけクロールを残せます。',
  tool_robots_rules_item_4:
    'サイト全体と Sitemap 行：Disallow: / はそのエージェントをすべての URL からブロックし、値が空の Disallow はすべて許可します。Sitemap: は RFC 9309 の範囲外の拡張で、大文字小文字を問わずどこに書いても構いません。このツールは末尾に置きます。',
  ...
  tool_robots_usecase_2:
    'AI クローラーの制御：Googlebot のクロールは残したまま、GPTBot・ClaudeBot・Google-Extended・CCBot・PerplexityBot に専用の Disallow グループを与えます。なお Google-Extended の対象は Gemini と Vertex AI のグラウンディングで、検索の「AI による概要」は引き続き Googlebot 経由です。',
  ...
  tool_rotate_pdf_faq_a1: 'いいえ。PDF ライブラリ はタブ内で動作します（スクリプトは このサイトから読み込みます）。PDF は当社サーバーにアップロードされません。',
  ...
  tool_serp_faq_a3:
    'できません。URL 検査が返すのはクロールとインデックスの状況、それとレンダリング後のスクリーンショットで、リッチリザルトテストは構造化データの対象条件を調べるだけです。どちらもテキストのスニペットをプレビューする機能ではありません。さらに Google はクエリとタイトルが噛み合わないときにタイトルリンクを書き換えるため、確実に確かめる方法は公開中の URL を実際に検索することだけです。',
  ...
  tool_short_drama_prompt_generator_ai_consent_body:
    'この手順は任意です。いま入力欄にある下書きを Cloudflare Workers AI に送って推論します。当サイトのサーバーから OpenAI・Google・Anthropic・DeepSeek へ転送することはありません。AI を使わなくても、プロンプトはブラウザー内で組み立てられます。',
  tool_short_drama_prompt_generator_ai_consent_cancel: 'やめる',
  tool_short_drama_prompt_generator_ai_consent_ok: '続ける',
  tool_short_drama_prompt_generator_ai_consent_title: '下書きを Cloudflare Workers AI に送りますか',
  tool_short_drama_prompt_generator_ai_done: 'AI の文章を全文そのまま出力欄に書き込みました。コピーする前に確認してください。',
  tool_short_drama_prompt_generator_ai_err_generic: '今回は AI が応答しませんでした。出力欄の内容はそのままです。',
  tool_short_drama_prompt_generator_ai_err_rate: 'AI の上限に達しました。ここでの組み立てを続けるか、UTC の翌日に試してください。',
  tool_short_drama_prompt_generator_ai_err_turnstile: 'AI を使う前に Turnstile の確認を済ませてください。',
  tool_short_drama_prompt_generator_ai_expand: 'AI で加筆',
  tool_short_drama_prompt_generator_ai_panel_label: '任意：Cloudflare AI（Turnstile 必須）',
  tool_short_drama_prompt_generator_ai_polish: 'AI で整える',
  tool_short_drama_prompt_generator_ai_working: 'Cloudflare AI が処理しています…',
  ...
  tool_short_drama_prompt_generator_build: 'プロンプトを作る',
  tool_short_drama_prompt_generator_clear: '消す',
  tool_short_drama_prompt_generator_cliffhanger_label: '各話の引き',
  tool_short_drama_prompt_generator_cliffhanger_ph: '例：第 6 話は留守電を消すところで終わる…',
  ...
  tool_short_drama_prompt_generator_empty: 'どれか一つは入力してからプロンプトを作ってください。',
  tool_short_drama_prompt_generator_episodes_label: '話数と長さ',
  tool_short_drama_prompt_generator_episodes_ph: '例：12 話 × 75 秒…',
  ...
  tool_short_drama_prompt_generator_example_title: '入力と出力の例',
  ...
  tool_short_drama_prompt_generator_faq_a4:
    'Turnstile は自動スクリプトを弾いて、無料の枠を人の利用に残すためのものです。加筆や整えを押す前に AI 欄で確認を済ませてください。有効なトークンがないとそのボタンはエラーになりますが、ブラウザー内での並べ替えは変わらず使えます。',
  tool_short_drama_prompt_generator_faq_a5: 'できます。JSON に切り替えると、同じ出力欄に項目化したデータと組み立て済みのプロンプト本文が並ぶので、各話を表に残して掴みと引きの手が重複していないか見比べられます。',
  tool_short_drama_prompt_generator_faq_a6: '使えます。出力をコピーして好きなチャット欄に貼ってください。このページは話ごとの割り振りを整えるだけで API を呼ばないため、サービスごとに別 URL を用意していません。',
  ...
  tool_short_drama_prompt_generator_faq_q1: '入力した筋書きはどこかに送信されますか',
  tool_short_drama_prompt_generator_faq_q2: 'ChatGPT などのモデル API を呼びますか',
  tool_short_drama_prompt_generator_faq_q3: 'プロンプトテンプレート作成ツールとの違いは何ですか',
  tool_short_drama_prompt_generator_faq_q4: 'AI を使うのに Turnstile が必要なのはなぜですか',
  tool_short_drama_prompt_generator_faq_q5: 'JSON で受け取れますか',
  tool_short_drama_prompt_generator_faq_q6: 'ChatGPT・Gemini・Claude・DeepSeek で使えますか',
  tool_short_drama_prompt_generator_faq_q7: 'ローカル動作と任意の Cloudflare AI はどう違いますか',
  ...
  tool_short_drama_prompt_generator_genre_ph: '例：職場もの＋家族の秘密…',
  tool_short_drama_prompt_generator_hook_label: '冒頭の掴み',
  tool_short_drama_prompt_generator_hook_ph: '例：インターンが給与情報の流出を暴く…',
  ...
  tool_short_drama_prompt_generator_how_item_1: '「サンプルを読み込む」でデフォルトのプリセットを入れる。',
  tool_short_drama_prompt_generator_how_item_2: '話数と長さ・掴み・引き・縦型の仕様・ジャンルを直して「プロンプトを作る」を押します。項目ごとに書き出したいときは JSON へ。',
  tool_short_drama_prompt_generator_how_item_3: '任意：AI 欄で Turnstile を済ませ、「AI で加筆」か「AI で整える」を押すと、返ってきた文章が出力欄に入ります。',
  tool_short_drama_prompt_generator_how_item_4: 'コピーまたはダウンロードして ChatGPT・Gemini・Claude・DeepSeek に貼り、この話数割りのまま続きを書かせます。',
  tool_short_drama_prompt_generator_how_title: '使い方',
  tool_short_drama_prompt_generator_load_sample: '作例を読み込む',
  tool_short_drama_prompt_generator_platforms_lead: '出力はそのまま ChatGPT・Gemini・Claude・DeepSeek の入力欄に貼れます。',
  tool_short_drama_prompt_generator_result_label: '出来上がったプロンプト',
  ...
  tool_short_drama_prompt_generator_rules_item_1: '入力欄の項目は、Markdown の「役割・タスク・制約・出力形式」のいずれかに振り分けられます。',
  tool_short_drama_prompt_generator_rules_item_2: '既定の書き出しは Markdown。JSON は同じ出力欄の切り替えボタンです。',
  tool_short_drama_prompt_generator_rules_item_3: '任意の AI は一手間を足すだけで、置き換えではありません。ローカル動作はいつでも使え、AI の文章は出力欄を全部入れ替えるので、コピー前に読み直してください。',
  tool_short_drama_prompt_generator_rules_item_4: 'このページが作るのは文章だけです。動画は生成せず、ブラウザー内でモデルやチャット API を動かすこともありません。',
  tool_short_drama_prompt_generator_rules_title: 'できること・できないこと',
  tool_short_drama_prompt_generator_sec_constraints: '制約',
  tool_short_drama_prompt_generator_sec_output: '出力形式',
  tool_short_drama_prompt_generator_sec_role: '役割',
  tool_short_drama_prompt_generator_sec_task: 'タスク',
  tool_short_drama_prompt_generator_status_copied: 'クリップボードにコピーしました。',
  tool_short_drama_prompt_generator_status_done: 'プロンプトができました。',
  tool_short_drama_prompt_generator_status_working: '組み立てています…',
  tool_short_drama_prompt_generator_title: '縦型ショートドラマのプロンプト作成ツール — 掴みと引きをブラウザー内で',
  tool_short_drama_prompt_generator_usecase_1: '打ち合わせ前に話数・掴み・各話の引きを一つのプロンプトにまとめ、ChatGPT・Gemini・Claude・DeepSeek にそのまま貼る。',
  tool_short_drama_prompt_generator_usecase_2: 'JSON を書き出し、各話の掴みと引きを表の項目として残して、同じ手が続いていないか確かめる。',
  tool_short_drama_prompt_generator_usecase_3: '縦型連続ドラマの項目ではなく題材を問わない四段構成のひな型が欲しいときは、プロンプトテンプレート作成ツールを使う。',
  tool_short_drama_prompt_generator_usecase_4: '配信前の企画はローカル動作だけで進める。確認ダイアログに同意しない限り、文章はブラウザーから出ません。',
  tool_short_drama_prompt_generator_usecases_title: 'こんなときに',
  tool_short_drama_prompt_generator_vertical_format_label: '縦型の仕様',
  tool_short_drama_prompt_generator_vertical_format_ph: '例：9:16、焼き込み字幕、冒頭 2 秒で掴む…',
  ...
  tool_sign_pdf_document_color_label: 'インクの色',
  ...
  tool_sign_pdf_document_description:
    'ブラウザで PDF 文書に署名します。手書きか氏名入力で印を作り、ページの X/Y に置いて保存します。端末内で処理し、サーバーにアップロードしません。見える押印であり証明書ではありません。入場時のサンプルでプロセスと手順の例が動きます。身分証明には使えません。',
  ...
  tool_sign_pdf_document_example: 'サンプル読み込みは「Sample agreement」1ページを作り、Jane Sample を入力し、右下に PNG を押します（座標は変更可）。',
  ...
  tool_sign_pdf_document_how_item_2: '氏名を入力するかパッドに書き、インク色を選ぶ',
  tool_sign_pdf_document_how_item_3: '四隅か中央を選ぶ（X/Y も編集可）。ページまたは全ページを選び、押印してプレビュー',
  ...
  tool_sign_pdf_document_page_all: '全ページ',
  tool_sign_pdf_document_page_label: 'ページ',
  tool_sign_pdf_document_page_option: '{n} ページ',
  tool_sign_pdf_document_pos_bl: '左下',
  tool_sign_pdf_document_pos_br: '右下',
  tool_sign_pdf_document_pos_center: '中央',
  tool_sign_pdf_document_pos_label: '位置',
  tool_sign_pdf_document_pos_tl: '左上',
  tool_sign_pdf_document_pos_tr: '右上',
  ...
  tool_sitemap_home_desc:
    '内部リンクだけでは辿り着けないページを Google に見つけてもらう——URL リストから lastmod・changefreq・priority 付きの正しい sitemap.xml を、ブラウザ内で生成。',
  ...
  tool_sitemap_usecase_2:
    '更新コンテンツ：本当に変更したページにだけ lastmod を付ける。Google が lastmod を参照するのはファイル全体で日付が一貫して正確なときだけなので、全 URL に今日の日付を入れると項目ごと無視されます。',
  ...
  tool_sketch_prompt_generator_faq_a2: 'ローカルは欄の整形のみ。任意 AI は Turnstile 後に Cloudflare Workers AI を使い、チャット API 呼び出しや Sketch.app の遠隔操作はしません。',
  tool_sketch_prompt_generator_faq_a3: 'Promptテンプレートビルダーは汎用4欄。本ページは Sketch.app の目標・アートボード・シンボル／スタイル・書き出しに特化します。',
  ...
  tool_sketch_prompt_generator_faq_a5: 'はい。Expand / Polish の前に任意 AI パネルで Turnstile を完了してください。トークンが無いと AI はエラーになり、ローカルは引き続き使えます。',
  tool_sketch_prompt_generator_faq_a6: 'はい。JSON チップは構造化フィールドと組み立て済みプロンプトを出します。',
  tool_sketch_prompt_generator_faq_a7: 'はい。完成プロンプトを ChatGPT などに貼り、Sketch.app のメニュー操作を案内させられます。テキスト整形のみで、Sketch 自体は実行しません。',
  ...
  tool_sketch_prompt_generator_platforms_lead: 'ChatGPT / Gemini / Claude / DeepSeek 向け — 完成プロンプトをコピーして Sketch.app 操作を案内させます。',
  tool_sketch_prompt_generator_result_label: 'プロンプト出力',
  tool_sketch_prompt_generator_rules_body: '欄は Sketch.app の成果物・アートボード・シンボル・書き出しに対応。既定はローカル。任意 AI は Turnstile と上限あり。本ページは Sketch.app を起動しません。',
  ...
  tool_sketch_prompt_generator_rules_item_4: 'テキスト組み立てのみ。Sketch.app・プラグイン・Midjourney・チャット API はローカルでは実行しません。',
  ...
  tool_sketch_prompt_generator_usecase_1: 'アートボード寸法とシンボル名をチームのチャット AI に渡し、Sketch.app で画面を再現させる。',
  tool_sketch_prompt_generator_usecase_2: 'デザイン QA 前に PNG / PDF 書き出しチェックリストを用意する。',
  tool_sketch_prompt_generator_usecase_3: 'ペルソナ／ワイヤーの製品思考が主目的なら Product design prompt builder と比較。',
  ...
  tool_spf_dkim_dmarc_checker_faq_a1: '受信側は多くの場合 3 つをまとめて評価します。DMARC だけだと、壊れた SPF や誤った DKIMセレクタを見逃すことがあります。',
  tool_spf_dkim_dmarc_checker_faq_a2: 'google（Google Workspace で多い値）です。ESP が別セレクタ（s1 や k1 など）なら変更してください。',
  tool_spf_dkim_dmarc_checker_faq_a3: 'いいえ。ドメイン認証 DNS（SPF 照会・DKIM 鍵・DMARC ポリシー）のみです。アドレス存在チェックは対象外です。',
  tool_spf_dkim_dmarc_checker_faq_a4: 'いいえ。レコードに加え、SPF の all と DMARC の p= を説明する行があります。',
  ...
  tool_spf_dkim_dmarc_checker_fetch_failed: 'DNS 照会に失敗しました。リゾルバに届かないか、名前が拒否された可能性があります。',
  tool_spf_dkim_dmarc_checker_formula_body: '照会は RFC 7208 / 6376 / 7489 の公開 TXT 形式に沿います。ポリシー項目を要約するだけで、送信やメールボックス探査は行いません。',
  tool_spf_dkim_dmarc_checker_formula_item_1: 'SPF: ドメイン上の v=spf1 TXT。末尾の all（~all ソフト失敗、-all ハード失敗）を表示します。',
  tool_spf_dkim_dmarc_checker_formula_item_2: 'DMARC: _dmarc.ドメイン の v=DMARC1 TXT。p=（none / quarantine / reject）と任意の pct を強調します。',
  tool_spf_dkim_dmarc_checker_formula_item_3: 'DKIM: {selector}._domainkey.ドメイン の TXT。空でない公開鍵 p= があるかを確認します。',
  tool_spf_dkim_dmarc_checker_formula_item_4: '欠落レコードは正直に表示します。DoH 失敗はエラーになります（ESP の実署名テストではありません）。',
  tool_spf_dkim_dmarc_checker_formula_item_5: 'SMTP RCPT 探査もゾーン編集もしません。「メールアドレスの存在確認」は対象外です。',
  tool_spf_dkim_dmarc_checker_formula_title: '照会の内容',
  tool_spf_dkim_dmarc_checker_how_body: '到達性の確認では SPF・DKIM・DMARC をまとめて見るのが一般的です。送信ドメインを入れ、必要ならセレクタを変え、各 TXT とポリシー要約を読んでください。',
  ...
  tool_spf_dkim_dmarc_checker_privacy_note: 'ドメインと DKIMセレクタは DNS-over-HTTPS のため Worker に送られます。プロダクト用の長期データベースとしては保持しません。',
  ...
  tool_spf_dkim_dmarc_checker_usecase_1: '公開前: ESP の DNS を追加したあと、送信ドメインに SPF・DKIM・DMARC があるか確認する。',
  tool_spf_dkim_dmarc_checker_usecase_2: 'DMARC レコード確認: 生 TXT だけでなく、p=none と quarantine/reject の違いを平易に読む。',
  tool_spf_dkim_dmarc_checker_usecase_3: '迷惑メール行きのときの SPF 照会: ~all か -all かを見て、DKIMセレクタを ESP に合わせる。',
  ...
  tool_split_a_disc_image_with_a_cue_sheet_desc: '端末上で cue の INDEX 01 に合わせてイメージを切り、曲名付き ZIP を受け取る。サーバーには上げません。',
  ...
  tool_split_a_disc_image_with_a_cue_sheet_drop_hint: 'WAV・FLAC・MP3・BIN と .cue をまとめてドロップ。処理はこのタブ内です。',
  ...
  tool_split_a_disc_image_with_a_cue_sheet_err_ape: 'このブラウザは APE を復号できません。イメージを WAV か FLAC に変換し、同じ cue を残してから「トラックに分割」してください。',
  tool_split_a_disc_image_with_a_cue_sheet_err_caps: 'この端末の上限を超えています（デスクトップ約 80 MB / 30 分、狭い画面は約 30 MB / 10 分）。700 MB の CD .bin はこのタブに入りません。',
  tool_split_a_disc_image_with_a_cue_sheet_err_cue_parse: 'そのテキストは使えるキューシートではありません。TRACK 行と MM:SS:FF の INDEX 01 が必要です。',
  tool_split_a_disc_image_with_a_cue_sheet_err_data: 'この cue はデータディスク（MODE トラック）です。AUDIO トラックだけを分割します。',
  tool_split_a_disc_image_with_a_cue_sheet_err_decode: 'このブラウザではそのイメージを復号できません。WAV か FLAC、DRM のないファイルを試してください。APE は扱いません。',
  ...
  tool_split_a_disc_image_with_a_cue_sheet_err_multi_file: 'この cue は FILE が複数あります。すでに1トラック1ファイルなので、ここで割る対象はありません。',
  tool_split_a_disc_image_with_a_cue_sheet_err_no_index: 'INDEX 01 が見つかりません。cue分割には MM:SS:FF の開始時刻が必要です。',
  tool_split_a_disc_image_with_a_cue_sheet_err_too_many: '50 トラックを超えています。切り詰めずに拒否します。短いシートにするか、デスクトップの shnsplit を使ってください。',
  tool_split_a_disc_image_with_a_cue_sheet_err_video: '動画を主入力にはできません。キューシート付きの音声イメージを分割するページです。',
  ...
  tool_split_a_disc_image_with_a_cue_sheet_faq_a1: 'いいえ。解析・復号・分割・ZIP 化はこのタブで行います。スクリプトはこのサイトから読みます。イメージも cue もサーバーへは送りません。',
  ...
  tool_split_a_disc_image_with_a_cue_sheet_faq_a3: 'INDEX 01 がトラック開始（MM:SS:FF、75フレーム/秒）です。INDEX 00 はプリギャップ表示用で、既定の切れ目は 01 です。最後のトラックはイメージ末尾まで続きます。',
  tool_split_a_disc_image_with_a_cue_sheet_faq_a4: 'いいえ。無音で分割するページも、秒数で等分割するページも別です。ここはキューシートだけです。FILE/INDEX のない YouTube チャプターは対象外です。',
  tool_split_a_disc_image_with_a_cue_sheet_faq_a5: '.cue ファイルが無いときは、ドロップ欄の下に全文を貼れます。.cue を落とすのと同じ解析です。',
  tool_split_a_disc_image_with_a_cue_sheet_faq_a6: 'ZIP 内の名前は「{nn} {title}.wav」（または .mp3）です。一覧から1曲だけ保存もできます。上限は 50 トラックで、超えると拒否します。',
  tool_split_a_disc_image_with_a_cue_sheet_faq_a7: 'できません。ノイズ除去、動画の無音化、等時間分割、手切り、YouTube 吸い出し、ISO データディスクは対象外です。権利のある音声イメージを使ってください。',
  tool_split_a_disc_image_with_a_cue_sheet_faq_a8: 'デスクトップは約 80 MB または 30 分。狭い画面は約 30 MB または 10 分。700 MB の CD .bin は拒否します。上限超えは復号前に止まります。',
  ...
  tool_split_a_disc_image_with_a_cue_sheet_format_hint: 'WAV はロスレス PCM です。MP3 エンコーダは「ZIPをダウンロード」のときだけ読み込みます。',
  tool_split_a_disc_image_with_a_cue_sheet_format_mp3: 'MP3',
  tool_split_a_disc_image_with_a_cue_sheet_format_wav: 'WAV',
  tool_split_a_disc_image_with_a_cue_sheet_how_body: 'キューシートの INDEX 01 を読み、対応するディスクイメージをそこで切り、曲名付き ZIP をダウンロードします。アップロードはありません。',
  ...
  tool_split_a_disc_image_with_a_cue_sheet_hud_decoded: 'cue を解析し、イメージを復号しました。白い印が INDEX 01 です。リストが正しければ「トラックに分割」してください。',
  ...
  tool_split_a_disc_image_with_a_cue_sheet_paste_hint: 'FILE / TRACK / INDEX 01 のあるキューシート全文を貼ってください。YouTube のチャプター一覧ではありません。',
  ...
  tool_split_a_disc_image_with_a_cue_sheet_rules_item_1: '切れ目は INDEX 01 です。INDEX 00 はプリギャップ表示で、既定の切れ目ではありません。時刻は CD フレームでありミリ秒ではありません。',
  tool_split_a_disc_image_with_a_cue_sheet_rules_item_2: 'デスクトップは約 80 MB または 30 分、狭い画面は約 30 MB または 10 分。超過は切り詰めず拒否。50 トラック超も拒否。700 MB の CD .bin は入りません。',
  tool_split_a_disc_image_with_a_cue_sheet_rules_item_3: 'ファイルは端末に残り、サーバーへは上がりません。JSZip と MP3 エンコーダは「ZIPをダウンロード」のあと、このサイトからだけ読みます。',
  ...
  tool_split_a_disc_image_with_a_cue_sheet_usecase_1: 'Exact Audio Copy や XLD の FLAC+CUE リップを、shnsplit を入れずに曲名付きトラックへ分ける。',
  tool_split_a_disc_image_with_a_cue_sheet_usecase_2: 'アナログレコード片面や CD の WAV/BIN イメージを cue 付きで切り、ZIP で持ち帰る。',
  tool_split_a_disc_image_with_a_cue_sheet_usecase_3: 'キューシート付きの DJ セットから、無音を推測せず INDEX 01 で曲を取り出す。',
  tool_split_a_disc_image_with_a_cue_sheet_usecases_title: '向いている場面',
  tool_split_a_disc_image_with_a_cue_sheet_why_choose_body: 'INDEX 01 でのアルバム分割と曲名 ZIP 用で、APE や巨大な .bin についてはできないことを先に書きます。',
  tool_split_a_disc_image_with_a_cue_sheet_why_choose_item_1: 'cue の INDEX 01（75フレーム/秒）で切り、ZIP 名は TITLE です。等秒カットでも無音カットでもありません。',
  tool_split_a_disc_image_with_a_cue_sheet_why_choose_item_2: 'イメージと .cue は同じドロップ欄。同じシートの貼り付けも可。YouTube チャプター編集を cue 分割と称しません。',
  tool_split_a_disc_image_with_a_cue_sheet_why_choose_item_3: 'ファイルはこのブラウザタブに留まり、アップロードしません。JSZip と lamejs は「ZIPをダウンロード」のときだけ読みます。',
  tool_split_a_disc_image_with_a_cue_sheet_why_choose_item_4: 'APE 復号、複数 FILE の cue、過大なイメージは平文で拒否します。700 MB を請け負ってタブを落とす約束はしません。',
  ...
  tool_split_a_recording_on_silence_desc: '長い無音で録音を切り、クリップ入り ZIP を端末内で書き出す。サーバーにアップロードしない。',
  ...
  tool_split_a_recording_on_silence_err_caps: 'この端末の上限を超えています（デスクトップはおよそ 40 MB / 20 分、狭い画面は 20 MB / 8 分）。先に短くするか、短いファイルを使ってください。',
  tool_split_a_recording_on_silence_err_decode: 'このブラウザではそのファイルを復号できませんでした。WAV か MP3、DRM のないクリップを試してください。',
  ...
  tool_split_a_recording_on_silence_err_no_clips: '残せる長さのクリップがありません。最短クリップを下げるか、最短無音を上げて、短い息継ぎが切れ目にならないようにしてください。',
  tool_split_a_recording_on_silence_err_too_many: 'クリップが 50 本を超えています。最短無音を上げるか、しきい値をより負にして近い無音をまとめ、もう一度「無音で分割」してください。途中で切らずに拒否します。',
  tool_split_a_recording_on_silence_err_video: '動画は主入力として受け付けません。音声ファイルを無音で切るページであり、映像のミュートやジャンプカットではありません。',
  ...
  tool_split_a_recording_on_silence_faq_a1: 'しません。復号・検出・分割・ZIP 化はすべてこのタブ内です。スクリプトはこのサイトから読みます。ファイルは当方のサーバーへ送りません。',
  tool_split_a_recording_on_silence_faq_a2: '別ツールではありません。無音で音声を分割、無音検出でカット、ZIPで書き出す、といった検索は、長い無音で切って複数ファイルを ZIP に入れるこの作業です。',
  ...
  tool_split_a_recording_on_silence_faq_a4: '等間隔（N 秒ごと）の分割は別作業です。キューシートによるアルバム分割も対象外です。十分な長さの静かな隙間があるところだけ切ります。',
  ...
  tool_split_a_recording_on_silence_faq_a6: 'ZIP 内は {stem}-01.wav（または .mp3）。一覧から 1 本だけ保存もできます。上限は 50 本で、超えると分割を拒否します。',
  tool_split_a_recording_on_silence_faq_a7: 'できません。ノイズ除去、えー・あのの削除、動画ミュート、cue/APE、YouTube 取り込みは対象外です。権利のある音声ファイルを使ってください。',
  ...
  tool_split_a_recording_on_silence_how_body: '十分な長さの静かな隙間を見つけ、各隙間の中点で切り、クリップ入り ZIP をダウンロードします。端末内で処理し、サーバーには送りません。',
  ...
  tool_split_a_recording_on_silence_result_one: '{orig}秒 · 分割できる長さの間が無いので、ZIP にはこの 1 本だけ入ります。最短無音を下げるか、しきい値を 0 に近づけてください。ZIPをダウンロードの準備はできています。',
  tool_split_a_recording_on_silence_result_tpl: '{orig}秒 · 隙間 {gaps} → クリップ {count} 本: {list}。ZIPをダウンロードの準備ができました。',
  ...
  tool_split_a_recording_on_silence_rules_item_1: '話し声の初期値: −40 dB、最短無音 1.0 s、最短クリップ 0.3 s。講義: −40 dB / 2.0 s / 0.5 s。アルバムの曲間: −45 dB / 1.5 s / 1.0 s。',
  tool_split_a_recording_on_silence_rules_item_2: 'デスクトップ上限はおよそ 40 MB または 20 分、狭い画面はおよそ 20 MB または 8 分。超えたファイルは切り詰めず拒否。50 本超も拒否。',
  tool_split_a_recording_on_silence_rules_item_3: 'ファイルは端末内に留まり、サーバーにはアップロードしません。JSZip と MP3 エンコーダはこのサイトから、ZIPをダウンロードのあとだけ読み込みます。',
  tool_split_a_recording_on_silence_rules_item_4: '復号はブラウザ次第です。DRM、一部コーデック、動画コンテナは明示エラーになります。',
  tool_split_a_recording_on_silence_rules_item_5: '多数のファイルを ZIP に出します。1 本に縫う、固定秒数で切る、cue に従う、ノイズ除去、動画ミュート、YouTube 取得はしません。',
  ...
  tool_split_a_recording_on_silence_usecase_1: '講義の章の間でファイルを分け、等間隔チョップではなく ZIP に章ごとの音声を入れる。',
  tool_split_a_recording_on_silence_usecase_2: 'インタビューの答えごとにクリップを分け、あとからラベルを付ける。',
  tool_split_a_recording_on_silence_usecase_3: '曲間に隙間があるミックスで cue が無いとき、無音でファイルを分ける。',
  tool_split_a_recording_on_silence_usecases_title: '向いている場面',
  tool_split_a_recording_on_silence_why_choose_body: '無音の中点で切ったクリップを ZIP にまとめるためのページです。話し声 / 講義 / アルバムの初期値は画面上で確認できます。',
  tool_split_a_recording_on_silence_why_choose_item_1: '長い静かな隙間の中点で切り、多数のファイルを ZIP に入れます。1 本の短いファイルに縫いません。',
  tool_split_a_recording_on_silence_why_choose_item_2: '話し声（−40 dB / 1.0 s / 最短クリップ 0.3 s）は息継ぎを細切れにしにくいです。講義とアルバムも画面に名前があります。',
  tool_split_a_recording_on_silence_why_choose_item_3: 'ファイルはこのブラウザタブ内に留まり、サーバーにアップロードしません。JSZip と lamejs は ZIPをダウンロードを押したときだけ読み込みます。',
  tool_split_a_recording_on_silence_why_choose_item_4: '大きすぎるファイルと 50 本超は、途中までの ZIP を出す前に拒否します。1 GB を約束してタブを落とすことはしません。',
  ...
  tool_split_an_audio_file_by_duration_chunk_hint: '初期値 2 秒はサンプル用です。講義なら 60 秒や 3 分を押してください。最後のクリップは余った時間を残します。',
  ...
  tool_split_an_audio_file_by_duration_desc: '端末内で長さで分割し、等長クリップの ZIP を保存。サーバーにはアップロードしません。',
  ...
  tool_split_an_audio_file_by_duration_equal_parts_hint: '空なら上の秒数を使います。2–50 を入れると、この分割の 1 本あたりは総長 ÷ N になります。',
  tool_split_an_audio_file_by_duration_err_caps: 'この端末の上限を超えています（デスクトップ約 40 MB / 20 分、狭い画面は約 20 MB / 8 分）。先に短くするか、短いファイルを使ってください。',
  tool_split_an_audio_file_by_duration_err_chunk: '1本あたりは 0.5〜1200 秒にしてください。50 本の上限に当たったら秒数を上げてください。',
  tool_split_an_audio_file_by_duration_err_decode: 'このブラウザではそのファイルを復号できません。WAV か MP3、または DRM のない素材を試してください。',
  ...
  tool_split_an_audio_file_by_duration_err_too_many: '50 本を超えています。秒数を大きくしてください（60 秒や 3 分）。途中で切らずに拒否します。',
  tool_split_an_audio_file_by_duration_err_video: 'このページは動画を主入力にしません。音声を秒数で分割するだけで、映像の音声を消す作業ではありません。',
  ...
  tool_split_an_audio_file_by_duration_faq_a1: 'いいえ。復号、分割、ZIP 作成はこのタブ内です。スクリプトはこのサイトから読みます。ファイルをサーバーへ送りません。',
  tool_split_an_audio_file_by_duration_faq_a2: '同じ作業です。秒数で分割、長さで分割、等分割、60秒ごとに切る、ZIPで書き出す検索は、このページで N 秒ごとに切って ZIP で持ち帰る話です。N 等分は詳細設定にあります。',
  tool_split_an_audio_file_by_duration_faq_a3: '最後のクリップが余りを持ちます。5.00 秒を 2 秒で切ると 2.00 / 2.00 / 1.00 秒になり、無音で埋めません。',
  tool_split_an_audio_file_by_duration_faq_a4: 'いいえ。録音を無音で分割は長い無音で切ります。こちらは時計だけです。cue やファイルサイズ分割も対象外です。',
  tool_split_an_audio_file_by_duration_faq_a5: 'サンプルは 2 秒のまま。短尺なら 30 秒か 60 秒、講義の通勤用なら 3 分か 5 分。4 本に等分したいときは詳細設定に 4 を入れてください。',
  tool_split_an_audio_file_by_duration_faq_a6: 'ZIP 内は {stem}-01.wav（または .mp3）です。一覧から 1 本だけ保存もできます。上限 50 本。超えたら拒否します。',
  tool_split_an_audio_file_by_duration_faq_a7: 'できません。ノイズ除去、動画ミュート、cue/APE、手切り、YouTube の取り込みは範囲外です。権利のある音声ファイルを使ってください。',
  tool_split_an_audio_file_by_duration_faq_a8: 'デスクトップは約 40 MB または 20 分。狭い画面は約 20 MB または 8 分。超えたファイルは復号前に拒否します。',
  ...
  tool_split_an_audio_file_by_duration_how_body: '時計どおり N 秒ごとに切り、余りは最後のクリップへ。ZIP を保存し、ファイルは端末から出さずサーバーにも上げません。',
  ...
  tool_split_an_audio_file_by_duration_result_one: '{orig}秒 · 1本の長さが全体以上なので、ZIP にはこの 1 ファイルだけ入ります。秒数を短くしてから、もう一度秒数で分割。ZIPをダウンロードは使えます。',
  tool_split_an_audio_file_by_duration_result_tpl: '{orig}秒 · {chunk}秒ごと → {count} 本：{list}。ZIPをダウンロードが使えます。',
  ...
  tool_split_an_audio_file_by_duration_rules_item_1: 'サンプルの初期値は 2 秒。チップは同じ欄に 30 秒、60 秒、180 秒（3 分）、300 秒（5 分）を入れます。N 等分（2–50）は詳細設定の任意項目です。',
  tool_split_an_audio_file_by_duration_rules_item_2: 'デスクトップ上限は約 40 MB または 20 分。狭い画面は約 20 MB または 8 分。超えたら切り詰めず拒否。50 本超も拒否します。',
  tool_split_an_audio_file_by_duration_rules_item_3: 'ファイルは端末に留まり、サーバーにはアップロードしません。JSZip と MP3 エンコーダは ZIPをダウンロードのあと、このサイトから読みます。',
  tool_split_an_audio_file_by_duration_rules_item_4: '復号はブラウザ次第です。DRM、一部コーデック、動画コンテナははっきりしたエラーになります。',
  tool_split_an_audio_file_by_duration_rules_item_5: 'このページは時計で多ファイル ZIP を出します。無音分割、cue、メガバイト分割、ノイズ除去、動画ミュート、YouTube 取得はしません。',
  ...
  tool_split_an_audio_file_by_duration_usecase_1: '講義を 3 分の通勤用に長さで分割し、ZIP で持ち帰る。無音待ちは不要。',
  tool_split_an_audio_file_by_duration_usecase_2: '長い回から 60 秒の短尺用に等分割する。',
  tool_split_an_audio_file_by_duration_usecase_3: '長めのボイスメモをチャットの時間上限に収まる本数へ切り、余りは最後のクリップへ。',
  tool_split_an_audio_file_by_duration_usecases_title: 'こんなときに',
  tool_split_an_audio_file_by_duration_why_choose_body: '時計どおりの ZIP 向け。30 秒 / 60 秒 / 3 分 / 5 分のチップと、短い最後のクリップをページ上で確認できます。',
  tool_split_an_audio_file_by_duration_why_choose_item_1: 'N 秒ごとに切って多ファイル ZIP にします。最後のクリップは余りを残し、無音で埋めません。',
  tool_split_an_audio_file_by_duration_why_choose_item_2: '30 秒 / 60 秒 / 3 分 / 5 分のチップと、任意の N 等分。無音検出で等分したように見せるページではありません。',
  tool_split_an_audio_file_by_duration_why_choose_item_3: 'ファイルはこのブラウザタブに留まり、サーバーにはアップロードしません。JSZip と lamejs は ZIPをダウンロードを押したときだけ読みます。',
  tool_split_an_audio_file_by_duration_why_choose_item_4: '大きすぎるファイルと 50 本超は、欠けた ZIP を出す前に拒否します。1 GB まで大丈夫という約束はしません。',
  ...
  tool_split_pdf_faq_a1: 'いいえ。pdf-lib と fflate はタブ内で動作します（スクリプトはこのサイトから読みます）。PDFはサーバーに送られません。',
  ...
  tool_text_diff_faq_a2: '貼り付けた本文は当社へ送信・保存しません。比較はブラウザ内で行います。ページがこのサイトから jsdiff（オープンソース）を読み込むことがありますが、本文は当社サーバーには送られません。',
  ...
  tool_text_diff_how_body: '左に原文、右に修正版を貼り付け、行・単語・文字の比較方法を選んで、緑の追加と赤の削除を確認します。本文は端末内に残り、サーバーへアップロードされません。',
  ...
  tool_text_diff_rules_body: '選んだモードが変更の単位になります。空白無視は行・単語比較だけの機能なので、文字モードでは無効になります。',
  ...
  tool_trim_an_audio_clip_and_export_article: '端末の音声を開き、開始と終了を入れて「切り出し」のあと「WAV書き出し」または「MP3書き出し」します。ファイルは端末内に留まり、サーバーにアップロードしません。波形をいじる編集ソフトではありません。',
  ...
  tool_trim_an_audio_clip_and_export_desc: '手元で音声カット：開始と終了を指定して WAV か MP3 を書き出します。端末内で処理し、サーバーにアップロードしません。',
  ...
  tool_trim_an_audio_clip_and_export_err_caps: 'このファイルは端末の上限を超えています（デスクトップ約 40 MB / 20 分、狭い画面は約 20 MB / 8 分）。先に短くするか、短いファイルを使ってください。',
  tool_trim_an_audio_clip_and_export_err_decode: 'このブラウザではそのファイルを復号できませんでした。WAV や MP3、DRM のないクリップを試してください。',
  ...
  tool_trim_an_audio_clip_and_export_err_video: 'このページは動画を主入力にしません。先に音声を取り出してから切ってください。',
  ...
  tool_trim_an_audio_clip_and_export_faq_a1: 'しません。復号と切り出しはこのタブ内です。スクリプトはこのサイトから読みます。ファイルは当方サーバーへ送りません。',
  tool_trim_an_audio_clip_and_export_faq_a2: 'いいえ。音声カット、mp3カット、音声トリミング、音源切り取り、音声切り出しは、開始〜終了を残して「WAV書き出し」または「MP3書き出し」する作業です。',
  tool_trim_an_audio_clip_and_export_faq_a3: '初期設定では切れ目を近くのゼロクロスへ寄せ、クリックノイズを減らします。詳細設定（任意）でオフにできます。',
  tool_trim_an_audio_clip_and_export_faq_a4: 'WAV は切った PCM のまま。MP3 は小さく（初期 128 kbps）、「MP3書き出し」を押したときだけエンコーダを読みます。',
  tool_trim_an_audio_clip_and_export_faq_a5: '違います。開始と終了を切って書き出すだけです。波形を扱うオンライン編集は別ツールになります。',
  tool_trim_an_audio_clip_and_export_faq_a6: 'およそ 30 秒まで切ることはできますが、M4A も自動フェードも出しません。着信音の仕様は別作業です。',
  tool_trim_an_audio_clip_and_export_faq_a7: 'できません。動画の分離も YouTube の吸い出しも対象外です。権利のある音声ファイルを使ってください。',
  tool_trim_an_audio_clip_and_export_faq_a8: 'デスクトップはおよそ 40 MB または 20 分。狭い画面はおよそ 20 MB または 8 分。上限超えは拒否し、黙って切り詰めません。',
  ...
  tool_trim_an_audio_clip_and_export_how_body: '開始と終了のあいだだけ残し、WAV か MP3 を保存します。ファイルは端末内、サーバーにアップロードしません。',
  ...
  tool_trim_an_audio_clip_and_export_rules_body: '開始から終了までのサンプルを新しいバッファへコピーします。初期設定では端を近くのゼロクロスへ寄せます。WAV は 16-bit PCM。MP3 は選んだビットレートの CBR です。',
  tool_trim_an_audio_clip_and_export_rules_item_1: 'デスクトップはおよそ 40 MB または 20 分、狭い画面はおよそ 20 MB または 8 分。超えたら拒否し、黙って短くしません。',
  tool_trim_an_audio_clip_and_export_rules_item_2: 'ファイルは端末に留まり、サーバーにアップロードしません。MP3 エンコーダはこのサイトから、「MP3書き出し」のあとだけ読みます。',
  tool_trim_an_audio_clip_and_export_rules_item_3: '復号はブラウザ次第です。DRM、一部コーデック、動画コンテナは明示的に失敗します。',
  tool_trim_an_audio_clip_and_export_rules_item_4: 'ミックス、フェード、M4A、YouTube 取得はありません。ファイルひとつ、範囲ひとつ、書き出しひとつです。',
  ...
  tool_trim_an_audio_clip_and_export_why_choose_body: '切って保存する一点向け。上限とクリック低減はページ上で確認できます。',
  tool_trim_an_audio_clip_and_export_why_choose_item_1: '復号と切り出しはこのタブ内。「MP3書き出し」がエンコーダを初めて読むタイミングです。',
  tool_trim_an_audio_clip_and_export_why_choose_item_2: '大きすぎる・長すぎるファイルは拒否し、黙って切り詰めません。',
  tool_trim_an_audio_clip_and_export_why_choose_item_3: 'ゼロクロス寄せが初期オンなので継ぎ目がカチッとなりにくい。オフにもできます。',
  tool_trim_an_audio_clip_and_export_why_choose_item_4: 'WAV と MP3 は別ボタンで、手順の文言と揃えています。ビットレートは詳細設定だけです。',
  ...
  tool_turn_pdf_into_editable_document_description:
    'ブラウザでPDFを編集できる文書にします。「編集できるようにする」でテキスト層を出し、直してから再描画PDFを書き出します。OCRはなく、スキャン頁は失敗します。ファイルは端末内に留まり、サーバーにアップロードしません。入場時のサンプルでプロセスと手順の例が動きます。Wordが必要なら抽出または新規作成を使ってください。',
  ...
  tool_turn_pdf_into_word_document_description:
    'ブラウザで PDF を Word 文書にします。選択できるテキストを抜き、確認してから .docx を保存します。端末内で処理し、サーバーにアップロードしません。OCR はありません。入場時のサンプルでプロセスと手順の例が動きます。スキャン頁は失敗します。',
  ...
  tool_turn_pdf_into_word_document_faq_a2:
    'スキャン頁は画像です。OCR はありません。スキャンPDFをWordにしたい場合は「スキャンしたPDFをOCRでまとめてWordにする」。テキスト層の .txt だけなら PDF からテキストを抽出を使ってください。',
  ...
  tool_unlock_pdf_faq_a2: 'いいえ。PDF ライブラリ はタブ内で動作（このサイトから読み込みます）。PDF は当社サーバーにアップロードされません。',
  ...
  tool_unzip_file_faq_a1: 'いいえ。ZIPはブラウザタブ内で読み取られ、展開後のデータも端末内に残ります。ZIPエンジンのスクリプトはこのサイトから読みますが、アーカイブ自体はサーバーにアップロードされません。',
  ...
  tool_validate_security_txt_faq_a1: '推奨は /.well-known/security.txt。同じホストの /security.txt はフォールバックです。',
  tool_validate_security_txt_faq_a2: '最低でも Contact。RFC 9116 の実務では Expires も強く期待され、欠落や期限切れを指摘します。',
  tool_validate_security_txt_faq_a3: 'いいえ。H1 は「security.txtを検証」。RFC はルールと参考文献にあります。',
  tool_validate_security_txt_faq_a4: 'いいえ。公開ファイルの取得と解析のみで、開示メールボックスではありません。',
  tool_validate_security_txt_faq_a5: '取得のため URL/ホストは Worker に届きますが、長期の製品 DB としては残しません。エッジツールであり「アップロードなし」ではありません。',
  ...
  tool_validate_security_txt_fetch_failed: 'security.txt を取得できませんでした。ホスト不通・ボット拒否の可能性があります。',
  tool_validate_security_txt_formula_body: 'RFC 9116 と securitytxt.org の一般的な運用に合わせています。',
  tool_validate_security_txt_formula_item_1: '取得順: まず /.well-known/security.txt、次に /security.txt。',
  ...
  tool_validate_security_txt_formula_item_4: 'Preferred-Languages / Canonical があれば表示（必須ではない）。',
  tool_validate_security_txt_formula_item_5: '取得と解析のみ。脆弱性受付窓口でもペネトレーションテストでもありません。',
  tool_validate_security_txt_formula_title: 'RFC 9116 で見るルール',
  tool_validate_security_txt_home_desc: 'サイトが Contact / Expires 付きの有効な security.txt を公開しているか確認します。',
  tool_validate_security_txt_home_title: 'security.txtを検証',
  tool_validate_security_txt_how_body: 'この検証ツールが答えるのは一点だけ: サイトは Contact 付きの discovery ファイルを公開し、Expires はまだ使えるか。',
  tool_validate_security_txt_how_item_1: 'ドメインまたは HTTPS URL を入力する。',
  tool_validate_security_txt_how_item_2: '「検証」を押す。Worker は /.well-known/security.txt を試し、次に /security.txt を試す。',
  tool_validate_security_txt_how_item_3: 'Contact・Expires・Preferred-Languages・Canonical とプレビューを確認する。',
  tool_validate_security_txt_how_item_4: '自分の security.txt を公開する前に、欠落を直す。',
  tool_validate_security_txt_how_title: '使い方',
  tool_validate_security_txt_privacy_note: 'URL とホスト名は Worker が security.txt を取得するために送信されます。製品データベースとしては保存しません。',
  ...
  tool_validate_security_txt_usecase_1: '公開前の security.txt チェッカー: well-known が届き Contact があるか確認。',
  tool_validate_security_txt_usecase_2: 'Expires 編集後のバリデータ確認: 日付が解釈でき、期限切れでないか。',
  tool_validate_security_txt_usecase_3: 'ベンダーに連絡する前に、相手ドメインが discovery ファイルを出しているか確認。',
  ...
  tool_wrap_formula_with_ifna_description:
    'IFNAで数式を包み、#N/Aを別値にする。手順：内側の式と代替値を入れてコピー。例：NA()と0。IFERRORではない。計算はブラウザ内。手順と例はサンプルと同じ方式です。ファイルは端末内で、サーバーにアップロードしません。いつでもサンプルを読めます。ページの例と同じです。',
  ...
  tool_write_countif_formula_in_excel_description:
    'COUNTIF数式を書く。手順：A1範囲と条件。* ?であいまい一致。例：A2:A6とWest。COUNTIFSは別。計算はブラウザ内。手順と例はサンプルと同じ方式です。ファイルは端末内で、サーバーにアップロードしません。いつでもサンプルを読めます。ページの例と同じです。',
  ...
  tool_write_ifs_formula_in_excel_description:
    '条件を順番に並べ、最後をTRUEの結果にしたIFS数式を作ります。例：WestはA、EastはB、それ以外はOther。Excel 2019、Microsoft 365以降が必要です。計算はブラウザ内。手順と例はサンプルと同じ方式です。ファイルは端末内で、サーバーにアップロードしません。',
  ...
  tool_write_nested_if_formula_for_excel_description:
    'ブラウザでネストしたIF数式を書く。手順：等しい/含む/空白の行を足し、それ以外を入れてコピー。例：A1=WestならA。計算はブラウザ内。手順と例はサンプルと同じ方式です。ファイルは端末内で、サーバーにアップロードしません。いつでもサンプルを読めます。ページの例と同じです。',
  ...
  tool_write_pdf_document_online_description:
    'オンラインで PDF 文書を作成. ファイルは端末内に留まり、サーバーにアップロードしません。 サンプルで実際の入力と出力を確認でき、手順と制限は本文で説明します。 手順はプレーンテキストと文字サイズを指定し、自動改行・改ページされた PDF を作成してプレビュー後に保存します。例では最初のページに2段落を出力します。リッチテキスト、表、画像、ヘッダー、任意フォントの編集には対応しません。',
  ...
  tool_writing_prompt_generator_ai_done: 'AI の文章を結果欄にそのまま書き出しました。コピー前に確認してください。',
  ...
  tool_writing_prompt_generator_faq_a4: '使えます。ランダムモードはジャンル・舞台・小道具・感情・葛藤を振り出します。数値の seed を入れれば同じ組み合わせを再現できます。出てくるのは着想のたたき台で、質は保証しません。',
  tool_writing_prompt_generator_faq_a5: '必要です。任意 AI パネルの Turnstile を通してから拡張または推敲を押してください。トークンがないとボタンはエラーになりますが、ローカルの組み立てはそのまま使えます。',
  ...
  tool_writing_prompt_generator_faq_q7: 'ChatGPT、Gemini、Claude、DeepSeek で使えますか？',
  tool_writing_prompt_generator_faq_q8: 'ローカルと任意 Cloudflare AI の違いは？',
  ...
  tool_writing_prompt_generator_rules_body: 'ライティング prompt には、モードごとに違うフィールドと、ランダムで出るものの限界をごまかさない説明、そして他のビルダーと同じ「まずブラウザ内で組み立てる」前提が要ります。',
  tool_writing_prompt_generator_rules_item_1: '出力四ブロック：Role、Task、Constraints、Output — 構造化 prompt テンプレートに整合。',
  tool_writing_prompt_generator_rules_item_2: 'ランダムモードは同じ画面の中にあります。ジャンル・舞台・小道具・感情・葛藤を振り出し、seed を入れれば同じ結果を再現できます。',
  tool_writing_prompt_generator_rules_item_3: '既定エクスポートは Markdown。JSON は同一キャンバスのチップ。',
  tool_writing_prompt_generator_rules_item_4: '任意の Cloudflare AI はローカルモードの代わりにはなりません。コピー前に AI の文章を確認してください。本ツールは prompt を組み立てるだけで、完成した物語は書きません。',
