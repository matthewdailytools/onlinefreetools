...
const ja: SiteLangDict = {
  ...
  tool_prompt_template_builder_faq_a1: 'いいえ。テンプレートはこのブラウザタブ内で組み立てます。OpenAI、Google、Anthropic、DeepSeek、当社サーバーへは送信しません。',
  tool_prompt_template_builder_faq_a2: 'いいえ。テキストをブロックに整形するだけです。ChatGPT、Gemini、Claude、DeepSeek や他のモデル API は呼びません。',
  ...
  tool_prompt_template_builder_faq_a4: 'はい。JSON チップで {role,task,constraints,output} を出力。設定やテスト用。必要なら JSON Schema バリデータと組み合わせてください。',
  ...
  tool_writing_prompt_generator_faq_a1: 'いいえ。prompt はこのブラウザタブ内で組み立てます。OpenAI、Google、Anthropic、DeepSeek、当社サーバーへは送信しません。',
  tool_writing_prompt_generator_faq_a2: 'いいえ。執筆 brief を prompt ブロックに整形するだけです。ChatGPT、Gemini、Claude、DeepSeek や他のモデル API は呼びません。',
  ...
  tool_writing_prompt_generator_faq_a4: 'はい。ランダムモードはジャンル、舞台、小道具、感情、葛藤を振り出します。任意の数値 seed で同じ結果を再現。ランダム出力はインスピレーションのみ — 品質保証なし。',
