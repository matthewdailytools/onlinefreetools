...
const ja: SiteLangDict = {
  ...
  tool_edit_pdf_text_online_faq_a4: '「テキストを追加」は座標に1行を重ねます。「テキスト抽出」は文言を取り出すだけです。この頁は既存の文言を直して頁を描き直します。',
  ...
  tool_edit_pdf_text_online_faq_q4: 'テキスト追加や抽出と何が違いますか？',
  ...
  tool_extract_text_from_pdf_how_body: '使い方: ファイルは端末内に留まり、サーバーにアップロードしません。',
  tool_extract_text_from_pdf_how_item_1: 'PDF を選択または入力',
  tool_extract_text_from_pdf_how_item_2: '「抽出」を押して処理を実行',
  tool_extract_text_from_pdf_how_item_3: '結果を確認',
  tool_extract_text_from_pdf_how_item_4: '必要ならダウンロード',
  ...
  tool_extract_text_from_pdf_rules_item_1: 'PDF からテキストを抽出.',
  ...
  tool_turn_pdf_into_editable_document_faq_a4: 'OCRしません。テキスト層がなければ「編集できるようにする」は失敗し、スキャンの文字を推測しません。',
  ...
  tool_turn_pdf_into_editable_document_faq_q4: '「編集できるようにする」はOCRしますか？',
  ...
  tool_write_pdf_document_online_faq_a2: 'いいえ。この処理は PDF のテキスト層抽出に依存しません。',
  ...
  tool_write_pdf_document_online_how_item_2: '「Create PDF」を押して処理を実行',
