...
const ja: SiteLangDict = {
  ...
  tool_prompt_template_builder_example: 'サンプル読込でコードレビュー Agent の四フィールドを入れ、## 見出し四つの Markdown を生成し、コピーとダウンロードを有効にします。',
  tool_prompt_template_builder_example_title: '例',
  tool_prompt_template_builder_faq_a1: 'いいえ。テンプレートはこのブラウザタブ内で組み立てます。OpenAI・Anthropic・当社サーバーへは送信しません。',
  tool_prompt_template_builder_faq_a2: 'いいえ。テキストをブロックに整形するだけで、モデル API は呼ばず、新しい文案も生成しません。',
  ...
  tool_prompt_template_builder_faq_a4: 'はい。JSON チップで {role,task,constraints,output} を出力。必要なら JSON Schema バリデータと組み合わせてください。',
  ...
  tool_prompt_template_builder_how_item_1: '自由欄に下書き、または Role・Task・Constraints・Output を入力 — 目的は構造化 prompt テンプレート。',
  ...
  tool_prompt_template_builder_rules_body: '再利用テンプレートには明確なブロックと正直な限界が必要 — 第二の生成器ではありません。',
  ...
  tool_prompt_template_builder_usecase_1: 'チームがどのチャット UI にも貼れるコードレビュー Agent の system prompt を共有。',
  tool_prompt_template_builder_usecase_2: 'API 接続前に議事録を Role/Task/Constraints ブロックに整理。',
  tool_prompt_template_builder_usecase_3: 'JSON を出力し、JSON Schema バリデータで設定ファイルを確認。',
