...
const pt: SiteLangDict = {
  ...
  tool_prompt_template_builder_desc: 'Modelo Prompt estruturado (Markdown/JSON) — fica no dispositivo, sem enviar ao servidor.',
  ...
  tool_prompt_template_builder_faq_a2: 'Não. Esta página só formata seu texto em blocos. Não chama nenhum modelo nem inventa texto novo.',
  ...
  tool_prompt_template_builder_rules_body: 'Um modelo reutilizável precisa de blocos claros e limites honestos — não um segundo gerador.',
  ...
  tool_prompt_template_builder_usecase_1: 'Publique um system prompt de revisão de código que a equipe possa colar em qualquer chat.',
  tool_prompt_template_builder_usecase_2: 'Transforme notas de reunião em blocos Role/Task/Constraints antes de conectar a API.',
  tool_prompt_template_builder_usecase_3: 'Exporte JSON e abra o validador JSON Schema para checar arquivos de configuração.',
