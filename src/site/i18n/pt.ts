...
const pt: SiteLangDict = {
  ...
  tool_text_diff_example:
    'Exemplo (modo palavra): A = "Hello world", B = "Hello there" → uma mudança (world → there). Se só a linha do meio muda num bloco de três, o modo linha marca essa linha.',
  ...
  tool_text_diff_how_body:
    'Cole duas versões, escolha a precisão (linha, palavra ou caractere) e revise adições em verde e remoções em vermelho. A comparação fica no navegador; não guardamos o seu texto.',
  ...
  tool_text_diff_faq_a2: 'Não. Tudo fica no navegador. Fechar a aba apaga a colagem; não armazenamos.',
