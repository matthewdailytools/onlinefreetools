...
const pt: SiteLangDict = {
  ...
  tool_color_from_image_article:
    'Paleta de cores dominantes local com média regional ao clicar e HEX/RGB/HSL copiáveis.',
  ...
  tool_color_from_image_pick_hint: 'Clique na imagem para fazer a média de uma região pequena em torno do ponto (cerca de 7×7 pixels de origem).',
  ...
  tool_color_from_image_rules_item_5:
    'Privacidade: decodificação, cálculo da paleta e amostragem por clique correm localmente nesta aba.',
  ...
  tool_color_from_image_usecase_2: 'Capturas de UI: veja a paleta da interface e depois clique num chip ou ícone para a cor exata da região.',
  tool_color_from_image_usecase_3: 'Ideias de gradiente: pegue dois acentos da paleta ou clicando, depois abra a calculadora de gradientes.',
  tool_color_from_image_faq_q1: 'A minha imagem sai do navegador?',
  tool_color_from_image_faq_a1: 'Não. Cálculo da paleta e amostragem por clique correm localmente. Veja o separador Rede — a imagem não é enviada por POST.',
  tool_color_from_image_faq_q2: 'Como são escolhidas as cores principais?',
  tool_color_from_image_faq_a2: 'A página reduz a imagem, descarta pixels de baixa opacidade, divide o espaço de cor com median-cut, faz a média de cada grupo e ordena pelo número de amostras.',
  tool_color_from_image_faq_q3: 'O que acontece quando clico na imagem?',
  tool_color_from_image_faq_a3: 'A ferramenta mapeia o clique para pixels de origem e faz a média de cores opacas num quadrado pequeno (~7×7). Obtém HEX/RGB/HSL dessa região, separado da lista da paleta.',
  tool_color_from_image_faq_q4: 'Por que um clique não é um único pixel?',
  tool_color_from_image_faq_a4: 'Fotos e capturas de UI são ruidosas em 1×1. Uma média de região pequena é mais estável para acentos CSS e ainda reflete onde clicou.',
  ...
  tool_image_merge_article: 'Colagem local de várias imagens com layout, espaço, fundo, ajuste em grade, formato e presets de tamanho.',
  ...
  tool_image_merge_rules_body: 'O tamanho da tela segue as fórmulas abaixo. Na grade as células partilham largura e altura; conter deixa margens, cobrir recorta.',
  ...
  tool_image_merge_faq_a1: 'Não. Decodificar, maquetar e exportar corre no navegador. Veja o separador Rede — não há POST de imagens.',
  tool_image_merge_faq_q2: 'Qual a diferença entre horizontal e vertical?',
  tool_image_merge_faq_a2: 'Horizontal unifica altura e cresce em largura; vertical unifica largura e cresce em altura. A grade usa células fixas com conter ou cobrir.',
  ...
  tool_image_merge_faq_a5: 'Bordas acima de ~8192 px ou muitos megapíxeis podem exceder a memória do navegador. Reduza imagens, colunas da grade ou recorte antes.',
  ...
  tool_image_overlay_article: 'Composição local de duas camadas: opacidade, canto superior esquerdo, escala, modos de mistura e fundo JPEG ao achatar transparência.',
  ...
  tool_image_overlay_rules_body: 'A tela de saída iguala os pixels naturais da base. A camada desenha-se com âncora superior esquerda em (x, y) após escala.',
  tool_image_overlay_rules_item_1: 'Largura × altura da tela = dimensões naturais da base; base desenhada em (0, 0).',
  tool_image_overlay_rules_item_2: 'Tamanho da camada = largura × altura natural × (escala% ÷ 100); posição em pixels da base, âncora superior esquerda.',
  tool_image_overlay_rules_item_3: 'globalAlpha = opacidade ÷ 100; globalCompositeOperation = mistura escolhida; reset após desenhar a camada.',
  ...
  tool_image_overlay_faq_a2: 'Unir concatena várias fotos em horizontal, vertical ou grade. Sobrepor mantém uma base e pinta uma camada com opacidade, posição e mistura.',
  tool_image_overlay_faq_q3: 'O que fazem os modos de mistura?',
  tool_image_overlay_faq_a3: 'Regras Canvas: Normal empilha; Multiplicar escurece; Tela clareia; Sobrepor aumenta contraste; Escurecer/Clarear escolhem min/máx por canal.',
...
tool_ip_address_title: 'Qual é o meu IP — Consulta IP pública (IPv4/IPv6)',
  ...
  tool_ip_address_rules_item_5: 'Local e ISP vêm de metadados IP do edge — muitas vezes nível cidade; móvel/CGNAT pode errar; VPN mostra o nó de saída.',
