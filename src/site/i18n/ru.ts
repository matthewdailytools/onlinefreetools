...
const ru: SiteLangDict = {
  ...
  footer_text: 'Online Free Tools · Обучающий проект · Постоянное обновление',
  ...
  tool_bmi_article: 'Что такое: Рассчитайте свой ИМТ (индекс массы тела), чтобы оценить, является ли ваш вес здоровым. Применение: Введите свой вес и рост, нажмите «рассчитать». Сценарии: медицинские осмотры, планирование фитнеса и контроль веса.',
