...
const ru: SiteLangDict = {
  ...
  tool_add_text_to_pdf_file_description:
    'Добавить текст в PDF. Файлы остаются на устройстве; без загрузки на сервер. El ejemplo al entrar показывает реальный результат при загрузке. un resultado real На этой странице показаны процесс, шаги и пример.',
  ...
  tool_check_pdf_a_compliance_description:
    'Проверить соответствие PDF/A. Файлы остаются на устройстве; без загрузки на сервер. El ejemplo al entrar показывает реальный результат при загрузке. un resultado real На этой странице показаны процесс, шаги и пример.',
  ...
  tool_combine_files_into_one_pdf_description:
    'Объединить файлы в один PDF. Файлы остаются на устройстве; без загрузки на сервер. El ejemplo al entrar показывает реальный результат при загрузке. un resultado real На этой странице показаны процесс, шаги и пример.',
  ...
  tool_compare_two_pdfs_description:
    'Сравнить два PDF. Файлы остаются на устройстве; без загрузки на сервер. El ejemplo al entrar показывает реальный результат при загрузке. un resultado real На этой странице показаны процесс, шаги и пример.',
  ...
  tool_convert_html_to_pdf_description:
    'Конвертировать HTML в PDF. Файлы остаются на устройстве; без загрузки на сервер. El ejemplo al entrar показывает реальный результат при загрузке. un resultado real На этой странице показаны процесс, шаги и пример.',
  ...
  tool_extract_text_from_pdf_description:
    'Извлечь текст из PDF. Файлы остаются на устройстве; без загрузки на сервер. El ejemplo al entrar показывает реальный результат при загрузке. un resultado real На этой странице показаны процесс, шаги и пример.',
  ...
  tool_make_pdf_flipbook_description:
    'Сделать PDF-флипбук. Файлы остаются на устройстве; без загрузки на сервер. El ejemplo al entrar показывает реальный результат при загрузке. un resultado real На этой странице показаны процесс, шаги и пример.',
  ...
  tool_open_pdf_in_browser_description:
    'Открыть PDF в браузере. Файлы остаются на устройстве; без загрузки на сервер. El ejemplo al entrar показывает реальный результат при загрузке. un resultado real На этой странице показаны процесс, шаги и пример.',
  ...
  tool_print_pdf_description:
    'Распечатать PDF. Файлы остаются на устройстве; без загрузки на сервер. El ejemplo al entrar показывает реальный результат при загрузке. un resultado real На этой странице показаны процесс, шаги и пример.',
  ...
  tool_turn_pdf_into_editable_document_faq_a2:
    'Эта страница открывает редактируемую копию из текстового слоя. «Редактировать текст PDF онлайн» меняет формулировку другой главной кнопкой.',
  ...
  tool_turn_pdf_into_editable_document_title: 'Сделать PDF редактируемым документом',
  ...
  tool_write_pdf_document_online_description:
    'Написать PDF-документ онлайн. Файлы остаются на устройстве; без загрузки на сервер. El ejemplo al entrar показывает реальный результат при загрузке. un resultado real На этой странице показаны процесс, шаги и пример.',
