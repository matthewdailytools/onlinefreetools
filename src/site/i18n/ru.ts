...
tool_ip_address_title: 'Узнать свой IP — Публичный адрес (IPv4/IPv6)',
  tool_ip_address_description:
    'Узнайте публичный IP, который наш edge видит для этого соединения — IPv4 или IPv6 в зависимости от маршрута. Процесс: откройте страницу или нажмите «Обновить»; worker читает доверенный IP клиента. Пример: может показать 203.0.113.10. При VPN/прокси — IP выхода, не 192.168 роутера. Для allowlist, удалённого доступа и проверки VPN.',
