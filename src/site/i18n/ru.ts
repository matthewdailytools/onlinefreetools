...
const ru: SiteLangDict = {
  ...
  tool_text_diff_example:
    'Пример (режим слов): A = "Hello world", B = "Hello there" → одно изменение (world → there). Если из трёх строк изменилась только средняя, режим строк отметит именно её.',
  ...
  tool_text_diff_how_body:
    'Вставьте две версии, выберите точность (строка, слово или символ) и смотрите зелёные добавления и красные удаления. Сравнение только в браузере; мы не сохраняем ваш текст.',
  ...
  tool_text_diff_faq_a2: 'Нет. Всё в браузере. Закрытие вкладки удаляет вставку; мы ничего не храним.',
