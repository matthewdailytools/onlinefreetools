...
const ru: SiteLangDict = {
  ...
  tool_prompt_template_builder_desc: 'Структурированный шаблон Prompt (Markdown/JSON) — на устройстве, без загрузки на сервер.',
  ...
  tool_prompt_template_builder_faq_a2: 'Нет. Страница только форматирует текст в блоки. Не вызывает модель и не придумывает новый текст.',
  ...
  tool_prompt_template_builder_rules_body: 'Переиспользуемый шаблон требует ясных блоков и честных границ — не второго генератора.',
  ...
  tool_prompt_template_builder_usecase_1: 'Опубликуйте system prompt для code review, который команда вставит в любой чат.',
  tool_prompt_template_builder_usecase_2: 'Превратите заметки встречи в блоки Role/Task/Constraints перед подключением API.',
  tool_prompt_template_builder_usecase_3: 'Экспортируйте JSON и откройте JSON Schema validator для проверки конфигов.',
