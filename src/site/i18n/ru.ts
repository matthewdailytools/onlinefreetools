...
const ru: SiteLangDict = {
  ...
  tool_yaml_json_rules_body:
    'По умолчанию типы как у классического js-yaml, пока не включите безопасные типы JSON. Оба направления на одной странице — без doorway-slug «только json в yaml».',
  ...
  tool_csv_json_rules_body:
    'По умолчанию каждая ячейка остаётся текстом, чтобы не испортить идентификаторы. Оба направления на одной странице, чтобы «json в csv» не был дорвей-URL.',
