...
const ru: SiteLangDict = {
  ...
  tool_sketch_prompt_generator_build: 'Собрать prompt',
  ...
  tool_sketch_prompt_generator_faq_q3: 'How is this different from Генератор sketch prompt?',
  ...
  tool_sketch_prompt_generator_platforms_lead: 'Для ChatGPT, Gemini, Claude, DeepSeek — копируйте готовый prompt в любой чат.',
  tool_sketch_prompt_generator_result_label: 'Вывод prompt',
  ...
  tool_sketch_prompt_generator_status_copied: 'Скопировано.',
  tool_sketch_prompt_generator_status_done: 'Prompt готов.',
  tool_sketch_prompt_generator_status_working: 'Сборка prompt…',
  tool_sketch_prompt_generator_stroke_label: 'Stroke',
  tool_sketch_prompt_generator_stroke_ph: 'Sample stroke…',
  tool_sketch_prompt_generator_title: 'Генератор sketch prompt — Локально + опциональный ИИ',
  ...
  tool_sketch_prompt_generator_usecases_title: 'Хорошие сценарии',
