...
const ar: SiteLangDict = {
	...
	tool_batch_compress_pdfs_for_email_faq_a1:
		'لا. التحويل الشبكي وإعادة البناء يجريان في هذا التبويب. الملفات تبقى على الجهاز ولا تُرفع إلى خادم. قد تُحمَّل pdf.js وpdf-lib ومساعد ZIP من هذا الموقع؛ ملفاتك لا تغادر التبويب.',
