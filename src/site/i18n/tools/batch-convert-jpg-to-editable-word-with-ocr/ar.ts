...
const ar: SiteLangDict = {
	...
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_elapsed_tpl: "مرّ {s} ث",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_fail_hint: "حدّث ثم تحويل الكل. الأقسام المنتهية تبقى قابلة للتنزيل.",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_fail_title: "توقف التحويل",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_api: "جارٍ تشغيل المُتعرّف…",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_core: "التشغيل الأول: تحميل محرّك التعرّف (~4 مب). ابقَ في هذه الصفحة — قد يستغرق دقيقة.",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_docx: "جارٍ تحميل مُجمّع وورد (~0.7 مب)…",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_lang: "التشغيل الأول: تحميل حزمة اللغة (عدة مب). انتظر؛ المرات التالية تعيد الاستخدام.",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_script: "جارٍ تحميل سكربتات التعرّف…",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_next: "انتهى. الخطوة التالية: تنزيل وورد.",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_pct_tpl: "{pct}%",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_step_load: "تحميل",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_step_pack: "تجميع",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_step_read: "قراءة",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_title: "تقدّم التحويل",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_working: "يبدأ…",
	...
	tool_batch_convert_jpg_to_editable_word_with_ocr_status_loading: "التشغيل الأول يحمّل محرّك التعرّف (~4 مب). ابقَ في هذه الصفحة…",
