...
const id: SiteLangDict = {
	...
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_elapsed_tpl: "{s}d berlalu",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_fail_hint: "Muat ulang lalu Konversi semua. Bagian selesai masih bisa diunduh.",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_fail_title: "Konversi berhenti",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_api: "Menyalakan pembaca…",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_core: "Pertama kali: memuat mesin OCR (~4 MB). Tetap di tab ini — bisa sekitar satu menit.",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_docx: "Memuat penyusun Word (~0,7 MB)…",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_lang: "Pertama kali: memuat data bahasa (beberapa MB). Berikutnya dipakai ulang.",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_script: "Memuat skrip OCR…",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_next: "Selesai. Langkah berikutnya: Unduh Word.",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_pct_tpl: "{pct}%",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_step_load: "Muat",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_step_pack: "Rakit",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_step_read: "Baca",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_title: "Kemajuan konversi",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_working: "Mulai…",
	...
	tool_batch_convert_jpg_to_editable_word_with_ocr_status_loading: "Pertama kali memuat mesin OCR (~4 MB). Tetap di tab ini…",
