...
const ja: SiteLangDict = {
	...
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_elapsed_tpl: "{s}秒経過",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_fail_hint: "再読み込みしてからすべて変換。終わった節はまだダウンロードできます。",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_fail_title: "変換が止まりました",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_api: "認識器を起動しています…",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_core: "初回：OCRエンジン（約4MB）を読み込みます。このタブのままお待ちください。1分ほどかかることがあります。",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_docx: "Word組み立て（約0.7MB）を読み込み中…",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_lang: "初回：言語データ（数MB）を読み込みます。次回以降は使い回します。",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_script: "OCRスクリプトを読み込み中…",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_next: "完了。次はWordをダウンロード。",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_pct_tpl: "{pct}%",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_step_load: "読み込み",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_step_pack: "組み立て",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_step_read: "読み取り",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_title: "変換の進み",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_working: "開始…",
	...
	tool_batch_convert_jpg_to_editable_word_with_ocr_status_loading: "初回はOCRエンジン（約4MB）を読み込みます。このタブのままお待ちください…",
