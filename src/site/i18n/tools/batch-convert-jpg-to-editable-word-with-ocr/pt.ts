...
const pt: SiteLangDict = {
	...
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_elapsed_tpl: "{s}s decorridos",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_fail_hint: "Atualize e clique Converter tudo. Seções prontas ainda baixam.",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_fail_title: "A conversão parou",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_api: "A iniciar o reconhecedor…",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_core: "Primeira vez: a carregar o motor OCR (~4 MB). Fique nesta aba — pode demorar um minuto.",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_docx: "A carregar o montador de Word (~0,7 MB)…",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_lang: "Primeira vez: a carregar os dados de idioma (alguns MB). Depois reutiliza.",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_load_script: "A carregar scripts de OCR…",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_next: "Pronto. Próximo passo: Baixar Word.",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_pct_tpl: "{pct}%",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_step_load: "Carregar",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_step_pack: "Montar",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_step_read: "Ler",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_title: "Andamento da conversão",
	tool_batch_convert_jpg_to_editable_word_with_ocr_hud_working: "Começando…",
	...
	tool_batch_convert_jpg_to_editable_word_with_ocr_status_loading: "A primeira vez carrega o motor OCR (~4 MB). Fique nesta aba…",
