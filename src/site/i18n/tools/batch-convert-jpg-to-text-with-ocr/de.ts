...
const de: SiteLangDict = {
	...
	tool_batch_convert_jpg_to_text_with_ocr_hud_elapsed_tpl: "{s}s vergangen",
	tool_batch_convert_jpg_to_text_with_ocr_hud_fail_hint: "Neu laden, dann Alle umwandeln. Fertige Zeilen bleiben herunterladbar.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_fail_title: "Umwandlung gestoppt",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_api: "Erkenner wird gestartet…",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_core: "Erster Lauf: OCR-Engine (~4 MB) wird geladen. Tab offen lassen — das kann eine Minute dauern.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_lang: "Erster Lauf: Sprachdaten (einige MB) werden geladen. Später wird das wiederverwendet.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_script: "OCR-Skripte werden geladen…",
	tool_batch_convert_jpg_to_text_with_ocr_hud_next: "Fertig. Nächster Schritt: ZIP herunterladen.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_pct_tpl: "{pct}%",
	tool_batch_convert_jpg_to_text_with_ocr_hud_step_load: "Laden",
	tool_batch_convert_jpg_to_text_with_ocr_hud_step_read: "Lesen",
	tool_batch_convert_jpg_to_text_with_ocr_hud_title: "Fortschritt der Umwandlung",
	tool_batch_convert_jpg_to_text_with_ocr_hud_working: "Start…",
	...
	tool_batch_convert_jpg_to_text_with_ocr_status_loading: "Beim ersten Mal wird die OCR-Engine (~4 MB) geladen. Tab offen lassen…",
