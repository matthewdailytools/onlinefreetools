...
const en: SiteLangDict = {
	...
	tool_batch_convert_jpg_to_text_with_ocr_hud_elapsed_tpl: "{s}s elapsed",
	tool_batch_convert_jpg_to_text_with_ocr_hud_fail_hint: "Refresh, then Convert all. Finished rows stay downloadable.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_fail_title: "Conversion stopped",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_api: "Starting the recognizer…",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_core: "First run: loading the OCR engine (~4 MB WASM). Stay on this tab — this can take a minute.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_lang: "First run: loading language data (a few MB). Later runs reuse this.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_script: "Loading OCR scripts…",
	tool_batch_convert_jpg_to_text_with_ocr_hud_next: "Finished. Next step: Download ZIP.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_pct_tpl: "{pct}%",
	tool_batch_convert_jpg_to_text_with_ocr_hud_step_load: "Load",
	tool_batch_convert_jpg_to_text_with_ocr_hud_step_read: "Read",
	tool_batch_convert_jpg_to_text_with_ocr_hud_title: "Conversion progress",
	tool_batch_convert_jpg_to_text_with_ocr_hud_working: "Starting…",
	...
	tool_batch_convert_jpg_to_text_with_ocr_status_loading: "First run loads the OCR engine (~4 MB). Stay on this tab…",
