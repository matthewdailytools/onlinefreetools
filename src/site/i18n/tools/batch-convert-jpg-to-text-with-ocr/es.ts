...
const es: SiteLangDict = {
	...
	tool_batch_convert_jpg_to_text_with_ocr_hud_elapsed_tpl: "{s}s transcurridos",
	tool_batch_convert_jpg_to_text_with_ocr_hud_fail_hint: "Recarga y pulsa Convertir todo. Las filas listas se pueden descargar.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_fail_title: "La conversión se detuvo",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_api: "Arrancando el reconocedor…",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_core: "Primera vez: se carga el motor OCR (~4 MB). Quédate en esta pestaña; puede tardar un minuto.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_lang: "Primera vez: se cargan los datos de idioma (varios MB). Luego se reutilizan.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_script: "Cargando scripts de OCR…",
	tool_batch_convert_jpg_to_text_with_ocr_hud_next: "Listo. Siguiente paso: Descargar ZIP.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_pct_tpl: "{pct}%",
	tool_batch_convert_jpg_to_text_with_ocr_hud_step_load: "Cargar",
	tool_batch_convert_jpg_to_text_with_ocr_hud_step_read: "Leer",
	tool_batch_convert_jpg_to_text_with_ocr_hud_title: "Progreso de la conversión",
	tool_batch_convert_jpg_to_text_with_ocr_hud_working: "Empezando…",
	...
	tool_batch_convert_jpg_to_text_with_ocr_status_loading: "La primera vez carga el motor OCR (~4 MB). Quédate en esta pestaña…",
