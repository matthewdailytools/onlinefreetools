...
const fr: SiteLangDict = {
	...
	tool_batch_convert_jpg_to_text_with_ocr_hud_elapsed_tpl: "{s}s écoulées",
	tool_batch_convert_jpg_to_text_with_ocr_hud_fail_hint: "Rechargez puis Tout convertir. Les lignes déjà faites restent téléchargeables.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_fail_title: "Conversion interrompue",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_api: "Démarrage du reconnaisseur…",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_core: "Premier lancement : chargement du moteur OCR (~4 Mo). Restez sur cet onglet — ça peut prendre une minute.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_lang: "Premier lancement : chargement des données de langue (quelques Mo). Ensuite c’est réutilisé.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_script: "Chargement des scripts OCR…",
	tool_batch_convert_jpg_to_text_with_ocr_hud_next: "Terminé. Suite : Télécharger ZIP.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_pct_tpl: "{pct}%",
	tool_batch_convert_jpg_to_text_with_ocr_hud_step_load: "Charger",
	tool_batch_convert_jpg_to_text_with_ocr_hud_step_read: "Lire",
	tool_batch_convert_jpg_to_text_with_ocr_hud_title: "Avancement de la conversion",
	tool_batch_convert_jpg_to_text_with_ocr_hud_working: "Démarrage…",
	...
	tool_batch_convert_jpg_to_text_with_ocr_status_loading: "Le premier lancement charge le moteur OCR (~4 Mo). Restez sur cet onglet…",
