...
const ru: SiteLangDict = {
	...
	tool_batch_convert_jpg_to_text_with_ocr_hud_elapsed_tpl: "прошло {s} с",
	tool_batch_convert_jpg_to_text_with_ocr_hud_fail_hint: "Обновите и нажмите Преобразовать всё. Готовые строки можно скачать.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_fail_title: "Преобразование остановилось",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_api: "Запуск распознавателя…",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_core: "Первый запуск: загружается OCR-движок (~4 МБ). Оставайтесь на вкладке — может занять минуту.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_lang: "Первый запуск: загружаются языковые данные (несколько МБ). Потом они переиспользуются.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_load_script: "Загрузка скриптов OCR…",
	tool_batch_convert_jpg_to_text_with_ocr_hud_next: "Готово. Дальше: Скачать ZIP.",
	tool_batch_convert_jpg_to_text_with_ocr_hud_pct_tpl: "{pct}%",
	tool_batch_convert_jpg_to_text_with_ocr_hud_step_load: "Загрузка",
	tool_batch_convert_jpg_to_text_with_ocr_hud_step_read: "Чтение",
	tool_batch_convert_jpg_to_text_with_ocr_hud_title: "Ход преобразования",
	tool_batch_convert_jpg_to_text_with_ocr_hud_working: "Запуск…",
	...
	tool_batch_convert_jpg_to_text_with_ocr_status_loading: "Первый запуск загружает OCR-движок (~4 МБ). Оставайтесь на вкладке…",
