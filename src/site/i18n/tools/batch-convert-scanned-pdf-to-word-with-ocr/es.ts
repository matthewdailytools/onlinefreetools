...
const es: SiteLangDict = {
	...
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_api: "Arrancando el reconocedor…",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_core: "Primera vez: se carga el motor OCR (~4 MB). Quédate en esta pestaña; puede tardar un minuto.",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_docx: "Cargando el ensamblador de Word (~0,7 MB)…",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_lang: "Primera vez: se cargan los datos de idioma (varios MB). Luego se reutilizan.",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_pdf: "Primera vez: se carga el dibujado de PDF. Quédate en esta pestaña.",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_script: "Cargando scripts de OCR…",
	...
	tool_batch_convert_scanned_pdf_to_word_with_ocr_status_loading: "La primera vez carga el dibujado PDF y el motor OCR (~4 MB). Quédate en esta pestaña…",
