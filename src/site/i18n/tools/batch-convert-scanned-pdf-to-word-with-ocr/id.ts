...
const id: SiteLangDict = {
	...
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_api: "Menyalakan pembaca…",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_core: "Pertama kali: memuat mesin OCR (~4 MB). Tetap di tab ini — bisa sekitar satu menit.",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_docx: "Memuat penyusun Word (~0,7 MB)…",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_lang: "Pertama kali: memuat data bahasa (beberapa MB). Berikutnya dipakai ulang.",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_pdf: "Pertama kali: memuat perender PDF. Tetap di tab ini.",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_script: "Memuat skrip OCR…",
	...
	tool_batch_convert_scanned_pdf_to_word_with_ocr_status_loading: "Pertama kali memuat gambar PDF dan mesin OCR (~4 MB). Tetap di tab ini…",
