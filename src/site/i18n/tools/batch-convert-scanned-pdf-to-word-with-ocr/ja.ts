...
const ja: SiteLangDict = {
	...
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_api: "認識器を起動しています…",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_core: "初回：OCRエンジン（約4MB）を読み込みます。このタブのままお待ちください。1分ほどかかることがあります。",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_docx: "Word組み立て（約0.7MB）を読み込み中…",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_lang: "初回：言語データ（数MB）を読み込みます。次回以降は使い回します。",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_pdf: "初回：PDF描画を読み込みます。このタブのままお待ちください。",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_script: "OCRスクリプトを読み込み中…",
	...
	tool_batch_convert_scanned_pdf_to_word_with_ocr_status_loading: "初回はPDF描画とOCRエンジン（約4MB）を読み込みます。このタブのままお待ちください…",
