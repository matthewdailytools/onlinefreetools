...
const pt: SiteLangDict = {
	...
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_api: "A iniciar o reconhecedor…",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_core: "Primeira vez: a carregar o motor OCR (~4 MB). Fique nesta aba — pode demorar um minuto.",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_docx: "A carregar o montador de Word (~0,7 MB)…",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_lang: "Primeira vez: a carregar os dados de idioma (alguns MB). Depois reutiliza.",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_pdf: "Primeira vez: a carregar o desenhador de PDF. Fique nesta aba.",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_script: "A carregar scripts de OCR…",
	...
	tool_batch_convert_scanned_pdf_to_word_with_ocr_status_loading: "A primeira vez carrega o desenho do PDF e o OCR (~4 MB). Fique nesta aba…",
