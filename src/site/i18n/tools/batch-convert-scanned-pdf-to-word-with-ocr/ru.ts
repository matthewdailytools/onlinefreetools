...
const ru: SiteLangDict = {
	...
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_api: "Запуск распознавателя…",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_core: "Первый запуск: загружается OCR-движок (~4 МБ). Оставайтесь на вкладке — может занять минуту.",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_docx: "Загрузка сборщика Word (~0,7 МБ)…",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_lang: "Первый запуск: загружаются языковые данные (несколько МБ). Потом они переиспользуются.",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_pdf: "Первый запуск: загружается отрисовка PDF. Оставайтесь на вкладке.",
	tool_batch_convert_scanned_pdf_to_word_with_ocr_hud_load_script: "Загрузка скриптов OCR…",
	...
	tool_batch_convert_scanned_pdf_to_word_with_ocr_status_loading: "Первый запуск загружает отрисовку PDF и OCR-движок (~4 МБ). Оставайтесь на вкладке…",
