...
const en: SiteLangDict = {
  ...
  tool_batch_trim_the_same_intro_from_audio_files_description: 'Batch trim the same intro from audio files in the browser without uploading. Steps: add several clips, set shared intro seconds, Trim to ZIP, download. Example: two four-second sample tones drop the first second into a ZIP of two WAVs. Decodes with browser decoding, writes 16-bit WAV, packs with lazy ZIP packaging. Files stay on your device—never uploaded.',
  tool_batch_trim_the_same_intro_from_audio_files_article: 'Podcast batches often share the same bumper. This page applies one intro length to a queue, exports trimmed 16-bit WAV files, and zips them with lazy ZIP packaging. It is not a single-file waveform editor—use the related trim page for precise handles. Bulk WAV→MP3 sits nearby for encoding after trim. Work stays on-device.',
  ...
  tool_batch_trim_the_same_intro_from_audio_files_err_format: 'Unsupported or damaged audio. Need mono/stereo that browser decoding can open.',
  ...
  tool_batch_trim_the_same_intro_from_audio_files_why_choose_item_2: 'The sample proves decode, trim, and lazy ZIP packaging in one path.',
  ...
  tool_batch_trim_the_same_intro_from_audio_files_usecase_3: 'A podcast batch all starts with the same 8-second bumper you want cut in one pass.',
