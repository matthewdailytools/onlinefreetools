...
const ar: SiteLangDict = {
	...
	tool_bulk_compress_product_photos_description:
		'ضغط صور المنتجات بالجملة: أضف صور العرض، واختر عند الحاجة قاعدة مقاس وحدّ كيلوبايت وJPEG/WebP/PNG، وأعد الترميز هنا، وتجاوز الفاشل ثم نزّل ZIP. الخطوات: اختر الدفعة؛ الخيارات تبدأ من «بدون تحديد» وتحافظ على الصيغة والبكسل؛ شريحة 200 كيلوبايت فقط إن طلب المتجر ذلك؛ اضغط الكل واقرأ إصابة أو تفويت. الصور التجريبية لا تُحمَّل إلا عند الضغط على تحميل مثال. تبقى الملفات على جهازك دون رفع إلى خادم.',
	...
	tool_bulk_compress_product_photos_example:
		'تحميل المثال يضع صورتين ويضغطهما بالإعدادات الحالية («بدون تحديد» يُبقي JPEG دون البحث عن كيلوبايت)، يملأ الجدول ويفعّل تنزيل ZIP. الأسماء المكررة تصبح name (2).jpg.',
	...
	tool_bulk_compress_product_photos_quality_hint_target:
		'مع حد الكيلوبايت يكون الشريط بداية البحث لا الجودة النهائية.',
	...
	tool_bulk_compress_product_photos_warn_png_target:
		'PNG لا يبحث عن حد الكيلوبايت. ابقَ على PNG أو انتقل إلى JPEG/WebP إن احتجت الحد.',
	...
	tool_bulk_compress_product_photos_how_item_2: 'الصيغة والكيلوبايت والمقاس تبدأ «بدون تحديد»: إعادة ترميز فقط. إن طلب المتجر JPEG أو 200 كيلوبايت ففعّل الشريحة أو الإعداد الجاهز. WebP وPNG متاحان أيضاً.',
	tool_bulk_compress_product_photos_how_item_3: 'إن كانت لقطة الهاتف ضخمة فاختر أطول ضلع أو أقصى عرض أو ارتفاع. «بدون تحديد» لا يغيّر البكسل.',
	tool_bulk_compress_product_photos_how_item_4: 'اضغط «ضغط الكل» واقرأ إصابة أو تفويت أو تجاوز.',
	tool_bulk_compress_product_photos_how_item_5: 'نزّل ZIP إن نجح ملف واحد على الأقل. المثال اختياري ولا يعمل تلقائيًا.',
	...
	tool_bulk_compress_product_photos_jpeg_bg_hint:
		'JPEG بلا شفافية. اللون يملأ البكسلات الفارغة فقط؛ الصور المعتمة لا تتغير. بدون تحديد يعني بلا طبقة.',
	tool_bulk_compress_product_photos_jpeg_bg_label: 'ملء الشفافية',
	tool_bulk_compress_product_photos_jpeg_bg_white: 'أبيض',
	tool_bulk_compress_product_photos_max_edge_label: 'أطول ضلع',
	tool_bulk_compress_product_photos_opt_none: 'بدون تحديد',
