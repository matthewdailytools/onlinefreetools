...
const ja: SiteLangDict = {
	...
	tool_bulk_compress_product_photos_preset_custom: 'カスタム',
	tool_bulk_compress_product_photos_preset_email: 'メール — 1280 px · 100 KB',
	tool_bulk_compress_product_photos_preset_group_combo: '出品シーン（サイズ + KB）',
	tool_bulk_compress_product_photos_preset_group_edge: 'サイズ規則のみ',
	tool_bulk_compress_product_photos_preset_group_kb: '目標容量のみ',
	tool_bulk_compress_product_photos_preset_hint: '規則・ピクセル・KB を一括入力',
	tool_bulk_compress_product_photos_preset_label: 'サイズプリセット',
	tool_bulk_compress_product_photos_preset_listing: '出品標準 — 1280 px · 200 KB',
	tool_bulk_compress_product_photos_preset_listing_hd: '出品 HD — 1920 px',
	tool_bulk_compress_product_photos_preset_social: 'SNS / スマホ — 1080 px · 150 KB',
	...
	tool_bulk_compress_product_photos_size_rule_max_edge: '長辺',
