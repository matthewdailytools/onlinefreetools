...
const ru: SiteLangDict = {
	...
	tool_bulk_compress_product_photos_quality_hint_target:
		'При потолке КБ ползунок — старт поиска, а не итоговое качество.',
	...
	tool_bulk_compress_product_photos_warn_png_target:
		'PNG не ищет потолок КБ. Оставьте PNG или переключитесь на JPEG/WebP, если нужен лимит.',
	...
	tool_bulk_compress_product_photos_how_item_2: 'Формат, КБ и размер сначала «Не выбирать» — только перекодировка. Площадка просит JPEG или 200 КБ — включите чип или пресет. Есть и WebP, и PNG.',
	tool_bulk_compress_product_photos_how_item_3: 'Если телефон снимает огромно, ограничьте длинную сторону, ширину или высоту. «Не выбирать» пиксели не трогает.',
