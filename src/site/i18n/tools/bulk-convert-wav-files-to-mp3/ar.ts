...
const ar: SiteLangDict = {
  ...
  tool_bulk_convert_wav_files_to_mp3_description: "حوّل ملفات WAV إلى MP3 دفعةً في المتصفح دون رفع. الخطوات: أضف عدة WAV، اختر معدل البت، حوّل إلى ZIP، نزّل. مثال: نغمتان ستيريو لخمس ثوانٍ تصبحان ملفين MP3 في ZIP عند 192 كيلوبت/ث. يستخدم decodeAudioData وlamejs لكل ملف ثم JSZip. تبقى الملفات على جهازك.",
