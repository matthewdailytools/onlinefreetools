...
/**
 * en strings for bulk-convert-wav-files-to-mp3. Rich How≥4 Why≥4 Rules≥4 FAQ≥5; local-only.
 */
const en: SiteLangDict = {
  ...
  tool_bulk_convert_wav_files_to_mp3_description: "Bulk convert WAV files to MP3 in the browser without uploading. Steps: add several WAV files, pick a bitrate, Convert to ZIP, download. Example: two five-second stereo tones become two MP3s in one ZIP at 192 kbps. Uses browser decoding and in-browser MP3 encoding per file, then ZIP packaging. Files stay on your device—never uploaded.",
  ...
  tool_bulk_convert_wav_files_to_mp3_usecase_3: "You finished a session as many WAVs and need one ZIP of shareable MP3s.",
