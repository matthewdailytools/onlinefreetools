...
const es: SiteLangDict = {
  ...
  tool_bulk_convert_wav_files_to_mp3_usecase_3: "Terminaste una sesión en muchos WAV y necesitas un ZIP de MP3 compartibles.",
