...
const fr: SiteLangDict = {
  ...
  tool_bulk_convert_wav_files_to_mp3_description: "Convertissez des WAV en MP3 en lot dans le navigateur sans téléverser. Étapes : ajouter plusieurs WAV, choisir le débit, Convertir en ZIP, télécharger. Exemple : deux tons stéréo de cinq secondes → deux MP3 dans un ZIP à 192 kbps. decodeAudioData et lamejs par fichier, puis JSZip. Les fichiers restent sur l’appareil.",
