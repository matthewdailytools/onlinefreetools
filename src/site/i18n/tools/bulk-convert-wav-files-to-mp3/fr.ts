...
/**
 * fr strings for bulk-convert-wav-files-to-mp3. Rich How≥4 Why≥4 Rules≥4 FAQ≥5; local-only.
 */
const fr: SiteLangDict = {
  ...
  tool_bulk_convert_wav_files_to_mp3_description: "Convertissez des WAV en MP3 en lot dans le navigateur sans téléverser. Étapes : ajouter plusieurs WAV, choisir le débit, Convertir en ZIP, télécharger. Exemple : deux tons stéréo de cinq secondes → deux MP3 dans un ZIP à 192 kbps. browser decoding et in-browser MP3 encoding par fichier, puis ZIP packaging. Les fichiers restent sur l’appareil.",
  tool_bulk_convert_wav_files_to_mp3_article: "Folders of WAV exports are awkward to share. This page queues several local WAV files, decodes each in the browser, encodes MP3 with in-browser MP3 encoding, and packs a ZIP with ZIP packaging. MP3 is lossy—keep the WAV masters. For one file use the related single WAV converter; FLAC is a different page. Work stays on-device.",
  tool_bulk_convert_wav_files_to_mp3_choose: "Choisir des fichiers WAV",
  tool_bulk_convert_wav_files_to_mp3_hint: "Up to 20 WAV files. Each file up to 40 MiB and 10 minutes. Mono or stereo PCM WAV.",
  tool_bulk_convert_wav_files_to_mp3_list_label: "File d’attente",
  tool_bulk_convert_wav_files_to_mp3_convert: "Convertir en ZIP",
  tool_bulk_convert_wav_files_to_mp3_download: "Télécharger le ZIP",
  tool_bulk_convert_wav_files_to_mp3_sample: "Charger un exemple",
  tool_bulk_convert_wav_files_to_mp3_clear: "Effacer",
  ...
  tool_bulk_convert_wav_files_to_mp3_remove: "Retirer",
  ...
  tool_bulk_convert_wav_files_to_mp3_how_title: "Comment convertir des WAV en MP3 en lot",
  ...
  tool_bulk_convert_wav_files_to_mp3_why_choose_title: "Pourquoi choisir notre conversion WAV en MP3 en lot",
  ...
  tool_bulk_convert_wav_files_to_mp3_rules_title: "Limites du lot et qualité",
  ...
  tool_bulk_convert_wav_files_to_mp3_example_title: "Un vrai exemple de lot",
  ...
  tool_bulk_convert_wav_files_to_mp3_usecases_title: "Utile pour",
  ...
  tool_bulk_convert_wav_files_to_mp3_usecase_3: "Une session a produit beaucoup de WAV ; il faut un ZIP de MP3 partageables.",
