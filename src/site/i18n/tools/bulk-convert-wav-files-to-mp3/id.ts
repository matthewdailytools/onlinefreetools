...
/**
 * id strings for bulk-convert-wav-files-to-mp3. Rich How≥4 Why≥4 Rules≥4 FAQ≥5; local-only.
 */
const id: SiteLangDict = {
  ...
  tool_bulk_convert_wav_files_to_mp3_description: "Ubah banyak WAV ke MP3 di browser tanpa unggah. Langkah: tambah beberapa WAV, pilih bitrate, Ubah ke ZIP, unduh. Contoh: dua nada stereo lima detik → dua MP3 dalam ZIP pada 192 kbps. Memakai decodeAudioData dan lamejs per berkas, lalu JSZip. Berkas tetap di perangkat.",
  ...
  tool_bulk_convert_wav_files_to_mp3_list_label: "Antrian berkas",
  tool_bulk_convert_wav_files_to_mp3_convert: "Ubah ke ZIP",
  tool_bulk_convert_wav_files_to_mp3_download: "Unduh ZIP",
  tool_bulk_convert_wav_files_to_mp3_sample: "Muat contoh",
  ...
  tool_bulk_convert_wav_files_to_mp3_remove: "Buang",
  ...
  tool_bulk_convert_wav_files_to_mp3_how_title: "Cara ubah banyak WAV menjadi MP3",
  ...
  tool_bulk_convert_wav_files_to_mp3_rules_title: "Batas batch dan kualitas jujur",
  ...
  tool_bulk_convert_wav_files_to_mp3_example_title: "Contoh konversi massal nyata",
