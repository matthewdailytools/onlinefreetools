...
const id: SiteLangDict = {
  ...
  tool_bulk_convert_wav_files_to_mp3_description: "Ubah banyak WAV ke MP3 di browser tanpa unggah. Langkah: tambah beberapa WAV, pilih bitrate, Ubah ke ZIP, unduh. Contoh: dua nada stereo lima detik → dua MP3 dalam ZIP pada 192 kbps. Memakai browser decoding dan in-browser MP3 encoding per berkas, lalu ZIP packaging. Berkas tetap di perangkat.",
