...
const ja: SiteLangDict = {
  ...
  tool_bulk_convert_wav_files_to_mp3_description: "ブラウザでWAVを一括MP3変換し、アップロードしません。手順：複数WAVを追加、ビットレートを選び、「ZIPに変換」、ダウンロード。例：5秒ステレオ音2本が192 kbpsでZIP内の2つのMP3に。ファイルごとにdecodeAudioDataとlamejs、その後JSZip。ファイルは端末に留まります。",
