...
/**
 * ja strings for bulk-convert-wav-files-to-mp3. Rich How≥4 Why≥4 Rules≥4 FAQ≥5; local-only.
 */
const ja: SiteLangDict = {
  ...
  tool_bulk_convert_wav_files_to_mp3_description: "ブラウザでWAVを一括MP3変換し、アップロードしません。手順：複数WAVを追加、ビットレートを選び、「ZIPに変換」、ダウンロード。例：5秒ステレオ音2本が192 kbpsでZIP内の2つのMP3に。ファイルごとにbrowser decodingとin-browser MP3 encoding、その後ZIP packaging。ファイルは端末に留まります。",
  ...
  tool_bulk_convert_wav_files_to_mp3_choose: "WAVファイルを選択",
  tool_bulk_convert_wav_files_to_mp3_hint: "Up to 20 WAV files. Each file up to 40 MiB and 10 minutes. Mono or stereo PCM WAV.",
  tool_bulk_convert_wav_files_to_mp3_list_label: "ファイルキュー",
  tool_bulk_convert_wav_files_to_mp3_convert: "ZIPに変換",
  tool_bulk_convert_wav_files_to_mp3_download: "ZIPをダウンロード",
  tool_bulk_convert_wav_files_to_mp3_sample: "サンプルを読み込む",
  tool_bulk_convert_wav_files_to_mp3_clear: "クリア",
  ...
  tool_bulk_convert_wav_files_to_mp3_remove: "削除",
  ...
  tool_bulk_convert_wav_files_to_mp3_how_title: "WAVを一括でMP3にする方法",
  ...
  tool_bulk_convert_wav_files_to_mp3_why_choose_title: "この一括WAV→MP3を選ぶ理由",
  ...
  tool_bulk_convert_wav_files_to_mp3_rules_title: "バッチ上限と品質の正直な説明",
  ...
  tool_bulk_convert_wav_files_to_mp3_example_title: "実際の一括変換例",
  ...
  tool_bulk_convert_wav_files_to_mp3_usecases_title: "こんなときに",
  ...
  tool_bulk_convert_wav_files_to_mp3_usecase_3: "セッションが多数のWAVになり、共有しやすいMP3のZIPが欲しい。",
