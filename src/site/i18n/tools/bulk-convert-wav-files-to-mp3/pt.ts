...
/**
 * pt strings for bulk-convert-wav-files-to-mp3. Rich How≥4 Why≥4 Rules≥4 FAQ≥5; local-only.
 */
const pt: SiteLangDict = {
  ...
  tool_bulk_convert_wav_files_to_mp3_description: "Converta WAV para MP3 em lote no navegador sem enviar. Passos: adicione vários WAV, escolha a taxa, Converter para ZIP, baixe. Exemplo: dois tons estéreo de cinco segundos → dois MP3 num ZIP a 192 kbps. Usa decodeAudioData e lamejs por arquivo, depois JSZip. Os arquivos ficam no dispositivo.",
  ...
  tool_bulk_convert_wav_files_to_mp3_list_label: "Fila de arquivos",
  tool_bulk_convert_wav_files_to_mp3_convert: "Converter para ZIP",
  tool_bulk_convert_wav_files_to_mp3_download: "Baixar ZIP",
  tool_bulk_convert_wav_files_to_mp3_sample: "Carregar amostra",
  ...
  tool_bulk_convert_wav_files_to_mp3_remove: "Remover",
  ...
  tool_bulk_convert_wav_files_to_mp3_how_title: "Como converter WAV para MP3 em lote",
  ...
  tool_bulk_convert_wav_files_to_mp3_rules_title: "Limites do lote e qualidade",
  ...
  tool_bulk_convert_wav_files_to_mp3_example_title: "Um exemplo real de lote",
