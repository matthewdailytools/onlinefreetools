...
/**
 * ru strings for bulk-convert-wav-files-to-mp3. Rich How≥4 Why≥4 Rules≥4 FAQ≥5; local-only.
 */
const ru: SiteLangDict = {
  ...
  tool_bulk_convert_wav_files_to_mp3_description: "Пакетно конвертируйте WAV в MP3 в браузере без загрузки. Шаги: добавьте несколько WAV, выберите битрейт, Конвертировать в ZIP, скачайте. Пример: два пятисекундных стереотона → два MP3 в ZIP при 192 кбит/с. browser decoding и in-browser MP3 encoding на файл, затем ZIP packaging. Файлы остаются на устройстве.",
  ...
  tool_bulk_convert_wav_files_to_mp3_choose: "Выбрать файлы WAV",
  tool_bulk_convert_wav_files_to_mp3_hint: "Up to 20 WAV files. Each file up to 40 MiB and 10 minutes. Mono or stereo PCM WAV.",
  tool_bulk_convert_wav_files_to_mp3_list_label: "Очередь файлов",
  tool_bulk_convert_wav_files_to_mp3_convert: "Конвертировать в ZIP",
  tool_bulk_convert_wav_files_to_mp3_download: "Скачать ZIP",
  tool_bulk_convert_wav_files_to_mp3_sample: "Загрузить образец",
  tool_bulk_convert_wav_files_to_mp3_clear: "Очистить",
  ...
  tool_bulk_convert_wav_files_to_mp3_remove: "Удалить",
  ...
  tool_bulk_convert_wav_files_to_mp3_how_title: "Как пакетно конвертировать WAV в MP3",
  ...
  tool_bulk_convert_wav_files_to_mp3_why_choose_title: "Почему выбрать наш пакетный WAV→MP3",
  ...
  tool_bulk_convert_wav_files_to_mp3_rules_title: "Лимиты пакета и честное качество",
  ...
  tool_bulk_convert_wav_files_to_mp3_example_title: "Реальный пример пакета",
  ...
  tool_bulk_convert_wav_files_to_mp3_usecases_title: "Полезно для",
  ...
  tool_bulk_convert_wav_files_to_mp3_usecase_3: "После сессии много WAV — нужен ZIP удобных для шаринга MP3.",
