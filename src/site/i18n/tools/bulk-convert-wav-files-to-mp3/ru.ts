...
const ru: SiteLangDict = {
  ...
  tool_bulk_convert_wav_files_to_mp3_description: "Пакетно конвертируйте WAV в MP3 в браузере без загрузки. Шаги: добавьте несколько WAV, выберите битрейт, Конвертировать в ZIP, скачайте. Пример: два пятисекундных стереотона → два MP3 в ZIP при 192 кбит/с. decodeAudioData и lamejs на файл, затем JSZip. Файлы остаются на устройстве.",
