...
const fr: SiteLangDict = {
	...
	tool_chatgpt_export_to_markdown_faq_a3: 'Oui. Les tableaux chat_messages de Claude (sender + text) passent par le même convertisseur : un seul collage traite les exports ChatGPT comme Claude.',
	...
	tool_chatgpt_export_to_markdown_faq_a5: 'Compter les tokens est un autre travail et n’est pas intégré ici. Utilisez un compteur de tokens dédié si besoin.',
	...
	tool_chatgpt_export_to_markdown_rules_body:
		'La conversion d’exports demande une carte de champs, un Markdown par défaut et une confidentialité claire sur le traitement local.',
	...
	tool_chatgpt_export_to_markdown_rules_item_3: 'Les puces JSON et CSV réémettent les mêmes tours pour pipelines ou tableurs.',
	...
	tool_chatgpt_export_to_markdown_usecase_3: 'Déposez un JSON chat_messages Claude ici ; le même convertisseur mappe ces tours en Markdown.',
