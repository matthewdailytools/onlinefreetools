...
const ru: SiteLangDict = {
	...
	tool_chatgpt_export_to_markdown_faq_a3: 'Да. Массивы chat_messages Claude (sender + text) разбирает тот же конвертер, поэтому одной вставки хватает и для экспорта ChatGPT, и для Claude.',
	...
	tool_chatgpt_export_to_markdown_faq_a5: 'Подсчёт токенов — другая задача, в этот конвертер она не входит. Когда нужно — возьмите отдельный счётчик токенов.',
	...
	tool_chatgpt_export_to_markdown_how_item_4: 'Скопируйте или скачайте. Нажмите «Загрузить пример», чтобы заполнить демо.',
	...
	tool_chatgpt_export_to_markdown_rules_body:
		'Конвертация экспорта требует карты полей, Markdown по умолчанию и ясной приватности локальной обработки.',
	...
	tool_chatgpt_export_to_markdown_rules_item_3: 'Чипы JSON и CSV снова отдают те же реплики для пайплайнов или таблиц.',
	...
	tool_chatgpt_export_to_markdown_usecase_3: 'Перетащите JSON chat_messages Claude сюда — тот же конвертер разложит реплики в Markdown.',
