...
const en: SiteLangDict = {
  ...
  tool_convert_a_flac_file_to_mp3_article: 'Archived music or voice often lives as FLAC. Players and chat apps still ask for MP3. This page opens one local FLAC, asks the browser to decode it, then encodes MP3 with in-browser MP3 encoding on your device. FLAC decode support varies by browser; when decode fails you see a clear message instead of a silent hang. Keep the FLAC master—MP3 is lossy. Related WAV and M4A converters sit nearby. Work stays on-device.',
  ...
  tool_convert_a_flac_file_to_mp3_usecase_3: 'An archive FLAC needs to become a chat-friendly MP3 without leaving your laptop.',
