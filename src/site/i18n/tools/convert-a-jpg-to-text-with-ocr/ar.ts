...
const ar: SiteLangDict = {
  ...
  tool_convert_a_jpg_to_text_with_ocr_hud_elapsed_tpl: "مرّ {s} ث",
  tool_convert_a_jpg_to_text_with_ocr_hud_fail_hint: "حدّث الصفحة ثم تحويل. النص المقروء يبقى قابلاً للنسخ أو التنزيل.",
  tool_convert_a_jpg_to_text_with_ocr_hud_fail_title: "توقف التحويل",
  tool_convert_a_jpg_to_text_with_ocr_hud_load_api: "جارٍ تشغيل المُتعرّف…",
  tool_convert_a_jpg_to_text_with_ocr_hud_load_core: "التشغيل الأول: تحميل محرّك التعرّف (~4 مب). ابقَ في هذه الصفحة — قد يستغرق دقيقة.",
  tool_convert_a_jpg_to_text_with_ocr_hud_load_lang: "التشغيل الأول: تحميل حزمة اللغة (عدة مب). انتظر؛ المرات التالية تعيد الاستخدام.",
  tool_convert_a_jpg_to_text_with_ocr_hud_load_script: "جارٍ تحميل سكربتات التعرّف…",
  tool_convert_a_jpg_to_text_with_ocr_hud_next: "انتهى. الخطوة التالية: نسخ النص أو تنزيل TXT.",
  tool_convert_a_jpg_to_text_with_ocr_hud_pct_tpl: "{pct}%",
  tool_convert_a_jpg_to_text_with_ocr_hud_step_load: "تحميل",
  tool_convert_a_jpg_to_text_with_ocr_hud_step_read: "قراءة",
  tool_convert_a_jpg_to_text_with_ocr_hud_title: "تقدّم التحويل",
  tool_convert_a_jpg_to_text_with_ocr_hud_working: "يبدأ…",
  ...
  tool_convert_a_jpg_to_text_with_ocr_status_loading: "التشغيل الأول يحمّل محرّك التعرّف (~4 مب). ابقَ في هذه الصفحة…",
