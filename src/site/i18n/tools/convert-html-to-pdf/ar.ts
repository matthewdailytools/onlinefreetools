...
const ar: SiteLangDict = {
  ...
  tool_convert_html_to_pdf_description: "تحويل HTML إلى PDF. تبقى الملفات على جهازك دون رفع إلى خادم. يمكن تحميل المثال لمراجعة مدخل فعلي ونتيجته؛ وتوضح الصفحة الخطوات والحدود.",
