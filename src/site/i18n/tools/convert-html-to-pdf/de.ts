...
const de: SiteLangDict = {
  ...
  tool_convert_html_to_pdf_description: "HTML in PDF umwandeln. Dateien bleiben auf Ihrem Gerät; ohne Server-Upload. El ejemplo al entrar Beim Laden wird ein echtes Ergebnis gezeigt. un resultado real Zeigt Prozess, Schritte und ein Beispiel auf der Seite.",
