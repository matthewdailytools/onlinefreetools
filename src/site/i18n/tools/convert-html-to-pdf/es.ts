...
const es: SiteLangDict = {
  ...
  tool_convert_html_to_pdf_description: "Convertir HTML a PDF. Los archivos permanecen en tu dispositivo; no se suben al servidor. El ejemplo al entrar muestra un resultado real.",
