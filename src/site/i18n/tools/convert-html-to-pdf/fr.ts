...
const fr: SiteLangDict = {
  ...
  tool_convert_html_to_pdf_description: "Convertir HTML en PDF. Les fichiers restent sur l’appareil ; sans envoi au serveur. L’exemple montre une entrée et une sortie réelles ; la page précise les étapes et les limites.",
  ...
  tool_convert_html_to_pdf_faq_a2: "Non. Cette opération ne dépend pas de l’extraction de la couche texte du PDF.",
  ...
  tool_convert_html_to_pdf_how_item_2: "Cliquez sur « Convert » pour lancer l’opération",
