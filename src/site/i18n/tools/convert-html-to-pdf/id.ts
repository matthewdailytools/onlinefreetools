...
const id: SiteLangDict = {
  ...
  tool_convert_html_to_pdf_description: "Konversi HTML ke PDF. Berkas tetap di perangkat; tanpa unggah ke server. Contoh memperlihatkan masukan dan keluaran nyata; langkah serta batas dijelaskan di halaman.",
