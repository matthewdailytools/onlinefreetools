...
const pt: SiteLangDict = {
  ...
  tool_convert_html_to_pdf_description: "Converter HTML para PDF. Os arquivos ficam no dispositivo; sem envio ao servidor. El ejemplo al entrar mostra resultado real ao abrir. un resultado real Inclui processo, passos e exemplo na página.",
