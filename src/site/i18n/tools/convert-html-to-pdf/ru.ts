...
const ru: SiteLangDict = {
  ...
  tool_convert_html_to_pdf_description: "Конвертировать HTML в PDF. Файлы остаются на устройстве; без загрузки на сервер. El ejemplo al entrar показывает реальный результат при загрузке. un resultado real На этой странице показаны процесс, шаги и пример.",
