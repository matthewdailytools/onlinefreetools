...
const zh: SiteLangDict = {
	...
	tool_convert_html_web_pages_to_word_document_how_item_3: 'HTML 里的图片要不要嵌进 Word？打开「高级设置（可选）」。默认开启，被拦的图仍会跳过。',
	...
	tool_convert_html_web_pages_to_word_document_opts_hint: '「嵌入图片」会尝试带上 HTML 里的图。CSS 定位不会映射。输出始终是一份 .docx。',
	...
	tool_convert_html_web_pages_to_word_document_rules_item_2: 'h1–h6 变成 Word 标题。ul/ol 变成列表。table 变成表格。a 变成超链接。',
	...
	tool_convert_html_web_pages_to_word_document_status_done: 'Word 已就绪——下载 .docx 再改字。',
