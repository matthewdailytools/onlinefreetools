...
const es: SiteLangDict = {
  ...
  tool_crop_pdf_how_item_1: "Selecciona la entrada con «Elegir PDF»",
  tool_crop_pdf_how_item_2: "Ajusta las opciones y pulsa «Recortar»",
  tool_crop_pdf_how_item_3: "Revisa la vista previa, el número de páginas o el estado",
  tool_crop_pdf_how_item_4: "Pulsa «Descargar» para guardar el resultado",
