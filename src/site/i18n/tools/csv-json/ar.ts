...
const ar: SiteLangDict = {
  ...
  tool_csv_json_faq_a5:
    'لا. يبقى التحليل في هذه اللسان، وتُقرأ الملفات المختارة محليًا. قد يقدّم هذا الموقع مكتبة Papa Parse؛ لكن ذلك الطلب ينزّل شيفرة فقط، وليس رفعًا لـ CSV أو JSON.',
  ...
  tool_csv_json_rules_item_4: 'الخصوصية: لا يُرفع نصك أو ملفاتك. جلب Papa Parse من هذا الموقع ينزّل شيفرة المكتبة فقط، لا بياناتك.',
