...
const ru: SiteLangDict = {
  ...
  tool_csv_json_how_item_1: 'Выберите CSV → JSON или JSON → CSV.',
  tool_csv_json_how_item_2: 'Вставьте вход и задайте разделитель / заголовок для CSV.',
  tool_csv_json_how_item_3: 'Нажмите «Преобразовать» (вложенный JSON разворачивается в колонки при экспорте CSV).',
  tool_csv_json_how_item_4: 'Скопируйте или скачайте результат.',
  ...
  tool_csv_json_title: 'Конвертер CSV ↔ JSON — таблицы в браузере, без загрузки на сервер',
