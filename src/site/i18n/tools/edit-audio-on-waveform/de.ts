...
/**
 * de copy for edit-audio-on-waveform (H0). Lightweight waveform hub; honest not-Pro-Tools FAQ.
 */
const de: SiteLangDict = {
  ...
  tool_edit_audio_on_waveform_description: 'Bearbeiten Sie Audio auf einer Wellenform im Browser: eine lokale Datei öffnen, Start–Ende auf einfacher Canvas-Wellenform wählen, Zuschneiden, dann WAV herunterladen—auf dem Gerät, ohne Upload. Schritte: Datei wählen (oder Beispiel laden), Wellenform ziehen, Zuschneiden, WAV herunterladen. Beispiel: 1,00–3,00 s einer 5-s-Probe als WAV. Chips öffnen Trim, nahtlose Schleife, Fade und Stereo→Mono. Leichter Hub—kein Pro Tools.',
  ...
  tool_edit_audio_on_waveform_trim: 'Zuschneiden',
  tool_edit_audio_on_waveform_export_wav: 'WAV herunterladen',
  tool_edit_audio_on_waveform_sample: 'Beispiel laden',
  tool_edit_audio_on_waveform_clear: 'Leeren',
  ...
  tool_edit_audio_on_waveform_how_title: 'So bearbeiten Sie Audio auf einer Wellenform',
  ...
  tool_edit_audio_on_waveform_why_choose_title: 'Warum unsere Audio-auf-Wellenform-Bearbeitungswerkzeuge',
  ...
  tool_edit_audio_on_waveform_faq_q1: 'Ist das Pro Tools oder ein volles DAW?',
  tool_edit_audio_on_waveform_faq_a1: 'Nein. Leichter Wellenform-Trim-Hub, kein Pro Tools und keine Mehrspur-Workstation.',
  tool_edit_audio_on_waveform_faq_q2: 'Wird mein Audio hochgeladen?',
  tool_edit_audio_on_waveform_faq_a2: 'Nein. Dekodieren und WAV-Schreiben laufen in diesem Tab.',
