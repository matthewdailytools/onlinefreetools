...
/**
 * es copy for edit-audio-on-waveform (H0). Lightweight waveform hub; honest not-Pro-Tools FAQ.
 */
const es: SiteLangDict = {
  ...
  tool_edit_audio_on_waveform_description: 'Edita audio en una forma de onda en el navegador: abre un archivo local, selecciona inicio–fin en un lienzo simple, Recortar, luego Descargar WAV—en el dispositivo, sin subir. Pasos: elige archivo (o Cargar muestra), arrastra la forma de onda, Recortar, Descargar WAV. Ejemplo: conserva 1.00–3.00 s de una muestra de 5 s. Chips abren recorte, bucle sin costura, fundido y estéreo a mono. Hub ligero—no Pro Tools. Procesamiento local.',
  ...
  tool_edit_audio_on_waveform_trim: 'Recortar',
  tool_edit_audio_on_waveform_export_wav: 'Descargar WAV',
  tool_edit_audio_on_waveform_sample: 'Cargar muestra',
  tool_edit_audio_on_waveform_clear: 'Borrar',
  ...
  tool_edit_audio_on_waveform_how_title: 'Cómo editar audio en una forma de onda',
  ...
  tool_edit_audio_on_waveform_why_choose_title: 'Por qué elegir nuestras herramientas Editar audio en una forma de onda',
  ...
  tool_edit_audio_on_waveform_faq_q1: '¿Es Pro Tools o un DAW completo?',
  tool_edit_audio_on_waveform_faq_a1: 'No. Es un hub ligero de recorte en forma de onda, no Pro Tools ni multipista.',
  tool_edit_audio_on_waveform_faq_q2: '¿Se sube mi audio?',
  tool_edit_audio_on_waveform_faq_a2: 'No. La decodificación y el WAV ocurren en esta pestaña.',
