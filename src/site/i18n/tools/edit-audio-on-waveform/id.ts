...
/**
 * id copy for edit-audio-on-waveform (H0). Lightweight waveform hub; honest not-Pro-Tools FAQ.
 */
const id: SiteLangDict = {
  ...
  tool_edit_audio_on_waveform_description: 'Edit audio pada gelombang di browser: buka satu file lokal, pilih awal–akhir pada kanvas sederhana, Potong, lalu Unduh WAV—di perangkat, tanpa diunggah. Langkah: pilih file (atau Muat sampel), seret gelombang, Potong, Unduh WAV. Contoh: pertahankan 1,00–3,00 s dari sampel 5 s. Chip membuka trim, loop mulus, fade, dan stereo→mono. Hub ringan—bukan Pro Tools.',
  ...
  tool_edit_audio_on_waveform_trim: 'Potong',
  tool_edit_audio_on_waveform_export_wav: 'Unduh WAV',
  tool_edit_audio_on_waveform_sample: 'Muat sampel',
  tool_edit_audio_on_waveform_clear: 'Hapus',
  ...
  tool_edit_audio_on_waveform_how_title: 'Cara mengedit audio pada gelombang',
  ...
  tool_edit_audio_on_waveform_faq_q1: 'Apakah ini Pro Tools atau DAW penuh?',
  tool_edit_audio_on_waveform_faq_a1: 'Tidak. Ini hub pemotong gelombang ringan, bukan Pro Tools atau multi-track.',
  tool_edit_audio_on_waveform_faq_q2: 'Apakah audio saya diunggah?',
  tool_edit_audio_on_waveform_faq_a2: 'Tidak. Decode dan tulis WAV di tab ini.',
