...
/**
 * ja copy for edit-audio-on-waveform (H0). Lightweight waveform hub; honest not-Pro-Tools FAQ.
 */
const ja: SiteLangDict = {
  ...
  tool_edit_audio_on_waveform_description: 'ブラウザの波形上でオーディオを編集：ローカルファイルを開き、簡易キャンバス波形で開始〜終了を選び、トリム、WAVを保存—端末内処理でアップロードしません。手順：ファイル選択（またはサンプル読込）、波形をドラッグ、トリム、WAVを保存。例：5秒サンプルの 1.00–3.00 秒を WAV に。チップで切り出し、シームレスループ、フェード、ステレオ→モノへ。軽量ハブで Pro Tools ではありません。',
  ...
  tool_edit_audio_on_waveform_trim: 'トリム',
  tool_edit_audio_on_waveform_export_wav: 'WAVを保存',
  tool_edit_audio_on_waveform_sample: 'サンプル読込',
  tool_edit_audio_on_waveform_clear: 'クリア',
  ...
  tool_edit_audio_on_waveform_how_title: '波形上でオーディオを編集する方法',
  ...
  tool_edit_audio_on_waveform_why_choose_title: 'この波形上でオーディオを編集するツールを選ぶ理由',
  ...
  tool_edit_audio_on_waveform_faq_q1: 'Pro Tools やフル DAW ですか？',
  tool_edit_audio_on_waveform_faq_a1: 'いいえ。軽量な波形トリマーハブであり、マルチトラック DAW ではありません。',
  tool_edit_audio_on_waveform_faq_q2: '音声はアップロードされますか？',
  tool_edit_audio_on_waveform_faq_a2: 'いいえ。デコードと WAV 書き込みはこのタブ内です。',
