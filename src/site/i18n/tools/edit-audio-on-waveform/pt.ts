...
/**
 * pt copy for edit-audio-on-waveform (H0). Lightweight waveform hub; honest not-Pro-Tools FAQ.
 */
const pt: SiteLangDict = {
  ...
  tool_edit_audio_on_waveform_description: 'Edite áudio em uma forma de onda no navegador: abra um arquivo local, selecione início–fim em um canvas simples, Cortar, depois Baixar WAV—no dispositivo, sem enviar. Passos: escolha arquivo (ou Carregar amostra), arraste a forma de onda, Cortar, Baixar WAV. Exemplo: manter 1,00–3,00 s de uma amostra de 5 s. Chips abrem corte, loop sem emenda, fade e estéreo→mono. Hub leve—não é Pro Tools.',
  ...
  tool_edit_audio_on_waveform_trim: 'Cortar',
  tool_edit_audio_on_waveform_export_wav: 'Baixar WAV',
  tool_edit_audio_on_waveform_sample: 'Carregar amostra',
  tool_edit_audio_on_waveform_clear: 'Limpar',
  ...
  tool_edit_audio_on_waveform_how_title: 'Como editar áudio em uma forma de onda',
  ...
  tool_edit_audio_on_waveform_faq_q1: 'Isto é Pro Tools ou um DAW completo?',
  tool_edit_audio_on_waveform_faq_a1: 'Não. É um hub leve de corte em forma de onda, não Pro Tools nem multipista.',
  tool_edit_audio_on_waveform_faq_q2: 'Meu áudio é enviado?',
  tool_edit_audio_on_waveform_faq_a2: 'Não. Decodificação e WAV ficam nesta aba.',
