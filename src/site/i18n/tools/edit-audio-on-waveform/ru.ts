...
/**
 * ru copy for edit-audio-on-waveform (H0). Lightweight waveform hub; honest not-Pro-Tools FAQ.
 */
const ru: SiteLangDict = {
  ...
  tool_edit_audio_on_waveform_description: 'Редактируйте аудио на волновой форме в браузере: откройте один локальный файл, выберите начало–конец на простом холсте, Обрезать, затем Скачать WAV—на устройстве, без загрузки. Шаги: выберите файл (или Загрузить образец), перетащите волну, Обрезать, Скачать WAV. Пример: оставить 1,00–3,00 с из образца 5 с. Чипы открывают обрезку, бесшовный цикл, фейд и стерео→моно. Лёгкий хаб—не Pro Tools.',
  ...
  tool_edit_audio_on_waveform_trim: 'Обрезать',
  tool_edit_audio_on_waveform_export_wav: 'Скачать WAV',
  tool_edit_audio_on_waveform_sample: 'Загрузить образец',
  tool_edit_audio_on_waveform_clear: 'Очистить',
  ...
  tool_edit_audio_on_waveform_how_title: 'Как редактировать аудио на волновой форме',
  ...
  tool_edit_audio_on_waveform_why_choose_title: 'Почему выбрать наши инструменты Редактировать аудио на волновой форме',
  ...
  tool_edit_audio_on_waveform_faq_q1: 'Это Pro Tools или полноценный DAW?',
  tool_edit_audio_on_waveform_faq_a1: 'Нет. Это лёгкий хаб обрезки по волне, не Pro Tools и не многодорожечная станция.',
  tool_edit_audio_on_waveform_faq_q2: 'Загружается ли моё аудио?',
  tool_edit_audio_on_waveform_faq_a2: 'Нет. Декодирование и запись WAV выполняются во вкладке.',
