...
const en: SiteLangDict = {
  ...
  tool_edit_mp3_title_and_cover_art_article: 'Players show missing titles and blank covers. This page rewrites ID3v2.3 title, artist, album and optional APIC cover on a local MP3 without decoding PCM or running lamejs on your track. Existing complex frames may be dropped when tags are rewritten. Keep a copy if you need rare frames. Related batch WAV→MP3 and single WAV→MP3 pages sit nearby. Work stays on-device.',
