...
const ru: SiteLangDict = {
	...
	tool_excel_compare_files_description:
		'Сравнить файлы Excel в браузере. Процесс: выберите два xlsx или csv, возьмите текущий лист (по умолчанию первый), затем перечислите ячейки с другим значением. Файлы остаются на устройстве и не загружаются на сервер. Пример: две таблицы по 3 строки, где B3 меняется с 2 на 9. «Онлайн» описывает работу, а не заголовок. Сдвиг столбцов сравнивается по адресу, не по имени заголовка.',
	...
	tool_excel_compare_files_faq_a3:
		'Да. CSV читается как один лист. Поиск «сравнить два csv» остаётся на этой странице, без отдельного URL.',
	...
	tool_excel_compare_files_how_item_4: 'Сравнение перечисляет отличающиеся ячейки; загрузка примера уже выполнена при первом показе.',
