...
const en: SiteLangDict = {
  ...
  tool_extract_audio_from_a_video_file_example: "Load sample builds a short synthetic WebM with a tone when browser media recording is available, then Extract runs automatically. Playback never starts by itself—press play on the preview if you want to hear it. Prefer dropping your own MP4 when the sample cannot be built.",
  ...
  tool_extract_audio_from_a_video_file_usecase_3: "You only need the VO or BGM from a camera clip as WAV or MP3.",
