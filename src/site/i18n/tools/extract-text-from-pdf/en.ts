...
const en: SiteLangDict = {
  ...
  tool_extract_text_from_pdf_how_body: "Choose a PDF with a text layer, extract plain paragraphs (page breaks as blank lines), then copy or download .txt. For a Markdown draft with ## Page N headings, use PDF to Markdown.",
  ...
  tool_extract_text_from_pdf_rules_item_1: "Output is plain UTF-8 text (.txt) with blank lines between pages — no Markdown headings.",
