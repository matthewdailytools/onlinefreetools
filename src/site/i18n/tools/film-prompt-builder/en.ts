/**
 * i18n tool shard (film-prompt-builder / en).
 * Master H1: Film prompt builder; local assembly + optional Cloudflare AI (Turnstile).
 */
...
const en: SiteLangDict = {
	...
	tool_film_prompt_builder_rules_item_4: 'This tool assembles text only; it does not run film prompt builder engines or call chat APIs locally.',
	...
	tool_film_prompt_builder_title:
		'Film prompt builder — Local + Optional AI',
