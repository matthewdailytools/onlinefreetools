...
const ar: SiteLangDict = {
	...
	tool_hreflang_rules_item_5:
		'تعامل جوجل الصيغ الثلاث — وسوم <link> في HTML ورأس HTTP Link وxhtml:link في خريطة الموقع — على أنها متكافئة، وتسمح باستخدامها معًا، لكنها تقول إن ذلك لا يمنح أي فائدة في البحث. اختر صيغة واحدة لكل مجموعة صفحات: فالتنفيذات الثلاث تتباعد مع الوقت، والتعليقات المتناقضة تُهمَل.',
