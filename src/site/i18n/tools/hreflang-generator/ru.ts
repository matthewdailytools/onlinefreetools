...
const ru: SiteLangDict = {
	...
	tool_hreflang_rules_item_5:
		'Google считает три формы — теги <link> в HTML, заголовок HTTP Link и xhtml:link в sitemap — равнозначными и разрешает применять их одновременно, но говорит, что выгоды для поиска в этом нет. Выбирайте одну на набор страниц: три реализации со временем расходятся, а противоречащие друг другу аннотации просто игнорируются.',
