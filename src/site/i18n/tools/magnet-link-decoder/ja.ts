...
const ja: SiteLangDict = {
  ...
  tool_magnet_link_decoder_how_body: '完全な Magnet URI を貼り付けて解析します。クエリを順序付きのキーと値に分け、% エスケープと + を復号し、重複キーをまとめ、exact topic、URL、サイズの形式を確認して、正規化 URI と JSON を作ります。壊れたエンコードは原因調査のため原文を残します。',
