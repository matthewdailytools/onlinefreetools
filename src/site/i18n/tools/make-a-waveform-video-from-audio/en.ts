...
const en: SiteLangDict = {
  ...
  tool_make_a_waveform_video_from_audio_settings_hint: 'Browsers record canvas frames plus audio with MediaRecorder. Output is often WebM (VP8/VP9 + Opus). This is not a lossless remux and not an MP4 guarantee. No YouTube download. Colors and layout are fixed for a clear audiogram look.',
  ...
  tool_make_a_waveform_video_from_audio_rules_body: 'Each run decodes audio, animates a canvas waveform, and re-encodes with MediaRecorder. Output is often WebM. This is not YouTube download, not extract-audio, and not a trim-only export.',
  ...
  tool_make_a_waveform_video_from_audio_faq_a2: 'Usually not. Most browsers record WebM via MediaRecorder. If MP4 is listed as supported, it may be used—but WebM is the common result. This is not a lossless remux.',
  ...
  tool_make_a_waveform_video_from_audio_faq_a6: 'MediaRecorder and canvas.captureStream must be available, and the audio must decode. Try Chrome or Edge, or a shorter WAV/MP3.',
};
export default en;
