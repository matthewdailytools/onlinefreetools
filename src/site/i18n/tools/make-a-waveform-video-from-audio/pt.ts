...
const pt: SiteLangDict = {
  ...
  tool_make_a_waveform_video_from_audio_settings_hint: 'Os navegadores gravam canvas + áudio com MediaRecorder. Costuma ser WebM. Não é remux sem perdas nem garantia MP4. Sem YouTube.',
  ...
  tool_make_a_waveform_video_from_audio_rules_body: 'Cada execução descodifica, anima a onda no canvas e reencode com MediaRecorder. Costuma ser WebM. Não é YouTube, extração nem só corte.',
