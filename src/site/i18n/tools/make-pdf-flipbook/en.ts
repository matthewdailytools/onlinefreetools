...
const en: SiteLangDict = {
  ...
  tool_make_pdf_flipbook_faq_a3: "It downloads one HTML file with the PDF bytes embedded. The viewer loads PDF.js from this site when opened, so it needs internet access.",
