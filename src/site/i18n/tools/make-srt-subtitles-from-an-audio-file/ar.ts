...
const ar: SiteLangDict = {
  ...
  tool_make_srt_subtitles_from_an_audio_file_faq_q1: 'هل هذه نسخة Whisper أو رفع ASR سحابي؟',
  tool_make_srt_subtitles_from_an_audio_file_faq_a1: 'لا. لا تتضمن Whisper wasm ولا ترفع ملفك إلى خوادمنا لـ ASR. تستخدم SpeechRecognition في المتصفح عند التوفر.',
