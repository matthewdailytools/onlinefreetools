...
const de: SiteLangDict = {
  ...
  tool_make_srt_subtitles_from_an_audio_file_description: 'Erstellen Sie SRT-Untertitel aus einer Audiodatei im Browser mit browser speech recognition, falls vorhanden. Schritte: lokale Audiodatei wählen, Sprache wählen, SRT beim Abspielen oder Mit Mikrofon diktieren, Vorschau bearbeiten, .srt herunterladen. Beispiel: Beispiel laden öffnet einen kurzen Ton und den Abspielpfad—echte Sprache braucht eine Aufnahme oder das Mikrofon. Cue-Zeiten sind Schätzungen beim Eintreffen finaler Ergebnisse, keine framegenaue a large speech model-Ausrichtung. Kein a large speech model-Klon und kein großes offline model-Modell. Viele Browser können hochgeladene Dateien nicht zuverlässig offline untertiteln. Diese Seite lädt Ihre Datei nicht für Server-ASR hoch.',
  ...
  tool_make_srt_subtitles_from_an_audio_file_why_choose_title: 'Warum unsere SRT-Untertitel-aus-Audiodatei-Tools',
  ...
  tool_make_srt_subtitles_from_an_audio_file_usecase_3: 'Du brauchst ein Start-SRT aus Spracherkennung zum Nachbearbeiten.',
  tool_make_srt_subtitles_from_an_audio_file_faq_q1: 'Ist das ein a large speech model-Klon oder Cloud-ASR-Upload?',
  tool_make_srt_subtitles_from_an_audio_file_faq_a1: 'Nein. Kein a large speech model-offline model und kein Upload zu unseren Servern für ASR. Nutzt browser speech recognition des Browsers, wenn verfügbar.',
