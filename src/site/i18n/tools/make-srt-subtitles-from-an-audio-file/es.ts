...
const es: SiteLangDict = {
  ...
  tool_make_srt_subtitles_from_an_audio_file_faq_q1: '¿Es un clon de Whisper o una subida ASR a la nube?',
  tool_make_srt_subtitles_from_an_audio_file_faq_a1: 'No. No incluye Whisper wasm ni sube tu archivo a nuestros servidores para ASR. Usa SpeechRecognition del navegador cuando esté disponible.',
