...
const fr: SiteLangDict = {
  ...
  tool_make_srt_subtitles_from_an_audio_file_description: 'Créez des sous-titres SRT depuis un fichier audio dans le navigateur avec browser speech recognition si disponible. Étapes : choisir un audio local, choisir la langue, Créer SRT pendant la lecture ou Dicter au micro, éditer l’aperçu, télécharger .srt. Exemple : Charger un échantillon ouvre une courte tonalité et lance le parcours lecture—il faut une vraie voix ou le micro. Les temps de cue sont des estimations à l’arrivée des résultats finaux, pas un alignement forcé type a large speech model. Ce n’est pas un clone a large speech model et n’charge pas un gros modèle offline model. Beaucoup de navigateurs ne sous-titrent pas fiablement les fichiers hors ligne. Cette page n’envoie pas votre fichier pour une ASR serveur.',
  ...
  tool_make_srt_subtitles_from_an_audio_file_why_choose_title: 'Pourquoi choisir nos outils pour créer des sous-titres SRT depuis un fichier audio',
  ...
  tool_make_srt_subtitles_from_an_audio_file_usecase_3: 'Il faut un premier SRT issu de la reconnaissance vocale à retravailler.',
  tool_make_srt_subtitles_from_an_audio_file_faq_q1: 'Est-ce un clone a large speech model ou un envoi ASR cloud ?',
  tool_make_srt_subtitles_from_an_audio_file_faq_a1: 'Non. Pas de a large offline speech model et pas d’envoi de votre fichier vers nos serveurs pour l’ASR. Utilise browser speech recognition du navigateur si disponible.',
