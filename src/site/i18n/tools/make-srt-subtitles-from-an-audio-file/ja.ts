...
/**
 * ja copy for make-srt-subtitles-from-an-audio-file (T1). SpeechRecognition → timed SRT; not cloud Whisper; honest limits.
 */
const ja: SiteLangDict = {
  ...
  tool_make_srt_subtitles_from_an_audio_file_description: 'ブラウザの SpeechRecognition がある場合、ローカル音声から SRT 字幕を作れます。手順：音声を選ぶ、言語を選ぶ、再生しながら SRT またはマイク口述、編集、.srt を保存。例：サンプル読込は短いトーンで再生パスを実行—実音声ファイルかマイクが必要。キュー時刻は最終結果到着時の推定で、Whisper 級の強制整列ではありません。Whisper クローンではなく巨大 wasm も読み込みません。多くのブラウザはアップロードファイルの確実なオフライン字幕化を持ちません。このページはサーバー ASR のためにファイルをアップロードしません。',
  ...
  tool_make_srt_subtitles_from_an_audio_file_convert: '再生しながら SRT',
  tool_make_srt_subtitles_from_an_audio_file_mic: 'マイクで口述',
  tool_make_srt_subtitles_from_an_audio_file_stop: '停止',
  tool_make_srt_subtitles_from_an_audio_file_download: 'SRTを保存',
  tool_make_srt_subtitles_from_an_audio_file_sample: 'サンプル読込',
  ...
  tool_make_srt_subtitles_from_an_audio_file_how_title: '音声ファイルから SRT 字幕を作る方法',
  ...
  tool_make_srt_subtitles_from_an_audio_file_faq_q1: 'Whisper クローンやクラウド ASR アップロードですか？',
  tool_make_srt_subtitles_from_an_audio_file_faq_a1: 'いいえ。Whisper wasm は同梱せず、ASR のために当サーバーへアップロードもしません。利用可能な場合はブラウザの SpeechRecognition を使います。',
  tool_make_srt_subtitles_from_an_audio_file_faq_q2: 'SRT の時刻はどれくらい正確ですか？',
  tool_make_srt_subtitles_from_an_audio_file_faq_a2: '最終認識結果が届いた時点の推定です。フレーム単位の強制整列ではありません。',
  ...
  tool_make_srt_subtitles_from_an_audio_file_faq_q4: '音声ファイルを文字に起こすツールとの違いは？',
  tool_make_srt_subtitles_from_an_audio_file_faq_a4: 'あちらは時刻なしの TXT。こちらは開始・終了付きの番号付き SRT です。',
