...
const ru: SiteLangDict = {
  ...
  tool_make_srt_subtitles_from_an_audio_file_faq_q1: 'Это клон Whisper или облачная загрузка ASR?',
  tool_make_srt_subtitles_from_an_audio_file_faq_a1: 'Нет. Нет Whisper wasm и нет загрузки файла на наши серверы для ASR. Используется SpeechRecognition браузера, если доступно.',
