...
const ar: SiteLangDict = {
  ...
  tool_merge_pdf_faq_a1:
    'لا. يعمل pdf-lib في تبويبك (قد تُحمَّل المكتبة من هذا الموقع). لا نرفع ملفاتك إلى خوادمنا.',
  ...
  tool_merge_pdf_rules_item_3: 'الخصوصية: تبقى البايتات في تبويب المتصفح. قد تُحمَّل المكتبة من هذا الموقع.',
