...
const ar: SiteLangDict = {
	...
	tool_serp_how_item_1: 'أدخل العنوان ووصف الميتا (URL للعرض اختياري).',
	tool_serp_how_item_2: 'بدّل بين تقدير الحاسوب أو الهاتف إذا كان كلاهما مهمًا.',
	tool_serp_how_item_3: 'راقب تلميحات الطول والبكسل أثناء التحرير.',
	tool_serp_how_item_4: 'عدّل الصياغة حتى تُقطَع المعاينة بشكل نظيف.',
	...
	tool_serp_faq_q3: 'هل توجد أداة من جوجل تعرض المقتطف النهائي؟',
	tool_serp_faq_a3: 'لا. أداة فحص الروابط تعطيك حالة الزحف والفهرسة مع لقطة للصفحة بعد عرضها، واختبار النتائج المنسقة يتحقق من أهلية البيانات المنظمة، ولا يعاين أي منهما نص المقتطف. كما تعيد جوجل كتابة عنوان الرابط عندما لا يناسب العنوان عبارة البحث، فالتحقق الحقيقي الوحيد هو أن تبحث عن الرابط المنشور بنفسك.',
