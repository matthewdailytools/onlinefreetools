...
const fr: SiteLangDict = {
	...
	tool_serp_faq_q3: 'Un outil Google peut-il montrer l’extrait final ?',
	tool_serp_faq_a3: 'Non. L’inspection d’URL donne l’état d’exploration et d’indexation avec une capture de la page rendue, et le test des résultats enrichis vérifie l’éligibilité des données structurées : aucun des deux n’affiche l’extrait textuel. Google réécrit aussi le lien de titre quand le title colle mal à la requête, donc la seule vraie vérification consiste à rechercher l’URL en ligne.',
