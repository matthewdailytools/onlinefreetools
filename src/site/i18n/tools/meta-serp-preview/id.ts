...
const id: SiteLangDict = {
	...
	tool_serp_faq_a3: 'Ini perkiraan lokal dengan arah yang sama. Untuk hasil akhir, buka halaman Anda di inspeksi URL Search Console atau Rich Results test, yang merender di lingkungan Google yang sebenarnya.',
