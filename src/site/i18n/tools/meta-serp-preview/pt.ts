...
const pt: SiteLangDict = {
	...
	tool_serp_faq_q3: 'Isso corresponde à prévia mobile do Search Console?',
	tool_serp_faq_a3: 'É uma estimativa local na mesma direção. Para o visual final, abra sua página na inspeção de URLs do Search Console ou no teste de resultados enriquecidos, que renderizam no ambiente real do Google.',
