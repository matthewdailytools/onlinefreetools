...
const ru: SiteLangDict = {
	...
	tool_meta_how_item_1: 'Заполните заголовок, описание и нужные необязательные поля.',
	tool_meta_how_item_2: 'При необходимости добавьте canonical, robots и значения Open Graph.',
	tool_meta_how_item_3: 'Нажмите «Создать», чтобы собрать экранированные head-теги.',
	tool_meta_how_item_4: 'Скопируйте результат и вставьте его в <head> страницы.',
