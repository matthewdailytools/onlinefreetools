...
const pt: SiteLangDict = {
	...
	tool_midjourney_prompt_builder_desc:
		'Construtor de prompts Midjourney — local por defecto + Expand/Polish opcional Cloudflare AI (Turnstile); Markdown/JSON en el dispositivo.',
	tool_midjourney_prompt_builder_description:
		'Processo e exemplo: Construtor de prompts Midjourney — Local + IA opcional para ChatGPT, Gemini, Claude y DeepSeek: ensambla prompts localmente por defecto y opcionalmente Expand/Polish con Cloudflare Workers AI (Turnstile obligatorio, límite de uso). Ejemplo al abrir. Markdown por defecto; JSON para pipelines. Texto en el dispositivo salvo que uses IA.',
	...
	tool_midjourney_prompt_builder_example:
		'Entrada: Subject = samurai na ponte; Style = tinta cinematográfica; Flags = --v 6.1 --style raw --chaos 8. Saída (Markdown): ## Task com linha MJ sugerida e --ar 16:9; JSON estruturado.',
	...
	tool_midjourney_prompt_builder_faq_a3:
		'Construtor de prompts Midjourney covers generic Role/Task/Constraints/Output templates. This page focuses on Construtor de prompts Midjourney fields with a dedicated sample and rules for this scenario.',
	...
	tool_midjourney_prompt_builder_faq_q3:
		'How is this different from Construtor de prompts Midjourney?',
	...
	tool_midjourney_prompt_builder_how_body:
		'Fill Construtor de prompts Midjourney fields, build a prompt locally, optionally Expand/Polish with Turnstile, then paste into ChatGPT, Gemini, Claude, or DeepSeek.',
	...
	tool_midjourney_prompt_builder_title:
		'Construtor de prompts Midjourney — Local + IA opcional',
