...
const ru: SiteLangDict = {
	tool_midjourney_prompt_builder_article:
		'Конструктор Midjourney prompt — Локально + опциональный ИИ для ChatGPT, Gemini, Claude и DeepSeek: локальная сборка по умолчанию, опционально Expand/Polish через Cloudflare Workers AI (Turnstile, лимиты). Пример на первом экране. Markdown по умолчанию; JSON для пайплайнов. Текст на устройстве, пока не включите ИИ.',
	...
	tool_midjourney_prompt_builder_desc:
		'Конструктор Midjourney prompt — local por defecto + Expand/Polish opcional Cloudflare AI (Turnstile); Markdown/JSON en el dispositivo.',
	tool_midjourney_prompt_builder_description:
		'Процесс и пример: Конструктор Midjourney prompt — Local + IA opcional para ChatGPT, Gemini, Claude y DeepSeek: ensambla prompts localmente por defecto y opcionalmente Expand/Polish con Cloudflare Workers AI (Turnstile obligatorio, límite de uso). Ejemplo al abrir. Markdown por defecto; JSON para pipelines. Texto en el dispositivo salvo que uses IA.',
	...
	tool_midjourney_prompt_builder_faq_a3:
		'Конструктор Midjourney prompt covers generic Role/Task/Constraints/Output templates. This page focuses on Конструктор Midjourney prompt fields with a dedicated sample and rules for this scenario.',
	...
	tool_midjourney_prompt_builder_faq_q3:
		'How is this different from Конструктор Midjourney prompt?',
	...
	tool_midjourney_prompt_builder_how_body:
		'Fill Конструктор Midjourney prompt fields, build a prompt locally, optionally Expand/Polish with Turnstile, then paste into ChatGPT, Gemini, Claude, or DeepSeek.',
	...
	tool_midjourney_prompt_builder_title:
		'Конструктор Midjourney prompt — Локально + опциональный ИИ',
