...
const ar: SiteLangDict = {
	...
	tool_onpage_description:
		'افحص العنوان ووصف الميتا وH1 وcanonical وrobots وOpen Graph وJSON-LD. الصق رابطًا أو HTML؛ اللصق يبقى في متصفحك دون رفع إلى خادم. مثال: صفحة بوسمَي H1.',
	...
	tool_onpage_desc_missing: 'لا يوجد وصف ميتا. في هذه الحالة تبني جوجل المقتطف من نص الصفحة نفسها. اكتب ملخصك بنفسك إذا أردت التحكم في هذه الصياغة.',
	...
	tool_onpage_h1_missing: 'لم يُعثر على H1. أضف عنواناً رئيسياً يوضح موضوع الصفحة؛ فقارئات الشاشة وعنوان المقتطف يعتمدان عليه.',
	tool_onpage_h1_multiple: 'وُجد {n} من وسوم H1. جوجل ترتّب الصفحات بأي عدد من وسوم H1، فهذه ليست عقوبة. ومع ذلك يظل H1 واحد مع أقسام H2–H6 أوضح في قارئات الشاشة.',
	...
	tool_onpage_canonical_other: 'يشير canonical إلى رابط مختلف، أي أنك تخبر جوجل بأن هذه الصفحة نسخة مكررة من ذلك الرابط. أبقِ ذلك فقط إن كان صحيحاً؛ فـ canonical تلميح، وقد تختار جوجل رابطاً آخر رغم ذلك.',
	...
	tool_onpage_how_item_1: 'ابق على «لصق HTML» أو انتقل إلى «جلب الرابط» لصفحة مباشرة.',
	tool_onpage_how_item_2: 'الصق الترميز أو أدخل URL بـ https.',
	tool_onpage_how_item_3: 'انقر «فحص الصفحة» (أو «مثال» لعرض توضيحي).',
	tool_onpage_how_item_4: 'راجع حالة كل فحص وأصلح الوسوم المبلّغ عنها.',
	tool_onpage_rules_title: 'القواعد التي تتبعها الفحوصات',
	tool_onpage_rules_body:
		'ما يقارن به كل فحص، ومدى صرامته. سلوك الوسوم (robots وcanonical والمحتوى المختلط) يتبع Google Search Central ومواصفات HTML. أما نصائح الطول والعناوين فهي إرشادات عرض وقابلية قراءة، وليست قواعد ترتيب.',
	...
	tool_onpage_rules_item_2:
		'H1: تحتاج الصفحة إلى عنوان يوضح موضوعها. لا تحدد جوجل عدداً مثالياً للعناوين ولا تعاقب على تعدد H1، لذلك يُنبّه الفحص على تعددها من أجل وضوح الهيكل وإمكانية الوصول فقط.',
	tool_onpage_rules_item_3:
		'Canonical: وسم <link rel="canonical"> داخل <head> تلميح بالرابط المفضّل بين النسخ المكررة، وليس أمراً مُلزماً. توازنه جوجل مع التحويلات وخرائط الموقع والروابط الداخلية ثم تختار بنفسها.',
	...
	tool_onpage_faq_q2: 'هل تعدد وسوم H1 يضر بالـ SEO؟',
	tool_onpage_faq_a2:
		'لا. تقول جوجل صراحة إنه لا يوجد عدد مثالي للعناوين، وهي ترتّب الصفحات بلا H1 أو بواحد أو بعدة وسوم. أسباب الإبقاء على H1 واحد هي إمكانية الوصول ووضوح الهيكل، مع فرصة أكبر أن تعيد جوجل استخدام عنوانك في عنوان المقتطف.',
	tool_onpage_faq_q3: 'هل يجب أن يشير canonical إلى نفسه؟',
	tool_onpage_faq_a3:
		'ليس بالضرورة، لكن الإحالة الذاتية أوضح إشارة لصفحة يُفترض أن تتصدر بنفسها. والإحالة إلى رابط آخر تعلن أن هذه الصفحة نسخة مكررة. وفي الحالتين تتعامل جوجل مع canonical كتلميح وقد تختار رابطاً مختلفاً.',
