...
const ar: SiteLangDict = {
	...
	tool_og_rules_item_1: 'يشترط بروتوكول Open Graph أربعة حقول: og:title وog:type وog:image وog:url. أما og:description فهو اختياري في المواصفة، لكن كل المنصات الكبرى تعرضه؛ فإن أهملته كتبت المنصة ملخصها بنفسها من نص الصفحة.',
	...
	tool_og_faq_a1:
		'تلجأ فيسبوك وX وواتساب إلى عنوان HTML ووصف meta وأي صورة تجدها في الصفحة. وهذا السلوك البديل يختلف من منصة إلى أخرى ويتغير مع الوقت، فقد تظهر البطاقة ناقصة أو بصورة خاطئة؛ ولهذا تُكتب حقول og: بنفسك.',
