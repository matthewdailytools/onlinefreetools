...
const ar: SiteLangDict = {
  ...
  tool_pdf_to_markdown_faq_a1:
    'لا. مُصيّر الصفحات يعمل في تبويبك (تُحمَّل السكربتات من هذا الموقع). PDF لا يُرفع إلى خوادمنا.',
  ...
  tool_pdf_to_markdown_faq_a4:
    'استخراج نص من PDF ينزّل .txt عادياً بأسطر فارغة بين الصفحات. هذه الأداة تلف كل صفحة كـ ## Page N وتفصل بـ --- لمحررات Markdown.',
  ...
  tool_pdf_to_markdown_faq_q4: 'ما الفرق عن استخراج نص من PDF؟',
  tool_pdf_to_markdown_faq_q5: 'متى أستخدم PDF إلى JPG؟',
  tool_pdf_to_markdown_how_body:
    'اختر PDF بطبقة نص، حوّل، راجع مسودة Markdown بعناوين لكل صفحة، ثم نزّل .md. الصفحات الممسوحة بلا نص تفشل بوضوح — بلا OCR.',
  tool_pdf_to_markdown_how_item_1: "اختر أو أسقط PDF بطبقة نص (أو تحميل مثال)",
  tool_pdf_to_markdown_how_item_2: "انقر تحويل لبناء مسودة Markdown",
  tool_pdf_to_markdown_how_item_3: "راجع أقسام ## Page N وفواصل --- في المعاينة",
  tool_pdf_to_markdown_how_item_4: "انقر تنزيل .md لحفظ المسودة",
  ...
  tool_pdf_to_markdown_rules_item_1: 'كل صفحة تصبح ## Page N مع أسطر النص؛ الصفحات مفصولة بـ --- لمحررات Markdown.',
  tool_pdf_to_markdown_rules_item_2: 'عكس استخراج نص من PDF (.txt): هذا تنزيل مسودة .md للمحررات — ليس تحويلاً layout-faithful.',
