...
const id: SiteLangDict = {
  ...
  tool_pdf_to_markdown_faq_a4:
    'Ekstrak teks dari PDF mengunduh .txt polos dengan baris kosong antar halaman. Alat ini membungkus setiap halaman sebagai ## Page N dan memisah dengan --- untuk editor Markdown.',
  ...
  tool_pdf_to_markdown_faq_q4: 'Bedanya dengan Ekstrak teks dari PDF?',
  tool_pdf_to_markdown_faq_q5: 'Kapan pakai PDF ke JPG?',
  tool_pdf_to_markdown_how_body:
    'Pilih PDF dengan lapisan teks, konversi, tinjau draf Markdown dengan judul per halaman, lalu unduh .md. Halaman pindaian tanpa teks gagal jelas — tanpa OCR.',
  tool_pdf_to_markdown_how_item_1: "Pilih atau jatuhkan PDF dengan lapisan teks (atau Muat contoh)",
  tool_pdf_to_markdown_how_item_2: "Klik Konversi untuk membangun draf Markdown",
  tool_pdf_to_markdown_how_item_3: "Tinjau bagian ## Page N dan pemisah --- di pratinjau",
  tool_pdf_to_markdown_how_item_4: "Klik Unduh .md untuk menyimpan draf",
  ...
  tool_pdf_to_markdown_rules_item_1: 'Setiap halaman menjadi ## Page N plus baris teks; halaman dipisah --- untuk editor Markdown.',
  tool_pdf_to_markdown_rules_item_2: 'Berbeda dari Ekstrak teks dari PDF (.txt): unduhan ini draf .md untuk editor — bukan konversi layout-faithful.',
