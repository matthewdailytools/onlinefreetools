...
const ru: SiteLangDict = {
  ...
  tool_pdf_to_markdown_faq_a4:
    '«Извлечь текст из PDF» скачивает plain .txt с пустыми строками между страницами. Здесь каждая страница — ## Page N, разделитель --- для Markdown-редакторов.',
  ...
  tool_pdf_to_markdown_faq_q4: 'Чем отличается от «Извлечь текст из PDF»?',
  tool_pdf_to_markdown_faq_q5: 'Когда использовать PDF в JPG?',
  tool_pdf_to_markdown_how_body:
    'Выберите PDF с текстовым слоем, конвертируйте, проверьте Markdown-черновик с заголовками страниц, скачайте .md. Скан без текста падает явно — без OCR.',
  tool_pdf_to_markdown_how_item_1: "Выберите или перетащите PDF с текстовым слоем (или «Загрузить пример»)",
  tool_pdf_to_markdown_how_item_2: "Нажмите «Конвертировать» для Markdown-черновика",
  tool_pdf_to_markdown_how_item_3: "Проверьте секции ## Page N и разделители --- в предпросмотре",
  tool_pdf_to_markdown_how_item_4: "Нажмите «Скачать .md», чтобы сохранить черновик",
  ...
  tool_pdf_to_markdown_rules_item_1: 'Каждая страница — ## Page N плюс строки текста; страницы разделены --- для Markdown-редакторов.',
  tool_pdf_to_markdown_rules_item_2: 'В отличие от «Извлечь текст из PDF» (.txt), здесь .md-черновик для редакторов — не layout-faithful конверсия.',
