...
const pt: SiteLangDict = {
	...
	tool_product_design_prompt_builder_desc:
		'Construtor de prompts de design de produto — local por defecto + Expand/Polish opcional Cloudflare AI (Turnstile); Markdown/JSON en el dispositivo.',
	tool_product_design_prompt_builder_description:
		'Processo e exemplo: Construtor de prompts de design de produto — Local + IA opcional para ChatGPT, Gemini, Claude y DeepSeek: ensambla prompts localmente por defecto y opcionalmente Expand/Polish con Cloudflare Workers AI (Turnstile obligatorio, límite de uso). Ejemplo al abrir. Markdown por defecto; JSON para pipelines. Texto en el dispositivo salvo que uses IA.',
	...
	tool_product_design_prompt_builder_example:
		'Entrada: Persona = co-parents; Problem = calendário ruidoso + handoff; Wireframe = 3 telas; Tokens = 8pt, #2563eb, WCAG AA. Saída (Markdown): ## Task → Persona / Problem / Wireframe / Design tokens.',
	...
	tool_product_design_prompt_builder_faq_a3:
		'Construtor de prompts de design de produto covers generic Role/Task/Constraints/Output templates. This page focuses on product design prompt builder fields with a dedicated sample and rules for this scenario.',
	...
	tool_product_design_prompt_builder_faq_q3:
		'How is this different from Construtor de prompts de design de produto?',
	...
	tool_product_design_prompt_builder_how_body:
		'Fill Construtor de prompts de design de produto fields, build a prompt locally, optionally Expand/Polish with Turnstile, then paste into ChatGPT, Gemini, Claude, or DeepSeek.',
	...
	tool_product_design_prompt_builder_title:
		'Construtor de prompts de design de produto — Local + IA opcional',
