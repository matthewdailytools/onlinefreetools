...
const ru: SiteLangDict = {
  ...
  tool_protect_pdf_how_item_1: "Выберите файл через «Выбрать PDF»",
  tool_protect_pdf_how_item_2: "Настройте параметры и нажмите «Защитить»",
  tool_protect_pdf_how_item_3: "Проверьте предпросмотр, число страниц или статус",
  tool_protect_pdf_how_item_4: "Нажмите «Скачать», чтобы сохранить результат",
