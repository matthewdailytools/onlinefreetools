...
const ar: SiteLangDict = {
  ...
  tool_remove_mains_hum_from_a_recording_article: "التسجيلات قرب مصادر الطاقة أو المخفتات أو معدات ضعيفة التأريض غالبًا تلتقط همهمة مستقرة عند 50 أو 60 هرتز، وأحيانًا بتوافقيات. هذه الصفحة تسلسل مراحل notch من EQ filter في on-device audio processing عند الأساسي المختار، واختياريًا التوافقيات من الثاني إلى الخامس تحت نيكويست. تستهدف نغمات كهربائية ضيقة—وليس تقليل هسهسة المروحة واسع النطاق، ولا إصلاح النقرات، ولا معادلة ثلاثية النطاق للصوت المكتوم. قد يخفّ الباس قرب الـ notch قليلًا. عدد القنوات يبقى 1 أو 2. احتفظ بالملف الأصلي؛ التنزيل WAV جديد بـ 16 بت. يعمل كل شيء في المتصفح على جهازك.",
  ...
  tool_remove_mains_hum_from_a_recording_usecase_3: "طنين 50/60 هرتز من الكهرباء مسموع تحت التسجيل.",
