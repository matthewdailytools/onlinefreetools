 ...
 * Mute local video via captureStream (video-only) + browser media recording; NOT YouTube download; NOT extract-audio.
 */
const en: SiteLangDict = {
  ...
  tool_remove_the_audio_track_from_a_video_description: 'Remove the audio track from a local video in the browser and download a muted clip. Steps: Choose a video, Remove audio, preview, download. Example: load a short sample with tone. Uses captureStream without audio tracks and browser media recording—often WebM output; not lossless remux. Never uploaded. No YouTube download.',
  tool_remove_the_audio_track_from_a_video_article: 'Short clips sometimes need picture only so you can add a new soundtrack later. This page lets you open a local video, capture its video frames without audio tracks, re-encode with browser media recording, then download a muted file—often WebM depending on the browser. It does not download YouTube or other URLs, does not extract the soundtrack as an audio file, and does not promise bit-identical MP4 remux without re-encoding. Success depends on whether your browser can play the container and support browser media recording. Keep the original; the download is a new file. Work runs on your device.',
  ...
  tool_remove_the_audio_track_from_a_video_settings_hint:
    'Browsers usually re-encode via browser media recording after dropping audio tracks. Output is often WebM, not a lossless remux of the original MP4. This page never downloads YouTube.',
  ...
  tool_remove_the_audio_track_from_a_video_err_encoder:
    'browser media recording could not write a muted video. Try Chrome/Edge or a shorter WebM/MP4.',
  ...
  tool_remove_the_audio_track_from_a_video_why_choose_item_2:
    'One clear mute job with honest browser media recording limits—not a fake lossless remux promise.',
  ...
  tool_remove_the_audio_track_from_a_video_rules_body:
    'Each run captures video without audio tracks and re-encodes with browser media recording. Output is often WebM. This is not YouTube download, not audio extract, and not guaranteed lossless remux.',
  ...
  tool_remove_the_audio_track_from_a_video_usecase_3: 'You need a silent picture file so you can add a new soundtrack later.',
  ...
  tool_remove_the_audio_track_from_a_video_faq_a2:
    'Usually not. Browsers re-encode with browser media recording after capturing video-only tracks. Output is often WebM and quality may differ.',
  ...
  tool_remove_the_audio_track_from_a_video_faq_a4:
    'The browser must be able to play the file and support browser media recording for a video MIME type. Try a shorter MP4/WebM or another browser.',
