...
const id: SiteLangDict = {
  ...
  tool_remove_the_audio_track_from_a_video_settings_hint: "Browser biasanya merekode ulang via MediaRecorder setelah membuang trek audio. Keluaran sering WebM, bukan remux lossless. Halaman ini tidak pernah mengunduh YouTube.",
  ...
  tool_remove_the_audio_track_from_a_video_rules_body: "Setiap proses menangkap video tanpa trek audio dan merekode ulang dengan MediaRecorder. Keluaran sering WebM. Bukan unduhan YouTube, bukan ekstrak audio, bukan remux lossless terjamin.",
  ...
  tool_remove_the_audio_track_from_a_video_faq_a2: "Biasanya tidak. Browser merekode ulang dengan MediaRecorder setelah tangkap hanya video. Sering WebM; kualitas bisa berbeda.",
  ...
  tool_remove_the_audio_track_from_a_video_faq_a4: "Browser harus bisa memutar file dan mendukung MediaRecorder untuk MIME video. Coba MP4/WebM lebih pendek atau browser lain.",
