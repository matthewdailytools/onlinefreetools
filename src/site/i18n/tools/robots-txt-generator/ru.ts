...
const ru: SiteLangDict = {
	...
	tool_robots_how_item_1: 'Отметьте или добавьте user-agent, которыми хотите управлять.',
	tool_robots_how_item_2: 'Введите пути Allow и Disallow для каждой группы (по одному пути в строке).',
	tool_robots_how_item_3: 'При желании добавьте URL Sitemap.',
	tool_robots_how_item_4: 'Нажмите «Сгенерировать», затем скопируйте или скачайте robots.txt.',
