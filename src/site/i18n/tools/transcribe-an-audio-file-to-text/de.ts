...
const de: SiteLangDict = {
  ...
  tool_transcribe_an_audio_file_to_text_faq_q1: 'Ist das ein Whisper-Klon oder Cloud-ASR-Upload?',
  tool_transcribe_an_audio_file_to_text_faq_a1: 'Nein. Kein Whisper-wasm und kein Upload zu unseren Servern für ASR. Nutzt SpeechRecognition des Browsers, wenn verfügbar.',
