...
const en: SiteLangDict = {
  ...
  tool_transcribe_an_audio_file_to_text_usecase_3: 'You need a draft transcript from browser speech recognition to edit into notes.',
  tool_transcribe_an_audio_file_to_text_faq_q1: 'Is this a large speech model clone or cloud ASR upload?',
  tool_transcribe_an_audio_file_to_text_faq_a1: 'No. It does not ship a large offline speech model model and does not upload your file to our servers for ASR. It uses the browser speech recognition API when available. Vendor speech services may still apply to microphone audio—see browser privacy docs.',
