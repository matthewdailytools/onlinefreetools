...
const fr: SiteLangDict = {
  ...
  tool_transcribe_an_audio_file_to_text_faq_q1: 'Est-ce un clone Whisper ou un envoi ASR cloud ?',
  tool_transcribe_an_audio_file_to_text_faq_a1: 'Non. Pas de Whisper wasm et pas d’envoi de votre fichier vers nos serveurs pour l’ASR. Utilise SpeechRecognition du navigateur si disponible.',
