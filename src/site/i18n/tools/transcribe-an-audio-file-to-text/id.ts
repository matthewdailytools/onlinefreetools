...
/**
 * id copy for transcribe-an-audio-file-to-text (A4). SpeechRecognition scene tool; not cloud Whisper; honest limits.
 */
const id: SiteLangDict = {
  ...
  tool_transcribe_an_audio_file_to_text_faq_a1: 'Tidak. Tidak menyertakan a large offline speech model dan tidak mengunggah file ke server kami untuk ASR. Menggunakan browser speech recognition browser jika tersedia.',
