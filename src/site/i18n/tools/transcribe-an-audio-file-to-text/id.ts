...
const id: SiteLangDict = {
  ...
  tool_transcribe_an_audio_file_to_text_faq_a1: 'Tidak. Tidak menyertakan Whisper wasm dan tidak mengunggah file ke server kami untuk ASR. Menggunakan SpeechRecognition browser jika tersedia.',
