...
/**
 * pt copy for transcribe-an-audio-file-to-text (A4). SpeechRecognition scene tool; not cloud Whisper; honest limits.
 */
const pt: SiteLangDict = {
  ...
  tool_transcribe_an_audio_file_to_text_faq_a1: 'Não. Não inclui a large offline speech model nem envia seu arquivo aos nossos servidores para ASR. Usa browser speech recognition do navegador quando disponível.',
