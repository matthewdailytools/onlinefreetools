...
const pt: SiteLangDict = {
  ...
  tool_transcribe_an_audio_file_to_text_faq_a1: 'Não. Não inclui Whisper wasm nem envia seu arquivo aos nossos servidores para ASR. Usa SpeechRecognition do navegador quando disponível.',
