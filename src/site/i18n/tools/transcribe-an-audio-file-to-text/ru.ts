...
const ru: SiteLangDict = {
  ...
  tool_transcribe_an_audio_file_to_text_faq_q1: 'Это клон Whisper или облачная загрузка ASR?',
  tool_transcribe_an_audio_file_to_text_faq_a1: 'Нет. Нет Whisper wasm и нет загрузки файла на наши серверы для ASR. Используется SpeechRecognition браузера, если доступно.',
