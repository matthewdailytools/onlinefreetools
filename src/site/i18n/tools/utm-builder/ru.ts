...
const ru: SiteLangDict = {
	...
	tool_utm_how_item_1: 'Введите базовый URL целевой страницы.',
	tool_utm_how_item_2: 'Заполните utm_source, utm_medium и utm_campaign (плюс необязательные параметры).',
	tool_utm_how_item_3: 'Нажмите «Создать», чтобы добавить percent-encoded UTM-параметры.',
	tool_utm_how_item_4: 'Скопируйте готовый tracking URL.',
