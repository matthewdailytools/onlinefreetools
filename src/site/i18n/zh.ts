...
const zh: SiteLangDict = {
  ...
  tool_sketch_prompt_generator_artist_ref_label: '艺术家 / 参考',
  tool_sketch_prompt_generator_artist_ref_ph: '参考风格…',
  tool_sketch_prompt_generator_build: '构建 Prompt',
  tool_sketch_prompt_generator_clear: '清空',
  tool_sketch_prompt_generator_composition_label: '构图',
  tool_sketch_prompt_generator_composition_ph: '构图说明…',
  ...
  tool_sketch_prompt_generator_faq_a1:
    '默认只在本浏览器标签页本地组装。可选「AI 扩写/润色」仅把该次点击提交的文字发往 Cloudflare Workers AI，不会从我们的服务器调用 OpenAI、Google、Anthropic 或 DeepSeek。',
  tool_sketch_prompt_generator_faq_a2: '本地模式只在本标签页整理字段，不调用 ChatGPT、Gemini、Claude、DeepSeek API。可选 AI 使用 Cloudflare Workers AI（须 Turnstile）。',
  ...
  tool_sketch_prompt_generator_faq_a4: '可以。使用 Expand/Polish 前须在可选 AI 面板完成 Turnstile；无有效 token 时 AI 按钮报错，本地模式仍可用。',
  ...
  tool_sketch_prompt_generator_faq_a6:
    'Yes. Copy the finished prompt into ChatGPT, Gemini, Claude, or DeepSeek. We do not split URLs per platform because the job is formatting text, not calling APIs.',
  tool_sketch_prompt_generator_faq_a7: '本地模式只在本标签页整理文字，不上传。可选 Expand/Polish 发往 Cloudflare Workers AI（须 Turnstile、有频率限制）。失败或超额时继续用本地模式。',
  ...
  tool_sketch_prompt_generator_faq_q3: 'How is this different from Prompt 模板构建器?',
  tool_sketch_prompt_generator_faq_q4: '为什么可选 AI 需要 Turnstile？',
  ...
  tool_sketch_prompt_generator_faq_q7: '本地模式与可选 Cloudflare AI 有何区别？',
  ...
  tool_sketch_prompt_generator_how_body: '填写 素描 Prompt 生成器 字段，本地构建 Prompt，可选 Turnstile 后 Expand/Polish，再粘贴到 ChatGPT、Gemini、Claude 或 DeepSeek。',
  tool_sketch_prompt_generator_how_item_1: '进页已自动运行默认样例（Load sample）。',
  ...
  tool_sketch_prompt_generator_how_item_4: '复制或下载，粘贴到 ChatGPT、Gemini、Claude 或 DeepSeek。',
  tool_sketch_prompt_generator_how_title: '使用方法',
  tool_sketch_prompt_generator_load_sample: '加载示例',
  tool_sketch_prompt_generator_medium_label: '媒介',
  tool_sketch_prompt_generator_medium_ph: '铅笔、炭笔…',
  tool_sketch_prompt_generator_platforms_lead: '适用于 ChatGPT、Gemini、Claude、DeepSeek — 复制成品 Prompt 到任意聊天界面。',
  tool_sketch_prompt_generator_result_label: 'Prompt 输出',
  tool_sketch_prompt_generator_rules_body: '素描 Prompt 生成器：默认本地组装；可选 Cloudflare AI 有频率限制且须 Turnstile。',
  ...
  tool_sketch_prompt_generator_stroke_label: '笔触',
  tool_sketch_prompt_generator_stroke_ph: '线条粗细…',
  tool_sketch_prompt_generator_title: '素描 Prompt 生成器 — 本地 + 可选 AI',
  tool_sketch_prompt_generator_usecase_1: '为团队在 ChatGPT、Gemini、Claude 或 DeepSeek 准备可粘贴的 素描 Prompt 生成器 简报。',
