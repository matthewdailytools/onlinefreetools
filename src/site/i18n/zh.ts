...
const zh: SiteLangDict = {
  ...
  tool_convert_an_m4a_file_to_mp3_article: '语音备忘录常以 M4A 保存。这里会在浏览器内解码一段完整 M4A 或 AAC，再按选择的码率生成 MP3 并显示实际大小。MP3 有损；以后还要编辑时请保留原 M4A。',
  ...
  tool_convert_an_m4a_file_to_mp3_desc: '把一段 M4A 或 AAC 录音转成便于分享的 MP3。文件留在设备上，不上传服务器。',
  tool_convert_an_m4a_file_to_mp3_description: '在浏览器中把 M4A 文件转成 MP3：选择一段 M4A 或 AAC 录音，选码率，转换、试听并下载 MP3。文件留在设备，不上传服务器；AAC 转 MP3 也是同一个工具。',
  tool_convert_an_m4a_file_to_mp3_done: '转换完成。试听后可下载 MP3。',
  tool_convert_an_m4a_file_to_mp3_download: '下载 MP3',
  tool_convert_an_m4a_file_to_mp3_elapsed: '已用 {s} 秒',
  tool_convert_an_m4a_file_to_mp3_empty: '请先选择 M4A/AAC 文件或加载示例。',
  tool_convert_an_m4a_file_to_mp3_encode: '编码 MP3',
  tool_convert_an_m4a_file_to_mp3_err_decode: '浏览器无法解码这个 M4A/AAC。DRM 文件和部分编码不支持。',
  tool_convert_an_m4a_file_to_mp3_err_encoder: 'MP3 编码器加载失败。检查网络后再次点击“转成 MP3”。',
  tool_convert_an_m4a_file_to_mp3_err_file: '每次只能拖入一个 M4A 或 AAC 文件。',
  tool_convert_an_m4a_file_to_mp3_err_format: '文件签名不支持。请选择 M4A/MP4 音频或 AAC ADTS，不要使用视频或仅改扩展名的文件。',
  tool_convert_an_m4a_file_to_mp3_err_limit: '文件超过 40 MiB、10 分钟或声道数限制。',
  tool_convert_an_m4a_file_to_mp3_example: '加载示例会在内存生成五秒双声道音调，并按 192 kbps 编成约 120 KiB 的 MP3。它演示输出流程；测试 M4A/AAC 解码请用自己的文件。',
  tool_convert_an_m4a_file_to_mp3_example_title: '试一次真实 MP3 输出',
  tool_convert_an_m4a_file_to_mp3_failed: '转换未完成。请换用当前浏览器可解码的较小 M4A/AAC 文件。',
  tool_convert_an_m4a_file_to_mp3_faq_a1: 'M4A 常是装 AAC 的 MP4 音频容器。本页接受 M4A/MP4 音频和 AAC ADTS 签名，但浏览器必须能解码其中音频；AAC 转 MP3 是同一项单文件任务。',
  tool_convert_an_m4a_file_to_mp3_faq_a2: '不会。读取、解码和编码均在设备浏览器内完成，文件不上传服务器。首次加载页面与编码器需要网络，不能保证离线可用。',
  tool_convert_an_m4a_file_to_mp3_faq_a3: '可能带 DRM、使用浏览器不支持的编码、实际是视频，或超出体积、时长、声道限制。请尝试新版浏览器和较短的非 DRM 音频。',
  tool_convert_an_m4a_file_to_mp3_faq_a4: '不能。MP3 有损，而源 M4A 可能本来已压缩。提高码率只能保留更多可听细节，不能恢复原数据；请保留 M4A 原件。',
  tool_convert_an_m4a_file_to_mp3_faq_a5: '不能。本页只把一个完整本地音频文件转成一个 MP3，不上传视频、不批量也不裁剪。只要录音片段时请使用相关音频裁剪工具。',
  tool_convert_an_m4a_file_to_mp3_faq_q1: 'M4A 和 AAC 一样吗？能转 AAC 吗？',
  tool_convert_an_m4a_file_to_mp3_faq_q2: '音频会上传服务器吗？',
  tool_convert_an_m4a_file_to_mp3_faq_q3: '为什么 M4A 会失败？',
  tool_convert_an_m4a_file_to_mp3_faq_q4: '转成 MP3 能保留原音质吗？',
  tool_convert_an_m4a_file_to_mp3_faq_q5: '能批量、转视频或做铃声吗？',
  tool_convert_an_m4a_file_to_mp3_hint: '拖入一个 M4A 或 AAC 文件；最多 40 MiB、10 分钟。能否解码取决于浏览器。',
  tool_convert_an_m4a_file_to_mp3_how_body: '需要分享完整本地录音时使用本页；还要编辑请保留 M4A 原件。',
  tool_convert_an_m4a_file_to_mp3_how_item_1: '选择 M4A 或 AAC 文件；也可加载示例检查 MP3 输出流程。',
  tool_convert_an_m4a_file_to_mp3_how_item_2: '保留 192 kbps，或在高级设置调整码率，然后点击“转成 MP3”。',
  tool_convert_an_m4a_file_to_mp3_how_item_3: '试听 MP3、比较实际大小，再点击“下载 MP3”。',
  tool_convert_an_m4a_file_to_mp3_how_title: '怎样把 M4A 录音转成 MP3',
  tool_convert_an_m4a_file_to_mp3_preview: '试听 MP3',
  tool_convert_an_m4a_file_to_mp3_progress: '转换进度',
  tool_convert_an_m4a_file_to_mp3_read: '读取音频文件',
  tool_convert_an_m4a_file_to_mp3_result: '音频 {seconds} 秒 · M4A/AAC {input} KiB → MP3 {output} KiB · {kbps} kbps · 44.1 kHz · {channels} 声道',
  tool_convert_an_m4a_file_to_mp3_rules_body: 'MP3 大小可粗略估算为秒数 × kbps × 1000 ÷ 8；编码填充会增加少量开销，结果区显示实测值。',
  tool_convert_an_m4a_file_to_mp3_rules_item_1: '口播可选 128 kbps，一般分享 192，音乐可试 320。MP3 始终有损，极小输入也可能变大。',
  tool_convert_an_m4a_file_to_mp3_rules_item_2: '输出为 44.1 kHz，保留解码后的一个或两个声道；不复制标签、封面或 M4A 元数据。',
  tool_convert_an_m4a_file_to_mp3_rules_item_3: '只处理一个不超过 40 MiB、10 分钟的 M4A/MP4 音频或 AAC ADTS。能否解码由浏览器决定；DRM、视频、列表和环绕声不在范围内。',
  tool_convert_an_m4a_file_to_mp3_rules_title: '码率、兼容性与限制',
  tool_convert_an_m4a_file_to_mp3_sample: '加载示例',
  tool_convert_an_m4a_file_to_mp3_sample_name: '五秒音调',
  tool_convert_an_m4a_file_to_mp3_settings_hint: '默认 192 kbps；口播可选 128，音乐细节可选 320。输出为 44.1 kHz。',
  tool_convert_an_m4a_file_to_mp3_title: '把 M4A 文件转成 MP3',
  tool_convert_an_m4a_file_to_mp3_usecase_1: '把 M4A 语音备忘录转成 MP3 附件，同时保留原始录音。',
  tool_convert_an_m4a_file_to_mp3_usecase_2: '把 AAC 录音转成 MP3，发给无法播放 M4A 的收件人。',
  tool_convert_an_m4a_file_to_mp3_usecases_title: '适合这些情况',
  tool_convert_an_m4a_file_to_mp3_why_choose_item_1: '解码前检查 M4A/MP4 或 AAC 签名，改名视频会明确报错。',
  tool_convert_an_m4a_file_to_mp3_why_choose_item_2: '下载前可试听真正生成的 MP3，并比较输入输出的实测大小。',
  tool_convert_an_m4a_file_to_mp3_why_choose_item_3: '只转换整段录音，不裁剪、不加淡化、不上传，也不另设第二种输入。',
