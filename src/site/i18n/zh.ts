...
const zh: SiteLangDict = {
  ...
  tool_trim_an_audio_clip_and_export_faq_a2: '不是。剪音频、音频裁剪、音频剪切、裁剪mp3、切割mp3 都是打开文件、标起点和终点、点「裁剪」，再导出 WAV 或 MP3。',
  ...
  tool_trim_an_audio_clip_and_export_faq_q2: '我搜的是 mp3剪切、剪mp3、切割mp3 或在线剪音频，这是另一个工具吗？',
