...
const zh: SiteLangDict = {
  ...
  tool_add_text_to_pdf_file_description:
    '向 PDF 文件添加文字. 文件留在本机，不上传服务器。 El ejemplo al entrar 进页样例会显示真实结果。 un resultado real 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。',
  ...
  tool_check_pdf_a_compliance_article: '检查 PDF/A 合规性. 文件留在本机，不上传服务器。',
  tool_check_pdf_a_compliance_check: '检查',
  ...
  tool_check_pdf_a_compliance_desc: '检查 PDF/A 合规性 — 文件留在本机，不上传服务器。',
  tool_check_pdf_a_compliance_description:
    '检查 PDF/A 合规性. 文件留在本机，不上传服务器。 El ejemplo al entrar 进页样例会显示真实结果。 un resultado real 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。',
  ...
  tool_check_pdf_a_compliance_err_notext: '未找到可选中文本（无 OCR）。',
  tool_check_pdf_a_compliance_err_pdfjs: 'PDF 渲染库加载失败。',
  tool_check_pdf_a_compliance_example: '加载样例: PDF/A check sample.',
  tool_check_pdf_a_compliance_example_title: '示例',
  tool_check_pdf_a_compliance_fail: '未通过',
  tool_check_pdf_a_compliance_faq_a1: '不会。渲染在浏览器标签页完成（库可能从 CDN 加载），PDF 不会上传到我们的服务器。',
  tool_check_pdf_a_compliance_faq_a2: '扫描版 PDF 通常是图片，没有文本层，本工具不做 OCR。',
  tool_check_pdf_a_compliance_faq_a3: '加密或损坏的文件会显示明确错误，不会静默失败。',
  tool_check_pdf_a_compliance_faq_a4: '相关 PDF 工具在页面底部 Related 区列出，可跳转邻页。',
  tool_check_pdf_a_compliance_faq_a5: '大文件可能较慢；建议先在桌面浏览器试用。',
  tool_check_pdf_a_compliance_faq_q1: '会上传服务器吗？',
  tool_check_pdf_a_compliance_faq_q2: '扫描版 PDF 为什么失败？',
  tool_check_pdf_a_compliance_faq_q3: '加密文件会怎样？',
  tool_check_pdf_a_compliance_faq_q4: '和邻近工具有什么区别？',
  tool_check_pdf_a_compliance_faq_q5: '大文件有限制吗？',
  tool_check_pdf_a_compliance_how_body: '使用方法: 文件留在本机，不上传服务器。',
  tool_check_pdf_a_compliance_how_item_1: '选择 PDF 或粘贴内容',
  tool_check_pdf_a_compliance_how_item_2: '点击主按钮运行处理',
  tool_check_pdf_a_compliance_how_item_3: '在结果区查看输出',
  tool_check_pdf_a_compliance_how_item_4: '需要时下载或打印',
  tool_check_pdf_a_compliance_how_title: '使用方法',
  tool_check_pdf_a_compliance_pass: '通过',
  tool_check_pdf_a_compliance_results_label: '检查结果',
  tool_check_pdf_a_compliance_rules_body: '文件留在本机，不上传服务器。',
  tool_check_pdf_a_compliance_rules_item_1: '检查 PDF/A 合规性.',
  tool_check_pdf_a_compliance_rules_item_2: '纯客户端处理，文件不上传服务器。',
  tool_check_pdf_a_compliance_rules_item_3: '无 OCR：扫描版需其他工作流。',
  tool_check_pdf_a_compliance_rules_item_4: '加密/损坏文件显示可读错误。',
  ...
  tool_check_pdf_a_compliance_title: '检查 PDF/A 合规性',
  tool_check_pdf_a_compliance_usecase_1: '办公：快速处理 PDF 日常任务',
  tool_check_pdf_a_compliance_usecase_2: '学生：本地预览与导出',
  tool_check_pdf_a_compliance_usecase_3: '隐私敏感：文件不出本机',
  tool_check_pdf_a_compliance_usecases_title: '适用场景',
  tool_check_pdf_a_compliance_warn: '警告',
  ...
  tool_combine_files_into_one_pdf_description:
    '将文件合并为一个 PDF. 文件留在本机，不上传服务器。 El ejemplo al entrar 进页样例会显示真实结果。 un resultado real 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。',
  ...
  tool_combine_files_into_one_pdf_faq_a2: '扫描版 PDF 通常是图片，没有文本层，本工具不做 OCR。',
  ...
  tool_combine_files_into_one_pdf_faq_q2: '扫描版 PDF 为什么失败？',
  ...
  tool_combine_files_into_one_pdf_how_item_2: '点击主按钮运行处理',
  ...
  tool_compare_two_pdfs_description:
    '对比两个 PDF. 文件留在本机，不上传服务器。 El ejemplo al entrar 进页样例会显示真实结果。 un resultado real 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。',
  ...
  tool_compare_two_pdfs_how_item_2: '点击主按钮运行处理',
  ...
  tool_convert_html_to_pdf_description:
    '将 HTML 转换为 PDF. 文件留在本机，不上传服务器。 El ejemplo al entrar 进页样例会显示真实结果。 un resultado real 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。',
  ...
  tool_convert_html_to_pdf_faq_a2: '扫描版 PDF 通常是图片，没有文本层，本工具不做 OCR。',
  ...
  tool_convert_html_to_pdf_faq_q2: '扫描版 PDF 为什么失败？',
  ...
  tool_convert_html_to_pdf_how_item_2: '点击主按钮运行处理',
  ...
  tool_extract_text_from_pdf_description:
    '从 PDF 提取文本. 文件留在本机，不上传服务器。 El ejemplo al entrar 进页样例会显示真实结果。 un resultado real 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。',
  ...
  tool_extract_text_from_pdf_how_item_2: '点击主按钮运行处理',
  ...
  tool_make_pdf_flipbook_description:
    '制作 PDF 翻页书. 文件留在本机，不上传服务器。 El ejemplo al entrar 进页样例会显示真实结果。 un resultado real 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。',
  ...
  tool_make_pdf_flipbook_faq_a2: '扫描版 PDF 通常是图片，没有文本层，本工具不做 OCR。',
  ...
  tool_make_pdf_flipbook_faq_q2: '扫描版 PDF 为什么失败？',
  ...
  tool_make_pdf_flipbook_how_item_2: '点击主按钮运行处理',
  ...
  tool_open_pdf_in_browser_description:
    '在浏览器中打开 PDF. 文件留在本机，不上传服务器。 El ejemplo al entrar 进页样例会显示真实结果。 un resultado real 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。',
  ...
  tool_open_pdf_in_browser_faq_a2: '扫描版 PDF 通常是图片，没有文本层，本工具不做 OCR。',
  ...
  tool_open_pdf_in_browser_faq_q2: '扫描版 PDF 为什么失败？',
  ...
  tool_open_pdf_in_browser_how_item_2: '点击主按钮运行处理',
  ...
  tool_print_pdf_description:
    '打印 PDF. 文件留在本机，不上传服务器。 El ejemplo al entrar 进页样例会显示真实结果。 un resultado real 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。',
  ...
  tool_print_pdf_faq_a2: '扫描版 PDF 通常是图片，没有文本层，本工具不做 OCR。',
  ...
  tool_print_pdf_faq_q2: '扫描版 PDF 为什么失败？',
  ...
  tool_print_pdf_how_item_2: '点击主按钮运行处理',
  ...
  tool_turn_pdf_into_editable_document_faq_a2: '不会。处理在本标签页完成，文件不会上传到我们的服务器。',
  ...
  tool_turn_pdf_into_editable_document_title: '把 PDF 变成可编辑文档',
  ...
  tool_write_pdf_document_online_description:
    '在线编写 PDF 文档. 文件留在本机，不上传服务器。 El ejemplo al entrar 进页样例会显示真实结果。 un resultado real 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。 本页展示过程、步骤和示例。',
  ...
  tool_write_pdf_document_online_faq_a2: '扫描版 PDF 通常是图片，没有文本层，本工具不做 OCR。',
  ...
  tool_write_pdf_document_online_faq_q2: '扫描版 PDF 为什么失败？',
  ...
  tool_write_pdf_document_online_how_item_2: '点击主按钮运行处理',
