...
const zh: SiteLangDict = {
  ...
  tool_check_robots_txt_url_blocked_description: '粘贴页面网址，在线检查 robots.txt 是否对 Googlebot、*、Bingbot 或 GPTBot 屏蔽该路径。边缘拉取并显示命中规则。示例：/admin。',
  ...
  tool_check_ssl_certificate_expiration_description: '输入主机名做 SSL 证书到期检查：经 crt.sh 查询证书透明度，展示最新匹配证书的 notBefore、notAfter、颁发者与剩余天数。不是实时 TLS 握手。示例：example.com。',
