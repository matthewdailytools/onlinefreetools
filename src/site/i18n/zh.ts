...
const zh: SiteLangDict = {
  ...
  tool_batch_convert_web_pages_to_jpg_article: '每行贴一个公开网页地址，按你选的视口在本标签页截成 JPEG，失败行跳过，成功项打成 ZIP。网址会经服务器代抓一次且不落盘；出图留在你的设备上。这是网页截图，不是 A4 PDF。',
  ...
  tool_batch_convert_web_pages_to_jpg_desc: '把网址列表里的网页批量截成 JPG，再打包 ZIP；代抓一次、不落盘。',
  ...
  tool_batch_convert_web_pages_to_jpg_example: '载入样例会填入两条 example.com 地址，用本地示例页生成两张 JPEG（不访问线上站点），并启用下载 ZIP。点「全部转换」才会去抓你贴的真实网址。视口、质量和整页/首屏会改变图里的像素。',
  ...
  tool_batch_convert_web_pages_to_jpg_how_body: '把公开网页的网址列表贴进来，点「全部转换」（默认桌面 1280、JPEG 85%、整页），再把成功的图打成 ZIP 带走。',
  ...
  tool_batch_convert_web_pages_to_jpg_url_hint: '每行一个公开 http(s) 网址，最多 10 条。我们代抓一次并改写 CSS/图片地址。截图前会去掉脚本。',
  ...
  tool_batch_convert_web_pages_to_pdf_article: '每行贴一个公开网页地址，在本标签页逐条转成 A4 PDF，失败行跳过，成功项打成 ZIP。网址会经服务器代抓一次且不落盘；转 PDF 留在你的设备上。',
  ...
  tool_batch_convert_web_pages_to_pdf_desc: '把网址列表里的网页批量转成 PDF，打包 ZIP 下载；代抓一次、不落盘，转换留在本机。',
  ...
  tool_batch_convert_web_pages_to_pdf_example: '载入样例会填入两条 example.com 地址，用本地示例页生成两份 PDF（不访问线上站点），并启用下载 ZIP。点「全部转换」才会去抓你贴的真实网址。',
  tool_batch_convert_web_pages_to_pdf_example_title: '示例',
  tool_batch_convert_web_pages_to_pdf_faq_a1: '转 PDF 在本标签页完成。转换网址列表时，我们会把每条地址发给服务器抓一次 HTML，页面内容不落盘。PDF 在你的设备上生成，再在本机打成 ZIP。',
  tool_batch_convert_web_pages_to_pdf_faq_a2: '本页做网址列表：多个网页转 PDF 再打包。只要一段 HTML 或单条地址加预览编辑，请用「HTML 转 PDF」。',
  tool_batch_convert_web_pages_to_pdf_faq_a3: '不会。脚本会被去掉。登录墙、付费墙、靠 JavaScript 渲染的应用通常对不上线上效果，打印 CSS 也可能不同。',
  tool_batch_convert_web_pages_to_pdf_faq_a4: '成功的每一行是一份独立 PDF，打进同一个 ZIP。本页不会合成一份文件——若要合并，下载后再用「合并文件成一个 PDF」。',
  tool_batch_convert_web_pages_to_pdf_faq_a5: '最多 10 条 http(s) 网址。多出的行会被忽略。失败行跳过，其余条目继续转。',
  ...
  tool_batch_convert_web_pages_to_pdf_how_body: '把公开网页的网址列表贴进来，逐条转成 PDF，再把成功的文件打成 ZIP 带走。',
  ...
  tool_batch_convert_web_pages_to_pdf_rules_body: '一行一个 http(s) 网址，最多 10 条。按顺序转换。失败跳过。成功的 PDF 打进 ZIP。',
  tool_batch_convert_web_pages_to_pdf_rules_item_1: '每条网址发给服务器抓一次 HTML，不落盘。PDF 在本标签页生成。',
  tool_batch_convert_web_pages_to_pdf_rules_item_2: '内网、登录墙、打不开的页面只让该行失败，整批其余行继续。',
  tool_batch_convert_web_pages_to_pdf_rules_item_3: 'ZIP 里重名会变成 name (2).pdf。截图前会去掉脚本。',
  tool_batch_convert_web_pages_to_pdf_rules_item_4: '这不是整站爬虫。请自己贴已经准备好的网址。',
  ...
  tool_batch_convert_web_pages_to_pdf_url_hint: '每行一个公开 http(s) 网址，最多 10 条。我们代抓一次并改写 CSS/图片地址。转 PDF 前会去掉脚本。',
  ...
  tool_batch_convert_web_pages_to_pdf_wait_hint: '图片开始加载后再多等几秒，远程图才来得及画完。默认 1 秒。PDF 里出现空图框时再调高。',
