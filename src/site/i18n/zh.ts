...
const zh: SiteLangDict = {
  ...
  tool_bulk_compress_product_photos_faq_a4: '要透明、还必须是 PNG 的图标，请用 PNG 压缩页。本页默认把商品照片压成 JPEG/WebP，方便上架体积闸。',
  ...
  tool_bulk_compress_product_photos_how_body: '先把要上架的照片选进来，共用一个体积上限，在本机压完后带走 ZIP。某张失败不会卡住整批。',
