...
const zh: SiteLangDict = {
  ...
  tool_android_prompt_builder_ai_consent_body: '此可选步骤会把当前草稿发往 Cloudflare Workers AI；不会从我们的服务器调用 OpenAI、Google、Anthropic 或 DeepSeek。不用 AI 也能本地组装。',
  tool_android_prompt_builder_ai_consent_cancel: '取消',
  tool_android_prompt_builder_ai_consent_ok: '继续',
  tool_android_prompt_builder_ai_consent_title: '发送到 Cloudflare Workers AI？',
  tool_android_prompt_builder_ai_done: '已应用 AI 建议，复制前请核对。',
  tool_android_prompt_builder_ai_err_generic: 'AI 失败，本地 Prompt 未改。',
  tool_android_prompt_builder_ai_err_rate: 'AI 配额已满，请用本地模式或明日（UTC）再试。',
  tool_android_prompt_builder_ai_err_turnstile: '使用 AI 前请完成 Turnstile 验证。',
  tool_android_prompt_builder_ai_expand: 'AI 扩写',
  tool_android_prompt_builder_ai_panel_label: '可选 Cloudflare AI（Turnstile）',
  ...
  tool_android_prompt_builder_build: '构建 Prompt',
  tool_android_prompt_builder_clear: '清空',
  tool_android_prompt_builder_compose_ui_label: 'Compose / UI',
  tool_android_prompt_builder_compose_ui_ph: 'Compose UI…',
  tool_android_prompt_builder_copy: '复制',
  tool_android_prompt_builder_desc: 'Android Prompt 构建器 — 默认本地组装，可选 Cloudflare AI 扩写/润色（Turnstile）；Markdown/JSON 留在本机。',
  ...
  tool_android_prompt_builder_faq_a2: '本地模式只在本标签页整理字段，不调用 ChatGPT、Gemini、Claude、DeepSeek API。可选 AI 使用 Cloudflare Workers AI（须 Turnstile）。',
  ...
  tool_android_prompt_builder_faq_a4: '可以。使用 Expand/Polish 前须在可选 AI 面板完成 Turnstile；无有效 token 时 AI 按钮报错，本地模式仍可用。',
  ...
  tool_android_prompt_builder_faq_a7: '本地模式只在本标签页整理文字，不上传。可选 Expand/Polish 发往 Cloudflare Workers AI（须 Turnstile、有频率限制）。失败或超额时继续用本地模式。',
  ...
  tool_android_prompt_builder_faq_q3: 'How is this different from Prompt 模板构建器?',
  tool_android_prompt_builder_faq_q4: '为什么可选 AI 需要 Turnstile？',
  ...
  tool_android_prompt_builder_faq_q7: '本地模式与可选 Cloudflare AI 有何区别？',
  tool_android_prompt_builder_feature_spec_label: '功能 / 规格',
  tool_android_prompt_builder_feature_spec_ph: '功能说明…',
  ...
  tool_android_prompt_builder_gradle_constraints_ph: 'Gradle 约束…',
  ...
  tool_android_prompt_builder_how_item_1: '进页已自动运行默认样例（Load sample）。',
  tool_android_prompt_builder_how_item_2: 'Edit fields, click Build prompt, or switch to JSON if you need structured export.',
  tool_android_prompt_builder_how_item_3: '可选：完成 Turnstile，再通过 Cloudflare Workers AI 扩写或润色。',
  tool_android_prompt_builder_how_item_4: '复制或下载，粘贴到 ChatGPT、Gemini、Claude 或 DeepSeek。',
  tool_android_prompt_builder_how_title: '使用方法',
  tool_android_prompt_builder_kotlin_stack_label: 'Kotlin / 技术栈',
  tool_android_prompt_builder_kotlin_stack_ph: 'Kotlin 栈…',
  tool_android_prompt_builder_load_sample: '加载示例',
  tool_android_prompt_builder_platforms_lead: '适用于 ChatGPT、Gemini、Claude、DeepSeek — 复制成品 Prompt 到任意聊天界面。',
  tool_android_prompt_builder_result_label: 'Prompt 输出',
  tool_android_prompt_builder_rules_body: 'Android Prompt 构建器：默认本地组装；可选 Cloudflare AI 有频率限制且须 Turnstile。',
  ...
  tool_android_prompt_builder_rules_item_3: '可选 Cloudflare AI 不取代本地模式 — 复制前请核对 AI 输出。',
  ...
  tool_android_prompt_builder_rules_title: '规则说明',
  ...
  tool_android_prompt_builder_status_done: 'Prompt 已就绪。',
  tool_android_prompt_builder_status_working: '正在构建…',
  tool_android_prompt_builder_title: 'Android Prompt 构建器 — 本地 + 可选 AI',
  tool_android_prompt_builder_usecase_1: '为团队在 ChatGPT、Gemini、Claude 或 DeepSeek 准备可粘贴的 Android Prompt 构建器 简报。',
  ...
  tool_android_prompt_builder_usecase_4: '敏感草稿保持本地 — 仅在同意弹窗后启用 AI。',
  ...
  tool_compare_two_text_files_online_faq_a2: '按 UTF-8 解码。开头的 BOM 会去掉，避免第一行只因为 BOM 被标红。其他编码可能乱码，请先另存为 UTF-8。',
  tool_compare_two_text_files_online_faq_a3: '文件里有空字节就当二进制拒绝。Word、Excel 请用对应对比页。',
  tool_compare_two_text_files_online_faq_a4: '本页面向 .txt / .text。搜 txt 对比或在线文件 diff 也是这件事。如果「对比两个文件」其实是 Word 或表格，请用那些专用页。只粘贴文字请用「查看两段文本的差异」。',
  ...
  tool_film_prompt_builder_act1_ph: '第一幕要点…',
  tool_film_prompt_builder_act2_label: '第二幕',
  tool_film_prompt_builder_act2_ph: '第二幕要点…',
  tool_film_prompt_builder_act3_label: '第三幕',
  tool_film_prompt_builder_act3_ph: '第三幕要点…',
  tool_film_prompt_builder_ai_consent_body: '此可选步骤会把当前草稿发往 Cloudflare Workers AI；不会从我们的服务器调用 OpenAI、Google、Anthropic 或 DeepSeek。不用 AI 也能本地组装。',
  tool_film_prompt_builder_ai_consent_cancel: '取消',
  tool_film_prompt_builder_ai_consent_ok: '继续',
  tool_film_prompt_builder_ai_consent_title: '发送到 Cloudflare Workers AI？',
  tool_film_prompt_builder_ai_done: '已应用 AI 建议，复制前请核对。',
  tool_film_prompt_builder_ai_err_generic: 'AI 失败，本地 Prompt 未改。',
  tool_film_prompt_builder_ai_err_rate: 'AI 配额已满，请用本地模式或明日（UTC）再试。',
  tool_film_prompt_builder_ai_err_turnstile: '使用 AI 前请完成 Turnstile 验证。',
  tool_film_prompt_builder_ai_expand: 'AI 扩写',
  tool_film_prompt_builder_ai_panel_label: '可选 Cloudflare AI（Turnstile）',
  tool_film_prompt_builder_ai_polish: 'AI 润色',
  tool_film_prompt_builder_ai_working: 'Cloudflare AI 处理中…',
  ...
  tool_film_prompt_builder_build: '构建 Prompt',
  tool_film_prompt_builder_character_arc_label: '人物弧光',
  tool_film_prompt_builder_character_arc_ph: '角色变化…',
  tool_film_prompt_builder_clear: '清空',
  tool_film_prompt_builder_copy: '复制',
  tool_film_prompt_builder_desc: '电影 Prompt 构建器 — 默认本地组装，可选 Cloudflare AI 扩写/润色（Turnstile）；Markdown/JSON 留在本机。',
  ...
  tool_film_prompt_builder_faq_a1:
    '默认只在本浏览器标签页本地组装。可选「AI 扩写/润色」仅把该次点击提交的文字发往 Cloudflare Workers AI，不会从我们的服务器调用 OpenAI、Google、Anthropic 或 DeepSeek。',
  tool_film_prompt_builder_faq_a2: '本地模式只在本标签页整理字段，不调用 ChatGPT、Gemini、Claude、DeepSeek API。可选 AI 使用 Cloudflare Workers AI（须 Turnstile）。',
  ...
  tool_film_prompt_builder_faq_a4: '可以。使用 Expand/Polish 前须在可选 AI 面板完成 Turnstile；无有效 token 时 AI 按钮报错，本地模式仍可用。',
  ...
  tool_film_prompt_builder_faq_a6:
    'Yes. Copy the finished prompt into ChatGPT, Gemini, Claude, or DeepSeek. We do not split URLs per platform because the job is formatting text, not calling APIs.',
  tool_film_prompt_builder_faq_a7: '本地模式只在本标签页整理文字，不上传。可选 Expand/Polish 发往 Cloudflare Workers AI（须 Turnstile、有频率限制）。失败或超额时继续用本地模式。',
  ...
  tool_film_prompt_builder_faq_q3: 'How is this different from Prompt 模板构建器?',
  tool_film_prompt_builder_faq_q4: '为什么可选 AI 需要 Turnstile？',
  ...
  tool_film_prompt_builder_faq_q7: '本地模式与可选 Cloudflare AI 有何区别？',
  tool_film_prompt_builder_fmt_json: 'JSON',
  tool_film_prompt_builder_fmt_label: '输出格式',
  tool_film_prompt_builder_fmt_md: 'Markdown',
  tool_film_prompt_builder_how_body: '填写 电影 Prompt 构建器 字段，本地构建 Prompt，可选 Turnstile 后 Expand/Polish，再粘贴到 ChatGPT、Gemini、Claude 或 DeepSeek。',
  tool_film_prompt_builder_how_item_1: '进页已自动运行默认样例（Load sample）。',
  tool_film_prompt_builder_how_item_2: 'Edit fields, click Build prompt, or switch to JSON if you need structured export.',
  tool_film_prompt_builder_how_item_3: '可选：完成 Turnstile，再通过 Cloudflare Workers AI 扩写或润色。',
  tool_film_prompt_builder_how_item_4: '复制或下载，粘贴到 ChatGPT、Gemini、Claude 或 DeepSeek。',
  tool_film_prompt_builder_how_title: '使用方法',
  tool_film_prompt_builder_load_sample: '加载示例',
  tool_film_prompt_builder_logline_label: 'Logline',
  tool_film_prompt_builder_logline_ph: '一句话梗概…',
  tool_film_prompt_builder_platforms_lead: '适用于 ChatGPT、Gemini、Claude、DeepSeek — 复制成品 Prompt 到任意聊天界面。',
  tool_film_prompt_builder_result_label: 'Prompt 输出',
  tool_film_prompt_builder_rules_body: '电影 Prompt 构建器：默认本地组装；可选 Cloudflare AI 有频率限制且须 Turnstile。',
  ...
  tool_film_prompt_builder_rules_item_3: '可选 Cloudflare AI 不取代本地模式 — 复制前请核对 AI 输出。',
  ...
  tool_film_prompt_builder_rules_title: '规则说明',
  tool_film_prompt_builder_scene_list_label: '场景列表',
  tool_film_prompt_builder_scene_list_ph: '场景节拍…',
  ...
  tool_film_prompt_builder_status_done: 'Prompt 已就绪。',
  tool_film_prompt_builder_status_working: '正在构建…',
  tool_film_prompt_builder_title: '电影 Prompt 构建器 — 本地 + 可选 AI',
  tool_film_prompt_builder_usecase_1: '为团队在 ChatGPT、Gemini、Claude 或 DeepSeek 准备可粘贴的 电影 Prompt 构建器 简报。',
  ...
  tool_film_prompt_builder_usecase_3:
    'Compare with Prompt template builder when you need generic four-field templates instead of this scenario.',
  tool_film_prompt_builder_usecase_4: '敏感草稿保持本地 — 仅在同意弹窗后启用 AI。',
  tool_film_prompt_builder_usecases_title: '适用场景',
  ...
  tool_hreflang_rules_item_5: '同一组页面只选一种投放形态：HTML 中的 <link> 标签、HTTP Link 响应头或 sitemap 的 xhtml:link。混用可能让信号互相矛盾。',
  ...
  tool_ios_prompt_builder_ai_consent_body: '此可选步骤会把当前草稿发往 Cloudflare Workers AI；不会从我们的服务器调用 OpenAI、Google、Anthropic 或 DeepSeek。不用 AI 也能本地组装。',
  tool_ios_prompt_builder_ai_consent_cancel: '取消',
  tool_ios_prompt_builder_ai_consent_ok: '继续',
  tool_ios_prompt_builder_ai_consent_title: '发送到 Cloudflare Workers AI？',
  tool_ios_prompt_builder_ai_done: '已应用 AI 建议，复制前请核对。',
  tool_ios_prompt_builder_ai_err_generic: 'AI 失败，本地 Prompt 未改。',
  tool_ios_prompt_builder_ai_err_rate: 'AI 配额已满，请用本地模式或明日（UTC）再试。',
  tool_ios_prompt_builder_ai_err_turnstile: '使用 AI 前请完成 Turnstile 验证。',
  tool_ios_prompt_builder_ai_expand: 'AI 扩写',
  tool_ios_prompt_builder_ai_panel_label: '可选 Cloudflare AI（Turnstile）',
  ...
  tool_ios_prompt_builder_build: '构建 Prompt',
  tool_ios_prompt_builder_clear: '清空',
  tool_ios_prompt_builder_copy: '复制',
  tool_ios_prompt_builder_desc: 'iOS Prompt 构建器 — 默认本地组装，可选 Cloudflare AI 扩写/润色（Turnstile）；Markdown/JSON 留在本机。',
  ...
  tool_ios_prompt_builder_faq_a1:
    '默认只在本浏览器标签页本地组装。可选「AI 扩写/润色」仅把该次点击提交的文字发往 Cloudflare Workers AI，不会从我们的服务器调用 OpenAI、Google、Anthropic 或 DeepSeek。',
  tool_ios_prompt_builder_faq_a2: '本地模式只在本标签页整理字段，不调用 ChatGPT、Gemini、Claude、DeepSeek API。可选 AI 使用 Cloudflare Workers AI（须 Turnstile）。',
  ...
  tool_ios_prompt_builder_faq_a4: '可以。使用 Expand/Polish 前须在可选 AI 面板完成 Turnstile；无有效 token 时 AI 按钮报错，本地模式仍可用。',
  ...
  tool_ios_prompt_builder_faq_a6:
    'Yes. Copy the finished prompt into ChatGPT, Gemini, Claude, or DeepSeek. We do not split URLs per platform because the job is formatting text, not calling APIs.',
  tool_ios_prompt_builder_faq_a7: '本地模式只在本标签页整理文字，不上传。可选 Expand/Polish 发往 Cloudflare Workers AI（须 Turnstile、有频率限制）。失败或超额时继续用本地模式。',
  ...
  tool_ios_prompt_builder_faq_q3: 'How is this different from Prompt 模板构建器?',
  tool_ios_prompt_builder_faq_q4: '为什么可选 AI 需要 Turnstile？',
  ...
  tool_ios_prompt_builder_faq_q7: '本地模式与可选 Cloudflare AI 有何区别？',
  tool_ios_prompt_builder_feature_spec_label: '功能 / 规格',
  tool_ios_prompt_builder_feature_spec_ph: '功能说明…',
  ...
  tool_ios_prompt_builder_hig_constraints_ph: 'HIG 约束…',
  tool_ios_prompt_builder_how_body: '填写 iOS Prompt 构建器 字段，本地构建 Prompt，可选 Turnstile 后 Expand/Polish，再粘贴到 ChatGPT、Gemini、Claude 或 DeepSeek。',
  tool_ios_prompt_builder_how_item_1: '进页已自动运行默认样例（Load sample）。',
  tool_ios_prompt_builder_how_item_2: 'Edit fields, click Build prompt, or switch to JSON if you need structured export.',
  tool_ios_prompt_builder_how_item_3: '可选：完成 Turnstile，再通过 Cloudflare Workers AI 扩写或润色。',
  tool_ios_prompt_builder_how_item_4: '复制或下载，粘贴到 ChatGPT、Gemini、Claude 或 DeepSeek。',
  tool_ios_prompt_builder_how_title: '使用方法',
  tool_ios_prompt_builder_load_sample: '加载示例',
  tool_ios_prompt_builder_platforms_lead: '适用于 ChatGPT、Gemini、Claude、DeepSeek — 复制成品 Prompt 到任意聊天界面。',
  tool_ios_prompt_builder_result_label: 'Prompt 输出',
  tool_ios_prompt_builder_rules_body: 'iOS Prompt 构建器：默认本地组装；可选 Cloudflare AI 有频率限制且须 Turnstile。',
  ...
  tool_ios_prompt_builder_rules_item_3: '可选 Cloudflare AI 不取代本地模式 — 复制前请核对 AI 输出。',
  ...
  tool_ios_prompt_builder_rules_title: '规则说明',
  ...
  tool_ios_prompt_builder_status_done: 'Prompt 已就绪。',
  tool_ios_prompt_builder_status_working: '正在构建…',
  tool_ios_prompt_builder_swift_stack_label: 'Swift / 技术栈',
  tool_ios_prompt_builder_swift_stack_ph: 'Swift 栈…',
  tool_ios_prompt_builder_swiftui_ui_label: 'SwiftUI / UI',
  tool_ios_prompt_builder_swiftui_ui_ph: 'SwiftUI 界面…',
  tool_ios_prompt_builder_title: 'iOS Prompt 构建器 — 本地 + 可选 AI',
  tool_ios_prompt_builder_usecase_1: '为团队在 ChatGPT、Gemini、Claude 或 DeepSeek 准备可粘贴的 iOS Prompt 构建器 简报。',
  ...
  tool_ios_prompt_builder_usecase_3:
    'Compare with Prompt template builder when you need generic four-field templates instead of this scenario.',
  tool_ios_prompt_builder_usecase_4: '敏感草稿保持本地 — 仅在同意弹窗后启用 AI。',
  ...
  tool_midjourney_prompt_builder_ai_consent_body: '此可选步骤会把当前草稿发往 Cloudflare Workers AI；不会从我们的服务器调用 OpenAI、Google、Anthropic 或 DeepSeek。不用 AI 也能本地组装。',
  tool_midjourney_prompt_builder_ai_consent_cancel: '取消',
  tool_midjourney_prompt_builder_ai_consent_ok: '继续',
  tool_midjourney_prompt_builder_ai_consent_title: '发送到 Cloudflare Workers AI？',
  tool_midjourney_prompt_builder_ai_done: '已应用 AI 建议，复制前请核对。',
  tool_midjourney_prompt_builder_ai_err_generic: 'AI 失败，本地 Prompt 未改。',
  tool_midjourney_prompt_builder_ai_err_rate: 'AI 配额已满，请用本地模式或明日（UTC）再试。',
  tool_midjourney_prompt_builder_ai_err_turnstile: '使用 AI 前请完成 Turnstile 验证。',
  tool_midjourney_prompt_builder_ai_expand: 'AI 扩写',
  tool_midjourney_prompt_builder_ai_panel_label: '可选 Cloudflare AI（Turnstile）',
  tool_midjourney_prompt_builder_ai_polish: 'AI 润色',
  tool_midjourney_prompt_builder_ai_working: 'Cloudflare AI 处理中…',
  ...
  tool_midjourney_prompt_builder_aspect_ph: '如 16:9…',
  tool_midjourney_prompt_builder_build: '构建 Prompt',
  tool_midjourney_prompt_builder_clear: '清空',
  tool_midjourney_prompt_builder_copy: '复制',
  tool_midjourney_prompt_builder_desc: 'Midjourney Prompt 构建器 — 默认本地组装，可选 Cloudflare AI 扩写/润色（Turnstile）；Markdown/JSON 留在本机。',
  ...
  tool_midjourney_prompt_builder_faq_a1:
    '默认只在本浏览器标签页本地组装。可选「AI 扩写/润色」仅把该次点击提交的文字发往 Cloudflare Workers AI，不会从我们的服务器调用 OpenAI、Google、Anthropic 或 DeepSeek。',
  tool_midjourney_prompt_builder_faq_a2: '本地模式只在本标签页整理字段，不调用 ChatGPT、Gemini、Claude、DeepSeek API。可选 AI 使用 Cloudflare Workers AI（须 Turnstile）。',
  ...
  tool_midjourney_prompt_builder_faq_a4: '可以。使用 Expand/Polish 前须在可选 AI 面板完成 Turnstile；无有效 token 时 AI 按钮报错，本地模式仍可用。',
  ...
  tool_midjourney_prompt_builder_faq_a6:
    'Yes. Copy the finished prompt into ChatGPT, Gemini, Claude, or DeepSeek. We do not split URLs per platform because the job is formatting text, not calling APIs.',
  tool_midjourney_prompt_builder_faq_a7: '本地模式只在本标签页整理文字，不上传。可选 Expand/Polish 发往 Cloudflare Workers AI（须 Turnstile、有频率限制）。失败或超额时继续用本地模式。',
  ...
  tool_midjourney_prompt_builder_faq_q3: 'How is this different from Prompt 模板构建器?',
  tool_midjourney_prompt_builder_faq_q4: '为什么可选 AI 需要 Turnstile？',
  ...
  tool_midjourney_prompt_builder_faq_q7: '本地模式与可选 Cloudflare AI 有何区别？',
  ...
  tool_midjourney_prompt_builder_how_item_1: '进页已自动运行默认样例（Load sample）。',
  tool_midjourney_prompt_builder_how_item_2: 'Edit fields, click Build prompt, or switch to JSON if you need structured export.',
  tool_midjourney_prompt_builder_how_item_3: '可选：完成 Turnstile，再通过 Cloudflare Workers AI 扩写或润色。',
  tool_midjourney_prompt_builder_how_item_4: '复制或下载，粘贴到 ChatGPT、Gemini、Claude 或 DeepSeek。',
  tool_midjourney_prompt_builder_how_title: '使用方法',
  tool_midjourney_prompt_builder_lighting_label: '光线',
  tool_midjourney_prompt_builder_lighting_ph: '光线描述…',
  tool_midjourney_prompt_builder_load_sample: '加载示例',
  tool_midjourney_prompt_builder_mj_flags_label: 'MJ 参数',
  tool_midjourney_prompt_builder_mj_flags_ph: '如 --v 6.1 --ar 16:9…',
  tool_midjourney_prompt_builder_platforms_lead: '适用于 ChatGPT、Gemini、Claude、DeepSeek — 复制成品 Prompt 到任意聊天界面。',
  tool_midjourney_prompt_builder_result_label: 'Prompt 输出',
  tool_midjourney_prompt_builder_rules_body: 'Midjourney Prompt 构建器：默认本地组装；可选 Cloudflare AI 有频率限制且须 Turnstile。',
  ...
  tool_midjourney_prompt_builder_rules_item_3: '可选 Cloudflare AI 不取代本地模式 — 复制前请核对 AI 输出。',
  ...
  tool_midjourney_prompt_builder_rules_title: '规则说明',
  ...
  tool_midjourney_prompt_builder_status_done: 'Prompt 已就绪。',
  tool_midjourney_prompt_builder_status_working: '正在构建…',
  tool_midjourney_prompt_builder_style_label: '风格',
  tool_midjourney_prompt_builder_style_ph: '风格描述…',
  tool_midjourney_prompt_builder_subject_label: '主体',
  tool_midjourney_prompt_builder_subject_ph: '主体描述…',
  tool_midjourney_prompt_builder_title: 'Midjourney Prompt 构建器 — 本地 + 可选 AI',
  tool_midjourney_prompt_builder_usecase_1: '为团队在 ChatGPT、Gemini、Claude 或 DeepSeek 准备可粘贴的 Midjourney Prompt 构建器 简报。',
  ...
  tool_midjourney_prompt_builder_usecase_3:
    'Compare with Prompt template builder when you need generic four-field templates instead of this scenario.',
  tool_midjourney_prompt_builder_usecase_4: '敏感草稿保持本地 — 仅在同意弹窗后启用 AI。',
  tool_midjourney_prompt_builder_usecases_title: '适用场景',
  ...
  tool_og_faq_a1: 'Facebook、X 与微信会用 HTML 标题、meta description 和页面第一张图片拼卡片。卡片可能不完整或显示错图，这正是 og: 必备字段存在的原因。',
  ...
  tool_onpage_faq_a2: '单个 H1 能清晰地向读者和搜索引擎表达页面主题。多个 H1 会让层级变得模糊；用一个 H1，其余用 H2–H6 组织。',
  tool_onpage_faq_a3: '对需要参与排名的页面，是的——自引用 canonical 是最清晰的信号。把 canonical 指向其他 URL 是在告诉 Google 本页是重复页，只有确属如此时才该这样做。',
  ...
  tool_onpage_rules_body: '以下是每项检查对照的标准，来源为 Google Search Central 与 HTML 规范。',
  tool_onpage_rules_item_1: '标题：每页应有一个描述性的 <title>。Google 可能改写标题，但 50–60 字符左右的简洁标题通常展示较好。',
  tool_onpage_rules_item_2: 'H1：每个页面只使用一个能概括主题的 H1，其余标题用 H2–H6 形成清晰的层级。',
  tool_onpage_rules_item_3: 'Canonical：当存在重复内容时，自引用 canonical 告诉 Google 哪个 URL 是首选。<link rel="canonical"> 放在 <head> 中。',
  ...
  tool_product_design_prompt_builder_ai_consent_body: '此可选步骤会把当前草稿发往 Cloudflare Workers AI；不会从我们的服务器调用 OpenAI、Google、Anthropic 或 DeepSeek。不用 AI 也能本地组装。',
  tool_product_design_prompt_builder_ai_consent_cancel: '取消',
  tool_product_design_prompt_builder_ai_consent_ok: '继续',
  tool_product_design_prompt_builder_ai_consent_title: '发送到 Cloudflare Workers AI？',
  tool_product_design_prompt_builder_ai_done: '已应用 AI 建议，复制前请核对。',
  tool_product_design_prompt_builder_ai_err_generic: 'AI 失败，本地 Prompt 未改。',
  tool_product_design_prompt_builder_ai_err_rate: 'AI 配额已满，请用本地模式或明日（UTC）再试。',
  tool_product_design_prompt_builder_ai_err_turnstile: '使用 AI 前请完成 Turnstile 验证。',
  tool_product_design_prompt_builder_ai_expand: 'AI 扩写',
  tool_product_design_prompt_builder_ai_panel_label: '可选 Cloudflare AI（Turnstile）',
  ...
  tool_product_design_prompt_builder_build: '构建 Prompt',
  tool_product_design_prompt_builder_clear: '清空',
  tool_product_design_prompt_builder_copy: '复制',
  tool_product_design_prompt_builder_desc: '产品设计 Prompt 构建器 — 默认本地组装，可选 Cloudflare AI 扩写/润色（Turnstile）；Markdown/JSON 留在本机。',
  ...
  tool_product_design_prompt_builder_design_tokens_label: '设计 / Tokens',
  ...
  tool_product_design_prompt_builder_faq_a1:
    '默认只在本浏览器标签页本地组装。可选「AI 扩写/润色」仅把该次点击提交的文字发往 Cloudflare Workers AI，不会从我们的服务器调用 OpenAI、Google、Anthropic 或 DeepSeek。',
  tool_product_design_prompt_builder_faq_a2: '本地模式只在本标签页整理字段，不调用 ChatGPT、Gemini、Claude、DeepSeek API。可选 AI 使用 Cloudflare Workers AI（须 Turnstile）。',
  ...
  tool_product_design_prompt_builder_faq_a4: '可以。使用 Expand/Polish 前须在可选 AI 面板完成 Turnstile；无有效 token 时 AI 按钮报错，本地模式仍可用。',
  ...
  tool_product_design_prompt_builder_faq_a6:
    'Yes. Copy the finished prompt into ChatGPT, Gemini, Claude, or DeepSeek. We do not split URLs per platform because the job is formatting text, not calling APIs.',
  tool_product_design_prompt_builder_faq_a7: '本地模式只在本标签页整理文字，不上传。可选 Expand/Polish 发往 Cloudflare Workers AI（须 Turnstile、有频率限制）。失败或超额时继续用本地模式。',
  ...
  tool_product_design_prompt_builder_faq_q3: 'How is this different from Prompt 模板构建器?',
  tool_product_design_prompt_builder_faq_q4: '为什么可选 AI 需要 Turnstile？',
  ...
  tool_product_design_prompt_builder_faq_q7: '本地模式与可选 Cloudflare AI 有何区别？',
  ...
  tool_product_design_prompt_builder_how_item_1: '进页已自动运行默认样例（Load sample）。',
  ...
  tool_product_design_prompt_builder_how_item_3: '可选：完成 Turnstile，再通过 Cloudflare Workers AI 扩写或润色。',
  tool_product_design_prompt_builder_how_item_4: '复制或下载，粘贴到 ChatGPT、Gemini、Claude 或 DeepSeek。',
  tool_product_design_prompt_builder_how_title: '使用方法',
  tool_product_design_prompt_builder_load_sample: '加载示例',
  tool_product_design_prompt_builder_persona_label: '用户画像',
  tool_product_design_prompt_builder_persona_ph: '目标用户…',
  tool_product_design_prompt_builder_platforms_lead: '适用于 ChatGPT、Gemini、Claude、DeepSeek — 复制成品 Prompt 到任意聊天界面。',
  tool_product_design_prompt_builder_problem_label: '问题',
  tool_product_design_prompt_builder_problem_ph: '要解决的问题…',
  tool_product_design_prompt_builder_result_label: 'Prompt 输出',
  tool_product_design_prompt_builder_rules_body: '产品设计 Prompt 构建器：默认本地组装；可选 Cloudflare AI 有频率限制且须 Turnstile。',
  ...
  tool_product_design_prompt_builder_rules_item_3: '可选 Cloudflare AI 不取代本地模式 — 复制前请核对 AI 输出。',
  ...
  tool_product_design_prompt_builder_rules_title: '规则说明',
  ...
  tool_product_design_prompt_builder_status_done: 'Prompt 已就绪。',
  tool_product_design_prompt_builder_status_working: '正在构建…',
  tool_product_design_prompt_builder_title: '产品设计 Prompt 构建器 — 本地 + 可选 AI',
  tool_product_design_prompt_builder_usecase_1: '为团队在 ChatGPT、Gemini、Claude 或 DeepSeek 准备可粘贴的 产品设计 Prompt 构建器 简报。',
  ...
  tool_product_design_prompt_builder_usecase_3:
    'Compare with Prompt template builder when you need generic four-field templates instead of this scenario.',
  tool_product_design_prompt_builder_usecase_4: '敏感草稿保持本地 — 仅在同意弹窗后启用 AI。',
  tool_product_design_prompt_builder_usecases_title: '适用场景',
  tool_product_design_prompt_builder_wireframe_scope_label: '线框 / 范围',
  tool_product_design_prompt_builder_wireframe_scope_ph: '线框范围…',
  ...
  tool_prompt_template_builder_desc: 'Prompt 模板构建器 — 默认本地组装，可选 Cloudflare AI 扩写/润色（Turnstile）；Markdown/JSON 留在本机。',
  ...
  tool_prompt_template_builder_faq_a6: '可以。构建完成后复制到 ChatGPT、Gemini、Claude 或 DeepSeek 即可——四字段结构在各聊天界面通用。我们不按平台拆独立 URL，因为任务是整理文本，不是代调用 API。',
  ...
  tool_robots_rules_body: 'robots.txt 的规则是路径前缀而非正则，爬虫应用文件中最后一个匹配它的分组。以下是本生成器遵循的规则。',
  ...
  tool_short_drama_prompt_generator_ai_consent_body: '此可选步骤会把当前草稿发往 Cloudflare Workers AI；不会从我们的服务器调用 OpenAI、Google、Anthropic 或 DeepSeek。不用 AI 也能本地组装。',
  tool_short_drama_prompt_generator_ai_consent_cancel: '取消',
  tool_short_drama_prompt_generator_ai_consent_ok: '继续',
  tool_short_drama_prompt_generator_ai_consent_title: '发送到 Cloudflare Workers AI？',
  tool_short_drama_prompt_generator_ai_done: '已应用 AI 建议，复制前请核对。',
  tool_short_drama_prompt_generator_ai_err_generic: 'AI 失败，本地 Prompt 未改。',
  tool_short_drama_prompt_generator_ai_err_rate: 'AI 配额已满，请用本地模式或明日（UTC）再试。',
  tool_short_drama_prompt_generator_ai_err_turnstile: '使用 AI 前请完成 Turnstile 验证。',
  tool_short_drama_prompt_generator_ai_expand: 'AI 扩写',
  tool_short_drama_prompt_generator_ai_panel_label: '可选 Cloudflare AI（Turnstile）',
  tool_short_drama_prompt_generator_ai_polish: 'AI 润色',
  tool_short_drama_prompt_generator_ai_working: 'Cloudflare AI 处理中…',
  ...
  tool_short_drama_prompt_generator_build: '构建 Prompt',
  tool_short_drama_prompt_generator_clear: '清空',
  tool_short_drama_prompt_generator_cliffhanger_label: '悬念',
  tool_short_drama_prompt_generator_cliffhanger_ph: '结尾 cliffhanger…',
  tool_short_drama_prompt_generator_copy: '复制',
  tool_short_drama_prompt_generator_desc: '短剧 Prompt 生成器 — 默认本地组装，可选 Cloudflare AI 扩写/润色（Turnstile）；Markdown/JSON 留在本机。',
  ...
  tool_short_drama_prompt_generator_faq_a1:
    '默认只在本浏览器标签页本地组装。可选「AI 扩写/润色」仅把该次点击提交的文字发往 Cloudflare Workers AI，不会从我们的服务器调用 OpenAI、Google、Anthropic 或 DeepSeek。',
  tool_short_drama_prompt_generator_faq_a2: '本地模式只在本标签页整理字段，不调用 ChatGPT、Gemini、Claude、DeepSeek API。可选 AI 使用 Cloudflare Workers AI（须 Turnstile）。',
  ...
  tool_short_drama_prompt_generator_faq_a4: '可以。使用 Expand/Polish 前须在可选 AI 面板完成 Turnstile；无有效 token 时 AI 按钮报错，本地模式仍可用。',
  ...
  tool_short_drama_prompt_generator_faq_a6:
    'Yes. Copy the finished prompt into ChatGPT, Gemini, Claude, or DeepSeek. We do not split URLs per platform because the job is formatting text, not calling APIs.',
  tool_short_drama_prompt_generator_faq_a7: '本地模式只在本标签页整理文字，不上传。可选 Expand/Polish 发往 Cloudflare Workers AI（须 Turnstile、有频率限制）。失败或超额时继续用本地模式。',
  ...
  tool_short_drama_prompt_generator_faq_q3: 'How is this different from Prompt 模板构建器?',
  tool_short_drama_prompt_generator_faq_q4: '为什么可选 AI 需要 Turnstile？',
  ...
  tool_short_drama_prompt_generator_faq_q7: '本地模式与可选 Cloudflare AI 有何区别？',
  ...
  tool_short_drama_prompt_generator_genre_label: '类型',
  tool_short_drama_prompt_generator_genre_ph: '类型说明…',
  tool_short_drama_prompt_generator_hook_label: '钩子',
  tool_short_drama_prompt_generator_hook_ph: '开场钩子…',
  tool_short_drama_prompt_generator_how_body: '填写 短剧 Prompt 生成器 字段，本地构建 Prompt，可选 Turnstile 后 Expand/Polish，再粘贴到 ChatGPT、Gemini、Claude 或 DeepSeek。',
  tool_short_drama_prompt_generator_how_item_1: '进页已自动运行默认样例（Load sample）。',
  ...
  tool_short_drama_prompt_generator_how_item_3: '可选：完成 Turnstile，再通过 Cloudflare Workers AI 扩写或润色。',
  tool_short_drama_prompt_generator_how_item_4: '复制或下载，粘贴到 ChatGPT、Gemini、Claude 或 DeepSeek。',
  tool_short_drama_prompt_generator_how_title: '使用方法',
  tool_short_drama_prompt_generator_load_sample: '加载示例',
  tool_short_drama_prompt_generator_platforms_lead: '适用于 ChatGPT、Gemini、Claude、DeepSeek — 复制成品 Prompt 到任意聊天界面。',
  tool_short_drama_prompt_generator_result_label: 'Prompt 输出',
  tool_short_drama_prompt_generator_rules_body: '短剧 Prompt 生成器：默认本地组装；可选 Cloudflare AI 有频率限制且须 Turnstile。',
  ...
  tool_short_drama_prompt_generator_rules_item_3: '可选 Cloudflare AI 不取代本地模式 — 复制前请核对 AI 输出。',
  ...
  tool_short_drama_prompt_generator_rules_title: '规则说明',
  ...
  tool_short_drama_prompt_generator_status_done: 'Prompt 已就绪。',
  tool_short_drama_prompt_generator_status_working: '正在构建…',
  tool_short_drama_prompt_generator_title: '短剧 Prompt 生成器 — 本地 + 可选 AI',
  tool_short_drama_prompt_generator_usecase_1: '为团队在 ChatGPT、Gemini、Claude 或 DeepSeek 准备可粘贴的 短剧 Prompt 生成器 简报。',
  ...
  tool_short_drama_prompt_generator_usecase_3:
    'Compare with Prompt template builder when you need generic four-field templates instead of this scenario.',
  tool_short_drama_prompt_generator_usecase_4: '敏感草稿保持本地 — 仅在同意弹窗后启用 AI。',
  tool_short_drama_prompt_generator_usecases_title: '适用场景',
  tool_short_drama_prompt_generator_vertical_format_label: '竖屏 / 格式',
  tool_short_drama_prompt_generator_vertical_format_ph: '竖屏短剧格式…',
  ...
  tool_sketch_prompt_generator_desc: 'Sketch.app Prompt 生成器 — 默认本地组装，可选 Cloudflare AI 扩写/润色（Turnstile）；Markdown/JSON 留在本机。',
  ...
  tool_sketch_prompt_generator_faq_a8: '本地模式只在本标签页整理文字，不上传。可选扩写/润色发往 Cloudflare Workers AI（须 Turnstile、有频率限制）。失败或超额时继续用本地模式。',
  ...
  tool_writing_prompt_generator_ai_done: '已应用 AI 建议，复制前请核对。',
  ...
  tool_writing_prompt_generator_desc: '写作 Prompt 生成器 — 默认本地组装，可选 Cloudflare AI 扩写/润色（Turnstile）；Markdown/JSON 留在本机。',
  ...
  tool_writing_prompt_generator_faq_a7: '可以。把成品 Prompt 复制到 ChatGPT、Gemini、Claude 或 DeepSeek。我们不按平台拆独立 URL，因为任务是整理文本，不是代调用 API。',
  ...
  tool_writing_prompt_generator_how_item_1: '选对话、人物、剧本或随机 — 进页已自动跑过对话预设样例。',
  ...
  tool_writing_prompt_generator_rules_body: '写作 Prompt 需要模式专属字段、诚实的随机边界，以及与其他构建器相同的本地隐私。',
  tool_writing_prompt_generator_rules_item_1: '输出四块：Role、Task、Constraints、Output — 与结构化 Prompt 模板对齐。',
  tool_writing_prompt_generator_rules_item_2: '随机模式在本 URL 内吸收随机 Prompt 生成器 — 无需另开页面。',
  tool_writing_prompt_generator_rules_item_3: '默认导出 Markdown。JSON 为同一画布上的芯片切换。',
  tool_writing_prompt_generator_rules_item_4: '本工具只组装文本，不生成成稿故事，也不调用云端模型。',
