...
| 主检索词 → title/H1 | **Add a digital signature to a PDF** |
...
|---|---|---|---|---|
| add a digital signature to a pdf | build 主词 | H1 | 进页默认该场景 | |
...
|---|---|
| 日期 | 2026-09-03 |
| 总判 | 满足：进页即 add a digital signature to a pdf 场景 |
| 主词搜索者任务 | Browser cert picker when available; appearance + PKCS#7 when supported; disclaimer. |
...
- 输入/输出：Browser cert picker when available; appearance + PKCS#7 when supported; disclaimer.
- 核心规则 / 算法：见 Page 实现
