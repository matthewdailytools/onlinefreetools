...
共同边界：本地完成 **Batch trim the same intro from audio files**；不上传。诚实边界见 Rules/FAQ。

| 语种 | 当地检索词（主词；次词） | Title / H1 方向 | 按钮 | 文案切入 / 次词落点 |
|---|---|---|---|---|
| en | primary; without upload | Batch trim the same intro from audio files | primary / Download | FAQ honesty |
...
| 轮次 | 日期 | 做了什么 | 结果 |
|---|---|---|---|
| 0b | 2026-09-21 | L2：清单前检索与同意图写入 02，定 slug 与 related | 02 回写；briefs-ready |
