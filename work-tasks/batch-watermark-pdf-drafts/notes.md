...
Parsed and rendered the downloaded three-page PDF: portrait, rotated small page, and offset CropBox. Red-watermark pixels were centered inside visible bounds on all pages. Duplicate input names produced separate ZIP entries. Corrupt and encrypted PDFs skipped; Unicode text, invalid opacity, stale-download reset, all-failed and retry were exercised.
