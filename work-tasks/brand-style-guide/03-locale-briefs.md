...
| 1 母版+lint | 2026-08-08 | en 母版 + 十语分片落地；`lint:seo` OK；进页 Northline 样例 | 通过；ar/ja/ru 待母语 |
| 1b 母版检索覆盖优化 | 2026-08-08 | title/desc 对齐 brief（EN style guide；ZH 品牌手册）；非 AI | 通过 |
| 2 按 brief 重写 | 2026-08-08 | 九语独立重写（非同构灌语） | 待抽查 |
| 2b 抽查语检索覆盖优化 | | | 待做 |
| 3 抽查+禁词+lint | | | 待做 |
