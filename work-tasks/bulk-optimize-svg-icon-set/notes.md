...
Compared original/optimized sample pixels: identical. Downloaded SVG retained gradient, clip, mask, use and ARIA targets plus text whitespace. Ten malformed, active-content, external-resource or broken-reference fixtures skipped. Checked all-failed, retry, no-saving fallback, stylesheet-preserved structure and exact original UTF-8 BOM bytes when serialization grew.
