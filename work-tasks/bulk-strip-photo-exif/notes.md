...
Downloaded ZIP contained three fresh PNGs and a CSV including every input. A JPEG with a valid GPS IFD and EXIF orientation 6 became a 40×60 PNG matching its decoded pixels. PNG text metadata was absent; alpha and pixels matched. Static WebP succeeded; animated PNG and malformed images skipped. Checked CSV formula neutralization, all-failed, retry and the 21-file limit.
