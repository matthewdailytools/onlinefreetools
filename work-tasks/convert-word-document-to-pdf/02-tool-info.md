...
**路径**：`/tools/convert-word-document-to-pdf`  
**主方向**：A  
**YMYL**：否  
...
- 目标主词 / 长尾意图：convert word document to pdf; related Planner absorb terms
- 用户真实任务：Upload .docx; mammoth→HTML→print/pdf pipeline; layout limits in FAQ.
...
| Title (en) / H1 | **Convert Word document to PDF** |
| Description 要点 | Upload .docx; mammoth→HTML→print/pdf pipeline; layout limits in FAQ. Files stay on your device; not uploaded to a server. Example in page. |
| FAQ | ≥3 场景/边界/邻页划界 |
...
|---|---|
| 日期 | 2026-09-03 |
| slug 结论 | 保留 `convert-word-document-to-pdf` |
| 主检索词 → title/H1 | **Convert Word document to PDF** |
...
|---|---|---|---|---|
| convert word document to pdf | build 主词 | H1 | 进页默认该场景 | |
...
|---|---|
| 日期 | 2026-09-03 |
| 总判 | 满足：进页即 convert word document to pdf 场景 |
| 主词搜索者任务 | Upload .docx; mammoth→HTML→print/pdf pipeline; layout limits in FAQ. |
...
- 输入/输出：Upload .docx; mammoth→HTML→print/pdf pipeline; layout limits in FAQ.
- 核心规则 / 算法：见 Page 实现
