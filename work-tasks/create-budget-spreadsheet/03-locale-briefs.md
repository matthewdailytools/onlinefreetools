...
**工具 slug**：`create-budget-spreadsheet`  
**母版语言**：en  
**状态**：`i18n-done`
...
- 检索词（3–5）：create a budget spreadsheet；本工具场景句；隐私「不上服务器」
- 语气：口语工具站
- Title / H1 方向：当地检索向场景句（en 母版 **Create a budget spreadsheet**），非参数枚举
...
| 轮次 | 日期 | 做了什么 | 结果 |
|---|---|---|---|
| 0b 清单前检索覆盖 | 2026-09-04 | slug 用场景 kebab；H1=Create a budget spreadsheet；次词进 FAQ；Planner 长尾写入 02 表 | 覆盖表已填；intent 总判满足；主词在 H1 |
...
| IG 修正复审 | 2026-09-05 | en/zh/es/ja 重写 SUM、总账边界与工作流；其余语补真实 1600 Example | 下载 xlsx 总额改为动态公式 |
