...
**工具 slug**：`create-invoice-spreadsheet`  
**母版语言**：en  
**状态**：`i18n-done`
...
- 检索词（3–5）：create an invoice spreadsheet；本工具场景句；隐私「不上服务器」
- 语气：口语工具站
- Title / H1 方向：当地检索向场景句（en 母版 **Create an invoice spreadsheet**），非参数枚举
...
| 轮次 | 日期 | 做了什么 | 结果 |
|---|---|---|---|
| 0b 清单前检索覆盖 | 2026-09-04 | slug 用场景 kebab；H1=Create an invoice spreadsheet；次词进 FAQ；Planner 长尾写入 02 表 | 覆盖表已填；intent 总判满足；主词在 H1 |
...
| IG 修正复审 | 2026-09-05 | en/zh/es/ja 重写动态公式、法规边界和 2×10+10%=22；其余语同步真实 Example | 样例与预览一致；xlsx 可重算 |
