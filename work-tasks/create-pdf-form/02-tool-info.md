...
- 目标主词 / 长尾意图：create a pdf form; related Planner absorb terms
- 用户真实任务：Blank PDF canvas; add fields; export PDF form.
...
| 字段 | 内容 |
|---|---|
| 集群 / 优先级 | pdf scene N10 |
| 技术 | pdf-lib / pdf.js CDN；`page.style: opts` |
| Title (en) / H1 | **Create a PDF form** |
| Description 要点 | Blank PDF canvas; add fields; export PDF form. Files stay on your device; not uploaded to a server. Example in page. |
| FAQ | ≥3 场景/边界/邻页划界 |
...
|---|---|
| 日期 | 2026-09-03 |
| slug 结论 | 保留 `create-pdf-form` |
| 主检索词 → title/H1 | **Create a PDF form** |
...
|---|---|---|---|---|
| create a pdf form | build 主词 | H1 | 进页默认该场景 | |
...
|---|---|
| 日期 | 2026-09-03 |
| 总判 | 满足：进页即 create a pdf form 场景 |
| 主词搜索者任务 | Blank PDF canvas; add fields; export PDF form. |
...
- 输入/输出：Blank PDF canvas; add fields; export PDF form.
- 核心规则 / 算法：见 Page 实现
