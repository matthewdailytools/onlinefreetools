...
- 目标主词 / 长尾意图：edit pdf text online; related Planner absorb terms
- 用户真实任务：Select text boxes; replace string in PDF text layer via pdf-lib overlay.
...
| Title (en) / H1 | **Edit PDF text online** |
| Description 要点 | Select text boxes; replace string in PDF text layer via pdf-lib overlay. Files stay on your device; not uploaded to a server. Example in page. |
| FAQ | ≥3 场景/边界/邻页划界 |
...
|---|---|
| 日期 | 2026-09-03 |
| slug 结论 | 保留 `edit-pdf-text-online` |
| 主检索词 → title/H1 | **Edit PDF text online** |
...
|---|---|---|---|---|
| edit pdf text online | build 主词 | H1 | 进页默认该场景 | |
...
|---|---|
| 日期 | 2026-09-03 |
| 总判 | 满足：进页即 edit pdf text online 场景 |
| 主词搜索者任务 | Select text boxes; replace string in PDF text layer via pdf-lib overlay. |
...
- 输入/输出：Select text boxes; replace string in PDF text layer via pdf-lib overlay.
- 核心规则 / 算法：见 Page 实现
