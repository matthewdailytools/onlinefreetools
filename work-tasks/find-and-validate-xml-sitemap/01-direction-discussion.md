...
- 工具做什么：User enters a site URL; tool finds sitemap via robots.txt Sitemap: lines and/or /sitemap.xml; validates XML structure, counts urls, flags index vs urlset, shows sample locs. Not a generator.
...
**选定主方向**：A  
**次要互链参考**：`sitemap-xml-generator`, `indexnow`, `on-page-seo-checker`
...
- 继续立项：是
- 建议 slug：`find-and-validate-xml-sitemap`
- 与已上线工具关系：新建；Related 见上；Generation ≠ validation; keep separate from sitemap-xml-generator.
