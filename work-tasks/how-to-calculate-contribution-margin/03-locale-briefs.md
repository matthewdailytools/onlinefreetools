...
**工具 slug**：`how-to-calculate-contribution-margin`  
**母版语言**：en  
**状态**：`i18n-done`  
**YMYL**：是
...
### en
- 检索词：见 title 主词
- Title：Contribution Margin Calculator — Price Minus Variable Cost
- 轮次2已重写：[x]  轮次3已抽查：[x]

### zh
- 检索词：见 title 主词
- Title：边际贡献计算器 — 单价减变动成本
- 轮次2已重写：[x]  轮次3已抽查：[x]
...
### id
- 检索词：见 title 主词
- Title：Kalkulator contribution margin
- 轮次2已重写：[x]  轮次3已抽查：[x]

### fr
- 检索词：见 title 主词
- Title：Calculateur de marge sur coût variable
- 轮次2已重写：[x]  轮次3已抽查：[x]

### ja
- 检索词：见 title 主词
- Title：貢献利益の計算ツール — 単価と変動費
- 轮次2已重写：[x]  轮次3已抽查：[x]

### ru
- 检索词：见 title 主词
- Title：Калькулятор маржинальной прибыли
- 轮次2已重写：[x]  轮次3已抽查：[x]

### de
- 检索词：见 title 主词
- Title：Deckungsbeitrag-Rechner
- 轮次2已重写：[x]  轮次3已抽查：[x]
...
| 轮次 | 日期 | 做了什么 | 结果 |
|---|---|---|---|
| 0b 清单前检索覆盖 | 2026-08-09 | 保留 how-to-calculate-contribution-margin；title 定为结果向主词+How to；次词与固定样例落入 desc/FAQ；禁参数枚举 | 覆盖表已写入 02；可标 ready |
