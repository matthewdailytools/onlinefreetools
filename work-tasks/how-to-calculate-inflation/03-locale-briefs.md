...
**工具 slug**：`how-to-calculate-inflation`  
**母版语言**：en  
**状态**：`i18n-done`  
**YMYL**：是
...
| 轮次 | 日期 | 做了什么 | 结果 |
|---|---|---|---|
| 0b 清单前检索覆盖 | 2026-08-09 | 保留 how-to-calculate-inflation；title 定为结果向主词+How to；次词与固定样例落入 desc/FAQ；禁参数枚举 | 覆盖表已写入 02；可标 ready |
