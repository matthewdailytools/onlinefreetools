...
### en
- 检索词：见 title 主词
- Title：VAT / GST Calculator — Add or Extract Tax
- 轮次2已重写：[x]  轮次3已抽查：[x]

### zh
- 检索词：见 title 主词
- Title：增值税计算器 — 含税与未税互算
- 轮次2已重写：[x]  轮次3已抽查：[x]

### es
- 检索词：见 title 主词
- Title：Calculadora de IVA / GST
- 轮次2已重写：[x]  轮次3已抽查：[x]

### ar
- 检索词：见 title 主词
- Title：حاسبة ضريبة القيمة المضافة VAT/GST
- 轮次2已重写：[x]  轮次3已抽查：[x]
...
### id
- 检索词：见 title 主词
- Title：Kalkulator PPN / VAT / GST
- 轮次2已重写：[x]  轮次3已抽查：[x]

### fr
- 检索词：见 title 主词
- Title：Calculateur de TVA / GST
- 轮次2已重写：[x]  轮次3已抽查：[x]

### ja
- 检索词：见 title 主词
- Title：VAT/GST（付加価値税）計算ツール
- 轮次2已重写：[x]  轮次3已抽查：[x]

### ru
- 检索词：见 title 主词
- Title：Калькулятор НДС / VAT / GST
- 轮次2已重写：[x]  轮次3已抽查：[x]

### de
- 检索词：见 title 主词
- Title：MwSt-/VAT-Rechner
- 轮次2已重写：[x]  轮次3已抽查：[x]
...
| 轮次 | 日期 | 做了什么 | 结果 |
|---|---|---|---|
| 0b 清单前检索覆盖 | 2026-08-09 | 保留 how-to-calculate-vat；title 定为结果向主词+How to；次词与固定样例落入 desc/FAQ；禁参数枚举 | 覆盖表已写入 02；可标 ready |
