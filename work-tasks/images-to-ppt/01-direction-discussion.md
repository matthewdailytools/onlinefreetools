...
- 工具做什么：多张本地图片各成一页幻灯片，导出 PPTX。
- 谁在什么任务里用：快速演示稿、看图说话、产品图串讲。
...
**选定主方向**：A  
**次要互链参考**：`images-to-pdf`, `images-to-word`, `image-merge`
...
- 成熟度 / 推荐包：懒加载 pptxgenjs；每图一幻灯片 contain
- Tier：**1**
...
- 继续立项：是
- 建议 slug：`images-to-ppt`（`/tools/images-to-ppt`）
- 与已上线工具关系：**新建**；catalog `image`；Related：`images-to-pdf`, `images-to-word`, `image-merge`
