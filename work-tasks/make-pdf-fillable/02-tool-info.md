...
- 目标主词 / 长尾意图：make a pdf fillable; related Planner absorb terms
- 用户真实任务：Draw fields on static PDF; add text/checkbox fields.
...
| Title (en) / H1 | **Make a PDF fillable** |
| Description 要点 | Draw fields on static PDF; add text/checkbox fields. Files stay on your device; not uploaded to a server. Example in page. |
| FAQ | ≥3 场景/边界/邻页划界 |
...
|---|---|
| 日期 | 2026-09-03 |
| slug 结论 | 保留 `make-pdf-fillable` |
| 主检索词 → title/H1 | **Make a PDF fillable** |
...
|---|---|---|---|---|
| make a pdf fillable | build 主词 | H1 | 进页默认该场景 | |
...
|---|---|
| 日期 | 2026-09-03 |
| 总判 | 满足：进页即 make a pdf fillable 场景 |
| 主词搜索者任务 | Draw fields on static PDF; add text/checkbox fields. |
...
- 输入/输出：Draw fields on static PDF; add text/checkbox fields.
- 核心规则 / 算法：见 Page 实现
