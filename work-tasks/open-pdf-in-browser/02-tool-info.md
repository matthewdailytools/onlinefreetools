...
- 目标主词 / 长尾意图：open a pdf in the browser; related Planner absorb terms
- 用户真实任务：pdf.js viewer; paginate; no edit controls.
...
| 字段 | 内容 |
|---|---|
| 集群 / 优先级 | pdf scene N13 |
| 技术 | pdf-lib / pdf.js CDN；`page.style: opts` |
| Title (en) / H1 | **Open a PDF in the browser** |
| Description 要点 | pdf.js viewer; paginate; no edit controls. Files stay on your device; not uploaded to a server. Example in page. |
| FAQ | ≥3 场景/边界/邻页划界 |
...
|---|---|
| 日期 | 2026-09-03 |
| slug 结论 | 保留 `open-pdf-in-browser` |
| 主检索词 → title/H1 | **Open a PDF in the browser** |
...
|---|---|---|---|---|
| open a pdf in the browser | build 主词 | H1 | 进页默认该场景 | |
...
|---|---|
| 日期 | 2026-09-03 |
| 总判 | 满足：进页即 open a pdf in the browser 场景 |
| 主词搜索者任务 | pdf.js viewer; paginate; no edit controls. |
...
- 输入/输出：pdf.js viewer; paginate; no edit controls.
- 核心规则 / 算法：见 Page 实现
