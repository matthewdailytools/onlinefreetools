...
- 目标主词 / 长尾意图：sign a pdf document; related Planner absorb terms
- 用户真实任务：Draw/type signature; place on page; not PKI.
...
| 字段 | 内容 |
|---|---|
| 集群 / 优先级 | pdf scene N11 |
| 技术 | pdf-lib / pdf.js CDN；`page.style: opts` |
| Title (en) / H1 | **Sign a PDF document** |
| Description 要点 | Draw/type signature; place on page; not PKI. Files stay on your device; not uploaded to a server. Example in page. |
| FAQ | ≥3 场景/边界/邻页划界 |
...
|---|---|
| 日期 | 2026-09-03 |
| slug 结论 | 保留 `sign-pdf-document` |
| 主检索词 → title/H1 | **Sign a PDF document** |
...
|---|---|---|---|---|
| sign a pdf document | build 主词 | H1 | 进页默认该场景 | |
...
|---|---|
| 日期 | 2026-09-03 |
| 总判 | 满足：进页即 sign a pdf document 场景 |
| 主词搜索者任务 | Draw/type signature; place on page; not PKI. |
...
- 输入/输出：Draw/type signature; place on page; not PKI.
- 核心规则 / 算法：见 Page 实现
