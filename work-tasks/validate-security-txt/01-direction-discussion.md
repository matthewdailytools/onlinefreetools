...
- 工具做什么：User enters domain/URL; fetch https://host/.well-known/security.txt (fallback /security.txt); parse Contact/Expires/Preferred-Languages/Canonical per RFC 9116; report missing required fields.
...
**选定主方向**：A  
**次要互链参考**：`website-headers`, `on-page-seo-checker`, `open-graph-preview`
...
- 继续立项：是
- 建议 slug：`validate-security-txt`
- 与已上线工具关系：新建；Related 见上；RFC docs SERP dropped as H1; keep product H1 Validate security.txt.
