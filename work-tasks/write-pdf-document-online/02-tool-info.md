...
**路径**：`/tools/write-pdf-document-online`  
**主方向**：A  
**YMYL**：否  
...
- 目标主词 / 长尾意图：write a pdf document online; related Planner absorb terms
- 用户真实任务：Rich/plain text editor→pdf-lib export multi-page PDF.
...
| 字段 | 内容 |
|---|---|
| 集群 / 优先级 | pdf scene N14 |
| 技术 | pdf-lib / pdf.js CDN；`page.style: opts` |
| Title (en) / H1 | **Write a PDF document online** |
| Description 要点 | Rich/plain text editor→pdf-lib export multi-page PDF. Files stay on your device; not uploaded to a server. Example in page. |
| FAQ | ≥3 场景/边界/邻页划界 |
...
|---|---|
| 日期 | 2026-09-03 |
| slug 结论 | 保留 `write-pdf-document-online` |
| 主检索词 → title/H1 | **Write a PDF document online** |
...
|---|---|---|---|---|
| write a pdf document online | build 主词 | H1 | 进页默认该场景 | |
...
|---|---|
| 日期 | 2026-09-03 |
| 总判 | 满足：进页即 write a pdf document online 场景 |
| 主词搜索者任务 | Rich/plain text editor→pdf-lib export multi-page PDF. |
...
- 输入/输出：Rich/plain text editor→pdf-lib export multi-page PDF.
- 核心规则 / 算法：见 Page 实现
